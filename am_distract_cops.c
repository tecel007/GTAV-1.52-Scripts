...
int func_39(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_71(PLAYER::PLAYER_ID()) || (func_70() && func_69())) && !MISC::IS_BIT_SET(Global_2540384.f_4655, 31)) && !bParam4)
	{
		iVar1 = func_68();
...
void func_76(int iParam0, var uParam1, int iParam2, char* sParam3, char* sParam4)
{
...
void func_78(int iParam0, int iParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5)
{
	int iVar0;
	bool bVar1;
	...
	iVar0 = iParam1;
	bVar1 = false;
	func_79(iParam0, sParam2, iVar0, bVar1, sParam3, bParam4, iParam5);
}

void func_79(int iParam0, char* sParam1, int iParam2, bool bParam3, char* sParam4, bool bParam5, int iParam6)
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_112(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	char cVar1[64];
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || bParam5)
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_117(&cVar1));
		if (!iParam3 == 0)
		{
		...
		func_113(27, sParam0, 1, &cVar1, iParam2, 0, 0, 0, 1, 0, 0, 0);
	}
	return iVar0;
}
	...
	switch (Local_95[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_3)
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_75.f_2, Local_75.f_5, Local_75.f_5, 1000f, false, true, 0))
			{
				...
				MISC::SET_BIT(&(Global_2540384.f_4656), 0);
...
void func_200(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		func_203(0, 1, 0, 1060320051 /* Float: 0.7f */, 1086324736 /* Float: 6f */, 1065353216 /* Float: 1f */, 1088421888 /* Float: 7f */, 1084227584 /* Float: 5f */, 0, 1066192077 /* Float: 1.1f */, 0, 0, 1, 0, 1109393408 /* Float: 40f */);
	}
	func_202(0);
	func_201();
}
...
void func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (MISC::IS_BIT_SET(Global_2425869[Global_2440049.f_2005.f_703.f_16 /*443*/].f_411, 0) && func_208())
		{
			iParam0 = 23;
		}
	}
...
int func_208()
{
	if ((((((func_185(PLAYER::PLAYER_ID()) == 229 || func_185(PLAYER::PLAYER_ID()) == 191) || func_215()) || func_214()) || func_213(PLAYER::PLAYER_ID())) || Global_2515847.f_227 == 1) || (Global_2405074.f_1747 && func_209(PLAYER::PLAYER_ID())))
	{
		return 0;
	}
	return 1;
...
void func_222(vector3 vParam0, int iParam3, int iParam4)
{
...
void func_223(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	func_224(vParam0, 0f, 0f, 0f, fParam3, 0, iParam4, iParam5);
}

void func_224(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7, int iParam8, int iParam9)
{
	struct<12> Var0;

	if (func_233(PLAYER::PLAYER_ID()) || iParam9)
	{
		if (Var0.f_10 == 1)
		{
			func_232(&vParam0, &vParam3);
		}
		Var0 = { vParam0 };
		Var0.f_3 = { vParam3 };
		Var0.f_6 = fParam6;
...
int func_228(vector3 vParam0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
	int iVar0;
		...
		if ((uParam12[iVar0 /*12*/])->f_9)
		{
			switch ((uParam12[iVar0 /*12*/])->f_10)
			{
				case 0:
					...
					{
						case 0:
							if (func_231(vParam0, vParam0.f_6, *(uParam12[iVar0 /*12*/]), (uParam12[iVar0 /*12*/])->f_6))
							{
								return 0;
							}
							break;
						case 1:
							if (func_229(vParam0, vParam0.f_3, *(uParam12[iVar0 /*12*/]), (uParam12[iVar0 /*12*/])->f_6))
							{
								return 0;
							}
							break;
...
bool func_229(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	return func_230(vParam0, vParam3, vVar0, vVar3);
}

int func_230(vector3 vParam0, vector3 vParam3, vector3 vParam6, vector3 vParam9)
{
...
int func_231(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
...
void func_241(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	func_242(vParam0, 0f, 0f, 0f, fParam3, 0, iParam4, iParam6, iParam5, iParam7);
}

void func_242(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	struct<12> Var0;
