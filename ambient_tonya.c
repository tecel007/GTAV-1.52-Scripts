...
void func_5(int iParam0)
{
	...
	MemCopy(&Global_61732, {func_10(iParam0)}, 4);
	Global_61720 = 0;
	Global_61719 = 0;
	switch (iParam0)
	{
...
{
	Global_61736 = 0;
	Global_61740 = func_16(joaat("SP0_SHOTS"));
	Global_61739 = func_16(joaat("SP0_HITS"));
	Global_61742 = func_16(joaat("SP1_SHOTS"));
	Global_61741 = func_16(joaat("SP1_HITS"));
	Global_61744 = func_16(joaat("SP2_SHOTS"));
	Global_61743 = func_16(joaat("SP2_HITS"));
}
...
void func_24(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_98955 != 10 && Global_98955 != 9)
	{
		...
		func_26(&Global_102423, cParam0, 0, "Start", iParam1, iParam2);
		func_25();
		Global_93133 = 0;
	}
}
...
void func_49(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				uParam1->f_59 = func_50(2052, iParam3, 0);
			}
			else
			{
...
void func_57()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_47(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_37(iVar0) && (!func_58(14) || Global_110809))
			{
...
void func_59(int iParam0, bool bParam1)
{
	...
	if (func_37(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_60(iParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_62(Var11.f_1)) && iVar72 < 51)
			{
...
Vector3 func_78(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 44:
			...
			break;
		case 45:
			return func_89(Global_101058);
		case 46:
			if (Global_1590519 != func_88())
			{
				if (func_87(Global_1590519))
				{
					return func_80(2, 2);
				}
				else if (func_79(Global_1590519))
				{
					return func_80(45, 3);
				}
				else
...
void func_113(int iParam0)
{
	...
	func_114(iParam0);
	iLocal_248 = SYSTEM::START_NEW_SCRIPT(sVar0, 37500);
...
{
	if ((func_137() && Global_98955.f_11 == 6) && iParam0 == func_136(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
{
	return func_139(iParam0, Global_41631);
}
...
int func_142(int iParam0)
{
	...
	iVar0 = func_144(&(Global_110945[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_155()) || Global_110905) || Global_30970) || func_154()) || func_153(8, -1)) || func_94()) || func_152()) || func_151()) || func_150()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_155()) || Global_30970) || func_154()) || func_153(8, -1)) || func_151()) || func_94()) || func_152()) || func_150()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_155()) || Global_110905) || Global_30970) || func_154()) || func_153(8, -1)) || func_151()) || func_94()) || func_152()) || func_150()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_155()) || Global_110905) || Global_30970) || func_154()) || func_153(8, -1)) || func_94()) || func_152()) || func_150()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_155() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_153(8, -1)) || func_150()) || func_149()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_184(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_184(iParam0) };
