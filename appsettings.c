...
void __EntryFunction__()
{
	...
	func_46(Global_19662, "SET_DATA_SLOT_EMPTY", 13f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_45();
	if (Global_19626 == 0)
	{
		fLocal_63 = 0.75f;
	...
	while (iVar0 < 9)
	{
		...
		else if (MISC::ARE_STRINGS_EQUAL(&(Global_111858.f_14047[Global_19681 /*20*/].f_11), &(Global_8356[Global_19681 /*2811*/][1 /*281*/].f_144[iVar0 /*6*/])))
		{
...
void func_12()
{
	...
	if (iLocal_43 == 1)
	{
		...
		if ((((func_10(2, Global_19657, 0) || func_10(2, Global_19658, 0)) || bLocal_51) || iLocal_65 == 1) || iLocal_66 == 1)
		{
			iLocal_65 = 0;
			iLocal_66 = 0;
			bLocal_51 = false;
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					{
						if (MISC::ARE_STRINGS_EQUAL(&(Global_8356[Global_19681 /*2811*/][1 /*281*/].f_144[iLocal_47 /*6*/]), "Silent Ringtone Dummy"))
						{
						}
						else
						{
							AUDIO::PLAY_PED_RINGTONE(&(Global_8356[Global_19681 /*2811*/][1 /*281*/].f_144[iLocal_47 /*6*/]), PLAYER::PLAYER_PED_ID(), true);
						}
					}
				}
			}
	...
	if (Global_19659 == 0)
	{
		if (func_10(2, Global_19650, 0))
		{
			...
			if (iLocal_43 == 2)
			{
				...
				func_46(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				if (Global_76833)
				{
					Global_4271300 = Global_8356[3 /*2811*/][2 /*281*/].f_259;
					func_20(2029, Global_8356[3 /*2811*/][2 /*281*/].f_259, -1, 1, 0);
					func_46(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_4271300), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				}
				else
				{
					func_46(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				...
				iLocal_45 = iLocal_46;
				func_46(Global_19662, "DISPLAY_VIEW", 22f, SYSTEM::TO_FLOAT(iLocal_46), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			}
			if (iLocal_43 == 4)
			{
				...
				if (Global_76833)
				{
					...
					if (Global_4271301 == 0)
					{
						...
						if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var17) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4271304 == 0)
						{
							SYSTEM::SETTIMERA(0);
						...
						{
							func_46(Global_19662, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(0), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
						}
					}
					else
					{
						func_46(Global_19662, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(Global_4271301), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
					}
				}
				else
				{
					func_46(Global_19662, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_9), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				}
				func_18(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_45), SYSTEM::TO_FLOAT(23), -1f, -1f, &(Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_7[iLocal_18[iLocal_45] /*4*/]), 0, 0, 0, 0);
				func_18(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(22), SYSTEM::TO_FLOAT(iLocal_46), SYSTEM::TO_FLOAT(48), -1f, -1f, &(Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_7[iLocal_18[iLocal_46] /*4*/]), 0, 0, 0, 0);
				iLocal_45 = iLocal_46;
				...
				else
				{
					...
					if (Global_8356[Global_19681 /*2811*/][0 /*281*/].f_259 == 2)
					{
						if (Global_41631 == 15)
						{
							...
							{
								func_46(Global_19662, "SET_SLEEP_MODE", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
					...
					{
						func_46(Global_19662, "SET_SLEEP_MODE", 0f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
						MISC::CLEAR_BIT(&Global_7551, 25);
						MISC::SET_BIT(&Global_7552, 11);
					}
				}
...
void func_27()
{
	...
	func_46(Global_19662, "SET_DATA_SLOT_EMPTY", 22f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	iLocal_39 = 0;
	iVar20 = 0;
	if (Global_76833)
	{
	...
	while (iVar20 < 19)
	{
		...
		iVar0[iVar35] = 1;
		if (MISC::ARE_STRINGS_EQUAL(&(Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_7[Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_259 /*4*/]), &(Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_7[iVar35 /*4*/])))
		{
			iLocal_48 = iVar20;
			if (iLocal_48 < 0)
			{
	...
	func_46(Global_19662, "DISPLAY_VIEW", 22f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_13(Global_19662, "SET_HEADER", &(Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_7[Global_8356[Global_19681 /*2811*/][iLocal_43 /*281*/].f_259 /*4*/]), 0, 0, 0, 0);
	if (Global_19669)
	{
...
void func_29()
{
	func_46(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_31()
{
	func_46(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19670, true);
	func_32();
}
...
void func_33()
{
	...
	func_46(Global_19662, "DISPLAY_VIEW", 13f, SYSTEM::TO_FLOAT(iLocal_44), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_36()
{
	...
	{
		if (func_40(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
