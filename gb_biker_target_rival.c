...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_2540384.f_5188.f_750 == 0)
		{
			func_79();
		}
		switch (iLocal_35)
...
int func_1()
{
	...
	if (func_7(1))
	{
		iVar0 = Global_2540384.f_5188.f_749;
		if (iVar0 != func_6())
		{
			if (func_4(iVar0))
			{
...
void func_2(int iParam0)
{
	...
	Global_2540384.f_5188.f_749 = func_6();
}
			...
			else
			{
				switch (iVar1)
				{
					...
					case 261:
						return func_60(11);
					case 254:
						if (PLAYER::GET_PLAYER_TEAM(iParam0) == PLAYER::GET_PLAYER_TEAM(Global_2440049))
						{
							return func_60(6);
						}
						else
					...
					case 163:
					case 164:
						if (func_59(Global_2440049, iParam0, -2, 0))
						{
							return func_60(6);
						}
						else
					...
					case 418:
						return func_60(10);
					case 364:
						if (func_20(Global_2440049, iParam0, 1))
						{
							return func_60(10);
						}
						else
					...
					case 417:
						...
						else if (func_20(Global_2440049, iParam0, 1))
						{
							return func_60(6);
						}
						else
...
int func_16(int iParam0)
{
	if (iParam0 != func_6())
	{
		if (func_5(iParam0, 1, 1))
		{
			...
			{
				return func_17(Global_2425869[iParam0 /*443*/].f_314.f_6) == 16;
			}
		}
	}
	return 0;
...
int func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_54(PLAYER::PLAYER_ID()) || (func_53() && func_52())) && !MISC::IS_BIT_SET(Global_2540384.f_4655, 31)) && !bParam4)
	{
		iVar1 = func_51();
...
int func_64(var uParam0, var uParam1, int* iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	if (bParam5)
	{
...
void func_79()
{
	func_2(Global_2540384.f_5188.f_749);
