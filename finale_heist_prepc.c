#region Local Var
	...
	vector3 vLocal_193[3] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	iLocal_149 = -1;
	vLocal_151 = { 0f, 0f, 0f };
	vLocal_154 = { -1154.086f, -2006.297f, 12.1803f };
	vLocal_160 = { -442.5602f, -2184.605f, 14.55648f };
	vLocal_163 = { -442.668f, -2172.496f, 9.39933f };
	fLocal_166 = 13.47f;
	...
	if (func_452(0))
	{
		func_418(func_450(), 96, 25000, 0, 0);
	}
	while (true)
	{
		func_417();
		if (func_416(PLAYER::PLAYER_PED_ID()))
		{
			func_414();
			func_401();
			func_397();
...
void func_1()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(iLocal_143))
			{
				func_16(iLocal_143);
			}
			else
		...
		case 1:
			if (func_7())
			{
				...
				if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_119))
				{
					OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Local_119, 0f, true, false);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119, 1, true, true);
				}
				func_2();
				func_462();
			}
...
void func_8(int iParam0)
{
	...
	if (Global_111858.f_9081 || func_452(0))
	{
		iVar0 = func_15();
		if (!func_9(iVar0))
		{
...
int func_9(int iParam0)
{
	...
	func_10(&(Global_111858.f_2359.f_539), iVar1);
...
void func_10(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_12(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_20()
{
	...
	func_203(&iLocal_176, &iLocal_177, &iLocal_95, &iLocal_147, &iLocal_146, vLocal_157, 0, 0, 1090519040 /* Float: 8f */);
	func_196();
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				...
				if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_96))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_96, joaat("PROP_COM_GAR_DOOR_01"), -440.0606f, -2171.827f, 11.3672f, true, true, false);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_96, 1, true, true);
				}
				if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_119))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(Local_119, joaat("PROP_COM_GAR_DOOR_01"), -445.3054f, -2171.827f, 11.3672f, true, true, false);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119, 1, true, true);
				}
		...
		case 1:
			iVar0 = -1;
			iVar1 = 0;
			func_62(&iLocal_146, vLocal_157, &iLocal_94, iLocal_95, &iLocal_145, &iLocal_174);
			if (func_51(iLocal_176, vLocal_157, &iLocal_146, iLocal_95, iLocal_94, &iLocal_172, &bLocal_175, &iVar0, &iVar1, &iLocal_145, 7f))
			{
		...
		case 3:
			if (func_4(iLocal_176))
			{
				...
				{
					func_34(iLocal_176, vLocal_157, 126.0705f, 0, 1);
					func_21(1, 1, 1);
					iLocal_93 = 1;
				}
			}
...
void func_24(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
void func_35()
{
	...
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119, 2, true, true);
	func_42(1, func_43());
	if (func_4(iLocal_176))
	{
...
void func_36(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_452(0) && Global_77079.f_1 == 1) && func_37(Global_77079))
		{
		}
		else
		{
...
void func_38(int iParam0)
{
	...
	{
		if (Global_61942[Global_73813[iVar0 /*9*/] /*13*/] == 12)
		{
...
int func_50()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_160, vLocal_163, fLocal_166, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_51(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	float fVar0;
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_56(PLAYER::PLAYER_PED_ID(), vParam1, fVar0))
					{
						*iParam7 = 0;
						func_55(1077936128 /* Float: 3f */, 1);
					}
				}
				func_19(iParam4);
			}
...
bool func_56(int iParam0, vector3 vParam1, float fParam4)
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_57(int iParam0, vector3 vParam1, int iParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_58(vParam1, 5, iParam4);
	}
}

int func_58(vector3 vParam0, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_62(int* iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	switch (*iParam4)
	{
		case 0:
...
int func_65(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			else if (func_192(1, vLocal_151, 0))
			{
				if (!func_456())
				{
					if (func_190())
					...
					else if (func_192(2, vLocal_151, 0))
					{
						func_189(func_41());
						return 1;
					}
		...
		case 1:
			if (bParam1)
			{
				if (func_192(2, vLocal_151, 0))
				{
					...
					if (func_4(Local_178))
					{
						iLocal_176 = Local_178;
						PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_178, -1);
						PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), false, false);
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(Local_178);
						if (func_452(0))
						{
							if (!DECORATOR::DECOR_EXIST_ON(Local_178, "MapGauntlet"))
							{
								DECORATOR::DECOR_SET_INT(Local_178, "MapGauntlet", 0);
							}
						}
					}
					if (!func_456())
		...
		case 2:
			if (bParam1)
			{
				if (func_192(2, vLocal_154, 134.0846f))
				{
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("GAUNTLET"), true);
					func_77();
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_178, -1);
					...
					func_188();
					bLocal_28 = false;
					func_66(vLocal_154, 1112014848 /* Float: 50f */, 12, 5000, 0, 0);
					func_21(1, 1, 1);
				}
			}
			else
		...
		case 4:
			if (bParam1)
			{
				if (func_192(2, vLocal_157, 181.3192f))
				{
					func_77();
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("GAUNTLET"), true);
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_178, -1);
...
void func_66(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
void func_77()
{
	...
	if (Global_98955.f_12[0] == 1)
	{
		func_187(&vVar0, &uVar3);
		if (!func_4(Local_178))
		{
			func_79(&Local_178, vVar0, uVar3, 1, 0, 0, 0, 1, joaat("ASTEROPE"), 0, 145, 1);
		}
		func_78(Local_178, 0);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_178, true);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("GAUNTLET"), true);
		if (!func_456())
		{
			func_66(vVar0, 80f, 12, 5000, 0, 0);
		}
	}
}
...
void func_79(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;

	iVar0 = 1;
	if (!func_456() || !func_186())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_161(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_160(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105407.f_2890 };
			fParam4 = Global_105407.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, true, false, false, false);
		func_151(vParam1, 5f, 0);
		if (func_150(iParam12))
		{
			func_148(iParam12, 0);
			while (!func_80(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_80(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_142(iParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_142(iParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_85(iParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_84(*iParam1);
				...
				func_82(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111858.f_20114[iParam0 /*43*/].f_1));
				...
				func_82(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111858.f_20114[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_82(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_83(iVar0, &uVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_83(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
...
int func_88(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			...
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_94(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_95(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_99(int iParam0)
{
	...
	if (func_100(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_112(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_91())
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_113(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_91())
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_114(int iParam0)
{
	if (iParam0 != func_91())
	{
		if (func_90(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_89(Global_2425869[iParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
...
void func_117(int iParam0, int iParam1)
{
	...
	func_118(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_138(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_138(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_148(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96286[iVar0]) == func_149(iParam0, iParam1))
				{
...
void func_152(int iParam0)
{
	...
	if (func_159(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_158(iParam0, 0)) && Global_76563.f_66 == 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] != 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] > 3) && (!func_156(0, Global_75654.f_555[0 /*21*/].f_12) || !func_156(1, Global_75654.f_555[0 /*21*/].f_12)))
			{
				func_155(&(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]), &Global_76563);
...
int func_156(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_157(&(Global_111858.f_32745.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_124(Global_111858.f_32745.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_159(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_160(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_160(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_160(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_160(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_161(vector3 vParam0, float fParam3)
{
	return func_162(&(Global_105407.f_2890), vParam0, fParam3, 0);
}

int func_162(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_164(int iParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_166(iParam0, Global_75654.f_139[38], 0))
			{
				func_152(38);
				return 1;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_166(iParam0, Global_75654.f_139[43], 1))
			{
				func_152(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_160(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_165(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_179(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("STUNT") && func_165(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608 /* Float: 0.5f */, 0))
	{
		return 0;
	}
	return 1;
...
bool func_180()
{
	return func_178(&(Global_105407.f_2890));
}

void func_181()
{
	func_182(&(Global_105407.f_2890));
}
...
int func_183(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_185(Global_105407.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_186()
{
	return func_179(&(Global_105407.f_2890));
}

void func_187(var uParam0, float fParam1)
{
	*uParam0 = { Global_102423.f_2884 };
	*fParam1 = Global_102423.f_2884.f_3;
}
...
int func_190()
{
	if (func_4(Global_95452[func_191()]))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_95452[func_191()], false))
		{
...
int func_192(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_165(vParam1, vLocal_151, 1056964608 /* Float: 0.5f */, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 2:
			if (func_4(Global_95452[func_191()]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[func_191()], true, true);
				Local_178 = Global_95452[func_191()];
				if (func_4(Local_178))
				{
					iLocal_176 = Local_178;
					func_78(Local_178, 0);
			...
			else if (Global_98955.f_12[0] != 1 || func_452(0))
			{
				if (func_193(&Local_178, Local_178.f_6, Local_178.f_1, Local_178.f_4, 1))
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_178, Local_178.f_5);
					func_78(Local_178, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_178, true);
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("GAUNTLET"), true);
					return 1;
...
int func_193(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_196()
{
	if (func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 50f))
	{
		if (!bLocal_167)
		{
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_96, true);
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_119, true);
			AUDIO::START_AUDIO_SCENE("BIG_SCORE_PREP_C_GARAGE_DOOR");
			bLocal_167 = true;
		}
	}
	else if (!func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 70f))
	{
		if (bLocal_167)
		{
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_96, false);
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_119, false);
...
void func_199(int iParam0)
{
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(*iParam0))
	{
		if (iParam0->f_22 != 0)
		{
			...
			{
				iParam0->f_22 = 3;
				OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(*iParam0, iParam0->f_1, true, true);
				iParam0->f_1 = (iParam0->f_1 - (0.2f * SYSTEM::TIMESTEP()));
				if (iParam0->f_1 <= 0f || (iLocal_92 == 4 && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 100f)))
				{
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(*iParam0, 1, true, true);
					iParam0->f_1 = 0f;
					OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(*iParam0, iParam0->f_1, true, true);
					iParam0->f_22 = 0;
				}
			}
			else if (iLocal_92 == 4 && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 100f))
			{
...
int func_202(struct<15> Param0, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22)
{
	if (func_4(iLocal_176))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_176, false) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_176, vLocal_160, vLocal_163, fLocal_166, false, true, 0))
		{
...
void func_203(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, vector3 vParam5, int iParam8, bool bParam9, float fParam10)
{
	if (func_4(*iParam0))
	{
		switch (*iParam2)
...
int func_210(int iParam0)
{
	...
	if ((func_416(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_4(iParam0))
	{
...
void func_212()
{
	func_203(&iLocal_176, &iLocal_177, &iLocal_95, &iLocal_147, &iLocal_146, vLocal_157, 0, 1, 1090519040 /* Float: 8f */);
	func_196();
	func_240();
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
			{
				func_57(&iLocal_146, vLocal_157, 1);
		...
		case 1:
			...
			if (func_223(iLocal_176, vLocal_157, &iLocal_146, iLocal_94, iLocal_95, &iLocal_145, &bLocal_175, 0, 0, 1086324736 /* Float: 6f */) && func_50())
			{
				iLocal_93 = 2;
			}
			break;
		case 2:
			...
			func_19(&iLocal_146);
			func_19(&iLocal_147);
			if (func_55(1077936128 /* Float: 3f */, 1))
			{
				if (func_4(iLocal_176))
				{
					RECORDING::_0x293220DA1B46CEBC(5f, 5f, 4);
		...
		case 3:
			if (func_4(iLocal_176))
			{
				...
				{
					func_34(iLocal_176, vLocal_157, 173.684f, 0, 1);
					func_21(1, 1, 1);
					iLocal_93 = 1;
				}
			}
...
int func_216(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (!MISC::IS_BIT_SET(Global_94809, iVar0))
		{
			return 0;
		}
		MISC::CLEAR_BIT(&Global_94809, iVar0);
		return 1;
	}
	return 0;
}
...
int func_221(int iParam0)
{
	...
	return Global_96433[func_222(iParam0)];
}
...
int func_223(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, float fParam11)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_228(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true))
			{
				...
				{
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, false), vLocal_154, 4, 20f, 786469, 2f, 10f, true);
				}
			}
			else
			{
...
int func_227(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_94808, iVar0))
		{
			...
			MISC::SET_BIT(&Global_94809, iVar0);
			return 1;
		}
	}
	return 0;
...
int func_228(int iParam0)
{
	if (!func_229())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_176) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_176, false)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_176, vLocal_154, 2f, 2f, 2f, false, true, 0))
		{
...
int func_235(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_236(iParam1)];
...
void func_240()
{
	if (func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 100f))
	{
		func_241(0, 80);
		func_241(1, 81);
		func_241(2, 82);
	}
	else if (func_56(PLAYER::PLAYER_PED_ID(), vLocal_157, 120f))
	{
		func_3(0);
		func_3(1);
		func_3(2);
...
void func_241(int iParam0, int iParam1)
{
	if (!iLocal_189[iParam0])
	{
		if (func_242(iParam1))
		{
			if (func_193(&(uLocal_185[iParam0]), joaat("GAUNTLET"), vLocal_193[iParam0 /*3*/], fLocal_203[iParam0], 1))
			{
				iLocal_189[iParam0] = 1;
				func_167(uLocal_185[iParam0], &(Global_111858.f_32745.f_4803[iParam0 /*78*/]), 0, 1);
...
void func_243()
{
	func_203(&iLocal_176, &iLocal_177, &iLocal_95, &iLocal_147, &iLocal_146, vLocal_154, 0, 0, 1090519040 /* Float: 8f */);
	switch (iLocal_93)
	{
		case 0:
			if (func_65(iLocal_92, bLocal_28))
		...
		case 1:
			...
			else
			{
				...
				func_57(&iLocal_146, vLocal_154, 1);
			}
			break;
		case 2:
...
int func_245()
{
	...
	if (func_246(4) == func_450())
	{
		return Global_4268288;
	}
	switch (func_450())
	{
		case 0:
...
void func_247()
{
	...
	switch (iLocal_93)
	{
		...
		case 1:
			...
			func_62(&iLocal_146, vLocal_154, &iLocal_94, iLocal_95, &iLocal_145, &iLocal_174);
			func_226();
			if (func_225(iLocal_176))
			{
				func_19(&iLocal_146);
			...
			if (func_223(iLocal_176, vLocal_154, &iLocal_146, iLocal_94, iLocal_95, &iLocal_145, &bLocal_175, 0, 1, 1086324736 /* Float: 6f */) || func_232())
			{
		...
		case 3:
			if (func_4(iLocal_176))
			{
				...
				{
					func_34(iLocal_176, vLocal_154, 146.5443f, 0, 1);
					func_21(1, 1, 1);
					iLocal_93 = 1;
				}
			}
...
int func_262(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_310(iVar10, iParam1, iParam2, -1) };
		if (!func_309(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_310(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_310(iVar10, 14, uVar28[iVar1], -1) };
							func_282(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_304(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_272(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_304(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_310(iVar10, iVar0, func_271(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_310(iVar10, 14, uVar69[iVar1], -1) };
			func_282(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_304(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_272(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_272(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
int func_263(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_375(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76647[1 /*14*/] = { func_310(iParam0, iParam1, iParam2, -1) };
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_375(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_284(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_272(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_272(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_285(iParam0, func_272(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_289(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_297(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_297(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_297(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_296(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_296(vVar16.z)] = func_289(iParam1, vVar16.x, func_296(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					(*uParam0)[func_296(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
void func_304(int iParam0)
{
	...
	{
		func_308(iParam0, Global_76647[1 /*14*/].f_5, Global_76647[1 /*14*/].f_2, 2, Global_76647[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_305(Global_2621444, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_306(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2551832[iParam0 /*3*/][func_236(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_307(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_312(int iParam0)
{
	...
	func_313(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_313(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_317(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_317(Global_2621444, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_235(func_316(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_235(func_315(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_235(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_320(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_313(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_313(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_313(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_313(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_272(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_310(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_375(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_375(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_310(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_375(iParam0, 14, iVar4))
										{
											if (!func_268(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_310(iVar0, iVar2, iVar1, -1) };
						if (!func_268(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_272(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_272(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_380(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_394(iParam5, &Var0, vParam1, fParam4, func_136(iParam0));
...
void func_381(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_383();
			}
...
void func_394(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_159(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_395(iParam0);
			func_155(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_401()
{
	if (!bLocal_28 && iLocal_92 != 5)
	{
		...
		{
			func_411();
			if (iLocal_92 <= 2 && func_410() != 21)
			{
				if (!func_408(bLocal_170, 11000))
				{
					func_407(4);
				}
				if (!bLocal_170 && func_403())
				{
					func_407(5);
				}
				if (func_402(39))
...
int func_403()
{
	...
	if (func_4(iLocal_176))
	{
		...
		if ((func_406(iVar0) - func_404(iLocal_176)) < 11000)
		{
			return 1;
		}
	}
...
void func_407(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			break;
		case 1:
			iLocal_143 = "PRF_FWRECK";
			break;
		case 2:
			iLocal_143 = "PRF_FFAR";
			break;
		case 3:
			iLocal_143 = "PRF_FSTUCK";
			break;
		case 4:
			iLocal_143 = "PRF_CASH";
			break;
		case 6:
			iLocal_143 = "PRF_FKICKOFF";
			break;
		case 5:
			iLocal_143 = "PRF_CASH";
			break;
...
void func_411()
{
	...
	if (!func_4(iLocal_176))
	{
		if (!func_4(iLocal_177) && !func_4(Local_178))
		{
			func_407(1);
			return;
		}
		if (func_4(Local_178) && !func_413(PLAYER::PLAYER_PED_ID(), Local_178, 500f, 1))
		{
			func_407(2);
		}
	}
	...
	{
		iVar0 = 0;
		if (!func_413(PLAYER::PLAYER_PED_ID(), iLocal_176, 500f, 1))
		{
			iVar0++;
		}
		if (func_4(iLocal_177))
		{
			if (!func_413(PLAYER::PLAYER_PED_ID(), iLocal_177, 500f, 1))
			{
				iVar0++;
			}
		}
		...
		if (func_4(Local_178))
		{
			if (!func_413(PLAYER::PLAYER_PED_ID(), Local_178, 500f, 1))
			{
				iVar0++;
			}
		}
		...
		iVar0 = 0;
		if (func_412(iLocal_176))
		{
			iVar0++;
		}
		if (func_4(iLocal_177))
		{
			if (func_412(iLocal_177))
			{
				iVar0++;
			}
		}
...
bool func_413(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_418(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;

	if (func_449(iParam0) == 3)
	{
		return;
	}
	...
	func_419(func_449(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_419(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_447(99, 1);
					func_446(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
				case 1:
					func_446(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
				case 2:
					func_446(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			func_431(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_446(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						case 1:
							func_446(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						case 2:
							func_446(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
					if (func_427(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_446(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						case 1:
							func_446(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						case 2:
							func_446(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				case 25:
					...
					{
						case 0:
							func_446(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						case 1:
							func_446(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						case 2:
							func_446(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				case 99:
				...
				case 113:
					...
					{
						case 0:
							func_446(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						case 1:
							func_446(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						case 2:
							func_446(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("CLOTHES_SHOP_SP"):
							...
							{
								case 0:
									func_446(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								case 1:
									func_446(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								case 2:
									func_446(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						case joaat("HAIRDO_SHOP_SP"):
							...
							{
								case 0:
									func_446(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								case 1:
									func_446(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								case 2:
									func_446(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
							if (func_427(0))
							{
						...
						case joaat("GUNCLUB_SHOP"):
							...
							{
								case 0:
									func_446(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								case 1:
									func_446(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								case 2:
									func_446(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						case joaat("CARMOD_SHOP"):
							...
							{
								case 0:
									func_446(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								case 1:
									func_446(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								case 2:
									func_446(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
							func_426(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_446(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
				case 1:
					func_446(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
				case 2:
					func_446(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
		case 0:
...
void func_422(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_424() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_424() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_423(iParam0));
...
bool func_425(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_427(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_428(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_428(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_428(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_428(137, -1, -1);
	}
	if (iParam0 == 12)
	{
		iVar0 = UNK_0x5A002C4821A13338();
		iVar1 = func_235(8270, -1, 0);
	...
	return MISC::IS_BIT_SET(Global_2097152[func_424() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_428(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_430(iParam0, iParam1);
	uVar2 = func_429(iParam0);
	if (0 != iVar1)
	{
...
int func_432(int iParam0, int iParam1)
{
	...
	return func_433(iParam0, iParam1);
}

int func_433(int iParam0, int iParam1)
{
	if (func_318(14) && !func_444(iParam0))
	{
		return 0;
	}
	...
	if (func_443(&Global_4271324))
	{
		if (func_441(&Global_4271324, iParam0))
		{
			return 0;
		}
		if (func_434(&Global_4271324, iParam0))
		{
			return 1;
		}
	}
...
int func_434(var uParam0, int iParam1)
{
	...
	if (func_318(14) && !func_444(iParam1))
	{
		return 0;
	}
...
void func_437(var uParam0)
{
	...
	func_439(uParam0, (Global_4271323 - 0.5f));
}
...
{
	return func_442(uParam0, iParam1) != -1;
}
...
void func_451()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_218(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_217(PLAYER::PLAYER_PED_ID());
			if (func_150(iVar0) && (!func_318(14) || Global_110809))
			{
				if (Global_111858.f_2359.f_539.f_4321 != iVar0 && func_150(Global_111858.f_2359.f_539.f_4321))
				{
...
void func_453()
{
	...
	{
		case 80:
			vVar0 = { -311.1739f, -771.6993f, 52.2467f };
			fVar3 = 182.106f;
			break;
		case 81:
			vVar0 = { -657.8753f, -272.2921f, 34.7628f };
			fVar3 = 30.6575f;
			break;
		case 82:
			vVar0 = { 307.123f, -1084.801f, 28.3597f };
			fVar3 = 299.7018f;
			break;
	}
	if (Global_98955.f_12[0] != 1)
	{
		if ((!func_76() && !func_456()) && !func_452(0))
		{
			func_455(PLAYER::PLAYER_PED_ID(), vVar0, fVar3);
		}
		else
		{
			func_454(vVar0, fVar3, 1, 0);
		}
	}
	else
	{
		func_187(&vVar0, &fVar3);
		if ((!func_76() && !func_456()) && !func_452(0))
		{
			func_455(PLAYER::PLAYER_PED_ID(), vVar0, fVar3);
		}
...
void func_454(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_456())
	{
...
void func_455(int iParam0, vector3 vParam1, float fParam4)
{
	if (func_416(iParam0))
	{
...
void func_458()
{
	Local_96 = { func_459(1616809629, -440.0352f, -2172.502f, 9.39933f, -440.1235f, -2166.841f, 12.3181f, -440.1479f, -2166.364f, 9.3181f, -439.9046f, -2174.041f, 12.39933f, -442.2598f, -2169.643f, 9.31843f, -438.0615f, -2173.349f, 13.31699f) };
	Local_119 = { func_459(-1380475172, -445.3699f, -2172.47f, 9.39933f, -445.3286f, -2166.688f, 12.31802f, -445.492f, -2166.232f, 9.31686f, -445.2189f, -2174.173f, 12.39933f, -447.3654f, -2169.836f, 9.30682f, -443.38f, -2173.165f, 12.31856f) };
}

struct<23> func_459(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, vector3 vParam13, vector3 vParam16)
{
	struct<23> Var0;
	...
	Var0.f_11 = { vParam10 };
	Var0.f_14 = 4.86f;
	Var0.f_15[0 /*3*/] = { vParam13 };
	Var0.f_15[1 /*3*/] = { vParam16 };
	return Var0;
}
...
void func_460()
{
	...
	{
		case 80:
			Local_178 = { func_461(-311.1739f, -771.6993f, 52.2467f, 182.106f, joaat("GAUNTLET"), 13) };
			vLocal_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
		case 81:
			Local_178 = { func_461(-657.8753f, -272.2921f, 34.7628f, 30.6575f, joaat("GAUNTLET"), 4) };
			vLocal_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
		case 82:
			Local_178 = { func_461(307.123f, -1084.801f, 28.3597f, 299.7018f, joaat("GAUNTLET"), 0) };
			vLocal_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
	}
	iLocal_189[0] = 0;
	iLocal_189[1] = 0;
	iLocal_189[2] = 0;
	vLocal_193[0 /*3*/] = { -438.2076f, -2181.515f, 9.3253f };
	vLocal_193[1 /*3*/] = { -442.1008f, -2181.29f, 9.3195f };
	vLocal_193[2 /*3*/] = { -445.3427f, -2181.132f, 9.3183f };
	fLocal_203[0] = 181.2117f;
	fLocal_203[1] = 180.056f;
	fLocal_203[2] = 181.0495f;
}

struct<7> func_461(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	struct<7> Var0;
...
void func_462()
{
	...
	func_46();
	func_464();
	func_463(joaat("GAUNTLET"), 1, 1, 90000);
...
void func_463(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	bool bVar0;
	int iVar1;
	...
	bVar0 = false;
	iVar1 = 0;
	while (iVar1 < Global_30979)
	{
		if (bParam2)
		{
			if (Global_30979[iVar1] == 0 && !bVar0)
			{
				Global_30979[iVar1] = iParam0;
				Global_30990[iVar1] = bParam1;
				Global_31001[iVar1] = (MISC::GET_GAME_TIMER() + iParam3);
				Global_31012 = 1;
				bVar0 = true;
			}
			else if (Global_30979[iVar1] == iParam0)
			{
				Global_30979[iVar1] = iParam0;
				Global_30990[iVar1] = bParam1;
				Global_31001[iVar1] = (MISC::GET_GAME_TIMER() + iParam3);
