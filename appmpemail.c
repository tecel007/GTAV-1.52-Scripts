...
void __EntryFunction__()
{
	...
	Global_19863 = 0;
	func_59();
	func_58(Global_19662, "SET_DATA_SLOT_EMPTY", 8f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_53();
	func_51();
...
void func_6()
{
	func_58(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_9()
{
	func_58(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19670, true);
	func_10();
}
...
void func_13()
{
	...
	{
		case 6:
			func_58(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_20(Global_8156);
			if (Global_8156 == 1)
			{
				func_58(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19685), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				Global_19661 = Global_19685;
			}
			else
			{
				func_58(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19686), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		case 7:
			break;
		case 10:
			func_58(Global_19662, "DISPLAY_VIEW", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		case 9:
			...
			{
				func_17();
				func_58(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				if (Global_21018)
				{
			...
			else if (Global_21005 == 4 || Global_21005 == 3)
			{
				...
				else
				{
					...
					if (func_23(Global_6866, Global_19681) == 0)
					{
						func_58(Global_19662, "SET_DATA_SLOT_EMPTY", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	...
	if (Global_19659 == 0)
	{
		if ((func_3(2, Global_19650, 0) || Global_4271009 == 1) || Global_22065 == 1)
		{
			...
			if (iLocal_34 == iLocal_33 || iLocal_34 > iLocal_33)
			{
				...
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				func_22(Global_19662, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
				func_58(Global_19662, "DISPLAY_VIEW", 9f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_38(int iParam0)
{
	...
	while (iVar0 < Global_111858.f_14137[iParam0 /*104*/].f_49)
	{
		...
		{
			case 4:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2540384.f_1722[iVar0 /*4*/]));
				break;
			case 5:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663783[iVar0 /*4*/]));
				break;
			case 6:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663824[iVar0 /*4*/]));
				break;
			case 7:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663845[iVar0 /*4*/]));
				break;
			case 8:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663862[iVar0 /*4*/]));
				break;
			case 9:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663875[iVar0 /*4*/]));
				break;
			case 10:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663888[iVar0 /*4*/]));
				break;
			case 11:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1663901[iVar0 /*4*/]));
				break;
		}
		iVar0++;
	}
		...
		while (iVar0 < 59)
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_4269759[iLocal_36 /*104*/]), &(Local_62[iVar0 /*6*/])))
			{
				if (func_43(&(Local_62[iVar0 /*6*/])))
				{
					...
					StringIntConCat(&cLocal_46, Global_1694998, 64);
				}
				else
				{
...
void func_45()
{
	...
	fVar0 = func_46(vLocal_1366, vLocal_1363, Global_19641, -90f, 0f, 90f, 350f, 0);
...
float func_46(vector3 vParam0, vector3 vParam3, vector3 vParam6, vector3 vParam9, float fParam12, bool bParam13)
{
	...
	if (fVar3 < 1f)
	{
		...
		Global_19609 = { func_47(vParam0, vParam3, fVar4) };
		Global_19612 = { func_47(vParam6, vParam9, fVar4) };
	}
	else
	{
...
void func_50()
{
	...
	fVar0 = func_46(vLocal_1363, vLocal_1366, -90f, 0f, 90f, Global_19641, 350f, 0);
...
void func_51()
{
	if (Global_4271009 == 0)
	{
		...
		func_58(Global_19662, "DISPLAY_VIEW", 8f, SYSTEM::TO_FLOAT(iLocal_35), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		if (Global_19669)
		{
			if (iLocal_32 > 0)
			{
	...
	while (iVar13 < 11)
	{
		...
		if (Global_4269759[iVar16 /*104*/].f_24 != 0)
		{
			if (Global_4269759[iVar16 /*104*/].f_99[Global_19681] == 1)
			{
				...
				cVar17 = { Global_4269759[iVar16 /*104*/] };
...
void func_59()
{
	...
	bLocal_1370 = true;
	bLocal_1371 = false;
	while (bLocal_1370 && Global_19681.f_1 > 3)
	{
		SYSTEM::WAIT(0);
