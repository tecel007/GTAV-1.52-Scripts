...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_388(64);
	iLocal_81 = func_388(63);
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_205(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_205(iParam0) };
...
void func_229()
{
	...
	switch (iLocal_323)
	{
		...
		case 1:
			...
			{
				case 0:
					if (func_310(1, 1093140480 /* Float: 10.5f */, 0))
					{
...
int func_232(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_233(int* iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	func_234(iParam0, iLocal_83, vParam1, fParam4);
	if (func_309(*iParam0))
	{
...
void func_234(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_235(iParam0);
...
void func_239(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_245(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_248(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_251(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	float fVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_299(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_296(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_252(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_252(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (func_290(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_286(iParam5, &Var0, vParam1, fParam4, func_289(iParam0));
...
void func_253(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_283(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_272();
			}
...
void func_254(int iParam0, int iParam1)
{
	...
	func_291(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_283(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_290(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_290(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_286(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_283(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_288(iParam0);
			func_287(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_296(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_297(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_297(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_300(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, int iParam17, float fParam18)
{
	func_301(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, iParam17, fParam18);
}

void func_301(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_303(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_303(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		vVar0 = { func_305(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.f_1 = vVar3.x;
		vVar0.f_2 = 0f;
		...
		if (((((((((((((((func_304(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_304(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_304(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_304(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_304(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_304(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_304(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_304(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_304(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_304(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_304(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_304(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_304(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_304(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_304(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_304(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_310(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_315(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_320(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_332(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_334(iParam0, Global_41631);
}
...
int func_341(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_342(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_342(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_366()
{
	...
	iVar0 = func_367(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_370()
{
	...
	{
		if (func_365(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
