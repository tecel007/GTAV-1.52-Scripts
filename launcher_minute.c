...
void __EntryFunction__()
{
	...
	if (!func_270(&iVar64, &Var0, vVar61, 1f))
	{
		func_269();
	...
	if (Var0 == 32)
	{
		...
		MISC::CLEAR_AREA(vVar61, 40f, true, false, false, false);
	}
	else if (Var0 == 34)
	{
		iLocal_97 = func_245();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608 /* Float: 0.5f */))
				{
		...
		func_203(Var0);
		func_196(&iLocal_96, &(Var0.f_9), vVar61);
		if (Var0 == 32)
		{
			func_192(&Var0, vVar61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		}
		else if (Var0 == 34)
		{
			func_187(&Var0, vVar61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800 /* Float: 20f */);
		}
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0))
			{
				func_169(Var0, &iLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_273(&Var0, 1);
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			if (!func_146())
			{
				if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_127(PLAYER::PLAYER_PED_ID())) && func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_196(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_191(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_199(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_191(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_201(iParam0);
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_237(*uParam0))
					{
						...
						if (func_220(uParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_204(uParam0);
...
bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_223(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_224(iParam4, iParam7) };
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_228(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_227(vVar3, vVar0);
...
float func_227(vector3 vParam0, vector3 vParam3)
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}
...
int func_235(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
{
	if ((func_243() && Global_98955.f_11 == 6) && iParam0 == func_167(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_247(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 4;
			iParam0->f_27 = 0;
			StringCopy(&(iParam0->f_9), "MMB_3_RCM", 24);
			iParam0->f_25 = 1;
			iParam0->f_17[0 /*3*/] = { -303.512f, 6211.81f, 30.48759f };
			iParam0->f_17[1 /*3*/] = { 20f, 20f, 3f };
			func_256(&(iParam0->f_48), "rcmminute3base", "base", "beckon");
			iParam0->f_48.f_5 = { -303.73f, 6211.56f, 31.49f };
			iParam0->f_48.f_8 = { 0f, 0f, -2.8f };
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
			...
			return 0;
		case 1:
			if (!func_255(&iVar0) || !func_254(&(iParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				func_253(&(iParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_250(&(iParam0->f_28[0]), 59, iParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
					PED::SET_PED_PROP_INDEX(iParam0->f_28[0], 0, 0, 0, false);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iParam0->f_28[0], false);
					if (func_126(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_LOOK_AT_ENTITY(iParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_248(&(iParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_248(&(iParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.5016f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[1], 0);
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iVar0[1], true);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				func_253(&(iParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[1], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, false, false, false, false, 2, true);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
...
void func_248(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_249(iParam0);
...
int func_250(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_251(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_251(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_257(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_15 = 7f;
			iParam0->f_27 = 0;
			StringCopy(&(iParam0->f_9), "MMB_2_RCM", 24);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			...
			return 0;
		case 2:
			func_248(&(iParam0->f_35[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 2);
				VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(iParam0->f_35[0], 5, false);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(iParam0->f_35[0], 14f);
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iVar0[0], true);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_258(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_25 = 1;
			iParam0->f_26 = 1;
			StringCopy(&(iParam0->f_9), "MMB_1_RCM", 24);
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_250(&(iParam0->f_28[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_250(&(iParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_248(&(iParam0->f_35[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_259(iParam0->f_35[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[1]))
			{
				func_248(&(iParam0->f_35[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_259(iParam0->f_35[1], iVar0[1]);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iParam0->f_35[1], false);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (func_127(iParam0->f_28[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						TASK::CLEAR_PED_TASKS(iParam0->f_28[0]);
						TASK::TASK_PLAY_ANIM(iParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0f, false, false, false);
				...
				if (func_127(iParam0->f_28[1]))
				{
					...
					TASK::TASK_PLAY_ANIM(iParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0f, false, false, false);
					PED::SET_PED_CONFIG_FLAG(iParam0->f_28[1], 185, true);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_270(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_271((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_271((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_271(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_272(Var1.f_6, vParam1, fParam4, 0))
	{
...
void func_278(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_285(iParam0, iParam1);
	func_282(iParam0, bParam2);
	func_279(iParam0, bParam3);
}

void func_279(int iParam0, bool bParam1)
{
	func_280(&(iParam0->f_41), bParam1);
}
