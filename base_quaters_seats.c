...
bool func_5(var uParam0)
{
	...
	func_7(uParam0, uParam0->f_29.f_2, &uVar0);
	func_7(uParam0, uParam0->f_29.f_2, &uVar4);
...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 4:
			...
			if (Var20 != 3)
			{
				vVar34 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&uVar0, &uVar16, func_39(uParam0), func_38(uParam0), 0f, 2) };
				vVar37 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&uVar0, &uVar16, func_39(uParam0), func_38(uParam0), 0f, 2) };
				fVar40 = vVar37.z;
		...
		case 5:
			...
			if (iVar41 != 1 && iVar41 != 0)
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_29.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar42))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar42) >= 1f)
				{
					...
					func_40(uParam0, &uVar16);
					uParam0->f_29.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_29.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 7:
			...
			break;
		case 8:
			iVar43 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
...
void func_24(var uParam0)
{
	...
	uParam0->f_29.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
	func_41(uParam0, &uVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_29.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
	func_9(&(uParam0->f_29.f_5));
	func_52(uParam0, 8);
}
...
Vector3 func_38(var uParam0)
{
	...
	vVar0 = { (uParam0[uParam0->f_29.f_2 /*14*/])->f_8.f_3 };
...
int func_73()
{
	if (Global_1590525 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1590525, true, 0))
		{
			return 0;
		}
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, Global_1590525);
		func_93(0, -1, 0);
		MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
		func_92();
		if (func_91(Global_1590525))
		{
			func_84();
		}
		else
...
void func_74()
{
	func_77(2, &uLocal_85, 0);
	func_77(3, &uLocal_85, 1);
	func_75(&uLocal_85, 6632);
}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_81(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_79(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_78(), fVar3) + vVar0 };
...
void func_84()
{
	func_85(2, &uLocal_85, 0);
	func_85(3, &uLocal_85, 1);
}
...
void func_85(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_80(func_88(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_80(func_87(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_80(func_86(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
{
	return MISC::IS_BIT_SET(Global_1590682[iParam0 /*883*/].f_274.f_271.f_1, 0);
}
