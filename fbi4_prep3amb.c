	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19662) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while ((!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19662) == 1)
				{
					SYSTEM::WAIT(0);
...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_105, 0) && Global_41631 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 1))
...
void func_208()
{
	...
	if ((Global_41631 == 15 && iLocal_38 == 0) && !func_207())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 0))
...
void func_222()
{
	...
	if (((((((Global_41631 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_207()) && Global_76830 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
	...
	else if (((((((Global_41631 != 15 || Global_41631 != 0) || Global_41631 != 2) || Global_41631 != 4) || Global_41631 != 17) || func_207()) || Global_76830 == -1) || Global_110913)
	{
		iVar1 = 0;
		if (func_132())
		{
...
int func_240()
{
	if (((((Global_41631 == 15 && !func_207()) && Global_76830 == -1) && !func_132()) && !func_241(1112014848 /* Float: 50f */)) && !Global_110913)
	{
		return 1;
	}
	return 0;
...
int func_246(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_247(iParam1)];
