...
int func_323(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_52(func_324(iParam0, iParam1), iParam2, 0);
	return uVar0;
}
...
int func_333(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_335(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_352(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
int func_353(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_354(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
