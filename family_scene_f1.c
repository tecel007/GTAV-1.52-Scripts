...
void __EntryFunction__()
{
	...
	while (bLocal_53)
	{
		...
		{
			func_36(&uLocal_113, &iLocal_114, &uLocal_117, &uLocal_118, vLocal_82, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam5, var uParam8)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_96433[iVar0]))
			{
	...
	if (Global_93978 != 8)
	{
		if (Global_93979 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_93979 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_13(vector3 vParam0, vector3 vParam3)
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, true))
	{
		...
		{
			if (MISC::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam3, iVar0, true))
			{
				Global_93978 = 0;
			}
		}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_29(iVar0) && (!func_24(14) || Global_110809))
			{
...
int func_28(int iParam0)
{
	if (func_29(iParam0))
	{
		if ((Global_111858.f_9081 || Global_3) || func_5(0))
		{
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam7)
{
	int iVar0;
	vector3 vVar1;
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			{
				if (!Global_111858.f_18510.f_17)
				{
					func_37("FAM_WEAPDIS", -1);
					Global_111858.f_18510.f_17 = 1;
				}
				*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam7))
				{
...
int func_46(int iParam0)
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_111848)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!MISC::IS_BIT_SET(Global_111858.f_9081.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
{
	return func_50(iParam0, Global_41631);
}
...
void func_54()
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_93961[iVar1] != 141)
			{
				func_58(iVar1);
				Global_93961[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)
{
	...
	while (iVar15 < Global_111858.f_7684.f_198)
	{
		...
		{
			func_66(Global_111858.f_7684.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_66(int iParam0)
{
	...
	{
		if (func_72(iParam0, Global_19681) == 1)
		{
			func_71(iParam0, Global_19681, 0);
			if (func_70(iParam0, Global_19681) == 0)
			{
				iVar0 = Global_19681;
...
{
	Global_31028[iParam0 /*11*/].f_10 = iParam1;
}
...
int func_78()
{
	...
	while (iVar23 < 11)
	{
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar1, 10f, iVar0, false))
		{
			iVar24 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar1, 10f, iVar0, false, false, true);
