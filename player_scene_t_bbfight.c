#region Local Var
	...
	float fLocal_302 = 0f;
	vector3 vLocal_303[2] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f } };
	float fLocal_310[2] = { 0f, 0f };
	vector3 vLocal_313[1] = {{ 0f, 0f, 0f } };
	vector3 vLocal_317[1] = {{ 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	iLocal_113 = 318;
	iLocal_279 = 1;
	StringCopy(&cLocal_489, "", 16);
	StringCopy(&cLocal_493, "", 16);
	StringCopy(&cLocal_497, "", 16);
	fLocal_501 = 0f;
...
int func_2()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
	{
		...
		if (func_26(iVar1))
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_497))
			{
				if (!bLocal_502)
				{
					if (fVar0 < fLocal_501)
					...
					{
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_489))
						{
							func_20(&uLocal_114, func_21(), PLAYER::PLAYER_PED_ID(), &cLocal_489, 0, 1);
						}
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_493))
						{
							func_20(&uLocal_114, 4, iLocal_280[0], &cLocal_493, 0, 1);
						}
						if (func_3(&uLocal_114, "PRSAUD", &cLocal_497, 3, 0, 0, 0))
						{
							bLocal_502 = true;
						}
					}
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_299) > 100f)
	{
		return 1;
	}
	return 0;
...
void func_22()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_24(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_15(14) || Global_110809))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_96284, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
						(*iParam1)[iVar0] = 101;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
					{
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_96285, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285))
							{
						...
						if (iLocal_113 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285))
								{
									if (STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
									{
										TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, false);
										PED::_0x2208438012482A1A((*iParam0)[iVar0], false, false);
										SYSTEM::WAIT(0);
										iLocal_486[iVar0] = -1;
										(*iParam1)[iVar0] = 5;
									}
									else if (iLocal_113 == 259)
									{
										if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285))
										{
										...
										else if (iLocal_113 == 246 && iVar0 == 0)
										{
											if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285))
											{
												TASK::TASK_PUT_PED_DIRECTLY_INTO_MELEE((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), 0f, -1f, 0f, false);
											...
											else
											{
												...
												if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 1))
												{
													...
													if (iLocal_113 == 108 || iLocal_113 == 109)
													{
														if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])) > 0.954f)
														{
															if (iLocal_113 == 108)
															{
																vLocal_303[iVar0 /*3*/] = { Vector(224.5948f, 1213.466f, 199.6328f) - vLocal_299 };
															}
															else if (iLocal_113 == 109)
															{
																vLocal_303[iVar0 /*3*/] = { Vector(5.9049f, -717.1404f, -1908.287f) - vLocal_299 };
															}
															TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1f, -1, 0.25f, false, 40000f);
												...
												Jump @2537; //curOff = 1384
												vVar8 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], true) };
												vVar11 = { vLocal_299 + vLocal_303[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
												...
												else
												{
													...
													else if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
													{
														iLocal_486[iVar0] = -1;
														(*iParam1)[iVar0] = 5;
													}
													...
													{
														Jump @2537; //curOff = 1638
														vVar18 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], true) };
														vVar21 = { vLocal_299 + vLocal_303[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
														fVar24 = SYSTEM::VDIST(vVar18, vVar21);
														if (fVar24 <= 0.5f)
														{
															(*iParam1)[iVar0] = 0;
														}
														else if (func_32((*iParam0)[iVar0]))
														{
															(*iParam1)[iVar0] = 10;
														}
														else if (!TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 713668775) == 1 && !TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 713668775) == 0)
														{
															TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar21, 0.5f, -1, 0.25f, false, 40000f);
														}
														else
														{
															Jump @2537; //curOff = 1816
															...
															Jump @2537; //curOff = 1980
															if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_299) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], true)) > 50f)
															{
																...
																TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
																TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0.5f, -1, 0.25f, false, 40000f);
																(*iParam1)[iVar0] = 1;
															}
															...
															if (func_32((*iParam0)[iVar0]))
															{
																...
																TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
																PED::_0xF1C03A5352243A30((*iParam0)[iVar0]);
																(*iParam1)[iVar0] = 10;
															}
															else
															{
																if (!TASK::PED_HAS_USE_SCENARIO_TASK((*iParam0)[iVar0]))
																{
																	...
																	{
																		if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, true))
																		{
																			TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 0);
...
int func_29(int iParam0, float fParam1)
{
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_31346[iVar0 /*23*/].f_16 == 9)
			{
			}
			else
			{
				vVar1 = { func_31(iVar0, 0) };
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (MISC::IS_BIT_SET(Global_31346[iVar0 /*23*/].f_11, 19))
				{
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5)
					{
						vVar6 = { func_31(iVar0, iVar4) };
						if (!func_30(vVar6))
						{
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vVar6) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_32(int iParam0)
{
	...
	while (iVar1 < 1)
	{
		if (!func_34(vLocal_317[iVar1 /*3*/], 0f, 0f, 0f, 0))
		{
			if (func_33(PLAYER::PLAYER_PED_ID(), vLocal_299 + vLocal_313[iVar1 /*3*/], vLocal_317[iVar1 /*3*/], (fLocal_302 + fLocal_321[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
...
int func_33(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	vector3 vVar3;

	vVar0.x = (vParam1.x - (SYSTEM::COS(fParam7) * vParam4.x));
	vVar0.f_1 = (vParam1.y - (SYSTEM::SIN(fParam7) * vParam4.x));
	vVar0.f_2 = (vParam1.z - vParam4.z);
	vVar3.x = (vParam1.x + (SYSTEM::COS(fParam7) * vParam4.x));
	vVar3.f_1 = (vParam1.y + (SYSTEM::SIN(fParam7) * vParam4.x));
	vVar3.f_2 = (vParam1.z + vParam4.z);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, vVar0, vVar3, (vParam4.y * 2f), bParam8, bParam9, iParam10))
	{
		return 1;
	}
	return 0;
...
bool func_34(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_37(int iParam0, float fParam1)
{
	...
	{
		if (func_38(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_38(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_40(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_40(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_39(vVar3, vVar0);
...
float func_39(vector3 vParam0, vector3 vParam3)
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}
...
int func_48(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_49(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
...
void func_56()
{
	...
	while (iVar0 < iLocal_280)
	{
		if (iLocal_286[iVar0] != 0)
		{
			iLocal_280[iVar0] = PED::CREATE_PED(26, iLocal_286[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0f, true, true);
		...
		if (iLocal_293[iVar0] != 0)
		{
			iLocal_290[iVar0] = OBJECT::CREATE_OBJECT(iLocal_293[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], true, true, false);
...
void func_57()
{
	...
	iLocal_113 = Global_98358;
	func_61(iLocal_113, &vLocal_299, &fLocal_302, &cVar0);
	func_59(iLocal_113, &uLocal_323, &cLocal_339, &cLocal_355, &uVar8, &uVar9);
	vLocal_313[0 /*3*/] = { 0f, 0f, 0f };
	vLocal_317[0 /*3*/] = { 0f, 0f, 0f };
	fLocal_321[0] = 0f;
	switch (iLocal_113)
	{
		case 108:
			vLocal_303[0 /*3*/] = { -0.88f, 0.8016f, -1f };
			fLocal_310[0] = -150f;
			...
			break;
		case 109:
			vLocal_303[0 /*3*/] = { -1.1832f, -0.3745f, -1f };
			fLocal_310[0] = -147f;
			...
			break;
		case 157:
			vLocal_303[0 /*3*/] = { -0.8296f, 1.1365f, -0.9999f };
			...
			break;
		case 166:
			vLocal_303[0 /*3*/] = { Vector(36.037f, -476.663f, -1050.724f) - vLocal_299 };
			...
			break;
		case 165:
			vLocal_303[0 /*3*/] = { 0.1366f, -1.2192f, -1f };
			...
			iLocal_296[0] = 60309;
			StringCopy(&cLocal_489, "MICHAEL", 16);
			StringCopy(&cLocal_493, "PREMPLOYEE", 16);
			cLocal_497 = { func_58("MICS3_IG_2", 3) };
			fLocal_501 = 0.2f;
			break;
		case 246:
			vLocal_303[0 /*3*/] = { Vector(4.6f, -1570.924f, -1194.77f) - vLocal_299 + Vector(-1f, 0f, 0f) };
			fLocal_310[0] = (0.61f - fLocal_302);
			vLocal_303[1 /*3*/] = { -1.3617f, 6.7273f, -1f };
			...
			break;
		case 256:
			vLocal_303[0 /*3*/] = { -4.7f, -0.2f, 0f };
			fLocal_310[0] = 143f;
			iLocal_286[0] = joaat("A_M_M_BUSINESS_01");
			iLocal_283[0] = 0;
			iLocal_283[1] = 0;
			vLocal_313[0 /*3*/] = { -3.65f, -1.2f, 1.5f };
			vLocal_317[0 /*3*/] = { 2.5f, 1.25f, 2f };
			fLocal_321[0] = -12f;
			StringCopy(&(Local_453[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		case 257:
			vLocal_303[0 /*3*/] = { Vector(7.1578f, -978.6192f, -1666.374f) - vLocal_299 };
			fLocal_310[0] = -149.0587f;
			iLocal_286[0] = joaat("A_M_M_BUSINESS_01");
			iLocal_283[0] = 0;
			iLocal_283[1] = 0;
			vLocal_313[0 /*3*/] = { 0.4f, -4.1f, 1.8f };
			vLocal_317[0 /*3*/] = { 2.5f, 1.5f, 2f };
			fLocal_321[0] = 57f;
			StringCopy(&(Local_453[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		case 258:
			vLocal_303[0 /*3*/] = { 1.5f, 5.7035f, 0f };
			vLocal_303[1 /*3*/] = { 4.2393f, 4.1781f, 0f };
			fLocal_310[0] = 145.8f;
			...
			iLocal_283[0] = 0;
			iLocal_283[1] = 0;
			vLocal_313[0 /*3*/] = { 2.1f, 4.3f, 2f };
			vLocal_317[0 /*3*/] = { 2.5f, 1.75f, 2f };
			fLocal_321[0] = 33f;
			StringCopy(&(Local_453[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			StringCopy(&(Local_453[1 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		case 259:
			vLocal_303[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_303[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_310[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			...
			break;
		case 285:
			vLocal_303[0 /*3*/] = { -3.264f, -3.7895f, 14.1815f };
			fLocal_310[0] = 0f;
			...
			StringCopy(&(Local_453[0 /*16*/]), "", 64);
			StringCopy(&cLocal_489, "TREVOR", 16);
			StringCopy(&cLocal_493, "DropGuy", 16);
			StringCopy(&cLocal_497, "TRVS_IG_29G", 16);
			fLocal_501 = 0.75f;
			break;
		case 260:
			vLocal_303[0 /*3*/] = { 0.219f, 5.8091f, 0.6f };
			vLocal_303[1 /*3*/] = { 2.4f, 4.6336f, 0.6f };
			...
			iLocal_283[0] = 0;
			iLocal_283[1] = 0;
			vLocal_313[0 /*3*/] = { 4f, 8f, 2f };
			vLocal_317[0 /*3*/] = { 10.5f, 5.5f, 2f };
			fLocal_321[0] = 0f;
			break;
		case 261:
			vLocal_303[0 /*3*/] = { 3.2998f, -1.8338f, 0.1366f };
			vLocal_303[1 /*3*/] = { 2.0737f, -3.6041f, 0.1348f };
			...
			vLocal_313[0 /*3*/] = { 3f, -3f, 2f };
			vLocal_317[0 /*3*/] = { 4.5f, 2.5f, 2f };
			fLocal_321[0] = 9f;
			break;
		case 239:
			vLocal_303[0 /*3*/] = { Vector(113.05f, 354.39f, -52.2f) - vLocal_299 + Vector(-1f, 0f, 0f) };
			vLocal_303[1 /*3*/] = { Vector(113.05f, 354.08f, -53.18f) - vLocal_299 + Vector(-1f, 0f, 0f) };
			fLocal_310[0] = -100f;
			fLocal_310[1] = -100f;
			iLocal_286[0] = joaat("A_M_M_BUSINESS_01");
			iLocal_286[1] = joaat("A_M_M_BUSINESS_01");
			vLocal_313[0 /*3*/] = { 1.6187f, -0.82f, 1f };
			vLocal_317[0 /*3*/] = { (2.5f + 0.5f), 8f, 2f };
			fLocal_321[0] = 6f;
			iLocal_283[0] = 100;
			iLocal_283[1] = 100;
		...
		default:
			...
			iLocal_286[0] = joaat("A_M_Y_MUSCLBEAC_01");
			iLocal_286[1] = joaat("A_M_Y_MUSCLBEAC_01");
			vLocal_313[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_317[0 /*3*/] = { 1f, 1f, 1f };
...
int func_61(int iParam0, var uParam1, float fParam2, char* sParam3)
{
	int iVar0;

	if (func_63(iParam0, fParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_67(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_67(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_67(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
