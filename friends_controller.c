...
void func_6(var uParam0)
{
	...
	func_21(Global_94689, uParam0->f_74, &uVar41, &cVar57);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_11(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_89(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	var uVar0;
	char[] cVar4[8];
...
int func_102(var uParam0, var uParam1)
{
	...
	func_21(Global_94689, uParam1->f_1, &uVar40, &cVar56);
...
int func_108(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_158(iVar10, iParam1, bParam2, -1) };
		if (!func_157(iParam3))
		{
...
{
	Global_76647[1 /*14*/] = { func_158(iParam0, iParam1, bParam2, -1) };
	return MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 2);
}

int func_114(int iParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
int func_122(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
int func_130(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (bParam1 - func_132(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (bParam1 - func_131(iParam0, func_118(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (bVar1 != -1 && bVar1 != 0)
	{
		...
		{
			return func_135(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 3);
		}
		else if (iVar0 == joaat("MP_F_FREEMODE_01"))
		{
			return func_135(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 4);
		}
	}
...
int func_135(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	void fVar1;
	...
	else
	{
		...
		if (fVar1 != -1)
		{
			return (func_131(iParam0, func_118(iParam2)) + fVar1);
		}
	}
	return -99;
}
...
void func_160(bool bParam0)
{
	...
	func_161(&(Global_76647[0 /*14*/]), iVar10, bParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
int func_165(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_167(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_161(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_161(&(Global_76647[0 /*14*/]), iParam0, bParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_161(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_161(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_222(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_158(iVar0, iParam1, bParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_222(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_222(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (bVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_158(iVar0, 14, bVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_222(iParam0, 14, bVar4))
										{
											if (!func_114(iVar0, bParam2, 14, bVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_158(iVar0, iVar2, bVar1, -1) };
						if (!func_114(iVar0, bParam2, iVar2, bVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
					...
					if (func_238(uParam0))
					{
						if (func_93(Global_94689, uParam1->f_1) > 15f)
						{
							if (fParam3 < (8f * 8f))
							{
								if (func_363(uParam1, 0))
								{
									func_90(Global_94689, uParam1->f_1, 29, &uVar6, &cVar2);
								}
								else
								{
									func_90(Global_94689, uParam1->f_1, 22, &uVar6, &cVar2);
								}
					...
					if (func_238(uParam0))
					{
						if (func_93(Global_94689, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_90(Global_94689, uParam1->f_1, 23, &uVar6, &cVar2);
								}
								func_234(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_71(uParam2, &uVar6, &cVar2, 4, 0, 0, 0))
								{
					...
					if (func_238(uParam0))
					{
						if (func_93(Global_94689, uParam1->f_1) > 10f)
						{
							if (fParam3 < (8f * 8f))
							{
								...
								{
									func_90(Global_94689, uParam1->f_1, 24, &uVar6, &cVar2);
								}
								func_234(uParam2, uParam1->f_1, uParam1->f_2, 0);
								if (func_71(uParam2, &uVar6, &cVar2, 4, 0, 0, 0))
								{
...
int func_270(var uParam0, bool bParam1, int iParam2)
{
	var uVar0[12];
	int iVar13;
	int iVar14;
...
int func_275(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_326(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	if (func_328(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		...
		{
			Global_8258 = iParam6;
			Global_8161[3 /*6*/] = { func_327(bParam0) };
			Global_8238 = bParam0;
...
int func_328(bool bParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_19865)
	{
		...
		{
			func_333(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_330(1);
			func_333(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19661), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
...
void func_384(int iParam0)
{
	...
	vVar6 = { Global_111858.f_2359.f_539.f_2318[iVar0 /*3*/] };
	func_386(iParam0, 0);
	if (!func_385(vVar1, 0f, 0f, 0f, 0))
	{
		fVar9 = MISC::ABSF((Global_111858.f_2359.f_539.f_2300[iVar0 /*3*/].f_2 - vVar1.z));
		fVar10 = SYSTEM::VDIST2(vVar1, Global_111858.f_2359.f_539.f_2300[iVar0 /*3*/]);
		...
		if (bVar12)
		{
			Global_111858.f_2359.f_539.f_2300[iVar0 /*3*/] = { vVar1 };
			Global_111858.f_2359.f_539.f_2310[iVar0] = uVar4;
			Global_111858.f_2359.f_539.f_2314[iVar0] = uVar5;
			Global_111858.f_2359.f_539.f_2318[iVar0 /*3*/] = { vVar6 };
		}
	}
}
...
void func_393(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_395(Var11.f_1)) && iVar72 < 51)
			{
...
int func_441(vector3 vParam0)
{
	...
	if (func_445())
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_94256[0 /*18*/], true) < 10f)
		{
			return 1;
		}
		else
	...
	if (!func_443())
	{
		if (Global_95883 == 0)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, 1, &vVar0, &fVar3, &uVar4, 4, 3f, 0f))
			{
				...
				Global_94256[0 /*18*/] = { vVar5 };
				Global_94256[0 /*18*/].f_3 = { vVar26 - vVar5 };
				Global_94256[0 /*18*/].f_6 = { vVar29 - vVar5 };
				Global_94256[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_94256[0 /*18*/].f_12 = 0f;
				Global_94256[0 /*18*/].f_13 = { vVar23 };
...
int func_467(int iParam0, int iParam1)
{
	...
	{
		*iParam1 = Global_111858.f_18099.f_175[iParam0 /*19*/];
		return 1;
	}
	if (Global_111858.f_18099.f_175[iParam0 /*19*/] == iVar0)
	{
		*iParam1 = Global_111858.f_18099.f_175[iParam0 /*19*/].f_1;
		return 1;
	}
	*iParam1 = 7;
	return 0;
...
{
	Global_94256[iLocal_94 /*18*/].f_9 = { vParam0 };
	Global_94256[iLocal_94 /*18*/].f_12 = fParam3;
	Global_94256[iLocal_94 /*18*/].f_13 = { vParam4 };
}

void func_478(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10)
{
	iLocal_94 = iParam0;
	Global_94256[iLocal_94 /*18*/] = { vParam1 };
	Global_94256[iLocal_94 /*18*/].f_3 = { vParam4 };
	Global_94256[iLocal_94 /*18*/].f_6 = { vParam7 };
