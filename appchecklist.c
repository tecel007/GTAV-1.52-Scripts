...
void __EntryFunction__()
{
	...
	func_33(Global_19467, "SET_DATA_SLOT_EMPTY", 18f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_31();
	func_30();
	while (true)
	{
...
void func_4()
{
	...
	if (Global_19482 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_115), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_131[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_19482 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_131[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_115), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_131[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	func_33(Global_19467, "DISPLAY_VIEW", 18f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_10()
{
	...
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			uLocal_129 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_129))
			{
				SYSTEM::WAIT(0);
			}
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_129);
			...
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_19467, "DISPLAY_VIEW", 18f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_5(Global_19467, "SET_HEADER", &(Local_131[iLocal_117 /*6*/]), 0, 0, 0, 0);
...
void func_15()
{
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			iLocal_128 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_129);
			if (Global_19486.f_1 > 3)
			{
				Global_19486.f_1 = 8;
				if (iLocal_128 == 0)
...
void func_16()
{
	...
	else
	{
		...
		{
			func_7(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Global_93536[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_115++;
...
void func_20()
{
	...
	while (iVar0 < 7)
	{
		if (Global_89496[iVar0 /*5*/] != -1)
		{
			if (Global_93745 < 52)
			{
				iVar1 = Global_76891.f_109[Global_89496[iVar0 /*5*/] /*4*/];
				MemCopy(&(Global_93536[Global_93745 /*4*/]), {func_24(iVar1)}, 4);
				Global_93745++;
			}
			else
			{
	...
	while (iVar0 < 63)
	{
		if ((MISC::IS_BIT_SET(Global_111638.f_18569[iVar0 /*6*/], 0) && MISC::IS_BIT_SET(Global_111638.f_18569[iVar0 /*6*/], 1)) && !MISC::IS_BIT_SET(Global_111638.f_18569[iVar0 /*6*/], 3))
		{
			if (Global_93745 < 52)
			{
				MemCopy(&(Global_93536[Global_93745 /*4*/]), {func_22(iVar0)}, 4);
				Global_93745++;
			}
			else
			{
	...
	while (iVar0 < 20)
	{
		if (MISC::IS_BIT_SET(Global_111638.f_9080.f_99.f_219[0], iVar0))
		{
			if (Global_93745 < 52)
			{
				StringCopy(&(Global_93536[Global_93745 /*4*/]), func_21(iVar0), 16);
				Global_93745++;
			}
			else
			{
...
void func_26()
{
	func_33(Global_19467, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_28()
{
	func_33(Global_19467, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19475, true);
	func_29();
}
