...
void func_9()
{
	...
	if (Local_83.f_1 != 3)
	{
		...
		bVar2 = PLAYER::GET_PLAYER_INDEX();
		if (PLAYER::IS_PLAYER_PLAYING(bVar2))
		{
			UNK_0xDDEDC06C88DA4E04(bVar2, false, false);
		}
	}
	func_10();
}
...
void func_70(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
void func_216(bool bParam0)
{
	...
	{
		bVar1 = PLAYER::GET_PLAYER_INDEX();
		if (PLAYER::IS_PLAYER_PLAYING(bVar1))
		{
			if (!PLAYER::IS_PLAYER_CONTROL_ON(bVar1))
			{
				UNK_0xDDEDC06C88DA4E04(bVar1, true, false);
			}
		}
	}
	if (!bParam0)
