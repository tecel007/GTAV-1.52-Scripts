...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	if (!func_267(&iVar64, &Var0, vVar61, 5f))
	{
		func_266();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_197(&Var0, vVar61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800 /* Float: 20f */);
		}
		else if (Var0 == 51)
		{
			func_197(&Var0, vVar61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800 /* Float: 20f */);
		}
		func_196(Var0);
		func_188(&iLocal_95, &(Var0.f_9), vVar61);
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0))
			{
				func_169(Var0, &iLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_270(&Var0, 1);
...
void func_148()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_149(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
int func_170(vector3 vParam0, bool bParam3)
{
	int iVar0;
...
void func_188(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_192(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_191(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_194(iParam0);
				}
			}
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_201(var uParam0, bool bParam1)
{
	...
	if ((func_238(*uParam0) || func_236(*uParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_230(*uParam0))
					{
						...
						if (func_213(uParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_206(uParam0);
...
bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_216(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_217(iParam4, iParam7) };
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_221(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_220(vVar3, vVar0);
...
Vector3 func_221(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, float fParam1)
{
	...
	{
		if (func_228(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_228(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_221(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_237() && Global_98955.f_11 == 6) && iParam0 == func_167(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_241(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -476.3686f, 229.5744f, 82.07077f };
			iParam0->f_17[1 /*3*/] = { -513.6883f, 234.2165f, 87.28937f };
			iParam0->f_24 = 25f;
			iParam0->f_27 = 0;
			iParam0->f_26 = 1;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "PAP_4_RCM", 24);
			iVar9 = 0;
			while (iVar9 <= (iVar0 - 1))
			{
		...
		case 2:
			...
			{
				if (func_247(&(iParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1000f, 0);
				}
				else
				{
					bVar11 = false;
			...
			{
				func_245(&(iParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
				if (func_126(iParam0->f_28[1]))
				{
					PED::SET_PED_NAME_DEBUG(iParam0->f_28[1], "Camera Man");
					TASK::TASK_PLAY_ANIM(iParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0f, false, false, false);
					...
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[1], 3, 0, 0, 1);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[2]))
			{
				func_245(&(iParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
				if (func_126(iParam0->f_28[2]))
				{
					PED::SET_PED_NAME_DEBUG(iParam0->f_28[2], "Makeup Woman");
					TASK::TASK_PLAY_ANIM(iParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0f, false, false, false);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iParam0->f_28[2], true);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 0, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 2, 3, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 4, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 8, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[2], 9, 0, 0, 0);
				}
				else
				{
					bVar11 = false;
			...
			{
				func_243(&(iParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_178(iParam0->f_35[0]))
				{
					VEHICLE::LOWER_CONVERTIBLE_ROOF(iParam0->f_35[0], true);
			...
			{
				func_243(&(iParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_178(iParam0->f_35[1]))
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[1], 1);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[1], 2);
					VEHICLE::SET_VEHICLE_LIVERY(iParam0->f_35[1], 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
			{
				func_242(&(iParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_127(iParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[0], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 57005), 0.1561f, -0.003f, -0.0344f, 202.8703f, -124.43f, -121.5398f, false, false, false, false, 2, true);
				}
				else
				{
					bVar11 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				func_242(&(iParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_127(iParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[1], iParam0->f_28[1], PED::GET_PED_BONE_INDEX(iParam0->f_28[1], 57005), 0.1181f, 0.2229f, -0.1535f, 259.2501f, 24.08f, -51.2899f, false, false, false, false, 2, true);
				}
				else
				{
					bVar11 = false;
...
void func_242(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_207(iParam0);
...
void func_243(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_244(iParam0);
...
void func_245(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_246(iParam0);
...
int func_247(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_248(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_248(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
{
	iParam0->f_16 = 3;
	iParam0->f_17[0 /*3*/] = { 1040.96f, -534.42f, 60.17f };
	iParam0->f_15 = 90f;
	iParam0->f_27 = 1;
	return 1;
}
...
int func_252(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 3;
			iParam0->f_17[0 /*3*/] = { 301.85f, 138.16f, 102.84f };
			iParam0->f_15 = 90f;
			iParam0->f_27 = 1;
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
		...
		case 1:
			...
			break;
		case 2:
			func_243(&(iParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[0], 2);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
...
int func_253(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -258.5052f, 287.5976f, 90.17828f };
			iParam0->f_17[1 /*3*/] = { -258.5263f, 298.0905f, 93.69456f };
			iParam0->f_24 = 7f;
			iParam0->f_27 = 1;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "PAP_3_RCM", 24);
			iVar31 = 0;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_247(&(iParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iParam0->f_28[0], true);
			...
			if (func_126(iParam0->f_28[0]))
			{
				...
				{
					func_242(&(iParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_127(iParam0->f_41[3]))
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[3], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true);
			...
			if (bVar32)
			{
				...
				iParam0->f_41[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("PROP_CS_DUMPSTER_01A"), vVar10[0 /*3*/], true, true, false);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[0], vVar20[0 /*3*/], 2, true);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(iParam0->f_41[0], false);
				iParam0->f_41[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("PROP_CS_DUMPSTER_LIDL"), vVar10[1 /*3*/], true, true, false);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[1], vVar20[1 /*3*/], 2, true);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(iParam0->f_41[1], false);
				iParam0->f_41[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("PROP_CS_DUMPSTER_LIDR"), vVar10[2 /*3*/], true, true, false);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[2], vVar20[2 /*3*/], 2, true);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(iParam0->f_41[2], false);
				iLocal_91 = 3;
			}
			break;
		case 3:
			...
			{
				iLocal_94 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iParam0->f_41[0], true), ENTITY::GET_ENTITY_ROTATION(iParam0->f_41[0], 2), 2);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1000f);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				if (func_127(iParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_127(iParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1000f);
				}
				if (func_127(iParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1000f);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
int func_254(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -82.64143f, 302.7307f, 104.6349f };
			iParam0->f_17[1 /*3*/] = { -68.78405f, 296.6317f, 107.8958f };
			iParam0->f_24 = 11f;
			iParam0->f_27 = 0;
			iParam0->f_26 = 1;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "PAP_2_RCM_P2", 24);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_247(&(iParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_126(iParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
				{
					func_242(&(iParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_127(iParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_243(&(iParam0->f_35[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[0], 7);
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(iParam0->f_35[0], "P4P4R4Z0");
			...
			break;
		case 3:
			if (func_127(iParam0->f_28[0]) && func_127(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1000f, 0);
				PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iParam0->f_28[0], false);
				PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 185, true);
			}
			UNK_0x1082C25039B168F8("rcmpaparazzo_2");
...
int func_255(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -154.9816f, 287.0432f, 96.63823f };
			iParam0->f_17[1 /*3*/] = { -155.4946f, 274.4067f, 90.82359f };
			iParam0->f_24 = 15f;
			iParam0->f_27 = 0;
			iParam0->f_25 = 1;
			iParam0->f_26 = 0;
			StringCopy(&(iParam0->f_9), "PAP_1_RCM", 24);
			iParam0->f_48 = sVar7;
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_247(&(iParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_243(&(iParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_178(iParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(iParam0->f_35[0], 62, 62);
				}
				else
				{
					bVar5 = false;
		...
		case 3:
			if (func_127(iParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(iParam0->f_28[0], iVar6);
					TASK::CLEAR_SEQUENCE_TASK(&iVar6);
				}
			}
			UNK_0x1082C25039B168F8(sVar7);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
				if (iVar4 != 1)
...
int func_267(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_268((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_268((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_268(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_269(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
	...
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 48:
				...
				break;
			case 51:
				UNK_0x1082C25039B168F8("rcmpaparazzo_4");
				func_272(iParam0, 0, 0, 0);
				break;
			default:
				break;
...
void func_272(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_276(iParam0, bParam2);
	func_273(iParam0, bParam3);
}

void func_273(int iParam0, bool bParam1)
{
	func_274(&(iParam0->f_41), bParam1);
}
