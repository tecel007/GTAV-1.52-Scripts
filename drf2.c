#region Local Var
	...
	int iLocal_405 = 0;
	int iLocal_406 = 0;
	vector3 vLocal_407[24] = "";
	var uLocal_410 = 0;
	var uLocal_411 = 0;
	var uLocal_412 = 0;
	vector3 vLocal_413[24] = "";
	var uLocal_416 = 0;
	var uLocal_417 = 0;
	var uLocal_418 = 0;
...
void __EntryFunction__()
{
	...
	StringCopy(&cLocal_407, "Michael", 24);
	StringCopy(&cLocal_413, "Therapist", 24);
	vLocal_419 = { -1907.785f, -574.8f, 18.616f };
	vLocal_422 = { -1895.534f, -564.2134f, 11.3497f };
	fLocal_425 = 179f;
	fLocal_426 = 314.381f;
	fLocal_427 = 54.08f;
	MISC::SET_MISSION_FLAG(true);
	StringCopy(&cVar14, "DrfAud", 16);
	iLocal_432 = func_273(func_274(), 0, 1);
	fLocal_433 = func_273(func_274(), 0, 1);
	iLocal_434 = func_273(func_274(), 0, 1);
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		func_272();
		if (bVar23)
		{
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_400) && PED::IS_PED_INJURED(bLocal_400))
			{
				func_271(80, 1);
		...
		func_254(&bLocal_399, &iLocal_402, iLocal_404, iLocal_60);
	}
	iLocal_82 = func_253();
	func_252(&Local_61, iLocal_82);
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				func_246(&uLocal_48, iLocal_55, iLocal_56, iLocal_57, iLocal_58, iLocal_59, func_253());
				...
				iVar12 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, false, 2);
				iVar13 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, false, 2);
			...
			case 1:
				if (!bVar4)
				{
					if (func_242(&uLocal_48))
					{
						func_234(&bLocal_399, iLocal_55, vLocal_419, fLocal_425, iLocal_432, fLocal_433, iLocal_434);
						func_224(&Local_61, func_253());
						func_244(&iLocal_248);
						bVar4 = true;
					}
				}
				if (bVar4)
				{
					if (!bVar5)
					{
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
							...
							{
								func_139(&cLocal_407, PLAYER::PLAYER_PED_ID(), 0, 2);
							}
							if (!ENTITY::IS_ENTITY_DEAD(bLocal_399, false))
							{
								func_139(&cLocal_413, bLocal_399, 0, 2);
							}
							bVar5 = true;
						}
					}
				}
				if (func_137(&iVar6) > 6f && func_136())
				{
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(bLocal_399, false))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_407, 0, 0, 0);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_399, &cLocal_413, 0, 0, 0);
					}
			...
			case 2:
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_407, 0))
				{
					func_134(bLocal_399, 1, 0);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_413, 0))
				{
					func_134(bLocal_399, 0, 1);
				}
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					func_133(bLocal_399, &iLocal_401, &iLocal_402, &iLocal_404, &uLocal_83, vLocal_422, fLocal_427, iLocal_57);
					func_131(func_253());
					func_244(&iLocal_251);
					func_130(&iLocal_275, 0, 0, 0, 1);
					func_129(&iLocal_275, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_129(&iLocal_275, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					bVar5 = false;
					UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), false, 0);
					iLocal_60 = 3;
			...
			case 3:
				...
				if (CAM::IS_SCREEN_FADED_OUT() || bVar24)
				{
					...
					func_121(&iLocal_251);
					while (func_137(&iLocal_251) < 0.4f)
					{
						SYSTEM::WAIT(0);
						func_122();
					}
				...
				if (!bVar2)
				{
					...
					{
						Local_61.f_20 = 0;
						func_109(&(Local_61.f_12), &Local_61, func_253());
						bLocal_435 = true;
					}
					if (func_99(&iLocal_251, &iLocal_275, &bVar1))
					{
						if (bVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_137(&iLocal_251) >= 14f)
					{
						Local_61.f_20 = 2;
						bVar2 = true;
						HUD::CLEAR_HELP(true);
					}
					else if (!bVar3 && func_137(&iLocal_251) >= 7f)
					{
						StringCopy(&cVar18, "DRF_PROMPT", 16);
						func_98(&uLocal_83, &cVar14, &cVar18, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if ((func_137(&iLocal_251) > 5f && func_136()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_137(&iLocal_251) > fVar22) || func_95(iLocal_82, bLocal_399, &iLocal_404))))
				{
					func_92();
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
					{
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), true, false);
							ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
							func_88(PLAYER::PLAYER_PED_ID(), -1902.609f, -559.9267f, 10.7916f);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_426);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
							func_80(0, 1, 1, 0, 0, 0, 0);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_402))
							{
								...
								{
									ENTITY::SET_ENTITY_COORDS(iLocal_402, func_79(iLocal_402), true, false, false, true);
							...
							if (CAM::IS_SCREEN_FADED_OUT())
							{
								if (!bLocal_436)
								{
									STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_78(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									bLocal_436 = true;
									SYSTEM::WAIT(0);
								}
								if (!bLocal_437)
				...
				else
				{
					if (!bLocal_436)
					{
						if (CUTSCENE::GET_CUTSCENE_TIME() > 60000)
						{
							if (iLocal_82 == 4)
							{
								STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_78(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								STREAMING::NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_78(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!bLocal_437)
					{
						if (CUTSCENE::_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_137(&iVar9) > func_76(func_253()))
							{
								if (func_253() == 4)
								{
									bLocal_400 = PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, true, true);
									PED::SET_PED_COMPONENT_VARIATION(bLocal_400, 3, iLocal_432, fLocal_433, 0);
									PED::SET_PED_COMPONENT_VARIATION(bLocal_400, 4, 0, iLocal_434, 0);
									PED::SET_PED_MONEY(bLocal_400, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
									ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_400, true, 1);
									func_75(&uLocal_83, 1, bLocal_400, "FRIEDLANDER", 0, 1);
								}
								bLocal_437 = true;
							}
						}
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_DEAD(bLocal_400, false))
				{
					func_271(80, 1);
					STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), true, true);
					func_98(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(bLocal_400) || func_74(bLocal_400, PLAYER::PLAYER_PED_ID(), 1) > 300f)
				{
					func_98(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (HUD::DOES_BLIP_EXIST(iLocal_403))
					{
						HUD::SET_BLIP_COLOUR(iLocal_403, 3);
					}
					if (ENTITY::DOES_ENTITY_EXIST(bLocal_400))
					{
						MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(bLocal_400, true), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_57();
					PED::SET_PED_CONFIG_FLAG(bLocal_400, 26, true);
					if (func_77(&iLocal_266))
					{
						if (func_137(&iLocal_266) > 2.5f)
						{
					...
					if (!bLocal_439)
					{
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (func_137(&iLocal_263) > 2f)
						{
							switch (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE())
							{
								case 0:
									vVar26 = { -1905.289f, -560.9047f, 12.5379f };
									vVar29 = { -8.9999f, 0f, -99.8165f };
									break;
								case 1:
									vVar26 = { -1908.006f, -560.4351f, 12.6592f };
									vVar29 = { -3f, 0f, -99.8148f };
									break;
								case 2:
									vVar26 = { -1908.759f, -558.642f, 13.4942f };
									vVar29 = { -12.0007f, 0f, -115.8697f };
									break;
								case 4:
									vVar26 = { -1904.658f, -560.0228f, 12.4975f };
									vVar29 = { -10.0948f, 0.0099f, -128.3421f };
									break;
								default:
									vVar26 = { -1908.006f, -560.4351f, 12.6592f };
									vVar29 = { -3f, 0f, -99.8148f };
							...
							iLocal_404 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vVar26, vVar29, 50f, false, 2);
					...
					{
						if (func_137(&iLocal_263) >= 2.66f)
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(func_56(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 2, -16f, 0f));
					...
					if (bLocal_438 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_54(&iLocal_257, 0.5f))
						{
							...
							if (!HUD::DOES_BLIP_EXIST(iLocal_403))
							{
								if (!ENTITY::IS_ENTITY_DEAD(bLocal_400, false))
								{
									iLocal_403 = HUD::ADD_BLIP_FOR_ENTITY(bLocal_400);
									HUD::SET_BLIP_COLOUR(iLocal_403, 1);
									func_121(&iLocal_257);
								}
							}
							...
							{
								HUD::SET_BLIP_COLOUR(iLocal_403, 3);
								if (func_77(&iLocal_260))
								{
									if (func_137(&iLocal_260) < (7500f / 1000f))
									{
										func_53("SHRINK_KILL_B", 7500, 1);
									}
									else
									{
					...
					{
						func_51(&iLocal_257, 0.3f);
					}
					if (!PED::IS_PED_INJURED(bLocal_400))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_401))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(bLocal_400, false))
							{
								bVar0 = true;
							}
							if (!PED::IS_PED_FLEEING(bLocal_400))
							{
								if ((((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_401, false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_401, true)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 0, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 1, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 2, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 3, 2000)) || (bVar0 && !PED::IS_PED_IN_ANY_VEHICLE(bLocal_400, false))) || func_50(iLocal_401)) || func_46(iLocal_401))
								{
									TASK::TASK_SMART_FLEE_PED(bLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, false, false);
								}
							}
						}
						else if (!PED::IS_PED_FLEEING(bLocal_400))
						{
							TASK::TASK_SMART_FLEE_PED(bLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, false, false);
						}
						if (!bVar25 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, false, true, 0))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_400, false);
							bVar25 = true;
						}
					}
				}
				break;
			case 16:
				if (!func_77(&iLocal_254))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_244(&iLocal_254);
				}
				else if (func_137(&iLocal_254) > 2f)
				{
					func_2(func_40(), 24, func_39(iLocal_82));
					func_272();
					func_269(0, 0);
					func_254(&bLocal_399, &iLocal_402, iLocal_404, iLocal_60);
				}
			...
			case 17:
				...
				if (func_137(&iLocal_254) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
					...
					if (!func_1(80))
					{
						if (ENTITY::DOES_ENTITY_EXIST(bLocal_400))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_401) && PED::IS_PED_IN_VEHICLE(bLocal_400, iLocal_401, false))
							{
								VEHICLE::DELETE_VEHICLE(&iLocal_401);
							}
						}
						PED::DELETE_PED(&bLocal_400);
					}
...
int func_2(int iParam0, int iParam1, int iParam2)
{
	...
	return func_3(func_38(iParam0), 0, iParam1, iParam2, 0);
}
...
void func_6(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_8() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_8() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2551832[iParam0 /*3*/][func_10(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_14(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_16(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_16(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_16(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_16(137, -1, -1);
	}
	if (iParam0 == 12)
	{
		iVar0 = UNK_0x5A002C4821A13338();
		iVar1 = func_15(8270, -1, 0);
	...
	return MISC::IS_BIT_SET(Global_2097152[func_8() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_15(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_10(iParam1)];
...
int func_21(int iParam0, int iParam1)
{
	...
	if (func_31(&Global_4271324))
	{
		if (func_29(&Global_4271324, iParam0))
		{
			return 0;
		}
		if (func_22(&Global_4271324, iParam0))
		{
			return 1;
		}
	}
...
void func_25(var uParam0)
{
	...
	func_27(uParam0, (Global_4271323 - 0.5f));
}
...
void func_41()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_44(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_42(iVar0) && (!func_33(14) || Global_110809))
			{
...
int func_46(int iParam0)
{
	...
	if ((func_49(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_47(iParam0))
	{
...
{
	iParam0->f_1 = (func_52(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_54(int iParam0, float fParam1)
{
	if (func_55(iParam0, fParam1))
	{
		func_135(iParam0);
		return 1;
	}
...
int func_55(int iParam0, float fParam1)
{
	if (func_77(iParam0))
	{
...
void func_57()
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(bLocal_400) || ENTITY::IS_ENTITY_DEAD(bLocal_400, false)) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		return;
	}
	if (!func_77(&iLocal_269))
	{
		func_244(&iLocal_269);
	}
	if (!func_77(&iLocal_272))
	{
		func_244(&iLocal_272);
	}
	fVar6 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(bLocal_400, true));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			if (func_137(&iLocal_269) > 0.2f)
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 7);
				MISC::SET_BIT(&iLocal_428, iVar4);
				StringCopy(&cVar0, "DRF_RUNOFF_", 16);
				StringIntConCat(&cVar0, iVar4 + 1, 16);
				func_58(&uLocal_83, "DrfAud", "DRF_RUNOFF", &cVar0, 8, 0, 0);
				iLocal_429 = 1;
				func_121(&iLocal_269);
			}
		}
		else if (func_137(&iLocal_269) > 12f)
		{
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			if (func_137(&iLocal_272) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_400))
			{
				iVar4 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
				MISC::SET_BIT(&iLocal_430, iVar4);
				StringCopy(&cVar0, "DRF_CHASE_", 16);
				StringIntConCat(&cVar0, iVar4 + 1, 16);
				func_58(&uLocal_83, "DrfAud", "DRF_CHASE", &cVar0, 8, 0, 0);
				iLocal_431 = 1;
				func_121(&iLocal_272);
			}
		}
		else if (func_137(&iLocal_272) > 10.3f)
		{
			if (fVar6 <= 2500f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_400))
			{
			...
			{
				func_51(&iLocal_272, 5f);
			}
		}
	}
	if (((!bLocal_438 && iLocal_429 >= 1) && iLocal_431 >= 1) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		bLocal_438 = true;
	}
}

int func_58(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	...
	Global_2621441 = 0;
	return func_59(sParam2, iParam4, 0);
}
...
float func_74(bool bParam0, int iParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_75(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
Vector3 func_79(int iParam0)
{
	...
	return Vector(10.7548f, -555.7014f, -1900.292f) - Vector(Var15, Var15, Var15) * Vector(0f, -0.7771f, -0.6293f) - Vector(Var15.f_1, Var15.f_1, Var15.f_1) * Vector(0f, -0.6293f, 0.7771f);
}

void func_80(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_86(0, bParam3, bParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_84(PLAYER::PLAYER_ID())) && !func_82(PLAYER::PLAYER_ID(), 0)) && !func_81()) && !bParam4) && !bParam5)
			{
...
Vector3 func_88(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_90()
{
	...
	{
		VEHICLE::DELETE_VEHICLE(&iLocal_401);
		iLocal_401 = VEHICLE::CREATE_VEHICLE(iLocal_57, vLocal_422, fLocal_427, true, true, false);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_401, 6);
	}
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_399))
	{
		PED::DELETE_PED(&bLocal_399);
	}
	if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_401, false)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_401, false))
	{
		...
		ENTITY::SET_ENTITY_COORDS(iLocal_401, vLocal_422, true, false, false, true);
		...
		if ((!bLocal_437 || !ENTITY::DOES_ENTITY_EXIST(bLocal_400)) || ENTITY::IS_ENTITY_DEAD(bLocal_400, false))
		{
			bLocal_400 = PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, true, true);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_400, 3, iLocal_432, fLocal_433, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_400, 4, 0, iLocal_434, 0);
			PED::SET_PED_MONEY(bLocal_400, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_400, true, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_400, true);
			func_75(&uLocal_83, 1, bLocal_400, "FRIEDLANDER", 0, 1);
			bLocal_437 = true;
		}
		else
		{
			ENTITY::SET_ENTITY_COORDS(bLocal_400, -1899.7f, -562.2f, 10.7945f, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(bLocal_400, 217.9453f);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_400);
			TASK::TASK_STAND_STILL(bLocal_400, -1);
		}
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			if (!bLocal_436)
			{
				STREAMING::NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_78(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				bLocal_436 = true;
				SYSTEM::WAIT(0);
			}
			while (!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || (!PED::IS_PED_INJURED(bLocal_400) && !PED::_HAS_STREAMED_PED_ASSETS_LOADED(bLocal_400)))
			{
				SYSTEM::WAIT(0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		...
		fVar0 = 2f;
		if (!PED::IS_PED_INJURED(bLocal_400) && !ENTITY::IS_ENTITY_DEAD(iLocal_401, false))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(bLocal_400, iLocal_406);
			PED::FORCE_PED_MOTION_STATE(bLocal_400, joaat("MOTIONSTATE_RUN"), true, 1, true);
		}
		iLocal_403 = HUD::ADD_BLIP_FOR_ENTITY(bLocal_400);
		HUD::SET_BLIP_COLOUR(iLocal_403, 1);
		func_121(&iLocal_257);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		iLocal_405 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, true, 2);
		CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
		HUD::DISPLAY_RADAR(false);
		HUD::DISPLAY_HUD(false);
	}
	...
	if (func_96())
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(bParam1))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cVar1, &Var13, 3))
			{
				...
				TASK::TASK_PLAY_ANIM(bParam1, &cVar1, &cVar21, 2f, -1000f, -1, iVar0, 0f, false, false, false);
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cVar9, &cVar25, 2f, -1000f, -1, 32 | iVar0, 0f, false, 4, false);
				TASK::TASK_PLAY_ANIM(bParam1, &cVar9, &cVar31, 2f, -1000f, -1, 32 | iVar0, 0f, false, false, false);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), false, false);
				PED::_0x2208438012482A1A(bParam1, false, false);
...
int func_99(int iParam0, int* iParam1, bool bParam2)
{
	...
	if (func_77(iParam0) && func_137(iParam0) > 1.3f)
	{
	...
	func_100(iParam1, 1128792064 /* Float: 200f */, 1, 0, 1, 1065353216 /* Float: 1f */);
	return 0;
}

void func_100(int* iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (!func_105(iParam0->f_1, 256) || (func_105(iParam0->f_1, 8192) && PAD::_0x6CD79468A1E595C6(2)))
	{
		...
		if (MISC::IS_PC_VERSION())
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_105(iParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
		while (iVar6 < iParam0->f_123)
		{
			...
			if (bVar4)
			{
				if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*iParam0, "SET_DATA_SLOT"))
				{
					...
					{
						func_103(iParam0->f_2[iVar6 /*15*/]);
					}
					if (MISC::IS_PC_VERSION())
					{
						if (func_105(iParam0->f_1, 4096))
						{
		...
		fVar8 = func_56(bParam4, func_56(func_105(iParam0->f_1, 32), 1f, 0f), -1f);
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_102(&(iParam0->f_1), 256);
		func_101(&(iParam0->f_1), 128);
	}
...
void func_109(char* sParam0, var uParam1, int iParam2)
{
	...
	iVar0 = func_120(uParam1->f_20);
	iVar0 |= 4;
	iVar0 = (iVar0 || func_110(uParam1, iParam2));
	iVar0 |= 98304;
...
int func_110(var uParam0, int iParam1)
{
	...
	Var1 = { func_111(uParam0, &uVar0, iParam1, 1) };
...
struct<4> func_111(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	struct<4> Var0;
	int iVar4;
	...
	if (func_119() <= 0)
	{
		if (!func_118())
		{
			iVar4 = func_115(1, 2, 3, 4, 12);
		}
		else if (func_114() >= 1)
		{
			iVar4 = func_115(5, 6, 7, 0, 0);
		}
		else
		{
			iVar4 = func_115(5, 7, 0, 0, 0);
		}
	}
	else if (func_119() >= 2)
	{
		iVar4 = func_115(10, 11, 0, 0, 0);
	}
	else if (!func_118())
	{
		if (iParam2 != 4)
		{
			iVar4 = func_115(8, 9, 0, 0, 0);
		}
		else
		{
			iVar4 = 9;
	...
	{
		iVar4 = func_115(8, 9, 10, 0, 0);
	}
	else
	{
		iVar4 = func_115(9, 10, 0, 0, 0);
	}
	func_113(uParam0, iVar4);
	if (bParam3)
	{
		func_112(&(Global_111858.f_19957), iVar4, 1);
	}
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_117(&(Global_111858.f_19957), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_117(&(Global_111858.f_19957), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_117(&(Global_111858.f_19957), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_117(&(Global_111858.f_19957), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_117(&(Global_111858.f_19957), iParam4))
	{
		iVar2[iParam4] = 0;
	}
	iVar1 = func_116(&iVar2, 13, 1, 13);
	if (iVar1 > 0)
	{
		return iVar1;
	}
...
int func_129(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_130(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (MISC::IS_PC_VERSION())
	{
		if (bParam3)
		{
			func_102(&(iParam0->f_1), 4096);
		}
	}
	if (bParam4)
	{
		func_102(&(iParam0->f_1), 8192);
	}
}
...
void func_133(bool bParam0, int iParam1, int iParam2, int iParam3, var uParam4, vector3 vParam5, float fParam8, int iParam9)
{
	int iVar0;
	int iVar1;
	...
	*iParam2 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	...
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam1))
	{
		*iParam1 = VEHICLE::CREATE_VEHICLE(iParam9, vParam5, fParam8, true, true, false);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam1, 6);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*iParam2))
	{
	...
	func_75(uParam4, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_75(uParam4, 1, bParam0, "FRIEDLANDER", 0, 1);
...
void func_134(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam2 && !PED::IS_PED_INJURED(iParam0))
	{
...
float func_137(int iParam0)
{
	if (func_77(iParam0))
	{
		...
		{
			return (func_52(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
void func_139(char* sParam0, bool bParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
...
void func_140(int iParam0, var uParam1, int iParam2)
{
	...
	func_220(iParam0, &Var2, 0, -1);
	func_220(iParam0, uParam1, iParam2, -1);
	iVar82 = 0;
	iVar83 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
	{
		...
		{
			if (func_217(iVar81, func_219(iVar0), func_218(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_219(iVar0)), &uVar1))
			{
				Var67 = { func_151(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
				iVar82 = 1;
			}
			if (func_149(iVar81, func_219(iVar0), func_218(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_219(iVar0)), &uVar1))
			{
				Var67 = { func_151(iVar81, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_217(iVar81, 14, func_142(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_151(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
			...
			if (func_149(iVar81, 14, func_142(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_151(iVar81, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var67.f_3;
				(*uParam1)[1] = Var67.f_4;
	...
	if (iVar83 || iVar82)
	{
		iVar84 = func_218(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar85 = func_218(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar86 = func_141(iVar81, iVar85, iVar84);
		if (iVar86 != -99)
		{
			Var67 = { func_151(iVar81, 0, iVar86, -1) };
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_146(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_145(iParam0, func_146(iParam2)) + fVar1);
		}
	}
	return -99;
}
...
struct<14> func_151(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_216();
...
void func_153(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 87:
			...
			break;
		default:
			func_162(iVar10, iParam0, 155, -1);
			return;
	}
	func_154(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_154(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_159(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_159(Global_2621444, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_15(func_157(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_15(func_156(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_15(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_159(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_160(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_154(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_154(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_154(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_154(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_146(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_210(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 108:
			...
			iVar7 = 12;
			iVar1 = 62;
			Jump @3116; //curOff = 3009
			StringCopy(&cVar2, "LEGS_P0_28_13", 16);
			iVar6 = 28;
			iVar7 = 13;
			iVar1 = 62;
			Jump @3116; //curOff = 3032
			StringCopy(&cVar2, "LEGS_P0_28_14", 16);
			iVar6 = 28;
			iVar7 = 14;
			iVar1 = 65;
			Jump @3116; //curOff = 3055
			StringCopy(&cVar2, "LEGS_P0_28_15", 16);
			iVar6 = 28;
			iVar7 = 15;
			iVar1 = 65;
			Jump @3116; //curOff = 3078
			StringCopy(&cVar2, "NO_LABEL", 16);
			iVar6 = 29;
			iVar7 = 0;
			Jump @3116; //curOff = 3096
			func_162(iVar10, iParam0, 113, -1);
			return;
			func_154(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
		}
...
void func_220(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (func_221(161, iParam3))
			{
				uParam1->f_59 = func_15(2052, iParam3, 0);
			}
			else
			{
				uParam1->f_59 = func_15(752, iParam3, 0);
			}
			uParam1->f_60 = func_15(753, iParam3, 0);
			uParam1->f_61 = func_15(754, iParam3, 0);
		}
...
int func_221(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2587834[iParam0 /*3*/][func_10(iParam1)];
...
void func_222(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_223(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_224(char* sParam0, int iParam1)
{
	...
	iVar1 = 15;
	iVar1 = (iVar1 || func_232(iParam1, 1));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(64, iVar0));
	iVar1 = (iVar1 || SYSTEM::SHIFT_LEFT(func_225(iParam1), iVar0));
...
int func_225(int iParam0)
{
	...
	Var1 = { func_226(iParam0, 1, 1, &uVar0) };
...
struct<4> func_226(int iParam0, bool bParam1, bool bParam2, var uParam3)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	if ((((!func_231(&(Global_111858.f_19957), 8) && bParam1) && iParam0 != 4) && func_229(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_231(&(Global_111858.f_19957), 1) && func_229(5) > 0)
		{
			MISC::SET_BIT(&iVar5, 1);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 2) && func_229(7) >= 2)
		{
			MISC::SET_BIT(&iVar5, 2);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 3) && ((((func_229(8) > 0 || func_229(9) > 0) && func_229(7) > 0) && bParam1) && iParam0 != 4))
		{
			MISC::SET_BIT(&iVar5, 3);
			iVar6++;
		}
		if ((!func_231(&(Global_111858.f_19957), 4) && func_229(1) > 0) && func_229(1) < 3)
		{
			MISC::SET_BIT(&iVar5, 4);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 5) && func_229(1) >= 3)
		{
			MISC::SET_BIT(&iVar5, 5);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 6) && func_229(0) > 0)
		{
			MISC::SET_BIT(&iVar5, 6);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 7))
		{
			MISC::SET_BIT(&iVar5, 7);
			iVar6++;
		}
		if (((!func_231(&(Global_111858.f_19957), 8) && bParam1) && func_229(3) > 0) && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar5, 8);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 9))
		{
			MISC::SET_BIT(&iVar5, 9);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 10))
		{
			MISC::SET_BIT(&iVar5, 10);
			iVar6++;
		}
		if (!func_231(&(Global_111858.f_19957), 11))
		{
		...
		if (iVar6 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar4 = func_228(7, 9, 10, 11, 0);
			}
			else
			{
				iVar4 = func_228(7, 9, 10, 0, 0);
			}
		}
		else
		{
	...
	if (bParam2)
	{
		func_227(&(Global_111858.f_19957), iVar4, 1);
	}
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_231(&(Global_111858.f_19957), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar15 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_231(&(Global_111858.f_19957), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar15 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_231(&(Global_111858.f_19957), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar15 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_231(&(Global_111858.f_19957), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar15 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_231(&(Global_111858.f_19957), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar15 = true;
	}
...
int func_229(int iParam0)
{
	...
	{
		case 0:
			return func_230(&Global_95423, 1);
		case 1:
			return func_230(&Global_95425, 3);
		case 2:
			return func_230(&Global_95429, 1);
		case 3:
			return func_230(&Global_95431, 1);
		case 4:
			return func_230(&Global_95433, 1);
		case 5:
			return func_230(&Global_95435, 1);
		case 6:
			return func_230(&Global_95437, 1);
		case 7:
			return func_230(&Global_95439, 2);
		case 8:
			return func_230(&Global_95442, 1);
		case 9:
			return func_230(&Global_95444, 1);
	}
	return 0;
}
...
int func_232(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			break;
		case 1:
			if (func_233(20) && !func_233(59))
			{
				if ((!func_233(21) || func_233(72)) || func_233(73))
				{
					if (func_233(21))
					{
						return 64;
			...
			break;
		case 4:
			if ((func_233(48) && func_233(61)) && func_233(22))
			{
				if (func_233(27))
				{
					return 64;
				...
				else if (!func_233(84) && !func_233(85))
				{
					return 16;
				}
			}
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8)
{
	...
	PED::SET_PED_COMPONENT_VARIATION(*iParam0, 3, iParam6, iParam7, 0);
	PED::SET_PED_COMPONENT_VARIATION(*iParam0, 4, 0, iParam8, 0);
	func_235(1, 0);
	func_80(1, 1, 1, 0, 0, 0, 0);
}
...
var func_239(int iParam0, int iParam1)
{
	struct<5> Var0;
...
struct<5> func_240(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 70:
			...
			Var0.f_3 = "apa_v_mp_h_04";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4084
			Var0 = { -773.2258f, 322.8252f, 194.8862f };
			Var0.f_3 = "apa_v_mp_h_05";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4122
			Var0 = { -773.2258f, 322.8252f, 194.8862f };
			Var0.f_3 = "apa_v_mp_h_06";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4160
			Var0 = { -773.2258f, 322.8252f, 194.8862f };
			Var0.f_3 = "apa_v_mp_h_07";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4198
			Var0 = { -773.2258f, 322.8252f, 194.8862f };
			Var0.f_3 = "apa_v_mp_h_08";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4236
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4274
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4312
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_03";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4350
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_04";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4388
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_05";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4426
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_06";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4464
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_07";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4502
			Var0 = { -787.7805f, 334.9232f, 186.1134f };
			Var0.f_3 = "apa_v_mp_h_08";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4540
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4582
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4624
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4666
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4708
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4750
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4792
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4834
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4876
			vVar5 = { func_241(87, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4918
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 4960
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5002
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5044
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5086
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5128
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5170
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5212
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5254
			vVar5 = { func_241(88, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5296
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5338
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5380
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5422
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5464
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5506
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5548
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5590
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5632
			vVar5 = { func_241(89, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5674
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5716
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5758
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_01c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5800
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5842
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5884
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_02c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5926
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03a_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 5968
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03b_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6010
			vVar5 = { func_241(90, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "ex_int_office_03c_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6052
			vVar5 = { func_241(91, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "bkr_biker_dlc_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6094
			vVar5 = { func_241(97, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "bkr_biker_dlc_int_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6136
			vVar5 = { func_241(103, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6178
			vVar5 = { func_241(104, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6220
			vVar5 = { func_241(105, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6262
			vVar5 = { func_241(106, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6304
			vVar5 = { func_241(107, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6346
			vVar5 = { func_241(108, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6388
			vVar5 = { func_241(109, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6430
			vVar5 = { func_241(110, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6472
			vVar5 = { func_241(111, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6514
			vVar5 = { func_241(112, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6556
			vVar5 = { func_241(113, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6598
			vVar5 = { func_241(114, 0) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_impexp_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6640
			vVar5 = { func_241(103, 1) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_imptexp_mod_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6682
			vVar5 = { func_241(106, 1) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_imptexp_mod_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6724
			vVar5 = { func_241(109, 1) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_imptexp_mod_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6766
			vVar5 = { func_241(112, 1) };
			Var0 = { vVar5 + Vector(1f, 0f, 0f) };
			Var0.f_3 = "imp_imptexp_mod_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6808
			Var0 = { 938.3077f, -3196.112f, -100f };
			Var0.f_3 = "gr_grdlc_int_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6846
			Var0 = { 512.5f, 4852f, -62.6f };
			Var0.f_3 = "xm_x17dlc_int_sub";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6884
			Var0 = { 2047f, 2942f, -61.9f };
			Var0.f_3 = "xm_x17dlc_int_facility";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6922
			Var0 = { -1047.6f, -232.3503f, 38.0135f };
			Var0.f_3 = "v_faceoffice";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6960
			Var0 = { 1100f, -2004f, 37f };
			Var0.f_3 = "v_foundry";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 6998
			Var0 = { 361f, 6306f, -159f };
			Var0.f_3 = "xm_x17dlc_int_silo_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7036
			Var0 = { 305f, 6298f, -160f };
			Var0.f_3 = "xm_x17dlc_int_silo_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7074
			Var0 = { 244f, 6163f, -159f };
			Var0.f_3 = "xm_x17dlc_int_lab";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7112
			Var0 = { 2168f, 2920f, -84f };
			Var0.f_3 = "xm_x17dlc_int_facility2";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7150
			Var0 = { 446f, 5922f, -158f };
			Var0.f_3 = "xm_x17dlc_int_bse_tun";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7188
			Var0 = { 252f, 5972f, -156f };
			Var0.f_3 = "xm_x17dlc_int_base_loop";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7226
			Var0 = { 682f, 5959f, -152f };
			Var0.f_3 = "xm_x17dlc_int_base_ent";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7264
			Var0 = { 551f, 5939f, -158f };
			Var0.f_3 = "xm_x17dlc_int_base";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7302
			Var0 = { 520.0001f, 4750f, -70f };
			Var0.f_3 = "xm_x17dlc_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7340
			Var0 = { -1266.802f, -3014.849f, -49.4903f };
			Var0.f_3 = "sm_smugdlc_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7378
			Var0 = { 974.9203f, -3000.065f, -40.647f };
			Var0.f_3 = "imp_impexp_intwaremed";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7416
			Var0 = { 969.5376f, -3000.411f, -48.647f };
			Var0.f_3 = "imp_impexp_int_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7454
			Var0 = { 1094.997f, -3100.012f, -39.9999f };
			Var0.f_3 = "ex_int_warehouse_s_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7492
			Var0 = { 1059.995f, -3100f, -39.9999f };
			Var0.f_3 = "ex_int_warehouse_m_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7530
			Var0 = { 1010.008f, -3100f, -39.9999f };
			Var0.f_3 = "ex_int_warehouse_l_dlc";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7568
			Var0 = { 372.6707f, 405.5235f, 144.5326f };
			Var0.f_3 = "apa_v_mp_stilts_a";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7606
			Var0 = { -282.0588f, -955.17f, 85.3036f };
			Var0.f_3 = "hei_dlc_apart_high_new";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7644
			Var0 = { 342.7946f, -997.4225f, -99.7444f };
			Var0.f_3 = "v_apart_midspaz";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7682
			Var0 = { 260.3268f, -997.4298f, -100.0086f };
			Var0.f_3 = "v_studio_lo";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7720
			Var0 = { 108.2369f, -753.5364f, 233.1523f };
			Var0.f_3 = "v_fib01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7758
			Var0 = { 135.3226f, -746.3677f, 253.1523f };
			Var0.f_3 = "v_fib03";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7796
			Var0 = { 108.2572f, -753.5342f, 44.7548f };
			Var0.f_3 = "v_office_lobby";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7834
			Var0 = { 228.6161f, -992.053f, -99.9999f };
			Var0.f_3 = "heist_dlc_garage_high_new";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7872
			Var0 = { 199.9716f, -999.6678f, -100f };
			Var0.f_3 = "v_garagem";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7910
			Var0 = { 173.1165f, -1003.28f, -99.9999f };
			Var0.f_3 = "v_garages";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7948
			Var0 = { 575f, 4750f, -60f };
			Var0.f_3 = "xm_v_apart_midspaz";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 7986
			Var0 = { 600f, 4750f, -60f };
			Var0.f_3 = "xm_v_studio_lo";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8024
			Var0 = { 630f, 4750f, -60f };
			Var0.f_3 = "xm_v_garagem";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8062
			Var0 = { 1257f, 4796.7f, -39.1f };
			Var0.f_3 = "xm_x17dlc_int_tun_entry";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8100
			Var0 = { 694.4f, 5898.9f, -152.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_straight";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8138
			Var0 = { 1121.8f, 5516.3f, -101.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_straight";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8176
			Var0 = { 1279.6f, 5233.2f, -80.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_straight";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8214
			Var0 = { 1158.6f, 5467.1f, -101.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_slope_flat";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8252
			Var0 = { 705.9f, 5838.5f, -152.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_slope_flat";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8290
			Var0 = { 1316.5f, 5184f, -80.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_slope_flat";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8328
			Var0 = { 1248f, 5276.1f, -80.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_flat_slope";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8366
			Var0 = { 1090.2f, 5559.2f, -101.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_flat_slope";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8404
			Var0 = { 1261f, 4808.6f, -39.3f };
			Var0.f_3 = "xm_x17dlc_int_tun_flat_slope";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8442
			Var0 = { 721.8f, 5781.4f, -146.7f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_r";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8480
			Var0 = { 780.8f, 5703.4f, -136.7f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_r";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8518
			Var0 = { 868.1f, 5659.2f, -126.7f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_r";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8556
			Var0 = { 1218.2f, 5321.2f, -85.7f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_r";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8594
			Var0 = { 1278.5f, 4859.7f, -44.7f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_r";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8632
			Var0 = { 1187.2f, 5419.8f, -96.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8670
			Var0 = { 1344.7f, 5136.4f, -75.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8708
			Var0 = { 1363.4f, 5039.5f, -65.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8746
			Var0 = { 1049.3f, 5602.1f, -107.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8784
			Var0 = { 1337.8f, 4944.3f, -55.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8822
			Var0 = { 961.5f, 5646.9f, -117.4f };
			Var0.f_3 = "xm_x17dlc_int_tun_30d_l";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8860
			Var0 = { 345.0041f, 4842.001f, -59.9997f };
			Var0.f_3 = "xm_x17dlc_int_02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8898
			Var0 = { 279.9322f, -1337.49f, 23.7419f };
			Var0.f_3 = "v_coroner";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8936
			Var0 = { -1604.664f, -3012.583f, -79.9999f };
			Var0.f_3 = "ba_dlc_int_01_ba";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 8974
			Var0 = { -1505.783f, -3012.587f, -79.9999f };
			Var0.f_3 = "ba_dlc_int_02_ba";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9012
			Var0 = { -630.4205f, -236.7843f, 37.057f };
			Var0.f_3 = "V_JEWEL2";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9050
			Var0 = { 2800f, -3800f, 100f };
			Var0.f_3 = "xs_x18_int_01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9088
			Var0 = { 2800f, -3942f, 182.5f };
			Var0.f_3 = "xs_arena_vip";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9126
			Jump @9778; //curOff = 9129
			Var0 = { 1049.6f, -3196.6f, -38.5f };
			Var0.f_3 = "bkr_biker_dlc_int_ware02";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9167
			Var0 = { 1093.6f, -3196.6f, -38.5f };
			Var0.f_3 = "bkr_biker_dlc_int_ware03";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9205
			Var0 = { 1009.5f, -3196.6f, -38.5f };
			Var0.f_3 = "bkr_biker_dlc_int_ware01";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9243
			Var0 = { 1100f, 245f, -49f };
			Var0.f_3 = "vw_dlc_casino_main";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9281
			Var0 = { 1380f, 200f, -50f };
			Var0.f_3 = "vw_dlc_casino_carpark";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9319
			Var0 = { 976.6364f, 70.29476f, 115.1641f };
			Var0.f_3 = "vw_dlc_casino_apart";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9357
			Var0 = { 1295f, 230f, -50f };
			Var0.f_3 = "vw_dlc_casino_garage";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9395
			Var0 = { 2479.3f, -273.9f, -58f };
			Var0.f_3 = "ch_DLC_Casino_Heist";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9433
			Var0 = { 2730f, -380f, -49f };
			Var0.f_3 = "ch_DLC_Arcade";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9471
			Var0 = { 2800f, -380f, -48.5f };
			Var0.f_3 = "ch_DLC_Plan";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9509
			Var0 = { 2497.7f, -312.8f, -69.9f };
			Var0.f_3 = "ch_DLC_Tunnel";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9547
			Var0 = { 2523.4f, -270f, -58.7f };
			Var0.f_3 = "ch_DLC_Casino_Back";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9585
			Var0 = { 2504.4f, -257.2f, -39.1f };
			Var0.f_3 = "ch_DLC_Casino_Hotel";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9623
			Var0 = { 2554f, -281.4f, -64.7f };
			Var0.f_3 = "ch_DLC_Casino_Loading";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9661
			Var0 = { 2488.3f, -267.4f, -70.6f };
			Var0.f_3 = "ch_DLC_Casino_Vault";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9699
			Var0 = { 2519.9f, -255.3f, -24.1f };
			Var0.f_3 = "ch_DLC_Casino_Utility";
			Var0.f_4 = Var0.f_3;
			Jump @9778; //curOff = 9737
...
struct<6> func_241(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	func_249(uParam0, iParam2);
	func_249(uParam0, iParam5);
	if (iParam6 == 4)
	{
...
void func_254(bool bParam0, int* iParam1, int iParam2, int iParam3)
{
	HUD::DISPLAY_HUD(true);
	HUD::DISPLAY_RADAR(true);
	func_258();
...
void func_255()
{
	...
	while (iVar0 < 1)
	{
		Global_95420[iVar0] = 0;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 2)
	{
		Global_95417[iVar0] = 0;
		iVar0++;
	}
}
...
void func_256()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_257(&Global_95423, 1);
				break;
			case 1:
				func_257(&Global_95425, 3);
				break;
			case 2:
				func_257(&Global_95429, 1);
				break;
			case 3:
				func_257(&Global_95431, 1);
				break;
			case 4:
				func_257(&Global_95433, 1);
				break;
			case 5:
				func_257(&Global_95435, 1);
				break;
			case 6:
				func_257(&Global_95437, 1);
				break;
			case 7:
				func_257(&Global_95439, 2);
				break;
			case 8:
				func_257(&Global_95442, 1);
				break;
			case 9:
				func_257(&Global_95444, 1);
				break;
		}
		iVar1++;
	}
...
void func_259()
{
	...
	if (Global_111858.f_9081 || func_268(0))
	{
		if (!func_267())
		{
			iVar0 = func_266();
...
int func_261(int iParam0)
{
	...
	func_262(&(Global_111858.f_2359.f_539), iVar1);
...
void func_262(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_264(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_269(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_268(0) && Global_77079.f_1 == 1) && func_270(Global_77079))
		{
		}
		else
		{
...
int func_273(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
