...
void func_65(var uParam0)
{
	...
	sVar0 = func_68(uParam0->f_18 == joaat("NIMBUS"), "Plane_1", "Plane");
...
int func_66(var uParam0)
{
	...
	STREAMING::REQUEST_MODEL(func_67());
	if (!STREAMING::HAS_MODEL_LOADED(func_67()))
	{
		return 0;
	}
	uParam0->f_20 = PED::CREATE_PED(4, func_67(), uParam0->f_7, 0f, false, false);
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_67());
	return 1;
}
...
char* func_68(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
void func_71(bool bParam0, bool bParam1, bool bParam2)
{
	func_73();
	func_48(1);
	HUD::CLEAR_HELP(true);
...
{
	if (func_196(PLAYER::PLAYER_ID(), 0, 0))
	{
		return;
	}
	...
	if (!uParam0->f_13)
	{
		if (!STREAMING::NEW_LOAD_SCENE_START(uParam0->f_7, func_78(uParam0->f_10), 4000f, 0))
		{
			return;
		}
		else
...
int func_79(var uParam0)
{
	...
	{
		uParam0->f_21 = PED::_CLONE_PED_EX(func_195(), 0f, false, true, 1);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
		{
			return 0;
		}
	...
	{
		uParam0->f_21 = PED::_CLONE_PED_EX(func_195(), 0f, false, false, 0);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
		{
			return 0;
		}
		func_80(uParam0->f_21, &(Global_1625151[iVar0 /*47*/]), 0, -1);
	}
...
void func_80(int iParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<9> Var0;
	int iVar13;
	bool bVar14;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		iVar13 = func_188(iParam0);
		bVar14 = func_182(iParam0, 0);
		bVar15 = func_178(iParam0);
		bVar16 = func_102(iParam0, iParam3);
		if (bParam2)
		{
			bVar15 = true;
		}
		...
		while (iVar17 < 127)
		{
			...
			{
				if (func_94(&Var0, iVar17, iVar13, iParam0, -1))
				{
					if (func_82(iParam0, &Var0, iVar17, Var0.f_4, Var0.f_8, bVar14, bVar15, bParam2, bVar16))
					{
		...
		while (iVar18 < iVar19)
		{
			if (FILES::_GET_TATTOO_COLLECTION_DATA(iVar13, iVar18, &Var20))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
				{
					...
					{
						if (func_82(iParam0, &(Var20.f_7), iVar35, Var20.f_2, Var20.f_6, bVar14, bVar15, bParam2, bVar16))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(iParam0, Var20.f_2, Var20.f_3);
							func_81(iParam0, Var20.f_2, Var20.f_3);
						}
					}
				}
			}
...
int func_82(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	...
	if (iParam4 == 0)
	{
		iVar1 = func_93(iVar0, sParam1, iParam4);
		iParam4 = MISC::GET_HASH_KEY(func_92(iVar1));
	}
				...
				if (!bParam6)
				{
					if (Global_4269381 == -1)
					{
						if (!Global_99007.f_1521)
						{
							...
							else if (func_83(14, -1))
							{
								return 0;
							}
							else if (func_83(15, -1))
							{
								return 0;
							}
							else if (func_83(16, -1))
							{
								return 0;
							}
							else if (func_83(71, -1))
							{
								return 0;
							}
							else if (func_83(72, -1))
							{
							}
						}
					}
...
int func_86(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_87(iParam1)];
...
int func_93(int iParam0, char* sParam1, int iParam2)
{
	switch (iParam2)
	{
		case 1019352240:
...
bool func_94(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	switch (iParam2)
	{
		case 0:
			switch (iParam1)
			{
				...
				case 20:
					...
					break;
				default:
					func_95(sParam0, iParam2, iParam1, 21);
					break;
			}
			break;
		case 1:
			switch (iParam1)
			{
				...
				case 39:
					...
					break;
				default:
					func_95(sParam0, iParam2, iParam1, 40);
					break;
			}
			break;
		case 2:
			switch (iParam1)
			{
				...
				case 33:
					...
					break;
				default:
					func_95(sParam0, iParam2, iParam1, 34);
					break;
			}
			break;
		case 3:
		case 4:
			...
			{
				func_95(sParam0, iParam2, iParam1, 129);
			}
			if (iParam4 == 22)
			{
				sParam0->f_7 *= 2;
...
int func_102(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_M_FREEMODE_01"))
		{
			...
			if (iVar0 > 15)
			{
				iVar3 = func_107(iParam0, 11, -1);
				if (iVar3 >= 237)
				{
					iVar4 = func_103(joaat("MP_M_FREEMODE_01"), iVar3, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_F_FREEMODE_01"))
		{
			...
			{
				iVar5 = func_107(iParam0, 11, -1);
				if (iVar5 >= 256)
				{
					iVar6 = func_103(joaat("MP_F_FREEMODE_01"), iVar5, 11, 4);
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (iParam1 - func_106(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (iParam1 - func_104(iParam0, func_105(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_105(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_110(int iParam0, int iParam1)
{
	...
	return func_111(iParam0, iVar0, iVar1, iParam1);
}
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar0 != -1)
		{
			return (func_106(iParam0) + iVar0);
		}
	}
	else
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_105(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_104(iParam0, func_105(iParam2)) + fVar1);
		}
	}
	return -99;
}
...
int func_115(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_131(iVar0, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_115(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar25 = { func_124(iVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_115(iParam0, 14, uVar25[iVar5]))
							{
								iVar6 = 0;
								while (iVar6 <= 19)
								{
									Global_76647[2 /*14*/] = { func_131(iVar0, 14, iVar6, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar5)
									{
										if (func_115(iParam0, 14, iVar6))
										{
											if (!func_119(iVar0, iParam2, 14, iVar6, &uVar8, &(Global_76647[2 /*14*/])))
											{
												Global_2621444 = uVar2;
												Global_2621445 = uVar3;
												return 0;
					...
					{
						iVar1 = func_108(iParam0, iVar4);
						Global_76647[2 /*14*/] = { func_131(iVar0, iVar4, iVar1, -1) };
						if (!func_119(iVar0, iParam2, iVar4, iVar1, &uVar8, &(Global_76647[2 /*14*/])))
						{
							Global_2621444 = uVar2;
							Global_2621445 = uVar3;
							return 0;
		...
		{
			if (func_86(1758, Global_76644, 0) != uVar8[10])
			{
				Global_2621444 = uVar2;
				Global_2621445 = uVar3;
				return 0;
	...
	{
		uVar36 = { func_124(iVar0, iParam2) };
		iVar35 = 0;
		while (iVar35 <= 8)
		{
			if (!func_115(iParam0, 14, uVar36[iVar35]))
			{
				return 0;
			}
			iVar35++;
	...
	{
		if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_105(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_105(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
		{
			...
			if (Global_76646 == 1)
			{
				if (func_118(iVar0, 11, func_108(iParam0, 11), -1))
				{
					if (func_117(iVar0, 4, iParam2, &iVar68))
					{
						return func_115(iParam0, 4, iVar68);
					}
				}
				else if (func_116(iVar0, 4, iParam2, &iVar68))
				{
					return func_115(iParam0, 4, iVar68);
				}
			}
		...
		case joaat("MP_F_FREEMODE_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						iVar0 = func_103(iParam0, iParam2, iParam1, 4);
						if (iVar0 != -1)
						{
							...
							while (iVar2 < iVar1)
							{
								...
								if (iVar5 == 4)
								{
									if (iVar3 != 0 && iVar3 != 1849449579)
									{
										...
										{
											*iParam3 = func_113(iParam0, iVar3, iParam1, 4);
											return 1;
										}
									}
								}
...
int func_117(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
							...
							while (iVar2 < iVar1)
							{
								...
								if (iVar5 == 4)
								{
									if (iVar3 != 0 && iVar3 != 1849449579)
									{
										if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar3, joaat("DRESS_LEGS"), 0))
										{
											*uParam3 = func_113(iParam0, iVar3, iParam1, 4);
											return 1;
										}
									}
								}
			...
			switch (iParam1)
			{
				case 11:
					if (iParam2 >= 256)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(iParam0, iParam2, 11, 4);
						}
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
	...
	if (func_123(iParam0, iParam2, iParam3))
	{
		return 1;
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(iParam0, iParam2, 14, 3);
						}
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_103(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(iParam0, iParam2, 1, 3);
						}
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_103(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(iParam0, iParam2, 14, 4);
						}
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_103(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				case 1:
					if (iParam2 >= 26)
					{
						if (iParam3 == -1)
						{
							iParam3 = func_103(iParam0, iParam2, 1, 4);
						}
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_103(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
struct<10> func_124(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_127(int iParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_130(&Var1, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					else
					{
						func_130(&Var1, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					}
					break;
				case 1:
					func_130(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
				case 2:
					func_130(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
				case 3:
					func_130(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
				case 4:
					func_130(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
				case 5:
					func_130(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
					func_130(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 7:
					func_130(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 8:
					func_130(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 9:
					func_130(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 10:
					func_130(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
				case 11:
					func_130(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
				case 12:
					func_130(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
				case 13:
					func_130(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 14:
					func_130(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
				case 15:
					func_130(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
				case 16:
					func_130(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
				case 17:
					func_130(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 18:
					func_130(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
				case 19:
					func_130(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 20:
					func_130(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 21:
					func_130(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 22:
					func_130(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 23:
					func_130(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 24:
					func_130(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
				case 25:
					func_130(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 26:
					func_130(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 27:
					func_130(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 28:
					func_130(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				case 29:
					func_130(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 30:
					func_130(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 31:
					func_130(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				case 32:
					func_130(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 33:
					func_130(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 34:
					func_130(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
				case 35:
					func_130(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 36:
					func_130(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 37:
					func_130(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 38:
					func_130(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 39:
					func_130(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 40:
					func_130(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 41:
					func_130(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 42:
					func_130(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 43:
					func_130(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 44:
					func_130(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 45:
					func_130(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 46:
					func_130(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 47:
					func_130(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 48:
					func_130(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 49:
					func_130(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 50:
					func_130(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
				case 51:
					func_130(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 52:
					func_130(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				default:
					func_128(&Var1, iParam0, iParam1, 53);
					break;
			}
			break;
		case joaat("PLAYER_ONE"):
			...
			{
				case 0:
					func_130(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 1:
					func_130(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				case 2:
					func_130(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
					func_130(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
				case 4:
					func_130(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				case 5:
					func_130(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 6:
					func_130(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 7:
					func_130(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
				case 8:
					func_130(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
				case 9:
					func_130(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 10:
					func_130(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 11:
					func_130(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				case 12:
					func_130(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 13:
					func_130(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 14:
					func_130(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 15:
					func_130(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 16:
					func_130(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 17:
					func_130(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 18:
					func_130(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
				case 19:
					func_130(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 20:
					func_130(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 21:
					func_130(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
				case 22:
					func_130(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
				case 23:
					func_130(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
				case 24:
					func_130(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
				case 25:
					func_130(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
				case 26:
					func_130(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
				case 27:
					func_130(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
				case 28:
					func_130(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
				case 29:
					func_130(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
				case 30:
					func_130(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
				case 31:
					func_130(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
				case 32:
					func_130(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
				case 33:
					func_130(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
				case 34:
					func_130(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
				case 35:
					func_130(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
				case 36:
					func_130(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
				case 37:
					func_130(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
				case 38:
					func_130(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 39:
					func_130(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 40:
					func_130(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 41:
					func_130(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 42:
					func_130(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
				case 43:
					func_130(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
				case 44:
					func_130(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				case 45:
					func_130(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
				case 46:
					func_130(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
				default:
					func_128(&Var1, iParam0, iParam1, 47);
					break;
			}
			break;
		case joaat("PLAYER_TWO"):
			...
			{
				case 0:
					func_130(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 1:
					func_130(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
				case 2:
					func_130(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				case 3:
					func_130(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
				case 4:
					func_130(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
					func_130(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
				case 6:
					func_130(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
				case 7:
					func_130(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
				case 8:
					func_130(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
				case 9:
					func_130(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 10:
					func_130(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 11:
					func_130(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
				case 12:
					func_130(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				case 13:
					func_130(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 14:
					func_130(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
				case 15:
					func_130(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 16:
					func_130(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 17:
					func_130(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 18:
					func_130(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 19:
					func_130(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 20:
					func_130(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 21:
					func_130(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 22:
					func_130(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 23:
					func_130(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 24:
					func_130(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 25:
					func_130(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 26:
					func_130(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 27:
					func_130(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 28:
					func_130(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 29:
					func_130(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 30:
					func_130(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 31:
					func_130(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 32:
					func_130(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 33:
					func_130(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 34:
					func_130(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 35:
					func_130(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 36:
					func_130(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 37:
					func_130(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 38:
					func_130(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 39:
					func_130(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 40:
					func_130(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 41:
					func_130(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 42:
					func_130(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 43:
					func_130(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 44:
					func_130(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
				case 45:
					func_130(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
				case 46:
					func_130(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 47:
					func_130(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
				default:
					func_128(&Var1, iParam0, iParam1, 48);
					break;
			}
			break;
		case joaat("MP_M_FREEMODE_01"):
			...
			{
				case 0:
					func_130(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
				case 1:
					func_130(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
				case 2:
					func_130(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				case 3:
					func_130(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
				case 4:
					func_130(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
				case 5:
					func_130(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
				case 6:
					func_130(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
				case 7:
					func_130(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
				case 8:
					func_130(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				case 9:
					func_130(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
				case 10:
					func_130(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
				case 11:
					func_130(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
				case 12:
					func_130(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
				case 13:
					func_130(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
				case 14:
					func_130(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
				case 15:
					func_130(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
				case 16:
					func_130(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
				case 17:
					func_130(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				case 18:
					func_130(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
				case 19:
					func_130(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
				case 20:
					func_130(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
				case 21:
					func_130(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				case 22:
					func_130(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
				case 23:
					func_130(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
				case 24:
					func_130(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
				case 25:
					func_130(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
				default:
					func_128(&Var1, iParam0, iParam1, 26);
					break;
			}
			break;
		case joaat("MP_F_FREEMODE_01"):
			...
			{
				case 0:
					func_130(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				case 1:
					func_130(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
				case 2:
					func_130(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
				case 3:
					func_130(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				case 4:
					func_130(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
				case 5:
					func_130(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
				case 6:
					func_130(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				case 7:
					func_130(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
				case 8:
					func_130(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				case 9:
					func_130(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
				case 10:
					func_130(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
				case 11:
					func_130(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
				case 12:
					func_130(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
				case 13:
					func_130(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				case 14:
					func_130(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
				case 15:
					func_130(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
				case 16:
					func_130(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
				case 17:
					func_130(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
				case 18:
					func_130(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
				case 19:
					func_130(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
				case 20:
					func_130(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
				case 21:
					func_130(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
				case 22:
					func_130(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
				case 23:
					func_130(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
				case 24:
					func_130(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
				case 25:
					func_130(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
				case 26:
					func_130(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
				case 27:
					func_130(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
				default:
					func_128(&Var1, iParam0, iParam1, 28);
					break;
			}
			break;
	}
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_129(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_129(vVar16.z)] = func_113(iParam1, vVar16.x, func_129(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					(*uParam0)[func_129(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
void func_130(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == joaat("MP_M_FREEMODE_01"))
	{
		func_161(iParam1, iParam2, iParam3);
	}
	else if (iParam0 == joaat("MP_F_FREEMODE_01"))
	{
...
void func_133(int iParam0)
{
	...
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_86(func_137(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_86(func_136(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_86(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_140(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_143(int iParam0, int iParam1)
{
	...
	func_144(iVar0, iParam0, 0, iParam1);
}
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_134(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_134(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_134(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_134(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_105(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_145(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 9, iParam1);
			return;
	}
	...
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_146(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 28, iParam1);
			return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_147(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 4;
		func_144(iVar10, iParam0, 327, iParam1);
...
void func_148(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 6, iParam1);
			return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_149(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 55, iParam1);
			if (Global_76647[0 /*14*/].f_7 > 0)
			{
...
void func_150(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 26, iParam1);
			if (Global_76647[0 /*14*/].f_7 > 0)
			{
...
void func_151(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 4;
		func_144(iVar10, iParam0, 256, iParam1);
		if (Global_76647[0 /*14*/].f_7 > 0)
		{
...
void func_153(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 4;
		func_144(iVar10, iParam0, 16, iParam1);
		return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_154(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 4;
		func_144(iVar10, iParam0, 36, iParam1);
		return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 136, iParam1);
			if (Global_76647[0 /*14*/].f_7 > 0)
			{
...
bool func_156(int iParam0, int iParam1)
{
	...
	if (func_158(iParam0) == 11771)
	{
		return false;
	}
	iVar0 = func_157(iParam0, iParam1);
	iVar1 = iParam0;
	return MISC::IS_BIT_SET(iVar0, func_84(iVar1));
}
...
int func_157(int iParam0, int iParam1)
{
	...
	iVar0 = func_86(func_158(iParam0), iParam1, 0);
	return iVar0;
}
...
void func_160(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 4;
			func_144(iVar10, iParam0, 92, iParam1);
			return;
	}
...
void func_167(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 3;
			func_144(iVar10, iParam0, 7, iParam1);
			return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_173(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 3;
			func_144(iVar10, iParam0, 46, iParam1);
			return;
	}
	func_134(&(Global_76647[0 /*14*/]), iVar10, iParam0, &uVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_174(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 3;
		func_144(iVar10, iParam0, 241, iParam1);
		if (Global_76647[0 /*14*/].f_7 > 0)
		{
...
void func_175(int iParam0, int iParam1)
{
	...
	{
		Global_76647[0 /*14*/].f_5 = 3;
		func_144(iVar10, iParam0, 237, iParam1);
		if (Global_76647[0 /*14*/].f_7 > 0)
		{
			Global_76647[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_76647[0 /*14*/].f_7) * Global_292332.f_16));
		}
...
void func_176(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_76647[0 /*14*/].f_5 = 3;
			func_144(iVar10, iParam0, 91, iParam1);
			return;
	}
...
bool func_180(bool bParam0)
{
	if (bParam0)
	{
		return (MISC::IS_BIT_SET(Global_4456448.f_123318, 12) && func_181());
	}
		...
		if (ENTITY::GET_ENTITY_MODEL(iParam0) == joaat("MP_M_FREEMODE_01"))
		{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = func_186(joaat("MP_M_FREEMODE_01"), 11, func_107(iParam0, 11, -1), 0);
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_183(PLAYER::PLAYER_ID(), 1) && Global_1630317[PLAYER::PLAYER_ID() /*595*/].f_11.f_75.f_21 != 0)
						{
							return 1;
						}
					}
			...
			switch (iVar0)
			{
				...
				default:
					if (iVar0 > 15)
					{
						iVar5 = func_107(iParam0, 8, -1);
						if (iVar5 >= 241)
						{
							iVar6 = func_103(joaat("MP_M_FREEMODE_01"), iVar5, 8, 3);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = func_186(joaat("MP_F_FREEMODE_01"), 11, func_107(iParam0, 11, -1), 0);
				...
				default:
					if (iVar0 > 15)
					{
						iVar8 = func_107(iParam0, 11, -1);
						if (iVar8 >= 256)
						{
							iVar9 = func_103(joaat("MP_F_FREEMODE_01"), iVar8, 11, 4);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = func_186(joaat("MP_F_FREEMODE_01"), 11, func_107(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = func_186(joaat("MP_F_FREEMODE_01"), 11, func_107(iParam0, 11, -1), 0);
				...
				default:
					if (iVar0 > 15)
					{
						iVar12 = func_107(iParam0, 8, -1);
						if (iVar12 >= 136)
						{
							iVar13 = func_103(joaat("MP_F_FREEMODE_01"), iVar12, 8, 4);
...
int func_184(int iParam0, bool bParam1, int iParam2)
{
	...
	if (iVar0 != func_189() && Global_1630317[iVar0 /*595*/].f_11.f_423 == iParam2)
	{
		return 1;
	}
	return 0;
...
int func_185(int iParam0, int iParam1)
{
	if (iParam0 != func_189())
	{
		if (Global_1630317[iParam0 /*595*/].f_11 != func_189())
		{
...
int func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == joaat("MP_M_FREEMODE_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				iVar0 = func_103(iParam0, iParam2, 11, 3);
				if (iVar0 != -1)
				{
					...
					else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar0, joaat("MULTI_DECAL"), 0))
					{
						if (iParam3 == 0)
						{
							iParam3 = func_86(1758, -1, 0);
						}
						return func_187(iParam3, 3);
					}
				}
			}
		}
		else if (iParam1 == 8)
		{
			...
			{
				iVar6 = func_103(iParam0, iParam2, 8, 3);
				if (iVar6 != -1)
				{
	...
	else if (iParam0 == joaat("MP_F_FREEMODE_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				iVar12 = func_103(iParam0, iParam2, 11, 4);
				if (iVar12 != -1)
				{
		...
		else if (iParam1 == 8)
		{
			...
			{
				iVar18 = func_103(iParam0, iParam2, 8, 4);
				if (iVar18 != -1)
				{
...
bool func_193(int iParam0, bool bParam1)
{
	...
	return Global_1630317[iParam0 /*595*/].f_11 != func_189();
}
...
int func_195()
{
	...
	if (func_192(1))
	{
		iVar0 = PLAYER::GET_PLAYER_PED(func_191());
	}
	return iVar0;
}
...
int func_204()
{
	...
	if (func_205() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_205()) == 0)
		{
			return 1;
		}
	}
...
void func_215()
{
	...
	func_223(&uLocal_85, joaat("NIMBUS"), "Plane_1");
	func_54(&uLocal_85, 1);
	func_221(&uLocal_85, -1640.596f, -3127.113f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_NIMB_LSA_ISD", 0, 1, 1023);
...
bool func_218()
{
	return func_219(PLAYER::PLAYER_PED_ID());
}
...
bool func_220(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_221(var uParam0, vector3 vParam1, vector3 vParam4, char* sParam7, int iParam8, int iParam9, int iParam10)
{
	func_222(uParam0, sParam7, iParam8, iParam9, iParam10);
	uParam0->f_7 = { vParam1 };
	uParam0->f_10 = { vParam4 };
}

void func_222(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_223(var uParam0, int iParam1, char* sParam2)
{
