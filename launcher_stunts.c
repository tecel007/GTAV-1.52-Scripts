					...
					if (!func_107(iLocal_100))
					{
						if (!func_109(uLocal_94, 8))
						{
							...
							else
							{
								...
								{
									MISC::CLEAR_AREA_OF_VEHICLES(ScriptParam_0.f_1[0 /*3*/], 8f, false, false, false, false, false, false);
								...
								else
								{
									...
									if (!func_86(3) && !Global_98989)
									{
										...
										{
											if ((!func_109(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_85())) && !Global_98989)
											{
												func_102(10);
											}
											else
											{
												...
												if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
												{
													...
													if (iLocal_99 != -1)
													{
														if (func_109(Global_110509, 0))
														{
															STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_99), 0, Global_98992, 0);
															func_7(func_19(iLocal_99), 0, Global_98992, 1, 0);
														}
														else
														{
															STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_99), 0, Global_98992, 0);
															func_7(func_19(iLocal_99), 0, Global_98992, 0, 0);
														}
													}
													func_4();
													func_111(&Global_110509, 0);
												...
												func_3();
												Jump @3061; //curOff = 2733
												func_102(0);
												Jump @3061; //curOff = 2741
												func_113(1);
												Jump @3061; //curOff = 2749
												if (fLocal_110 > (fLocal_102 * fLocal_102))
												{
													if (iLocal_105 != 263)
													{
...
void func_4()
{
	...
	iVar0 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 1697.183f, 3279.226f, 41.7283f, 1.5897f, 0f, 146.8519f, 50f, true, 2);
	iVar1 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 1697.755f, 3280.423f, 41.7708f, -9.1434f, 0f, 168.0244f, 50f, false, 2);
...
int func_26(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (!func_6(iVar0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), vLocal_45, false, true, 0))
			{
...
void func_27(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_28(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}
...
int func_30(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_31(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_31(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_33()
{
	...
	{
		if (func_36(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_38(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_39(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_39(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_39(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_39(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_39(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_39(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_39(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_39(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_39(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_39(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_39(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_39(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_39(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_39(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_39(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_39(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_83()) || Global_110905) || Global_30970) || func_82()) || func_70(8, -1)) || func_81()) || func_80()) || func_79()) || func_72()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						...
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_83()) || Global_110905) || Global_30970) || func_82()) || func_70(8, -1)) || func_79()) || func_81()) || func_80()) || func_72()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_83()) || Global_110905) || Global_30970) || func_82()) || func_70(8, -1)) || func_81()) || func_80()) || func_72()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_83() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_70(8, -1)) || func_72()) || func_78()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						...
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_83()) || Global_110905) || Global_30970) || func_82()) || func_70(8, -1)) || func_79()) || func_78()) || func_81()) || func_80()) || func_72())
						{
							return 0;
						}
						break;
...
void func_110()
{
	...
	fLocal_102 = 209f;
	iLocal_105 = 95;
	MISC::CLEAR_AREA_OF_VEHICLES(vLocal_114, 10f, false, false, false, false, false, false);
	iLocal_99 = 10;
