...
void __EntryFunction__()
{
	...
	while (iVar0 != 7)
	{
		...
		if (iVar10 > 1)
		{
			...
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_310, joaat("AMBIENT_GANG_BALLAS"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_310, joaat("AMBIENT_GANG_FAMILY"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("AMBIENT_GANG_BALLAS"), iLocal_310);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("AMBIENT_GANG_FAMILY"), iLocal_310);
			}
			else
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_310, joaat("AMBIENT_GANG_BALLAS"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_310, joaat("AMBIENT_GANG_FAMILY"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("AMBIENT_GANG_BALLAS"), iLocal_310);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("AMBIENT_GANG_FAMILY"), iLocal_310);
			}
		}
		if ((iVar10 > 1 && iVar10 < 7) && !bLocal_283)
		{
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_289))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), true))
				{
					func_169();
					SYSTEM::WAIT(0);
					if (!PED::IS_PED_INJURED(iLocal_290[0]))
		...
		if (func_168(&iLocal_290, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 180f))
		{
			...
			if (bLocal_283)
			{
				...
				if (!bLocal_279)
				{
					if (!PED::IS_PED_INJURED(bLocal_289))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(bLocal_289, "random@getawaydriver", "idle_a", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(bLocal_289, "random@getawaydriver", "idle_2_hands_up", 3))
						{
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
						TASK::TASK_PERFORM_SEQUENCE(bLocal_289, iLocal_309);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
						PED::SET_PED_KEEP_TASK(bLocal_289, true);
						bLocal_279 = true;
					}
				}
			}
			...
			if (bLocal_278)
			{
				...
				else if (PED::IS_PED_INJURED(bLocal_289))
				{
					iVar18 = 0;
					iVar0 = 7;
					func_246(Var1, &iLocal_290, uVar12);
			...
			if (bLocal_279)
			{
				if (!PED::IS_PED_INJURED(bLocal_289))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0))
					{
						if (!func_185())
						{
							TASK::TASK_LOOK_AT_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), 3000, 2048, 2);
						...
						else
						{
							if (!PED::IS_PED_INJURED(bLocal_289))
							{
								PED::SET_PED_CAN_BE_TARGETTED(bLocal_289, true);
							}
							while (func_185())
							{
								SYSTEM::WAIT(0);
					...
					else if (!ENTITY::IS_ENTITY_AT_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, false, true, 0))
					{
						iVar18 = 0;
						iVar0 = 7;
						func_246(Var1, &iLocal_290, uVar12);
						...
						else
						{
							if (!bLocal_282)
							{
								if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Vector(28.4601f, -1565.293f, 61.5891f) - Vector(30f, 30f, 30f), Vector(28.4601f, -1565.293f, 61.5891f) + Vector(30f, 30f, 30f), false, true))
								{
									...
									if (!PED::IS_PED_INJURED(bLocal_289))
									{
										TASK::TASK_SMART_FLEE_PED(bLocal_289, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
										PED::SET_PED_KEEP_TASK(bLocal_289, true);
									}
									bLocal_282 = true;
								}
...
int func_1(int iParam0, struct<5> Param1, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, int iParam11, var uParam12)
{
	int iVar0;
	vector3 vVar1[2];
	float fVar8[2];
	...
	switch (*iParam0)
	{
		...
		case 1:
			*iParam11 = 0;
			...
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_234 - Vector(20f, 20f, 20f), vLocal_234 + Vector(20f, 20f, 20f), false, true);
			PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_234 - Vector(50f, 50f, 50f), vLocal_234 + Vector(50f, 50f, 50f), false, true, true, true);
			PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_234 - Vector(20f, 20f, 20f), vLocal_234 + Vector(20f, 20f, 20f), false, 0);
			PATHFIND::SET_ROADS_IN_AREA(vLocal_234 - Vector(20f, 20f, 20f), vLocal_234 + Vector(20f, 20f, 20f), false, true);
			...
			(*iParam10)[0] = PED::CREATE_PED(22, Param1, vVar1[0 /*3*/], fVar8[0], true, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*iParam10)[0], true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*iParam10)[0], iLocal_310);
			WEAPON::GIVE_WEAPON_TO_PED((*iParam10)[0], joaat("WEAPON_APPISTOL"), -1, true, true);
			PED::SET_PED_MONEY((*iParam10)[0], MISC::GET_RANDOM_INT_IN_RANGE(800, 2000));
			PED::SET_PED_CONFIG_FLAG((*iParam10)[0], 206, true);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[0], 2, false);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[0], 1024, true);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[0], 65536, true);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[0], 9, 1, 0, 0);
			func_118(&uLocal_55, 2, (*iParam10)[0], "REGETRobber2", 0, 1);
			(*iParam10)[1] = PED::CREATE_PED(22, Param1.f_1, vVar1[1 /*3*/], fVar8[1], true, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*iParam10)[1], true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH((*iParam10)[1], iLocal_310);
			WEAPON::GIVE_WEAPON_TO_PED((*iParam10)[1], joaat("WEAPON_PISTOL"), -1, true, true);
			PED::SET_PED_MONEY((*iParam10)[1], MISC::GET_RANDOM_INT_IN_RANGE(800, 2000));
			PED::SET_PED_CONFIG_FLAG((*iParam10)[1], 206, true);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[1], 2, false);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[1], 1024, true);
			PED::SET_PED_FLEE_ATTRIBUTES((*iParam10)[1], 65536, true);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 0, 5, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 1, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 3, 6, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 4, 6, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 6, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 8, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 9, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION((*iParam10)[1], 10, 1, 0, 0);
			AUDIO::SET_AMBIENT_VOICE_NAME((*iParam10)[1], "PACKIE_AI_Norm_Part1_Booth");
			func_118(&uLocal_55, 1, (*iParam10)[1], "PACKIE", 0, 1);
			bLocal_289 = PED::CREATE_PED(4, Param1.f_2, vVar11, fVar14, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Param1.f_2);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_289, true);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_289, iLocal_311);
			AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_289, "A_M_Y_Business_01_CHINESE_MINI_01");
			...
			*iParam0 = 2;
			break;
		case 2:
			if (((((!ENTITY::IS_ENTITY_DEAD(bLocal_289, false) && !ENTITY::IS_ENTITY_DEAD(iLocal_293[0], false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_293[2], false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_293[3], false)) && !ENTITY::IS_ENTITY_DEAD((*iParam10)[0], false)) && !ENTITY::IS_ENTITY_DEAD((*iParam10)[1], false))
			{
				if (((((PED::_HAS_STREAMED_PED_ASSETS_LOADED(bLocal_289) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_293[0])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_293[2])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED(iLocal_293[3])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED((*iParam10)[0])) && PED::_HAS_STREAMED_PED_ASSETS_LOADED((*iParam10)[1]))
				{
					...
					if (!PED::IS_PED_INJURED(bLocal_289))
					{
						TASK::TASK_HANDS_UP(bLocal_289, -1, 0, -1, false);
						if (!PED::IS_PED_INJURED((*iParam10)[0]))
						{
							TASK::TASK_PLAY_ANIM((*iParam10)[0], "random@getawaydriver@thugs", "base_a", 4f, -2f, -1, 1, 0f, false, false, false);
							TASK::TASK_LOOK_AT_ENTITY((*iParam10)[0], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
						if (!PED::IS_PED_INJURED((*iParam10)[1]))
						{
							TASK::TASK_PLAY_ANIM((*iParam10)[1], "random@getawaydriver@thugs", "base_b", 4f, -2f, -1, 1, 0f, false, false, false);
							TASK::TASK_LOOK_AT_ENTITY((*iParam10)[1], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
					}
					SYSTEM::SETTIMERA(0);
					*iParam0 = 3;
		...
		case 3:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 81.71976f, -1530.834f, 28.17651f, 26.78526f, -1595.693f, 58.29443f, 32.875f, false, true, 0))
			{
				if (!bLocal_282)
				{
					if (!PED::IS_PED_INJURED(iLocal_293[0]))
					{
						TASK::TASK_SMART_FLEE_COORD(iLocal_293[0], vLocal_234, 200f, -1, false, false);
					}
					if (!PED::IS_PED_INJURED(iLocal_293[2]))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
						TASK::TASK_PAUSE(0, 250);
						TASK::TASK_SMART_FLEE_COORD(0, vLocal_234, 200f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
			...
			if (func_77(iParam10, PLAYER::GET_PLAYERS_LAST_VEHICLE()))
			{
				*iParam0 = 4;
			}
			if (func_76())
			...
			{
				if (!PED::IS_PED_INJURED((*iParam10)[0]) && !PED::IS_PED_INJURED((*iParam10)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*iParam10)[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
					TASK::TASK_SMART_FLEE_PED((*iParam10)[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
					func_169();
					SYSTEM::WAIT(0);
		...
		case 4:
			if (!func_185())
			{
				if ((!PED::IS_PED_INJURED((*iParam10)[0]) && !PED::IS_PED_INJURED((*iParam10)[1])) && !PED::IS_PED_INJURED(bLocal_289))
				{
				}
				if (ENTITY::DOES_ENTITY_EXIST(bLocal_289))
				{
					if (!PED::IS_PED_INJURED(bLocal_289))
					{
						...
						TASK::TASK_LOOK_AT_ENTITY((*iParam10)[0], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
		...
		case 5:
			if (PED::IS_PED_INJURED(bLocal_289))
			{
				if (!PED::IS_PED_INJURED((*iParam10)[0]) && !PED::IS_PED_INJURED((*iParam10)[1]))
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY((*iParam10)[0], PLAYER::PLAYER_PED_ID(), -1);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY((*iParam10)[1], PLAYER::PLAYER_PED_ID(), -1);
				}
			}
			else if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_289, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(bLocal_289, 242628503) != 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
				TASK::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_2_hands_up", 4f, -4f, -1, 0, 0.25f, false, false, false);
				TASK::TASK_PLAY_ANIM(0, "random@getawaydriver", "idle_a", 4f, -4f, -1, 1, 0f, false, false, false);
			...
			if (!PED::IS_PED_INJURED(iLocal_290[0]) && !PED::IS_PED_INJURED(iLocal_290[1]))
			{
					...
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
					{
						if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) < 0.1f)
						{
							if (func_128() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
								...
								if (!PED::IS_PED_INJURED(bLocal_289))
								{
									vLocal_273 = { ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) };
									vVar56 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), -1.5f, -1.5f, 0f) };
									vVar59 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1.5f, 0f, 0f) };
									TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_289, 1500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar56, bLocal_289, 3f, false, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_290[0], iLocal_309);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_289, 2500, false);
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar59, bLocal_289, 3f, false, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_290[1], iLocal_309);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), (*iParam10)[1], 10f, 10f, 10f, false, true, 0))
				{
					if (!bLocal_280)
					{
						if (!func_185())
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_COP_PED_IN_AREA_3D(vLocal_234 - Vector(40f, 40f, 40f), vLocal_234 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(vLocal_234 - Vector(40f, 40f, 40f), vLocal_234 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*iParam10)[0]) && !PED::IS_PED_INJURED((*iParam10)[1]))
				{
					TASK::TASK_SMART_FLEE_PED((*iParam10)[0], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					TASK::TASK_SMART_FLEE_PED((*iParam10)[1], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					func_169();
					SYSTEM::WAIT(0);
					func_171(&uLocal_55, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
		...
		case 7:
			*iParam11 = 0;
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				if (!func_73(iParam10, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 120f) || !bLocal_276)
				{
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				if (func_73(iParam10, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 120f) || bLocal_276)
				{
					if (!PED::IS_PED_INJURED(bLocal_289))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
						PED::SET_PED_KEEP_TASK(bLocal_289, true);
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_289);
					}
					func_72();
					...
					if (!PED::IS_PED_INJURED((*iParam10)[iVar48]))
					{
						ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY((*iParam10)[iVar48]);
					}
		...
		case 9:
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false) && !PED::IS_PED_INJURED((*iParam10)[iVar48]))
				{
					if (!PED::IS_PED_SITTING_IN_VEHICLE((*iParam10)[iVar48], PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						if (!HUD::DOES_BLIP_EXIST(uLocal_285[iVar48]))
						{
							uLocal_285[iVar48] = func_67((*iParam10)[iVar48], 0, 145);
							func_70(iLocal_53);
						}
					}
				}
				...
				if (!PED::IS_PED_INJURED(iLocal_290[0]) && !PED::IS_PED_INJURED(iLocal_290[1]))
				{
					if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar15[iLocal_223 /*3*/], Global_19, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_290[0], vVar15[iLocal_223 /*3*/], 20f, 20f, 20f, false, true, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_290[1], vVar15[iLocal_223 /*3*/], 20f, 20f, 20f, false, true, 0))
					{
						...
						while (iVar48 <= (*iParam10 - 1))
						{
							...
							{
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY((*iParam10)[iVar48]);
								PED::REMOVE_PED_FROM_GROUP((*iParam10)[iVar48]);
		...
		case 12:
			...
			if (bLocal_278)
			{
				...
				if (!PED::IS_PED_INJURED((*iParam10)[0]))
				{
					...
					TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
					TASK::TASK_PERFORM_SEQUENCE((*iParam10)[0], iLocal_309);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
					PED::SET_PED_KEEP_TASK((*iParam10)[0], true);
				}
				if (!PED::IS_PED_INJURED((*iParam10)[1]))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
					...
					TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
					TASK::TASK_PERFORM_SEQUENCE((*iParam10)[1], iLocal_309);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
					PED::SET_PED_KEEP_TASK((*iParam10)[1], true);
				}
				*iParam0 = 20;
			}
			break;
		case 13:
			if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 5f)
			{
				...
				while (iVar48 <= (*iParam10 - 1))
				{
					if (!PED::IS_PED_INJURED((*iParam10)[iVar48]))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS((*iParam10)[iVar48], 242628503) != 1 || TASK::GET_SCRIPT_TASK_STATUS((*iParam10)[iVar48], 242628503) != 0)
						{
							if (!PED::IS_PED_INJURED((*iParam10)[iVar48]))
							{
								iVar0 = 0;
		...
		case 14:
			...
			while (iVar48 < *iParam10)
			{
				if (!PED::IS_PED_INJURED((*iParam10)[0]))
				{
					TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), (*iParam10)[iVar48], 4000, 2048, 2);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 4194816);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar32[iLocal_223 /*3*/], 2f, -1, 0.25f, false, 40000f);
					TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::TASK_PERFORM_SEQUENCE((*iParam10)[0], iVar0);
					...
					if (!PED::IS_PED_INJURED((*iParam10)[1]))
					{
						...
						TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iVar0);
						TASK::TASK_PERFORM_SEQUENCE((*iParam10)[1], iVar0);
						TASK::CLEAR_SEQUENCE_TASK(&iVar0);
					}
					iVar0 = 0;
					PED::SET_PED_KEEP_TASK((*iParam10)[iVar48], true);
					TASK::TASK_LOOK_AT_ENTITY((*iParam10)[iVar48], PLAYER::PLAYER_PED_ID(), 4000, 2052, 2);
					func_169();
					SYSTEM::WAIT(0);
					if (iLocal_228 > 0)
					{
		...
		case 15:
			...
			else if (!PED::IS_PED_INJURED((*iParam10)[0]) && !PED::IS_PED_INJURED((*iParam10)[1]))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE((*iParam10)[0], false) && !PED::IS_PED_IN_ANY_VEHICLE((*iParam10)[1], false))
				{
					HUD::CLEAR_PRINTS();
		...
		case 18:
			...
			if (!bLocal_279)
			{
				if (!PED::IS_PED_INJURED(bLocal_289))
				{
					PED::SET_PED_CAN_BE_TARGETTED(bLocal_289, false);
					TASK::TASK_PLAY_ANIM(bLocal_289, "random@getawaydriver", "base", 4f, -4f, -1, 1, 0f, false, false, false);
				}
			}
			iVar65 = 0;
...
void func_22(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_24() /*10930*/].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_24() /*10930*/].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_30(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_24() /*10930*/].f_6174.f_10, iParam0);
}
...
{
	if (!PED::IS_PED_INJURED((*iParam0)[0]) && !PED::IS_PED_INJURED((*iParam0)[1]))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY((*iParam0)[0], (*iParam0)[1], 15f, 15f, 15f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY((*iParam0)[0], PLAYER::PLAYER_PED_ID(), 15f, 15f, 15f, false, true, 0))
		{
			switch (iLocal_227)
			{
				case 0:
...
int func_73(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
	...
	while (iVar0 <= (*iParam0 - 1))
	{
		...
		{
			if (!PED::IS_PED_IN_VEHICLE((*iParam0)[iVar0], iParam1, false))
			{
				if (fParam2 > 0f)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), fParam2, fParam2, fParam2, false, true, 0))
					{
						return 0;
					}
				}
	...
	while (iVar0 <= (*iParam0 - 1))
	{
		...
		else
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				{
					if (PED::IS_PED_IN_VEHICLE((*iParam0)[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
					{
						if (HUD::DOES_BLIP_EXIST(uLocal_285[iVar0]))
						{
							HUD::REMOVE_BLIP(&(uLocal_285[iVar0]));
					...
					{
						uLocal_285[iVar0] = func_67((*iParam0)[iVar0], 0, 145);
					}
				}
			}
			else if (!HUD::DOES_BLIP_EXIST(uLocal_285[iVar0]))
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), fParam1, fParam1, fParam1, false, true, 0))
			{
				if (HUD::DOES_BLIP_EXIST(uLocal_285[iVar0]))
				{
					HUD::REMOVE_BLIP(&(uLocal_285[iVar0]));
...
int func_77(int iParam0, int iParam1)
{
	...
	if (!bLocal_221)
	{
		...
		while (iVar0 <= (*iParam0 - 1))
		{
			if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 121.8366f, -1503.006f, 28.0999f, 0.1367f, -1649.705f, 48.1608f, 125.8125f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*iParam0)[iVar0])) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, false, true, 0))
				{
					if (!HUD::DOES_BLIP_EXIST(uLocal_285[iVar0]))
					{
						if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, false, true, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, false))
						{
							if (!func_185())
							{
								...
								if (!PED::IS_PED_INJURED((*iParam0)[1]) && !PED::IS_PED_INJURED(bLocal_289))
								{
									PED::SET_PED_RESET_FLAG((*iParam0)[1], 156, true);
									TASK::OPEN_SEQUENCE_TASK(&iLocal_309);
									...
									TASK::TASK_AIM_GUN_AT_ENTITY(0, bLocal_289, -1, false);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
									TASK::TASK_PERFORM_SEQUENCE((*iParam0)[1], iLocal_309);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
								}
								TASK::TASK_LOOK_AT_ENTITY((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
							}
						}
					}
				}
...
int func_104(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_126(vector3 vParam0, float fParam3, int iParam4)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_141()) || Global_110685) || Global_30770) || func_140()) || func_139(8, -1)) || func_138()) || func_137()) || func_136()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_141()) || Global_30770) || func_140()) || func_139(8, -1)) || func_136()) || func_138()) || func_137()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_141()) || Global_110685) || Global_30770) || func_140()) || func_139(8, -1)) || func_136()) || func_138()) || func_137()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5) || Global_41978 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_141()) || Global_110685) || Global_30770) || func_140()) || func_139(8, -1)) || func_138()) || func_137()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_141()) || Global_30770) || func_140()) || func_139(8, -1)) || func_137()) || func_136()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_141()) || func_137()) || Global_110685) || Global_30770) || func_140()) || Global_42596) || func_139(8, -1)) || func_136()) || func_134()) || func_135()) || Global_111638.f_7683.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_141()) || Global_110685) || Global_30770) || func_140()) || func_139(8, -1)) || func_136()) || func_134()) || func_138()) || func_137()) || func_135())
						{
							return 0;
						}
						break;
...
void func_167()
{
	if (!bLocal_278)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_186(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), MISC::GET_RANDOM_INT_IN_RANGE(5, 15), &vLocal_243, 1, 3f, 0f);
		...
		else
		{
			...
			if (bLocal_277)
			{
				...
				{
					iLocal_299[0] = PED::CREATE_PED(6, joaat("S_M_Y_COP_01"), vLocal_237 + Vector(0f, 5f, 0f), 0f, true, true);
					if (func_65())
					{
				...
				{
					iLocal_299[1] = PED::CREATE_PED(6, joaat("S_M_Y_COP_01"), vLocal_237 - Vector(0f, 5f, 0f), 0f, true, true);
					if (func_65())
					{
...
int func_168(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_246(struct<9> Param0, int iParam9, bool bParam10)
{
	...
	if (bLocal_313)
	{
		...
		func_258();
		func_105(0);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_234 - Vector(20f, 20f, 20f), vLocal_234 + Vector(20f, 20f, 20f), true, true);
		...
		if (!PED::IS_PED_INJURED(bLocal_289))
		{
			...
			TASK::CLEAR_PED_SECONDARY_TASK(bLocal_289);
			PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_289, 17, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_289, false);
		}
		if (!PED::IS_PED_INJURED((*iParam9)[0]))
		{
...
void func_252(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_230();
	func_255(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_254(iParam0, &iVar0);
	Var1 = { func_253(&iVar0) };
}
...
void func_255(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar0 = (iVar0 + iParam6);
	func_256(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_256(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
