#region Local Var
	...
	var uLocal_271 = 0;
	var uLocal_272 = 0;
	vector3 vLocal_273[4] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void func_4()
{
	...
	{
		case 0:
			if ((func_64(vVar0, vVar3) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (func_63() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (func_63() + 90f))
			{
				func_62();
		...
		case 1:
			...
			if (func_59(1, 0, 1))
			{
				if ((((func_64(vVar0, vVar3) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (func_63() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (func_63() + 90f)) && vVar6.z > 33f) && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_CONTROL_PRESSED(2, 51))
					{
						...
						MISC::CLEAR_AREA_OF_PROJECTILES(vVar0, 3f, 0);
		...
		case 4:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_302, true, false, false, true);
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_297))
			{
				...
				{
					case 0:
						vVar9.f_2 = (vVar9.z - 0.2f);
						break;
					case 1:
						vVar9.f_2 = (vVar9.z - 0.15f);
						break;
					case 2:
						vVar9.f_2 = (vVar9.z - 0.05f);
						break;
					case 3:
						vVar9.f_2 = (vVar9.z - 0.15f);
						break;
					case 4:
						...
						break;
					case 5:
						vVar9.f_2 = (vVar9.z - 0.1f);
						break;
				}
				iLocal_297 = PED::CREATE_SYNCHRONIZED_SCENE(vVar9.x, vVar9.y, vVar9.z, 0f, 0f, fLocal_305, 2);
...
void func_25()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_18(14) || Global_110809))
			{
...
void func_33(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_39(&(Global_111858.f_18099.f_175[iVar0 /*19*/].f_5)))
		{
			func_34(&(Global_111858.f_18099.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_39(&(Global_111858.f_18099.f_362[iVar1 /*3*/])))
		{
			func_34(&(Global_111858.f_18099.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
float func_37(int* iParam0)
{
	if (func_39(iParam0))
	{
		...
		{
			return (func_36(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
char* func_42()
{
	...
	fVar4 = MISC::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[0 /*3*/], true);
	fVar5 = MISC::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[1 /*3*/], true);
	if (fVar4 < fVar5)
	{
...
void func_43()
{
	vLocal_273[0 /*3*/] = { -10.1749f, 517.8317f, 175.192f };
	vLocal_273[1 /*3*/] = { -7.694f, 516.4619f, 175.2034f };
	vLocal_273[2 /*3*/] = { -8.0344f, 518.4184f, 175.1866f };
	vLocal_273[3 /*3*/] = { -9.7451f, 515.6803f, 175.1711f };
}
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95883 && Global_95884) || func_66())
					{
						return 0;
					}
					if (func_65(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_74()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_41, true) };
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_41, false) && vVar0.z > 33f)
		{
			return 1;
		}
	}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_80(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_88(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_80(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(bParam1);
		if (fVar1 != -1)
		{
			return (func_83(iParam0, func_80(iParam2)) + fVar1);
		}
	}
	return -99;
}
	...
	switch (iLocal_40)
	{
		...
		case joaat("PROP_BONG_01"):
			...
			if (func_24() == 0)
			{
				...
				if (((((Global_93961[0] == 5 || Global_93961[0] == 21) || Global_93961[0] == 20) || Global_93961[0] == 16) || Global_93961[0] == 18) || Global_93961[0] == 9)
				{
					return 0;
				}
				if (((((Global_93961[0] == 6 || Global_93961[0] == 7) || Global_93961[0] == 11) || Global_93961[0] == 17) || Global_93961[0] == 140) || Global_93961[0] == 141)
				{
					return 1;
				}
				return 1;
		...
		case joaat("P_TUMBLER_CS2_S_TREV"):
			...
			break;
		case joaat("PROP_ROLLED_SOCK_02"):
			if (func_24() == 2 || Global_76833)
			{
				return 1;
			}
			break;
		case joaat("PROP_MR_RASPBERRY_01"):
			if (Global_111858.f_7257.f_227[145] == 1)
			{
				if (func_24() == 2)
				{
					if (((((Global_93961[13] != 127 && Global_93961[13] != 135) && Global_93977 != 127) && Global_93977 != 135) && !func_93()) && !func_95())
					{
						return 1;
					}
				}
		...
		case joaat("PROP_RADIO_01"):
			bLocal_31 = true;
			if ((Global_38996[78] != 1 && Global_93961[9] != 117) && Global_93961[11] != 117)
			{
				if (func_24() == 2)
				{
					bLocal_35 = true;
		...
		case joaat("P_W_GRASS_GLS_S"):
			...
			if (func_24() == 0)
			{
				if (Global_93961[0] != 17 && Global_93961[2] != 73)
				{
					return 1;
				}
			}
...
{
	return func_100(iParam0, Global_41631);
}
...
void func_101()
{
	...
	UNK_0x1082C25039B168F8(func_75());
	if (CAM::DOES_CAM_EXIST(iLocal_296))
	{
...
void func_102()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && func_59(1, 0, 1)) && bLocal_36)
		{
			func_49(0, 1, 1, 0, 0, 0, 0);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
