...
void func_33(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_39(&(Global_111638.f_18098.f_175[iVar0 /*19*/].f_5)))
		{
			func_34(&(Global_111638.f_18098.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_39(&(Global_111638.f_18098.f_362[iVar1 /*3*/])))
		{
			func_34(&(Global_111638.f_18098.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_80(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_80(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
