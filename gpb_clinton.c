...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_25(14) || Global_110809))
			{
...
void func_106()
{
	...
	StringCopy(&cLocal_234, "PBCL", 8);
	StringCopy(&cLocal_236, "CLINTON", 16);
	StringCopy(&cLocal_202, "Special_Ped@Clinton", 64);
	...
	StringCopy(&cLocal_312, "PBCL_CONV_M1", 16);
	StringCopy(&cLocal_316, "PBCL_CONV_T1", 16);
	StringCopy(&cLocal_320, "PBCL_CONV_F1", 16);
