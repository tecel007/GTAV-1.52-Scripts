...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_350(60);
	iLocal_81 = func_350(14);
	sLocal_85 = "Marnie";
	fLocal_315 = 40f;
	fLocal_316 = 0.35f;
	fLocal_317 = 0f;
...
void func_1()
{
	switch (iLocal_84)
	{
		case 0:
			...
			break;
		case 1:
			if (func_245(1, 1093140480 /* Float: 10.5f */, 0))
			{
...
void func_7()
{
	...
	{
		func_199(13, SYSTEM::FLOOR(Global_111638.f_10189.f_3853));
	}
...
int func_200(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_51915[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_201(Global_51915[iVar0 /*203*/].f_4[iVar1], Global_51915[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_201(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_207(Global_42615[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_207(Global_42615[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_211(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
void func_217(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_223(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_229(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_232(bool bParam0)
{
	...
	func_217(1, 1, 0, 0, 0, 0);
}

void func_233(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, int iParam17, float fParam18)
{
	func_234(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, iParam17, fParam18);
}

void func_234(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_238(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_236(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_237(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_237(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_238(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_239(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_239(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_239(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_239(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_239(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_239(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_239(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_239(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_239(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_239(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_239(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_239(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_239(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_239(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_239(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_239(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_245(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_252(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
		...
		case 1:
			if (func_272(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) >= 4.5f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					...
					CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fLocal_316);
					CAM::_SET_GAMEPLAY_HINT_ANGLE(fLocal_317);
...
void func_269(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_274()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_252(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_283(Global_76877, Global_76879, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_294(0) || Global_76891) || Global_76880 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76876)
...
{
	return func_296(iParam0, Global_41431);
}
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_299(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_299(iParam0) };
...
int func_305(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_306(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_306(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_332()
{
	...
	iVar0 = func_333(&(Global_98744.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_336()
{
	...
	{
		if (func_331(&(Global_98744.f_3)) > -1)
		{
			return 1;
		}
	}
