			...
			switch (iLocal_151)
			{
				case 0:
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						iLocal_131 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_125, vLocal_128, 2);
						...
						if (!PED::IS_PED_INJURED(bLocal_62))
						{
							...
							TASK::TASK_SYNCHRONIZED_SCENE(bLocal_62, iLocal_131, cLocal_361, sLocal_363, 1000f, -8f, 0, 0, 1000f, 0);
						}
...
void func_114(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_174(bool bParam0)
{
	if (func_176())
	{
		...
		if (bParam0 && func_175(Global_111847))
		{
...
void func_215()
{
	...
	if (iLocal_90 == 3)
	{
		...
		iLocal_131 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_125, vLocal_128, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(bLocal_63, iLocal_131, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1000f, 0);
	}
	if (iLocal_90 == 4)
	{
