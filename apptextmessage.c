...
void __EntryFunction__()
{
	...
	Global_19863 = 0;
	func_45(Global_19662, "SET_DATA_SLOT_EMPTY", 6f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_43();
	func_42();
...
void func_7()
{
	...
	{
		case 6:
			func_45(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_14(Global_8156);
			if (Global_8156 == 1)
			{
				func_45(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19685), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				Global_19661 = Global_19685;
			}
			else
			{
				func_45(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19686), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		case 7:
			break;
		case 10:
			func_45(Global_19662, "DISPLAY_VIEW", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		case 9:
			...
			{
				func_11();
				func_45(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				if (Global_21018)
				{
			...
			else if (Global_21005 == 4 || Global_21005 == 3)
			{
				...
				else
				{
					...
					if (func_17(Global_6866, Global_19681) == 0)
					{
						func_45(Global_19662, "SET_DATA_SLOT_EMPTY", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	...
	if (Global_19659 == 0)
	{
		if ((func_3(2, Global_19650, 0) || Global_111858.f_14047[Global_19681 /*20*/].f_17 == 1) || Global_22065 == 1)
		{
			...
			if (Global_111858.f_14137[iLocal_58 /*104*/].f_24 != 0)
			{
				...
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				Global_22071 = 1;
				func_45(Global_19662, "DISPLAY_VIEW", 7f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_38()
{
	func_45(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_40()
{
	func_45(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19670, true);
	func_41();
}
...
void func_42()
{
	if (Global_111858.f_14047[Global_19681 /*20*/].f_17 == 0)
	{
		...
		func_45(Global_19662, "DISPLAY_VIEW", 6f, SYSTEM::TO_FLOAT(iLocal_57), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		func_34(Global_19662, "SET_HEADER", "CELL_1", 0, 0, 0, 0);
		if (Global_19669)
		{
			if (iLocal_55 > 0)
