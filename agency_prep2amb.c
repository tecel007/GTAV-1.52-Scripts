...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_105, 0) && Global_41431 == 15) && !func_208())
	{
		if (iLocal_38 == 0)
		{
...
int func_188(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam3 || MISC::IS_BIT_SET(Global_111638.f_7224.f_17[iVar0], 0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_93883[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_201()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_93782[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
void func_224()
{
	...
	if (((((((Global_41431 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_208()) && Global_76619 == -1) && !func_234()) && !func_84(9)) || func_103(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
...
int func_242()
{
	if (((((Global_41431 == 15 && !func_208()) && Global_76619 == -1) && !func_132()) && !func_206(1112014848 /* Float: 50f */)) && !Global_110693)
	{
		return 1;
	}
	return 0;
