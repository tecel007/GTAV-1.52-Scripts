...
void __EntryFunction__()
{
	...
	if (!func_279(32))
	{
		iLocal_37 = Global_111858.f_10045.f_128;
		if (iLocal_37 == 2)
		{
			MISC::SET_BIT(&iLocal_105, 10);
			vLocal_110 = { func_278(25) };
	...
	else
	{
		...
		Global_111858.f_10045.f_128 = iLocal_37;
	}
...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_110498) && !MISC::IS_BIT_SET(iLocal_105, 15))
			{
				MISC::SET_BIT(&iLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
		}
		else if ((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110498) && !MISC::IS_BIT_SET(iLocal_105, 15))
		{
			MISC::SET_BIT(&iLocal_105, 15);
			HUD::CLEAR_HELP(true);
		}
...
int func_8()
{
	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19662) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while ((!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19662) == 1)
				{
					SYSTEM::WAIT(0);
				...
				iVar2 = Global_19687[iVar1];
				iVar3 = iVar2;
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19662) == 0)
				{
					iVar3 = 145;
				}
				if (iVar6 == 1)
...
void func_16(int iParam0)
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_108(1);
				iLocal_1267 = UNK_0x5DEA4192B46CB99B("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
...
void func_17()
{
	...
	if (!MISC::IS_BIT_SET(iLocal_105, 2))
	{
		...
		{
			if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f) && !func_75())
			{
			...
			{
				if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f))
				{
				}
			}
		}
		...
		if (!func_77(0f, 0f, 0f, vLocal_110, 0))
		{
			if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f))
			{
				if (func_85(iLocal_109))
				{
					...
					{
						func_21(iLocal_109, vLocal_110, fLocal_113, 25, 1);
...
void func_18()
{
	if (MISC::IS_BIT_SET(iLocal_105, 2) && MISC::IS_BIT_SET(iLocal_105, 0))
	{
		if (func_85(iLocal_109))
		{
			...
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_109, true), vLocal_110) >= 100f)
				{
					func_68(0);
				}
			}
...
void func_21(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_56(iParam5, &Var0, vParam1, fParam4, func_61(iParam0));
...
void func_22(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_52(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_41();
			}
...
void func_23(int iParam0, int iParam1)
{
	...
	func_62(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_40(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_52(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_77(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_77(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_77(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_56(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_52(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_60(iParam0);
			func_59(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	Global_111858.f_10045.f_128 = iParam0;
	iLocal_37 = iParam0;
	if (bParam1)
	{
		return;
...
void func_83()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_71(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_55(iVar0) && (!func_84(14) || Global_110809))
			{
...
void func_92()
{
	Global_111858.f_10012.f_21++;
	if (iLocal_42 == 0)
	{
		STATS::STAT_SET_INT(joaat("FL_CO_FB4P3"), Global_111858.f_10012.f_21, true);
		if (func_101())
		{
...
void func_95()
{
	...
	{
		func_97(13, SYSTEM::FLOOR(Global_111858.f_10190.f_3853));
	}
...
bool func_98(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_131()
{
	...
	else if (func_135() == -1)
	{
		...
		{
			if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_106, 5f))
			{
				if (func_133())
				{
...
bool func_132()
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_111858.f_18099.f_395);
}
...
void func_136()
{
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 60f))
		{
			if (func_85(func_74(25)))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_74(25), true), vLocal_110) >= 100f)
				{
					func_68(0);
				}
			}
...
void func_142(int iParam0, vector3 vParam1)
{
	...
	if (HUD::DOES_BLIP_EXIST(Global_31346[iParam0 /*23*/].f_19))
	{
		HUD::SET_BLIP_COORDS(Global_31346[iParam0 /*23*/].f_19, vParam1);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		Global_31346[iParam0 /*23*/][iVar0 /*3*/] = { vParam1 };
		iVar0++;
	}
}
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_164(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_164(iParam0) };
...
void func_171()
{
	if (!MISC::IS_BIT_SET(iLocal_105, 6))
	{
		if (func_85(iLocal_109))
		{
			vLocal_110 = { ENTITY::GET_ENTITY_COORDS(iLocal_109, true) };
...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_105, 0) && Global_41631 == 15) && !func_208())
	{
		if (iLocal_38 == 0)
		{
									...
									if (!func_205() && func_185(ENTITY::GET_ENTITY_COORDS(iLocal_109, true)))
									{
										if (func_182(iLocal_109))
										{
											if (func_181(iLocal_109))
											{
												...
												vLocal_106 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
												return;
											}
										}
									}
			...
			{
				if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_106, 10f))
				{
					MISC::CLEAR_BIT(&iLocal_105, 1);
				}
...
int func_181(int iParam0)
{
	...
	if (!VEHICLE::_0x639431E895B9AA57(PLAYER::PLAYER_PED_ID(), iParam0, -1, false, false) && !VEHICLE::_0x639431E895B9AA57(PLAYER::PLAYER_PED_ID(), iParam0, false, false, false))
	{
		func_69(37);
		return 0;
	}
...
int func_182(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		if (func_85(iParam0))
		{
			MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam0), &vVar1, &vVar4);
			vVar1 = { vVar1 + Vector(-1f, -1f, -2f) };
			vVar4 = { vVar4 + Vector(1f, 1f, 2f) };
			if (!MISC::IS_AREA_OCCUPIED(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar4), false, true, false, false, false, iParam0, false))
			{
				iVar0++;
			}
			else if (func_13())
...
int func_183(vector3 vParam0)
{
	...
	if (MISC::GET_GROUND_Z_FOR_3D_COORD(vVar2, &fVar0, false, false) && MISC::GET_GROUND_Z_FOR_3D_COORD(vParam0, &fVar1, false, false))
	{
...
int func_184()
{
	...
	while (iVar6 <= 4)
	{
		...
		{
			if (SYSTEM::VDIST2(vLocal_106, ENTITY::GET_ENTITY_COORDS(uVar0[iVar6], true)) <= 16f)
			{
				return 1;
			}
		}
...
int func_187(vector3 vParam0)
{
	...
	fVar0 = SYSTEM::VDIST2(vParam0, Global_94094[func_188(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_188(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_94094[iVar0 /*9*/].f_7 != 263)
		{
			if (!bParam3 || MISC::IS_BIT_SET(Global_111858.f_7225.f_17[iVar0], 0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_94094[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_189(vector3 vParam0)
{
	...
	fVar0 = SYSTEM::VDIST2(vParam0, Global_94158[func_190(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_192(vector3 vParam0, vector3 vParam3)
{
	float fVar0;
...
int func_201()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Global_93993[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
int func_206(int iParam0)
{
	if (iLocal_42 == 1)
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[1 /*15*/], iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[0 /*15*/], iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94901[3 /*15*/], iParam0))
		{
			return 1;
		}
	}
...
void func_209()
{
	...
	if ((Global_41631 == 15 && iLocal_38 == 0) && !func_208())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 0))
		...
		if (func_85(iVar0))
		{
			...
			if ((iVar1 == joaat("CARGOBOB") || iVar1 == joaat("CARGOBOB2")) || iVar1 == joaat("CARGOBOB3"))
			{
				if (VEHICLE::DOES_CARGOBOB_HAVE_PICK_UP_ROPE(iVar0))
				{
					...
					{
						*iParam0 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iVar2);
						if (func_85(*iParam0))
						{
							return 1;
						}
...
void func_224()
{
	...
	if (((((((Global_41631 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_208()) && Global_76830 == -1) && !func_234()) && !func_84(9)) || func_103(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
	...
	else if (((((((Global_41631 != 15 || Global_41631 != 0) || Global_41631 != 2) || Global_41631 != 4) || Global_41631 != 17) || func_208()) || Global_76830 == -1) || Global_110913)
	{
		iVar1 = 0;
		if (func_132())
		{
...
int func_229(int iParam0)
{
	...
	{
		if (MISC::IS_BIT_SET(Global_111858.f_7684.f_651[iVar0 /*14*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (MISC::IS_BIT_SET(Global_111858.f_7684.f_765[iVar0 /*10*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_132()) && !Global_110498)
					{
						MISC::SET_BIT(&iLocal_105, 15);
						HUD::CLEAR_HELP(true);
					}
...
void func_237()
{
	if (iLocal_37 != 4)
	{
		if (iLocal_37 != 2)
		{
			if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110498)
			{
				MISC::SET_BIT(&iLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
...
int func_242()
{
	if (((((Global_41631 == 15 && !func_208()) && Global_76830 == -1) && !func_132()) && !func_206(1112014848 /* Float: 50f */)) && !Global_110913)
	{
		return 1;
	}
	return 0;
...
int func_247(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_248(iParam1)];
...
void func_253(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_111858.f_20406.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_111858.f_20406[iVar0 /*16*/])))
		{
			...
			func_255((Global_111858.f_20406.f_145 - 1));
...
struct<8> func_262(char* sParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	struct<8> Var0;
...
void func_266()
{
	StringCopy(&(Global_7389[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_267()
{
	StringCopy(&(Global_7389[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_268()
{
	StringCopy(&(Global_7389[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_269()
{
	StringCopy(&(Global_7389[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_270(char* sParam0)
{
	StringCopy(&(Global_7389[0 /*16*/].f_8), sParam0, 32);
}

void func_271(char* sParam0)
{
	StringCopy(&(Global_7389[2 /*16*/].f_8), sParam0, 32);
}

void func_272(char* sParam0)
{
	StringCopy(&(Global_7389[1 /*16*/].f_8), sParam0, 32);
}

void func_273(char* sParam0)
{
	StringCopy(&(Global_7389[3 /*16*/].f_8), sParam0, 32);
}
...
int func_276(var uParam0, int iParam1)
{
	...
	if (!func_52(&(Global_75654.f_555[0 /*21*/]), iParam1))
	{
		return 0;
	}
	else
	{
		func_59(&(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]), uParam0);
	}
	return 1;
}
...
float func_277(int iParam0)
{
	...
	return Global_75654.f_555[0 /*21*/].f_3;
}
...
Vector3 func_278(int iParam0)
{
	...
	return Global_75654.f_555[0 /*21*/];
}
