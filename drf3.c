	...
	while (true)
	{
		...
		switch (iLocal_48)
		{
			case 0:
				...
				{
					func_90(&uLocal_74, &uLocal_335, &uLocal_524, &iLocal_1261, &uLocal_769, &uLocal_878, &iLocal_1262, &uLocal_1043, &uLocal_1152, &iLocal_1263, &uLocal_49, iLocal_70);
					Global_95416 = 0;
					func_124(&uLocal_239, &uLocal_335, iLocal_1261);
					func_124(&uLocal_287, &uLocal_524, iLocal_1261);
			...
			case 3:
				...
				if (func_56())
				{
					if ((!bVar1 && bVar3) && ((func_133() == 2 && iVar0 >= 8) || (func_133() == 3 && iVar0 >= 10)))
					{
						iLocal_48 = 4;
					}
					else
...
void func_1(int iParam0)
{
	...
	if (Global_111858.f_9081 || func_9(0))
	{
		iVar0 = func_8();
		if (!func_2(iVar0))
		{
...
int func_2(int iParam0)
{
	...
	func_3(&(Global_111858.f_2359.f_539), iVar1);
...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_5(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_11(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_9(0) && Global_77079.f_1 == 1) && func_12(Global_77079))
		{
		}
		else
		{
...
void func_17(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_19() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_19() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_25(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_19() /*10931*/].f_6175.f_10, iParam0);
}
...
void func_51()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_54(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_52(iVar0) && (!func_44(14) || Global_110809))
			{
...
float func_67(int iParam0)
{
	if (func_70(iParam0))
	{
		...
		{
			return (func_68(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_68(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_76(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	MISC::SET_BIT(&Global_7552, 9);
	Global_21989 = iParam0;
	iVar0 = 0;
	while (iVar0 < iParam0 + 1)
	{
		StringCopy(&(Global_21264[iVar0 /*6*/]), (*uParam2)[iVar0], 24);
		StringCopy(&(Global_21626[iVar0 /*6*/]), (*uParam3)[iVar0], 24);
		iVar0++;
	}
	Global_21988 = iParam1;
	iVar1 = 0;
	while (iVar1 < iParam1 + 1)
	{
		StringCopy(&(Global_21445[iVar1 /*6*/]), (*uParam4)[iVar1], 24);
		StringCopy(&(Global_21807[iVar1 /*6*/]), (*uParam5)[iVar1], 24);
		iVar1++;
	}
	return 1;
}
...
bool func_77(int iParam0, var uParam1, int iParam2, char* sParam3, var uParam4, var uParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	func_86(iParam0);
	Global_21057 = 1;
	StringCopy(&Global_21153, sParam6, 24);
	Global_21004 = 3;
...
void func_90(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, int iParam9, var uParam10, int iParam11)
{
	int iVar0;
	struct<4> Var1;
	var uVar5;
	...
	func_104(uParam4, uParam5, uParam7, uParam8, iParam6, iParam9, iParam11);
	func_94(uParam4, uParam5, uParam7, uParam8, iParam6, iParam9, uParam10, iParam11);
	func_93(uParam4, uParam5, uParam7, uParam8, iParam6, iParam9, uParam10);
	func_91(uParam4, uParam5, uParam7, uParam8, iParam6, iParam9, iParam11);
	iVar7 = 0;
	while (iVar7 < 47)
	{
...
void func_91(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	char cVar0[16];
	int iVar4;
	int iVar5;
	...
	{
		case 2:
			StringCopy(&cVar0, "DRF_3", 16);
			iVar4 = 17;
			iVar5 = 7;
			break;
		case 3:
			StringCopy(&cVar0, "DRF_4", 16);
			iVar4 = 6;
			iVar5 = 17;
			break;
		default:
	...
	func_92(uParam0, uParam1, iParam4, &cVar0, iVar4, iVar5, 0);
	func_92(uParam2, uParam3, iParam5, &cVar0, iVar4, iVar5, 0);
}

void func_92(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
void func_93(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6)
{
	int iVar0;
	...
	func_92(uParam0, uParam1, iParam4, "PMCSUM", (iVar0 - 1), 1, 0);
	func_92(uParam2, uParam3, iParam5, "PMCSUM", (iVar0 - 1), 1, 0);
}

void func_94(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	func_92(uParam0, uParam1, iParam4, "DRF_SEX", iVar4, 1, 0);
	func_92(uParam2, uParam3, iParam5, "DRF_SEX", iVar4, 1, 0);
	Var0 = { func_95(uParam6, &iVar5, iParam7, 1) };
	func_92(uParam0, uParam1, iParam4, &Var0, 0, iVar5, 0);
	func_92(uParam2, uParam3, iParam5, &Var0, 0, iVar5, 0);
}

struct<4> func_95(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	struct<4> Var0;
	int iVar4;
	...
	if (bParam3)
	{
		func_96(&(Global_111858.f_19957), iVar4, 1);
	}
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 13) && !func_101(&(Global_111858.f_19957), iParam0))
	{
		iVar2[iParam0] = 0;
	}
	else if ((iParam1 > 0 && iParam1 < 13) && !func_101(&(Global_111858.f_19957), iParam1))
	{
		iVar2[iParam1] = 0;
	}
	else if ((iParam2 > 0 && iParam2 < 13) && !func_101(&(Global_111858.f_19957), iParam2))
	{
		iVar2[iParam2] = 0;
	}
	else if ((iParam3 > 0 && iParam3 < 13) && !func_101(&(Global_111858.f_19957), iParam3))
	{
		iVar2[iParam3] = 0;
	}
	else if ((iParam4 > 0 && iParam4 < 13) && !func_101(&(Global_111858.f_19957), iParam4))
	{
		iVar2[iParam4] = 0;
	}
...
void func_104(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	...
	func_92(uParam0, uParam1, iParam4, "DRF_ACC", iVar0, 1, 0);
	func_92(uParam2, uParam3, iParam5, "DRF_DEN", iVar1, 1, 0);
}
...
void func_105(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_92(uParam0, uParam1, iParam2, "DRF_OPW", iVar4, 1, 0);
	Var0 = { func_106(iParam3, 0, 1, &iVar5) };
	func_92(uParam0, uParam1, iParam2, &Var0, 0, iVar5, 0);
}

struct<4> func_106(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	if ((((!func_111(&(Global_111858.f_19957), 8) && bParam1) && iParam0 != 4) && func_109(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar4 = 8;
		*iParam3 = 4;
	}
	...
	{
		if (!func_111(&(Global_111858.f_19957), 1) && func_109(5) > 0)
		{
			MISC::SET_BIT(&iVar5, 1);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 2) && func_109(7) >= 2)
		{
			MISC::SET_BIT(&iVar5, 2);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 3) && ((((func_109(8) > 0 || func_109(9) > 0) && func_109(7) > 0) && bParam1) && iParam0 != 4))
		{
			MISC::SET_BIT(&iVar5, 3);
			iVar6++;
		}
		if ((!func_111(&(Global_111858.f_19957), 4) && func_109(1) > 0) && func_109(1) < 3)
		{
			MISC::SET_BIT(&iVar5, 4);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 5) && func_109(1) >= 3)
		{
			MISC::SET_BIT(&iVar5, 5);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 6) && func_109(0) > 0)
		{
			MISC::SET_BIT(&iVar5, 6);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 7))
		{
			MISC::SET_BIT(&iVar5, 7);
			iVar6++;
		}
		if (((!func_111(&(Global_111858.f_19957), 8) && bParam1) && func_109(3) > 0) && iParam0 != 4)
		{
			MISC::SET_BIT(&iVar5, 8);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 9))
		{
			MISC::SET_BIT(&iVar5, 9);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 10))
		{
			MISC::SET_BIT(&iVar5, 10);
			iVar6++;
		}
		if (!func_111(&(Global_111858.f_19957), 11))
		{
	...
	if (bParam2)
	{
		func_107(&(Global_111858.f_19957), iVar4, 1);
	}
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if ((iParam0 > 0 && iParam0 < 12) && !func_111(&(Global_111858.f_19957), iParam0))
	{
		iVar2[iParam0] = 0;
		bVar15 = true;
	}
	if ((iParam1 > 0 && iParam1 < 12) && !func_111(&(Global_111858.f_19957), iParam1))
	{
		iVar2[iParam1] = 0;
		bVar15 = true;
	}
	if ((iParam2 > 0 && iParam2 < 12) && !func_111(&(Global_111858.f_19957), iParam2))
	{
		iVar2[iParam2] = 0;
		bVar15 = true;
	}
	if ((iParam3 > 0 && iParam3 < 12) && !func_111(&(Global_111858.f_19957), iParam3))
	{
		iVar2[iParam3] = 0;
		bVar15 = true;
	}
	if ((iParam4 > 0 && iParam4 < 12) && !func_111(&(Global_111858.f_19957), iParam4))
	{
		iVar2[iParam4] = 0;
		bVar15 = true;
	}
...
int func_109(int iParam0)
{
	...
	{
		case 0:
			return func_110(&Global_95423, 1);
		case 1:
			return func_110(&Global_95425, 3);
		case 2:
			return func_110(&Global_95429, 1);
		case 3:
			return func_110(&Global_95431, 1);
		case 4:
			return func_110(&Global_95433, 1);
		case 5:
			return func_110(&Global_95435, 1);
		case 6:
			return func_110(&Global_95437, 1);
		case 7:
			return func_110(&Global_95439, 2);
		case 8:
			return func_110(&Global_95442, 1);
		case 9:
			return func_110(&Global_95444, 1);
	}
	return 0;
}
...
void func_112(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_92(uParam0, uParam1, iParam2, &Var0, iVar4, iVar5, 0);
}
...
void func_113(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_92(uParam0, uParam1, iParam2, "DRF_OVG", MISC::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_92(uParam0, uParam1, iParam2, "DRF_TMG", func_115(func_116(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_92(uParam0, uParam1, iParam2, "DRF_OVO", MISC::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_114(uParam0, uParam1, iParam2, "PDRTMO", 3);
	}
	else
	{
		func_92(uParam0, uParam1, iParam2, "DRF_OVB", 0, 1, 0);
		func_92(uParam0, uParam1, iParam2, "DRF_TMB", 2, 1, 0);
	}
}

void func_114(var uParam0, var uParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
...
struct<4> func_118(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	struct<4> Var0;
	...
	if (func_121(59) && !func_121(45))
	{
		if (iParam0 == 2)
		{
			...
			*iParam2 = 19;
			if (bParam3)
			{
				func_120(&(Global_111858.f_19957), 6);
			}
		}
	}
	else if (func_121(14) && !func_121(16))
	{
		...
		*iParam2 = 9;
		if (bParam3)
		{
			func_120(&(Global_111858.f_19957), 7);
		}
	}
	else if (func_121(16) && !func_121(39))
	{
		...
		*iParam2 = 10;
		if (bParam3)
		{
			func_120(&(Global_111858.f_19957), 8);
		}
	}
	else if ((func_121(39) && !func_121(47)) && !func_119(518202687))
	{
		...
		*iParam2 = 15;
		if (bParam3)
		{
			func_120(&(Global_111858.f_19957), 9);
		}
	}
	else if (func_121(47) && !func_121(22))
	{
		...
		*iParam2 = 13;
		if (bParam3)
		{
			func_120(&(Global_111858.f_19957), 10);
		}
	}
	return Var0;
}
...
void func_122(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_92(uParam0, uParam1, iParam2, &Var0, 0, iVar4, 0);
	switch (iParam3)
	{
		case 2:
	...
	StringCopy(uParam0[*iParam2 /*4*/], "DRF_OVR", 16);
	*(uParam1[*iParam2 /*4*/]) = { Var0 };
	*iParam2++;
}
...
void func_124(var uParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < iParam2)
	{
		(*uParam0)[iVar0] = func_125(uParam1[iVar0 /*4*/]);
		iVar0++;
	}
}
...
int func_126(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (Global_95416 != 0 && (MISC::GET_GAME_TIMER() - Global_95416) < 1800000)
	{
		return 0;
	}
	HUD::REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
	...
	if (!func_127(uParam1, uParam2, iParam3))
	{
		return 0;
	}
	func_123(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_123(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_95416 = MISC::GET_GAME_TIMER();
	return 1;
}

int func_127(var uParam0, var uParam1, int iParam2)
{
	int iVar0;

	iVar0 = func_129(&(Global_111858.f_19957));
	switch (iVar0)
	{
		case 0:
			func_92(uParam0, uParam1, iParam2, "PBTNM", 0, 11, 0);
			func_128(&(Global_111858.f_19957), 1);
			break;
		case 1:
			func_92(uParam0, uParam1, iParam2, "PBTNM2", 0, 10, 0);
			func_128(&(Global_111858.f_19957), 2);
			break;
		case 2:
			func_92(uParam0, uParam1, iParam2, "PBTNM3", 0, 12, 0);
			func_128(&(Global_111858.f_19957), 3);
			break;
		default:
			return 0;
	}
...
void func_136()
{
	...
	while (iVar1 < 10)
	{
		...
		{
			case 0:
				func_137(&Global_95423, 1);
				break;
			case 1:
				func_137(&Global_95425, 3);
				break;
			case 2:
				func_137(&Global_95429, 1);
				break;
			case 3:
				func_137(&Global_95431, 1);
				break;
			case 4:
				func_137(&Global_95433, 1);
				break;
			case 5:
				func_137(&Global_95435, 1);
				break;
			case 6:
				func_137(&Global_95437, 1);
				break;
			case 7:
				func_137(&Global_95439, 2);
				break;
			case 8:
				func_137(&Global_95442, 1);
				break;
			case 9:
				func_137(&Global_95444, 1);
				break;
		}
		iVar1++;
	}
