...
int func_56()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_69) && !PED::IS_PED_INJURED(iLocal_70))
	{
		...
		vVar0 = { vVar0 + PED::GET_PED_BONE_COORDS(iLocal_69, 31086, 0f, 0f, 0f) };
		vVar3 = { vVar3 + PED::GET_PED_BONE_COORDS(iLocal_69, 31086, 0f, 0f, 0f) };
		...
		if (PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_69, false) - vLocal_55, ENTITY::GET_ENTITY_COORDS(iLocal_69, false) + vLocal_55) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_69, false) - vLocal_55, ENTITY::GET_ENTITY_COORDS(iLocal_69, false) + vLocal_55))
		{
			return 1;
		}
	}
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_49, 15f, 15f, 15f, false, true, 0))
	{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_49, 40f, 40f, 40f, false, true, 0))
	{
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_69))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iLocal_75);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_64, PLAYER::PLAYER_PED_ID(), 2f, false, 0f, 4f, true, 512, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
void func_106()
{
	if (!func_135())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, false))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_49, 65f, 60f, 60f, false, true, 0) || Global_111853)
			{
	...
	if (!bLocal_241)
	{
		if (!PED::IS_PED_INJURED(iLocal_69))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 25f, 25f, 25f, false, true, 0) && func_135())
			{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 8f, 8f, 8f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, false))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_61, 2f, -1, 0.25f, 512, 80.1325f);
...
int func_113()
{
	switch (func_114(&Global_31027, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
		case 0:
...
void func_119()
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_49 - Vector(10f, 30f, 30f), vLocal_49 + Vector(10f, 30f, 30f), false, true, true, true);
	PED::ADD_RELATIONSHIP_GROUP("mugger", &iLocal_68);
	iLocal_69 = PED::CREATE_PED(19, joaat("A_F_M_SKIDROW_01"), vLocal_58, 79.765f, true, true);
	...
	TASK::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_75);
	TASK::CLEAR_SEQUENCE_TASK(&iLocal_75);
	iLocal_70 = PED::CREATE_PED(7, joaat("A_M_M_TRAMP_01"), vLocal_52, fLocal_67, true, true);
...
int func_139(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_175(Global_111858.f_24991.f_43[iParam3]))
		{
			return 0;
		}
...
void func_144(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_145(func_156(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_145(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_173()) || Global_110905) || Global_30970) || func_172()) || func_51(8, -1)) || func_171()) || func_170()) || func_169()) || func_168()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_173()) || Global_30970) || func_172()) || func_51(8, -1)) || func_169()) || func_171()) || func_170()) || func_168()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						...
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_173()) || Global_110905) || Global_30970) || func_172()) || func_51(8, -1)) || func_171()) || func_170()) || func_168()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_173() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_51(8, -1)) || func_168()) || func_167()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						...
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_173()) || func_170()) || Global_110905) || Global_30970) || func_172()) || Global_42801) || func_51(8, -1)) || func_169()) || func_167()) || func_168()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_173()) || Global_110905) || Global_30970) || func_172()) || func_51(8, -1)) || func_169()) || func_167()) || func_171()) || func_170()) || func_168())
						{
							return 0;
						}
						break;
...
void func_187(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_156();
	func_190(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
...
struct<16> func_188(int iParam0)
{
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_152(*iParam0), 64);
	return Var0;
}
...
void func_190(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar0 = (iVar0 + iParam6);
	func_191(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_191(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_162(iParam0, iParam1);
	func_161(iParam0, iParam2);
	func_160(iParam0, iParam3);
	func_158(iParam0, iParam5);
	func_159(iParam0, iParam4);
	func_157(iParam0, iParam6);
}
