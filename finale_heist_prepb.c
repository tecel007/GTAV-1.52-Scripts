...
void func_8(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_10(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
{
	return func_39(&(Global_102423.f_2890), vParam0, fParam3, 0);
}
...
{
	return func_105(Global_102423.f_2890.f_12.f_66, vParam0, iParam3);
}
...
void func_108()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[6]))
		{
			...
			iLocal_43[0] = Global_95452.f_9[6];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_43[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[7]))
		{
			...
			iLocal_43[1] = Global_95452.f_9[7];
...
void func_147()
{
	if (iLocal_62 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452[3]))
		{
			...
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_95452[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[3], true, true);
					func_149(1.0095f, -631.9655f, 34.7259f, 349.0681f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_95452[3])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_95452[3]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_95452[3]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_95452[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[3], true, true);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102423.f_4, false))
		{
			if (func_169(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_166(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_150(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (PED::IS_PED_IN_VEHICLE(iParam0, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), -1, false) == iParam0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_33, false))
					{
						if ((PED::IS_PED_IN_VEHICLE(iParam0, iLocal_33, false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_33, -1, false) == iParam0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_33, vLocal_116, 3f, 3f, 3f, false, true, 0))
						{
