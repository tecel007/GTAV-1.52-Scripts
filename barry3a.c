#region Local Var
	...
	vector3 vLocal_167[6] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	vLocal_156 = { 0f, -1f, 0.64f };
	iLocal_159 = joaat("PROP_WEED_TUB_01B");
	vLocal_161 = { -1138.977f, -1252.549f, 6.05f };
	...
	if (func_450())
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				break;
			case 1:
				func_448(vLocal_161, 298.7f, 1, 0);
				func_445(1);
				break;
			case 2:
		...
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					bLocal_437 = true;
					bLocal_438 = false;
					iLocal_144 = func_213(vLocal_161, 5, 1);
				}
				else
				{
					bLocal_437 = true;
			...
			break;
		case 1:
			if (!func_207(Local_145.f_4, vLocal_161, 125f))
			{
			...
			else if (!bLocal_437)
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
				{
					...
					{
						bLocal_438 = false;
						if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
						{
							func_214(&iLocal_144);
							iLocal_143 = 0;
							iLocal_142 = 6;
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
			{
				func_214(&iLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
...
{
	if (vLocal_167[iParam0 /*3*/].f_1 < vLocal_167[iParam0 /*3*/] || vLocal_167[iParam0 /*3*/] == -1)
	{
		return 1;
	}
	return 0;
...
void func_210(int iParam0)
{
	if (func_209(iParam0))
	{
		func_211(vLocal_167[iParam0 /*3*/].f_2, 7500, 1);
		vLocal_167[iParam0 /*3*/].f_1++;
	}
}
...
int func_213(vector3 vParam0, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_215()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				func_214(&iLocal_144);
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				...
				else
				{
					...
					else if ((bLocal_433 && func_209(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
int func_235()
{
	...
	while (iLocal_250 <= 5)
	{
		if (func_236(vLocal_167[iLocal_250 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_250++;
...
void func_237()
{
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_240(Local_145.f_4, 1093140480 /* Float: 10.5f */, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				func_239(0, -1);
				bLocal_442 = false;
				iLocal_439 = 0;
...
void func_242()
{
	switch (iLocal_143)
	{
		case 0:
			...
			break;
		case 1:
			func_248(&uLocal_450, &uLocal_251, "BAR3AAU", &uLocal_451, &cLocal_457);
			if (!bLocal_248 && MISC::GET_GAME_TIMER() > iLocal_249)
			{
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				...
				else
				{
					...
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_328(&(Global_98744.f_3));
				if (iVar10 > -1)
				{
...
void func_259(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	func_260(&Global_105187, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, sParam1, iParam3, iParam2);
}

void func_260(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*iParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
				{
					if (iParam2 == 0 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*iParam1, true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 100f)
					{
						...
						if (func_276(*iParam1, func_230(), 1))
						{
...
int func_277(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0x310836EE7129BA33(iVar9, &Var11) && !func_286(Var11.f_1)) && iVar72 < 51)
			{
...
int func_292(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
bool func_294(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_295(int iParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_316())
		{
			*iParam0 = func_300(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
			if (func_299(*iParam0) && !func_296(*iParam0))
			{
				return 1;
			}
		}
...
int func_300(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_301(iVar0, 0), true);
...
Vector3 func_301(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 44:
			...
			break;
		case 45:
			return func_311(Global_100839);
		case 46:
			if (Global_1590374 != func_224())
			{
				if (func_310(Global_1590374))
				{
					return func_303(2, 2);
				}
				else if (func_302(Global_1590374))
				{
...
Vector3 func_303(int iParam0, int iParam1)
{
	...
	if (Global_1590374 != func_224())
	{
		if (iParam1 == 3)
		{
			if (func_304(iParam0, 1, &vVar0, 0, 0))
			{
				vVar6 = { vVar0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_304(iParam0, 2, &vVar0, 0, 0))
				{
					vVar6 = { vVar0 };
				}
			}
...
int func_304(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_305(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_305(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_305(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_329(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_330(Global_111638.f_9080.f_99.f_205[10]);
		case 74:
		case 75:
			return func_330(Global_111638.f_9080.f_99.f_205[8]);
		case 84:
		case 85:
			return func_330(Global_111638.f_9080.f_99.f_205[11]);
		case 90:
			return func_330(Global_111638.f_9080.f_99.f_205[7]);
		case 93:
			return func_330(Global_111638.f_9080.f_99.f_205[9]);
	}
	return 0;
}
...
void func_335(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	float fVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		...
		{
			if (func_362(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_336(Global_102203.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_336(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (func_294(vParam1, 0f, 0f, 0f, 0))
		{
		...
		func_355(iParam5, &Var0, vParam1, fParam4, func_267(iParam0));
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111638.f_32744.f_4801 = func_317();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_271(iParam0, &(Global_111638.f_32744.f_5510));
}
	...
	switch (iParam1)
	{
		...
		case 44:
			*uParam0 = { -73.6963f, 495.124f, 143.5226f };
			...
			iVar0 = 1;
			Jump @5414; //curOff = 3986
			*uParam0 = { -67.6314f, 891.8266f, 234.5348f };
			uParam0->f_3 = 294.993f;
			uParam0->f_4 = joaat("SURANO");
			iVar0 = 1;
			Jump @5414; //curOff = 4029
			*uParam0 = { 533.9048f, -169.2469f, 53.7005f };
			uParam0->f_3 = 1.2998f;
			uParam0->f_4 = joaat("TORNADO2");
			iVar0 = 1;
			Jump @5414; //curOff = 4072
			*uParam0 = { -726.8914f, -408.6952f, 34.0416f };
			uParam0->f_3 = 267.7392f;
			uParam0->f_4 = joaat("SUPERD");
			iVar0 = 1;
			Jump @5414; //curOff = 4115
			*uParam0 = { -1321.519f, 261.3993f, 61.5709f };
			uParam0->f_3 = 350.7697f;
			uParam0->f_4 = joaat("DOUBLE");
			iVar0 = 1;
			Jump @5414; //curOff = 4158
			*uParam0 = { -1267.999f, 451.6463f, 93.7071f };
			uParam0->f_3 = 48.9311f;
			uParam0->f_4 = joaat("DOUBLE");
			iVar0 = 1;
			Jump @5414; //curOff = 4201
			*uParam0 = { -1062.076f, -226.7637f, 37.157f };
			uParam0->f_3 = 234.2767f;
			uParam0->f_4 = joaat("DOUBLE");
			iVar0 = 1;
			Jump @5414; //curOff = 4244
			...
			*uParam0 = { -1602.62f, 5260.37f, 0.86f };
			...
			MISC::SET_BIT(&(uParam0->f_9), 6);
			iVar0 = 1;
			Jump @5414; //curOff = 4744
			*uParam0 = { 2116.571f, 4763.279f, 40.1596f };
			uParam0->f_3 = 198.723f;
			uParam0->f_4 = joaat("BFINJECTION");
			iVar0 = 1;
			Jump @5414; //curOff = 4787
			...
			*uParam0 = { -806.31f, -2679.65f, 13.9f };
			...
			MISC::SET_BIT(&(uParam0->f_9), 21);
			iVar0 = 1;
			Jump @5414; //curOff = 5021
			*uParam0 = { 1985.85f, 3828.96f, 31.98f };
			uParam0->f_3 = -16.58f;
			uParam0->f_4 = joaat("BLAZER3");
			MISC::SET_BIT(&(uParam0->f_9), 6);
			iVar0 = 1;
			Jump @5414; //curOff = 5073
			*uParam0 = { 3870.75f, 4464.67f, 0f };
			...
			MISC::SET_BIT(&(uParam0->f_9), 30);
			iVar0 = 1;
			Jump @5414; //curOff = 5163
			*uParam0 = { 1257.729f, -2564.474f, 41.717f };
			uParam0->f_3 = 284.5561f;
			uParam0->f_4 = joaat("DUKES2");
			MISC::SET_BIT(&(uParam0->f_9), 6);
			iVar0 = 1;
			Jump @5414; //curOff = 5215
			*uParam0 = { 643.2823f, 3014.152f, 42.2733f };
			uParam0->f_3 = 128.0554f;
			uParam0->f_4 = joaat("DUKES2");
			MISC::SET_BIT(&(uParam0->f_9), 6);
			iVar0 = 1;
			Jump @5414; //curOff = 5267
			...
			*uParam0 = { 1333.875f, 4262.226f, 30.78f };
			...
			if (MISC::IS_BIT_SET(uParam0->f_9, 10))
			{
				...
				if (!func_294(Global_111638.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
				{
			...
			{
				if (!func_294(Global_111638.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
				{
			...
			{
				if (!func_294(Global_111638.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
				{
...
void func_355(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_354(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_359(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_360(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_360(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_366()
{
	...
	if ((bLocal_245 && Local_186[0 /*29*/].f_24 == 1) && Local_186[1 /*29*/].f_24 == 1)
	{
...
void func_370(int iParam0, bool bParam1)
{
	...
	if (bParam1 && func_204(Local_186[iParam0 /*29*/]))
	{
...
int func_372(int iParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		else if (MISC::IS_PROJECTILE_IN_AREA(vVar0 - Vector(3f, 3f, 3f), vVar0 + Vector(3f, 3f, 3f), true))
		{
			return 1;
		}
		else if (func_373(iParam0, 1126825984 /* Float: 170f */))
		{
			return 1;
		}
	}
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_376(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_381(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_381(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_385(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		else if (MISC::IS_PROJECTILE_IN_AREA(vVar0 - Vector(5f, 5f, 5f), vVar0 + Vector(5f, 5f, 5f), true))
		{
			return 1;
		}
	}
...
int func_390()
{
	switch (iLocal_439)
	{
		...
		case 2:
			...
			{
				if ((!bLocal_443 && MISC::GET_GAME_TIMER() >= iLocal_441) && !func_212())
				{
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_76877, Global_76879, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_417(0) || Global_76891) || Global_76880 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76876)
...
{
	return func_419(iParam0, Global_41431);
}
...
void func_429(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_435(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
{
	if (vLocal_167[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		vLocal_167[iParam0 /*3*/].f_1 = vLocal_167[iParam0 /*3*/];
	}
}
...
void func_442(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	func_206(&iLocal_155);
	func_203(&(Local_145.f_4));
	Local_145.f_4 = VEHICLE::CREATE_VEHICLE(Local_145.f_5, vParam0, fParam3, true, true, false);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_145.f_4, 1);
	if (bParam4)
	{
		func_443(PLAYER::PLAYER_PED_ID(), Local_145.f_4, -1);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_145.f_4, true);
	...
	iLocal_155 = OBJECT::CREATE_OBJECT(iLocal_159, vParam0, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_155, Local_145.f_4, 0, vLocal_156, 0f, 0f, 0f, false, false, true, false, 2, true);
...
{
	vLocal_167[iParam0 /*3*/].f_1 = iParam1;
}

void func_448(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_450())
	{
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_454(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_454(iParam0) };
...
void func_460()
{
	vLocal_167[0 /*3*/] = { func_461("B3ADELV", 1) };
	vLocal_167[1 /*3*/] = { func_461("B3AGETIN", 1) };
	vLocal_167[2 /*3*/] = { func_461("B3AWAN1", -1) };
	vLocal_167[3 /*3*/] = { func_461("B3ARTV", 1) };
	vLocal_167[4 /*3*/] = { func_461("B3AEXIT", 1) };
	vLocal_167[5 /*3*/] = { func_461("B3ALEAVE", 1) };
}
...
int func_475()
{
	...
	iVar0 = func_331(&(Global_98744.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_477()
{
	...
	{
		if (func_328(&(Global_98744.f_3)) > -1)
		{
			return 1;
		}
	}
