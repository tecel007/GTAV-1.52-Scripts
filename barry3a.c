...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_328(&(Global_98955.f_3));
				if (iVar10 > -1)
				{
...
{
	func_260(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, sParam1, iParam3, iParam2);
}
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_286(Var11.f_1)) && iVar72 < 51)
			{
...
Vector3 func_301(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 44:
			...
			break;
		case 45:
			return func_311(Global_101058);
		case 46:
			if (Global_1590519 != func_224())
			{
				if (func_310(Global_1590519))
				{
					return func_303(2, 2);
				}
				else if (func_302(Global_1590519))
				{
...
int func_329(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_330(Global_111858.f_9081.f_99.f_205[10]);
		case 74:
		case 75:
			return func_330(Global_111858.f_9081.f_99.f_205[8]);
		case 84:
		case 85:
			return func_330(Global_111858.f_9081.f_99.f_205[11]);
		case 90:
			return func_330(Global_111858.f_9081.f_99.f_205[7]);
		case 93:
			return func_330(Global_111858.f_9081.f_99.f_205[9]);
	}
	return 0;
}
...
void func_335(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_362(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_336(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_317();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_271(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_354(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_294(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_355(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_354(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_417(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_419(iParam0, Global_41631);
}
...
void func_429(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_454(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_454(iParam0) };
...
int func_475()
{
	...
	iVar0 = func_331(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_477()
{
	...
	{
		if (func_328(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
