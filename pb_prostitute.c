...
int func_93(int iParam0)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if ((VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0) == joaat("LAYOUT_STD_ISSI3") && ENTITY::GET_ENTITY_MODEL(iParam0) == 1644055914) || ENTITY::GET_ENTITY_MODEL(iParam0) == 1429622905)
		{
			return 1;
		}
	}
...
void func_107(bool bParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_INJURED(bParam0))
	{
		...
		if (func_548())
		{
			...
			{
				if (NETWORK::IS_NETWORK_ID_OWNED_BY_PARTICIPANT(NETWORK::NETWORK_GET_NETWORK_ID_FROM_ENTITY(bLocal_96)))
				{
...
void func_142(bool bParam0)
{
	...
	Global_111858.f_10045.f_1[iVar0 /*11*/].f_10 = ENTITY::GET_ENTITY_MODEL(bParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
void func_157(bool bParam0, bool bParam1)
{
	...
	func_158(bLocal_96, iLocal_81, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_160(bLocal_96, iLocal_81, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
void func_160(bool bParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8)
{
	if (func_548())
	{
		NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(bParam0, iParam1, sParam2, sParam3, fParam4, fParam5, iParam6, iParam7, fParam8, 0);
	}
}

void func_161(int iParam0, int iParam1, float fParam2, float fParam3)
{
	vector3 vVar0;

	vVar0 = { 0f, 0f, 0f };
	*iParam0 = func_164(vVar0, 0f, 0f, 0f, fParam3, fParam2, 2);
	if (iParam1 == 0)
	{
...
int func_164(vector3 vParam0, vector3 vParam3, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (func_548())
	{
		...
		iVar0 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vParam0, vParam3, iParam8, bParam6, bParam7, 1f, 0f, 1f);
	}
	else
	{
...
void func_165(bool bParam0, bool bParam1)
{
	...
	func_158(bLocal_96, iLocal_80, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_166(bool bParam0, bool bParam1)
{
	...
	func_160(bLocal_96, iLocal_80, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_158(bLocal_96, iLocal_79, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_175(bool bParam0, bool bParam1)
{
	...
	func_160(bLocal_96, iLocal_79, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080 /* Float: 1000f */);
	func_160(PLAYER::PLAYER_PED_ID(), iLocal_79, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080 /* Float: 1000f */);
}
...
void func_176(bool bParam0, bool bParam1)
{
	...
	func_158(bLocal_96, iLocal_78, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
...
void func_177(bool bParam0, bool bParam1)
{
	...
	func_160(bLocal_96, iLocal_78, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
...
void func_180(bool bParam0, bool bParam1)
{
	...
	func_158(bLocal_96, iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
...
void func_181(bool bParam0, bool bParam1)
{
	...
	func_160(bLocal_96, iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080 /* Float: 1000f */);
	func_161(&iLocal_77, 0, 0, 1);
	func_160(PLAYER::PLAYER_PED_ID(), iLocal_77, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080 /* Float: 1000f */);
}
		...
		if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_99) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iLocal_99))
		{
			if ((func_397() && !func_387()) && !func_396())
			{
				...
				if (func_7(&iLocal_116) > 2.5f)
				{
					...
					UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), false, 896);
					func_480(&iLocal_49, 2048);
					iLocal_100 = 0;
...
int func_402(int iParam0, Vector3* vParam1)
{
	vector3 vVar0[4];
...
int func_436(bool bParam0)
{
	...
	if (!func_378())
	{
		if (!func_548())
		{
			if ((!bLocal_88 && !Global_110905) && func_438(PLAYER::PLAYER_PED_ID(), 0) == -1)
			{
				func_351("PROS_CAR", -1);
				bLocal_88 = true;
			}
...
void func_501()
{
	...
	if ((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(bLocal_96, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < Global_31121 || Global_31121 == 0f) && iLocal_296 != 4)
	{
		Global_31121 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(bLocal_96, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
