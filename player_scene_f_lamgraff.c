...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(Global_98676))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98676, &uLocal_245, &cLocal_277, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98676))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98676, 0, false);
					TASK::CLEAR_PED_TASKS(Global_98676);
					return 0;
				}
...
int func_26()
{
	...
	if (!PED::IS_PED_INJURED(Global_98676))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_239))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98676, &uLocal_245, &cLocal_261, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98676))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98676, 0, false);
				...
				else
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Global_98676, iLocal_293, &uLocal_245, &cLocal_277, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Global_98676);
					PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(Global_98676, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
					{
						iLocal_293 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_241, 0f, 0f, fLocal_244, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_293, true);
...
int func_29(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_30(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
...
void func_37()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_98676) || !STREAMING::HAS_MODEL_LOADED(iLocal_240))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_98676))
	{
		if (!PED::IS_PED_INJURED(Global_98676))
		{
			TASK::TASK_STAND_STILL(Global_98676, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_98676, joaat("PLAYER"));
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98676, true, true);
	PED::SET_PED_CONFIG_FLAG(Global_98676, 132, true);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(Global_98676, 16);
	func_39(&Global_98676, Global_93959);
	func_38(&uLocal_72, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_239 = OBJECT::CREATE_OBJECT(iLocal_240, ENTITY::GET_ENTITY_COORDS(Global_98676, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_239, Global_98676, PED::GET_PED_BONE_INDEX(Global_98676, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true);
}
...
int func_49(int iParam0, float fParam1, char* sParam2)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_53(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_53(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_53(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
...
int func_50(int iParam0, int iParam1, var uParam2, float fParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_52(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
