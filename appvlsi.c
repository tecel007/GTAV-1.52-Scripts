...
void func_10()
{
	if (iLocal_21 == 0)
	{
		...
		func_11(Global_19662, "SET_DATA_SLOT_EMPTY", 23f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_11(Global_19662, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		iLocal_21 = 1;
	}
	else if (iLocal_21 == 1)
	{
