...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_272(&Var0, 1);
	}
	if (!func_269(&iVar64, &Var0, vVar61, 1f))
	{
		func_268();
	...
	if (Var0 == 17)
	{
		iLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), false, true, true, true);
	...
	while (true)
	{
		...
		func_204(Var0);
		func_197(&iLocal_94, &(Var0.f_9), vVar61);
		if (Var0 == 18)
		{
			func_196(&Var0);
			func_191(&Var0, vVar61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800 /* Float: 20f */);
		}
		else if (Var0 == 19)
		{
			func_196(&Var0);
			...
			{
				func_191(&Var0, vVar61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800 /* Float: 20f */);
			}
			...
			if ((iLocal_95 == 0 && func_189(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				vVar69 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				if (vVar69.z < 100f)
				{
					iLocal_95 = 1;
...
void func_146()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_147(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
int func_157(int iParam0)
{
	...
	iVar0 = func_159(&(Global_110945[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_162(iParam0, Global_41631);
}
...
int func_168(vector3 vParam0, bool bParam3)
{
	int iVar0;
...
int func_171(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, false, true, 0))
		{
			...
			else if ((!func_172(PLAYER::PLAYER_PED_ID(), -828834893) && func_189(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_147(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_191(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_189(PLAYER::PLAYER_PED_ID()) && func_189(iParam0->f_28[0])) && !func_190()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_195(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_200(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_195(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_202(iParam0);
				}
			}
...
int func_205(var uParam0, bool bParam1)
{
	...
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_234(*uParam0))
					{
						...
						if (func_217(uParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_210(uParam0);
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_220(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_221(iParam4, iParam7) };
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_225(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_224(vVar3, vVar0);
...
Vector3 func_225(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_225(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_241() && Global_98955.f_11 == 6) && iParam0 == func_165(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_244(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 0;
			iParam0->f_15 = 12f;
			StringCopy(&(iParam0->f_9), "ES_4_RCM_P1", 24);
			iParam0->f_27 = 0;
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
			...
			func_250(&(iParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_249(&iVar0) || !func_248(&(iParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
			break;
		case 2:
			func_245(&(iParam0->f_28[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
			PED::SET_PED_CAN_LEG_IK(iParam0->f_28[0], true);
...
void func_245(int* iParam0, vector3 vParam1, float fParam4)
{
	func_246(iParam0, iLocal_93, vParam1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_246(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_247(iParam0);
...
int func_251(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -63.19179f, -808.9167f, 320.2477f };
			iParam0->f_17[1 /*3*/] = { -68.8908f, -813.6761f, 324.29f };
			iParam0->f_24 = 10f;
			iParam0->f_27 = 0;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "ES_3_RCM", 24);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				STREAMING::REQUEST_MODEL(iVar0[iVar2]);
			...
			func_250(&(iParam0->f_48), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_249(&iVar0) || !func_248(&(iParam0->f_48)))
		...
		case 2:
			...
			{
				if (func_252(&(iParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 118, false);
					PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 208, true);
					WEAPON::GIVE_WEAPON_TO_PED(iParam0->f_28[0], joaat("GADGET_PARACHUTE"), 1, false, false);
...
int func_252(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_253(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_253(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_255(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_25 = 1;
			iParam0->f_26 = 1;
			StringCopy(&(iParam0->f_9), "es_2_rcm_concat", 24);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
			...
			func_250(&(iParam0->f_48), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_249(&iVar0) || !func_248(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_252(&(iParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0->f_28[0], -954.2f, -2760.05f, 14.04f, true, false, true);
					PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 118, false);
					PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 208, true);
					ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_28[0], true);
					ENTITY::SET_ENTITY_COLLISION(iParam0->f_28[0], false, false);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[0], 8, 1, 0, 0);
					TASK::TASK_PLAY_ANIM(iParam0->f_28[0], iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 33281, 0f, false, false, false);
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_LOOK_AT_ENTITY(iParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					}
				}
				else
				{
			...
			{
				func_256(&(iParam0->f_35[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[0], 0);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(iParam0->f_35[0], 0f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[1]))
			{
				func_256(&(iParam0->f_35[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[1], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[1], 1);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(iParam0->f_35[1], 0f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[2]))
			{
				func_256(&(iParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[2], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[2], 2);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(iParam0->f_35[2], 0f);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iParam0->f_35[2], false);
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iParam0->f_35[2], false, 0);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
...
int func_258(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 0;
			StringCopy(&(iParam0->f_9), "ES_1_RCM_P1", 24);
			iParam0->f_15 = 15f;
			iParam0->f_27 = 0;
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			...
			func_250(&(iParam0->f_48), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_249(&iVar0) || !func_248(&(iParam0->f_48)))
			...
			break;
		case 2:
			func_245(&(iParam0->f_28[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar2]);
...
int func_269(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_270((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_270((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_270(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	if (func_271(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_271(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_272(int iParam0, bool bParam1)
{
	...
	{
		AUDIO::STOP_SOUND(iLocal_96);
		UNK_0x1082C25039B168F8("rcmextreme3");
...
void func_274(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_281(iParam0, iParam1);
	func_278(iParam0, bParam2);
	func_275(iParam0, bParam3);
}

void func_275(int iParam0, bool bParam1)
{
	func_276(&(iParam0->f_41), bParam1);
}
