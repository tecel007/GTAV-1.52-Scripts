...
void __EntryFunction__()
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_111858.f_18570[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
void func_19(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_111858.f_2348[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_29 + iVar0), 0)) || MISC::IS_BIT_SET(Global_111858.f_18570[(iLocal_30 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
...
void func_28()
{
	...
	{
		func_32(13, SYSTEM::FLOOR(Global_111858.f_10190.f_3853));
	}
