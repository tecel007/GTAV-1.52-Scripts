	...
	while (!MISC::IS_BIT_SET(iLocal_216, 1))
	{
		if (!MISC::IS_BIT_SET(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar3, 8f, -8f, -1, 262152, 0f, 2, 0);
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar3, 8f, -8f, -1, 262153, 0f, 2, 0);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
			{
				...
				if (Global_77097 == 86)
				{
					if (!Global_111853 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, false, true, 0))
					{
						func_3(7, 1);
						Global_111849 = 0;
						Global_111853 = 1;
...
int func_2()
{
	iLocal_219 = UNK_0x5DEA4192B46CB99B("JHPB_02_Laptop");
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_26(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_24(iVar0) && (!func_16(14) || Global_110809))
			{
...
void func_30()
{
	...
	UNK_0x1082C25039B168F8("MISSHEIST_JEWEL@HACKING");
