...
void func_20(int iParam0)
{
	...
	Global_2549971[iParam0] = 0;
	Global_2549982[iParam0] = 0;
	Global_2549993[iParam0] = 0;
	Global_2550004[iParam0] = 0;
	Global_2550015[iParam0] = 0;
	Global_2550026[iParam0] = 0;
	Global_2550037[iParam0] = 0;
	Global_2550048[iParam0] = 0;
	Global_2550059[iParam0] = 0;
	Global_2550070[iParam0] = 0;
	Global_2550081[iParam0] = 0;
	Global_2550092[iParam0] = 0;
	Global_2550103[iParam0] = 0;
	Global_2550114[iParam0] = 0;
	Global_2550125[iParam0] = 0;
	Global_2550136[iParam0] = 0;
		...
		if (func_78(&cVar149, &cVar155, &cVar167, &cVar173, &cVar185, &cVar191, &cVar203, &cVar209, &cVar221, &cVar227) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			else if (func_57(sParam7))
			{
				if (iParam9 == 0)
				{
					...
					{
						func_53(uParam4, uParam2, "NUMBER", fParam6, Global_2463768, 2);
					}
				}
				else
				{
			...
			{
				func_53(uParam4, uParam2, sParam7, fParam6, Global_2463768, 2);
			}
			func_45();
		}
	}
...
void func_165(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, bool bParam11, char* sParam12, int iParam13, float fParam14, int iParam15, int iParam16, int iParam17, bool bParam18, int iParam19, bool bParam20, int iParam21, int iParam22, bool bParam23, int iParam24, int iParam25, bool bParam26, int iParam27, bool bParam28, bool bParam29, int iParam30, bool bParam31, int iParam32, int iParam33)
{
	...
	if (func_107())
	{
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			else if (bParam11 && Global_2462264 == 0)
			{
			...
			if (bVar36)
			{
				...
				if ((iParam21 == 0 || iParam21 == 5) || iParam21 == 9)
				{
					...
					else if (iParam21 == 5)
					{
						...
						{
							func_53(uParam4, uParam2, "HUD_KSMULTI", fParam14, Global_2463768, 2);
						}
					}
					else if (func_57(sParam12))
					{
						if (iParam19 == 0)
						{
							...
							{
								func_53(uParam4, uParam2, "NUMBER", fParam14, Global_2463768, 2);
							}
						}
						else
						{
					...
					{
						func_53(uParam4, uParam2, sParam12, fParam14, Global_2463768, 2);
					}
				}
			}
			func_45();
	...
	if (func_107())
	{
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			if (bVar9)
			{
				...
				{
					func_176(iParam4, iParam5, uParam3, iParam8, uParam14, iVar10, &(Global_1378744.f_800[iParam0 /*2*/]), &(Global_1378744.f_821[iParam0 /*2*/]), iParam18, iParam20, bParam25, iParam26, fParam30, fParam31, iParam27, iParam28, bParam32, iParam33, fParam34, bParam35, iParam36, iParam37, iParam38);
				}
			}
			func_45();
		}
...
void func_176(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, int iParam5, var uParam6, var uParam7, int iParam8, int iParam9, bool bParam10, int iParam11, float fParam12, float fParam13, int iParam14, int iParam15, bool bParam16, int iParam17, float fParam18, bool bParam19, int iParam20, int iParam21, int iParam22)
{
	struct<9> Var0[2];
	float fVar19;
	struct<9> Var20;
	...
	if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
	{
		...
		*(uParam2[3 /*9*/]) = { *(uParam2[0 /*9*/]) };
		...
		{
			Var20 = { *(uParam2[1 /*9*/]) };
			func_117(*(uParam2[0 /*9*/]), fParam18, &Var20, 1, 1, uParam4, iParam22);
...
int func_234()
{
	...
	if (func_221() == 0)
	{
		...
		{
			if (((NETWORK::NETWORK_IS_IN_SPECTATOR_MODE() == 0 && Global_1574407 == 0) && !MISC::IS_BIT_SET(Global_2440049.f_2005.f_756, 11)) && Global_1590682[PLAYER::PLAYER_ID() /*883*/] != 0)
			{
				return 0;
			}
		}
