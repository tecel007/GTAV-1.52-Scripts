		...
		switch (iLocal_250)
		{
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_507)
					{
						Global_111803[iLocal_251] = uLocal_506;
					}
					else
					{
...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBPD", 8);
	StringCopy(&cLocal_236, "PAMELADRAKE", 16);
	StringCopy(&cLocal_202, "Special_Ped@pamela", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = true;
	iLocal_252 = 14;
	sLocal_303 = "PBPD_INTERACT";
	StringCopy(&cLocal_312, "PBPD_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBPD_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBPD_CONV_GF", 16);
