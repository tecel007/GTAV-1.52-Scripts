...
void __EntryFunction__()
{
	...
	sLocal_188 = "FBIPRD";
	vLocal_194 = { 0f, 0f, 0f };
	vLocal_197 = { -1335.314f, -1277.943f, 3.8649f };
	vLocal_200 = { -1336.378f, -1279.056f, 3.855f };
	iLocal_205 = -1;
	sLocal_212 = "FBIPRAU";
	...
	if (func_271())
	{
		func_270(-1339.786f, -1277.51f, 3.8874f, 261.2839f, 1, 0);
	}
	if (func_269(0))
	{
		Global_111638.f_2358.f_539.f_2395[0] = -99;
		Global_111638.f_2358.f_539.f_2395[1] = -99;
		Global_111638.f_2358.f_539.f_2395[2] = -99;
		func_235();
	}
	while (true)
	{
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			HUD::CLEAR_HELP(true);
			func_21();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(iLocal_187))
			{
				if (MISC::ARE_STRINGS_EQUAL(iLocal_187, "PRE_FKICKOFF"))
				{
...
void func_4(int iParam0)
{
	...
	if (Global_111638.f_9080 || func_269(0))
	{
		iVar0 = func_18();
		if (!func_5(iVar0))
		{
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_8(Global_111638.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_23()
{
	switch (iLocal_81)
	{
		case 0:
			...
			break;
		case 1:
			if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_200, 2f) && func_87(21))
			{
			...
			else
			{
				...
				else if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_197, 75f))
				{
					if (!bLocal_207)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, vLocal_200, 1, 1, "PRD_SHOP");
				}
				else if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_200, 12f))
				{
					if (bLocal_207)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, vLocal_200, 1, 1, "PRD_BLIP");
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_204) > 2000)
			{
				...
				{
					func_42(0, -1);
					if ((Global_111638.f_2358.f_539.f_2395[0] == 38 && Global_111638.f_2358.f_539.f_2395[1] == 33) && Global_111638.f_2358.f_539.f_2395[2] == 54)
					{
						func_41(821);
					}
					func_38();
			...
			break;
		case 3:
			Global_111638.f_2358.f_539.f_2395[0] = 38;
			Global_111638.f_2358.f_539.f_2395[1] = 33;
			Global_111638.f_2358.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_81 = 2;
			break;
	}
...
void func_39(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_269(0) && Global_76868.f_1 == 1) && func_40(Global_76868))
		{
		}
		else
		{
...
int func_57(int iParam0)
{
	...
	return Global_96222[func_58(iParam0)];
}
...
bool func_60(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	func_74(uParam0, iParam1, sParam3, iParam7, iParam8, 0);
	Global_6674 = iParam2;
	Global_20853 = 0;
	Global_20812 = 1;
	Global_20819 = 0;
...
void func_84(int iParam0, vector3 vParam1, int iParam4, bool bParam5, char* sParam6)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_85(vParam1, 5, iParam4);
		if (bParam5)
		{
...
int func_85(vector3 vParam0, int iParam3, bool bParam4)
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0 /*3*/][func_90(iParam1)];
...
bool func_93(int iParam0, vector3 vParam1, float fParam4)
{
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_97(1, vLocal_194, 0))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (bParam1)
			{
				func_95(PLAYER::PLAYER_PED_ID(), vLocal_200, 261.2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_95(int iParam0, vector3 vParam1, float fParam4)
{
	if (func_234(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_96(iParam0, vParam1, fParam4, 0, 1);
}

int func_96(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_98(vParam1, vLocal_194, 1056964608 /* Float: 0.5f */, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!bLocal_203)
			{
				if (func_93(PLAYER::PLAYER_PED_ID(), vLocal_197, 60f))
				{
		...
		case 2:
			...
			break;
		case 3:
			func_95(PLAYER::PLAYER_PED_ID(), vLocal_200, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_114(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;

	iVar0 = 1;
	if (!func_271() || !func_218())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_194(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_193(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105187.f_2890 };
			fParam4 = Global_105187.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, true, false, false, false);
		func_184(vParam1, 5f, 0);
		if (func_14(iParam12))
		{
			func_182(iParam12, 0);
			while (!func_115(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_115(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_176(iParam0, &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_176(iParam0, &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_116(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_120(iParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0 /*43*/].f_31 = func_119(*iParam1);
				...
				func_117(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111638.f_20113[iParam0 /*43*/].f_1));
				...
				func_117(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111638.f_20113[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_117(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_118(iVar0, &uVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_118(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
...
int func_123(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			...
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_128(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_129(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 7;
			}
		}
	}
	return 0;
...
int func_133(int iParam0)
{
	...
	if (func_134(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_146(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0 /*421*/].f_310.f_5 != -1 && Global_2425662[iParam0 /*421*/].f_310.f_8 != func_66())
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_147(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0 /*421*/].f_310.f_5 != -1 && Global_2425662[iParam0 /*421*/].f_310.f_8 != func_66())
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_148(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2425662[iParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_124(Global_2425662[iParam0 /*421*/].f_310.f_5) == 9;
			}
		}
	}
	return 0;
...
void func_151(int iParam0, int iParam1)
{
	...
	func_152(iParam0, &(Global_111638.f_32744.f_5510));
}
...
int func_171(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_172(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_172(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_182(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96075[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96075[iVar0]) == func_183(iParam0, iParam1))
				{
...
void func_184(vector3 vParam0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_192(&(Global_75441.f_555[0 /*21*/]), iVar0))
		{
...
void func_185(int iParam0)
{
	...
	if (func_192(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_191(iParam0, 0)) && Global_76350.f_66 == 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0 /*21*/].f_14] != 0) && Global_111638.f_32744.f_1958[Global_75441.f_555[0 /*21*/].f_14] > 3) && (!func_189(0, Global_75441.f_555[0 /*21*/].f_12) || !func_189(1, Global_75441.f_555[0 /*21*/].f_12)))
			{
				func_188(&(Global_111638.f_32744.f_69[Global_75441.f_555[0 /*21*/].f_14 /*78*/]), &Global_76350);
...
int func_189(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_190(&(Global_111638.f_32744.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_158(Global_111638.f_32744.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_192(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_193(Global_111638.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_193(Global_111638.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_193(Global_111638.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_197(int iParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_198(iParam0, Global_75441.f_139[38], 0))
			{
				func_185(38);
				return 1;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_198(iParam0, Global_75441.f_139[43], 1))
			{
				func_185(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_193(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_211(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("STUNT") && func_98(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608 /* Float: 0.5f */, 0))
	{
		return 0;
	}
	return 1;
...
bool func_212()
{
	return func_210(&(Global_105187.f_2890));
}

void func_213()
{
	func_214(&(Global_105187.f_2890));
}
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_217(Global_105187.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_218()
{
	return func_211(&(Global_105187.f_2890));
}
...
void func_221()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_197, 150f))
				{
					func_227(2);
				}
				else if (!func_93(PLAYER::PLAYER_PED_ID(), vLocal_197, 75f))
...
void func_227(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			break;
		case 1:
			iLocal_187 = "PRD_FKICKOFF";
			break;
		case 2:
			iLocal_187 = "PRD_FLEFT";
			break;
		case 3:
			iLocal_187 = "PRD_CASH";
			break;
...
void func_230()
{
	if (func_232())
	{
		...
		{
			case 0:
				if (Global_111638.f_2358.f_539.f_2395[0] == -99)
				{
					func_231(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
				}
				else if (Global_111638.f_2358.f_539.f_2395[1] == -99)
				{
					func_231(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
				}
				else if (Global_111638.f_2358.f_539.f_2395[2] == -99)
				{
					func_231(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
				}
				break;
			case 1:
				if (Global_111638.f_2358.f_539.f_2395[1] == -99)
				{
					func_231(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
				}
				else if (Global_111638.f_2358.f_539.f_2395[0] == -99)
				{
					func_231(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
				}
				else if (Global_111638.f_2358.f_539.f_2395[2] == -99)
				...
				break;
			case 2:
				if (Global_111638.f_2358.f_539.f_2395[2] == -99)
				{
					func_231(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
				}
				else if (Global_111638.f_2358.f_539.f_2395[0] == -99)
...
int func_233()
{
	...
	while (iVar1 <= 2)
	{
		if (Global_111638.f_2358.f_539.f_2395[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_236(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_237(func_268(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
		...
		case 0:
			switch (iParam0)
			{
				case 0:
					...
					break;
				case 1:
					func_265(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
				case 2:
					func_265(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			func_250(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_265(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						case 1:
							func_265(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
						case 2:
							func_265(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
					if (func_246(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_265(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						case 1:
							func_265(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
						case 2:
							func_265(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				case 25:
					...
					{
						case 0:
							func_265(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						case 1:
							func_265(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
						case 2:
							func_265(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				case 99:
				...
				case 113:
					...
					{
						case 0:
							func_265(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						case 1:
							func_265(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
						case 2:
							func_265(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("CLOTHES_SHOP_SP"):
							...
							{
								case 0:
									func_265(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								case 1:
									func_265(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
								case 2:
									func_265(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						case joaat("HAIRDO_SHOP_SP"):
							...
							{
								case 0:
									func_265(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								case 1:
									func_265(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
								case 2:
									func_265(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
							if (func_246(0))
							{
						...
						case joaat("GUNCLUB_SHOP"):
							...
							{
								case 0:
									func_265(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								case 1:
									func_265(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
								case 2:
									func_265(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						case joaat("CARMOD_SHOP"):
							...
							{
								case 0:
									func_265(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								case 1:
									func_265(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
								case 2:
									func_265(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
							func_245(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_265(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
				case 1:
					func_265(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
				case 2:
					func_265(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
		case 0:
...
void func_240(int iParam0)
{
	...
	if (iParam0 == 12)
	{
		func_243(8269, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 13)
	{
		func_243(8270, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 14)
	{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_242() /*10930*/].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_242() /*10930*/].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_243(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0 /*3*/][func_90(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_246(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_247(129, -1, -1);
	}
	if (iParam0 == 9)
	{
		return func_247(135, -1, -1);
	}
	if (iParam0 == 10)
	{
		return func_247(136, -1, -1);
	}
	if (iParam0 == 11)
	{
		return func_247(137, -1, -1);
	}
	if (iParam0 == 12)
	{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_242() /*10930*/].f_6174.f_10, iParam0);
}
...
bool func_247(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_249(iParam0, iParam1);
...
{
	if (func_13(14) && !func_263(iParam0))
	{
		return 0;
	}
	...
	if (func_262(&Global_4270065))
	{
		if (func_260(&Global_4270065, iParam0))
		{
			return 0;
		}
		if (func_253(&Global_4270065, iParam0))
		{
			return 1;
		}
	}
...
int func_253(var uParam0, int iParam1)
{
	...
	if (func_13(14) && !func_263(iParam1))
	{
		return 0;
	}
...
void func_256(var uParam0)
{
	...
	func_258(uParam0, (Global_4270064 - 0.5f));
}
...
void func_270(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_271())
	{
...
void func_272()
{
	func_273(joaat("PLAYER_ZERO"), 14, 31, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 32, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 33, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 34, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 35, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 36, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 37, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 38, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 39, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 40, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 41, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 42, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 43, 1);
	func_273(joaat("PLAYER_ZERO"), 14, 44, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 9, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 10, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 11, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 12, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 13, 1);
	func_273(joaat("PLAYER_ZERO"), 9, 14, 1);
	func_273(joaat("PLAYER_ONE"), 14, 26, 1);
	func_273(joaat("PLAYER_ONE"), 14, 27, 1);
	func_273(joaat("PLAYER_ONE"), 14, 28, 1);
	func_273(joaat("PLAYER_ONE"), 14, 29, 1);
	func_273(joaat("PLAYER_ONE"), 14, 30, 1);
	func_273(joaat("PLAYER_ONE"), 14, 31, 1);
	func_273(joaat("PLAYER_ONE"), 14, 32, 1);
	func_273(joaat("PLAYER_ONE"), 14, 33, 1);
	func_273(joaat("PLAYER_ONE"), 14, 34, 1);
	func_273(joaat("PLAYER_ONE"), 14, 35, 1);
	func_273(joaat("PLAYER_ONE"), 14, 36, 1);
	func_273(joaat("PLAYER_ONE"), 14, 37, 1);
	func_273(joaat("PLAYER_ONE"), 14, 38, 1);
	func_273(joaat("PLAYER_ONE"), 14, 39, 1);
	func_273(joaat("PLAYER_ONE"), 9, 5, 1);
	func_273(joaat("PLAYER_ONE"), 9, 6, 1);
	func_273(joaat("PLAYER_ONE"), 9, 7, 1);
	func_273(joaat("PLAYER_ONE"), 9, 8, 1);
	func_273(joaat("PLAYER_ONE"), 9, 9, 1);
	func_273(joaat("PLAYER_ONE"), 9, 10, 1);
	func_273(joaat("PLAYER_TWO"), 14, 49, 1);
	func_273(joaat("PLAYER_TWO"), 14, 50, 1);
	func_273(joaat("PLAYER_TWO"), 14, 51, 1);
	func_273(joaat("PLAYER_TWO"), 14, 52, 1);
	func_273(joaat("PLAYER_TWO"), 14, 53, 1);
	func_273(joaat("PLAYER_TWO"), 14, 54, 1);
	func_273(joaat("PLAYER_TWO"), 14, 55, 1);
	func_273(joaat("PLAYER_TWO"), 14, 56, 1);
	func_273(joaat("PLAYER_TWO"), 14, 57, 1);
	func_273(joaat("PLAYER_TWO"), 14, 58, 1);
	func_273(joaat("PLAYER_TWO"), 14, 59, 1);
	func_273(joaat("PLAYER_TWO"), 14, 60, 1);
	func_273(joaat("PLAYER_TWO"), 9, 9, 1);
	func_273(joaat("PLAYER_TWO"), 9, 10, 1);
	func_273(joaat("PLAYER_TWO"), 9, 11, 1);
	func_273(joaat("PLAYER_TWO"), 9, 12, 1);
	func_273(joaat("PLAYER_TWO"), 9, 13, 1);
	func_273(joaat("PLAYER_TWO"), 9, 14, 1);
	func_273(joaat("PLAYER_TWO"), 9, 15, 1);
	func_273(joaat("PLAYER_TWO"), 9, 16, 1);
}

int func_273(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_76434[1 /*14*/] = { func_275(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_274(iParam1, Global_76434[1 /*14*/].f_5, Global_76434[1 /*14*/].f_2, 0, Global_76434[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_274(iParam1, Global_76434[1 /*14*/].f_5, Global_76434[1 /*14*/].f_2, 0, Global_76434[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_274(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_275(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_340();
...
void func_277(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 87:
			...
			break;
		default:
			func_285(iVar10, iParam0, 155, -1);
			return;
	}
	func_278(&(Global_76434[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_278(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_282(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_282(Global_2621444, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_274(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_274(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_274(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_281(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_89(func_280(iParam1, uParam0->f_2), Global_76431, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_279(iParam1, uParam0->f_2, &iVar1))
			{
				iVar0 = func_89(iVar1, Global_76431, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_282(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_283(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_285(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_278(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_278(&(Global_76434[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_278(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_278(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_286(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_343(var uParam0, int iParam1)
{
	...
	{
		func_347(&uLocal_82, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_346(&uLocal_82);
	func_344(&uLocal_134, &uLocal_82, 50f);
}

void func_344(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_345(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = { -vVar9 };
		}
...
bool func_345(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_360(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
