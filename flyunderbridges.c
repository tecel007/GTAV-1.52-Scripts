			...
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_39[iLocal_31 /*3*/]) < fLocal_250)
							{
								if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
									{
										if (func_15())
										{
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, false, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, false, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
						...
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (bLocal_33)
							{
								if (bLocal_37)
								{
									if (bLocal_36)
									{
										if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, false, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, false, true, 0))
										{
											func_14();
											func_1();
									...
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, false, true, 0))
									{
										bLocal_36 = true;
									}
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, false, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, false, true, 0))
...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = MISC::IS_BIT_SET(Global_111638.f_10044.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = MISC::IS_BIT_SET(Global_111638.f_10044.f_97, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = MISC::IS_BIT_SET(Global_111638.f_10044.f_98, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			MISC::SET_BIT(&(Global_111638.f_10044.f_96), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			MISC::SET_BIT(&(Global_111638.f_10044.f_97), (iLocal_31 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_111638.f_10044.f_98), (iLocal_31 - 64));
		}
		Global_95189 = 1;
		func_30();
		bLocal_29 = true;
...
void func_16()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_268) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (MISC::IS_BIT_SET(Global_111638.f_10044.f_96, iLocal_31))
			{
				bLocal_267 = true;
			}
		}
...
void func_26()
{
	...
	while (iVar0 < 70)
	{
		if (func_28(vLocal_264, vLocal_39[iVar0 /*3*/], 1056964608 /* Float: 0.5f */, 0))
		{
	...
	{
		if (MISC::IS_BIT_SET(Global_111638.f_10044.f_97, (iLocal_31 - 32)))
		{
			bLocal_267 = true;
		}
	}
	else if (MISC::IS_BIT_SET(Global_111638.f_10044.f_98, (iLocal_31 - 64)))
	{
		bLocal_267 = true;
	}
	if (bLocal_267)
...
void func_45()
{
	...
	{
		func_48(13, SYSTEM::FLOOR(Global_111638.f_10189.f_3853));
	}
...
int func_49()
{
	...
	while (iVar1 < 32)
	{
		if (MISC::IS_BIT_SET(Global_111638.f_10044.f_96, iVar1))
		{
			if (func_50(iVar1))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_111638.f_10044.f_97, iVar1))
		{
			if (func_50(iVar1 + 32))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_111638.f_10044.f_98, iVar1))
		{
			if (func_50(iVar1 + 64))
			{
				iVar0++;
