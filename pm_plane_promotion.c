...
void func_1()
{
	...
	bLocal_329 = false;
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_241))
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_241, false))
		{
			func_141();
		}
		else if (iLocal_47 == 2)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_241, false))
			{
				...
				if (func_138(PLAYER::PLAYER_PED_ID(), bLocal_241, 1) > 300f)
				{
					func_141();
				}
			}
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(bLocal_241) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_241, false)) && ENTITY::IS_ENTITY_IN_AIR(bLocal_241)) && bLocal_325) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_326)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 114))
			{
				if (iLocal_324 == -1 || (MISC::GET_GAME_TIMER() - iLocal_324) > 2000)
				{
					...
					{
						iLocal_332 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", bLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, false, false, false);
						fLocal_330 = 0f;
					}
					if (func_137("LEAFLET"))
					{
					...
					AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", bLocal_241, 0, false, 0);
	...
	switch (iLocal_47)
	{
		case 0:
			...
			{
				bLocal_241 = Global_110568.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(bLocal_241))
				{
					bLocal_241 = VEHICLE::CREATE_VEHICLE(joaat("STUNT"), vVar0, 121.2244f, true, true, false);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_241, 5f);
				}
				else
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_241, true, true);
				}
			...
			break;
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_241) && VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_241, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_241, false))
				{
					HUD::CLEAR_PRINTS();
		...
		case 2:
			...
			break;
		case 3:
			if (func_30(&iLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, bLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(bLocal_241))
			{
				func_133(&iLocal_51, 1, 0);
				iLocal_47++;
			}
		...
		case 5:
			...
			VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(bLocal_241, false);
			func_27();
			break;
	}
	switch (iLocal_48)
	{
		case 0:
			...
			else if ((func_26() && (MISC::GET_GAME_TIMER() - iLocal_49) > 5000) && bLocal_329)
			{
...
int func_28(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_30(int* iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, bool bParam10, int iParam11, bool bParam12, char* sParam13, int iParam14, char* sParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19)
{
	return func_31(iParam0, vParam1, func_75(), vParam4, vParam7, iParam11, 5, 0, 0, 0, bParam12, sParam13, func_74(), func_74(), func_74(), func_74(), iParam14, 0, bParam16, sParam15, 1, bParam17, bParam18, bParam19, func_74(), func_74(), func_74(), 1, bParam10);
}

int func_31(int* iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, bool bParam14, bool bParam15, int iParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24, bool bParam25, bool bParam26, bool bParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, bool bParam32, bool bParam33, bool bParam34, bool bParam35, bool bParam36)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	func_72(iParam0);
	func_71();
	if (func_54(iParam0, iParam0->f_17[0], iParam0->f_17[1], iParam0->f_17[2], bParam20, bParam21, bParam22, bParam23, iParam0->f_8, bParam25, bParam18, 0, 0, bParam32, bParam33, bParam34, bParam14, bParam26))
	{
		func_53(bParam20);
		func_53(bParam21);
		func_53(bParam22);
...
int func_41(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_45(iParam2), true);
}
...
int func_51(int* iParam0, int iParam1)
{
	...
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		if (func_52(iVar0, iParam0, iParam1))
		{
			return 1;
		}
	}
...
int func_54(int* iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, float fParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_21, false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_21, true)) < 400f)
			{
				if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_52(iParam0->f_21, iParam0, iVar3))
						{
							iVar0 = 0;
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
								{
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(iParam0->f_17[iVar0], -1794415470) == 7 && !func_70(iParam0->f_17[iVar0], iParam0->f_21))
									{
		...
		if (bVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
				{
					...
					if (!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()))
					{
						if (func_68(iParam0, iParam0->f_17[iVar0], fParam8, 1))
						{
	...
	if (!MISC::IS_BIT_SET(iParam0->f_13, 26))
	{
		if ((!func_67(iParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(bParam10))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bVar13, false))
			{
				if (!MISC::IS_BIT_SET(iParam0->f_13, 13))
				{
					...
					if (!func_48(iParam0, 2))
					{
						...
						{
							func_44(iParam0->f_17[iVar27], "NEED_A_BIGGER_VEHICLE", 3);
						}
						func_46(iParam0, "MORE_SEATS", 0);
						MISC::SET_BIT(&(iParam0->f_13), 13);
					}
		...
		if (!ENTITY::DOES_ENTITY_EXIST(bParam10))
		{
			if ((!PED::IS_PED_INJURED(iParam0->f_17[0]) || !PED::IS_PED_INJURED(iParam0->f_17[1])) || !PED::IS_PED_INJURED(iParam0->f_17[2]))
			{
				...
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_48(iParam0, 2))
					{
						bVar13 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
						if (func_66(bVar13, iParam0))
						{
							func_46(iParam0, "CMN_VEHSUIT", 0);
				...
				if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(bVar13, false))
						{
							if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()))
							{
								if (!func_67(iParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
								{
									if (!func_65(iParam0->f_17[iVar0]))
									{
										PED::REMOVE_PED_FROM_GROUP(iParam0->f_17[iVar0]);
									}
								}
					...
					if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()))
					{
						...
						{
							if (func_52(iVar32, iParam0, 0))
							{
								if (func_64(iVar0, iParam0) || !MISC::IS_BIT_SET(iParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iParam0->f_17[iVar0], iVar0);
							...
							else if (!func_64(iVar0, iParam0))
							{
								...
								func_62(iVar0, iParam0);
							}
						}
					}
					if ((!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()) && !func_61(iParam0->f_17[iVar0], bParam10)) && !func_60(iParam0->f_17[iVar0], bParam10))
					{
						if (func_68(iParam0, iParam0->f_17[iVar0], fParam8, bParam11))
						{
							if (!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()))
							{
						...
						if (bVar11)
						{
							if (!HUD::DOES_BLIP_EXIST(iParam0->f_1[iVar0]))
							{
								...
								iParam0->f_1[iVar0] = func_32(iParam0->f_17[iVar0], 0, 0);
								HUD::SET_BLIP_DISPLAY(iParam0->f_1[iVar0], 2);
								if (bParam9)
								{
									func_42(iParam0->f_1[iVar0], iParam0);
								}
							}
						}
						bVar6 = false;
					...
					{
						if (((func_38(iParam0->f_17[iVar0], 1) || func_61(iParam0->f_17[iVar0], bParam10)) || bParam12) || (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam10, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bParam10, false)))
						{
							if (HUD::DOES_BLIP_EXIST(iParam0->f_1[iVar0]))
							{
								HUD::REMOVE_BLIP(&(iParam0->f_1[iVar0]));
								func_53(bVar15[iVar0]);
							}
						}
						else
						{
					...
					else if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam10, false))
					{
						if (!PED::IS_PED_SITTING_IN_VEHICLE(iParam0->f_17[iVar0], bParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(iParam0->f_17[iVar0], bParam10, 20f, 20f, 5f, false, true, 0) && !MISC::IS_BIT_SET(iParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bParam10, false)))
							{
								if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iParam0->f_17[iVar0]))
								{
									...
									{
										if (!func_38(iParam0->f_17[iVar0], 1))
										{
											if (func_37(iParam0->f_17[iVar0]))
											{
								...
								else
								{
									...
									iVar14 = TASK::GET_SCRIPT_TASK_STATUS(iParam0->f_17[iVar0], -1794415470);
									if (iVar14 == 7 && !func_70(iParam0->f_17[iVar0], bParam10))
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(iParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_59(iParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(iParam0->f_17[iVar0])) && !TASK::IS_PED_GETTING_UP(iParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(bParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iParam0->f_17[iVar0], true);
						...
						else if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()) && !FIRE::IS_ENTITY_ON_FIRE(bParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(iParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
						{
							if (func_65(iParam0->f_17[iVar0]) || ENTITY::IS_ENTITY_AT_ENTITY(iParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), iParam0->f_8, iParam0->f_8, iParam0->f_8, false, true, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!ENTITY::IS_ENTITY_AT_ENTITY(iParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), (iParam0->f_8 * 0.85f), (iParam0->f_8 * 0.85f), iParam0->f_8, false, true, 0) && !func_65(iParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
					...
					if (iParam0->f_12 < iVar1)
					{
						...
						else
						{
							...
							while (iVar0 < 3)
							{
								if (iVar7[iVar0])
								{
									if (!func_58(iVar0, iParam0))
									{
										if (!MISC::IS_STRING_NULL(bVar19[iVar0]))
										{
											if (!MISC::ARE_STRINGS_EQUAL(bVar19[iVar0], ""))
											{
												func_56(iParam0, bVar15[iVar0], bVar19[iVar0], 0);
												func_55(iVar0, iParam0);
												iParam0->f_12 = iVar1;
											}
										}
										if (!func_58(iVar0, iParam0))
										{
											func_46(iParam0, bVar15[iVar0], 0);
											func_55(iVar0, iParam0);
											iParam0->f_12 = iVar1;
										}
									}
...
void func_56(int* iParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (!bParam3)
	{
...
int func_77(vector3 vParam0, float fParam3, bool bParam4)
{
	int iVar0;

	iVar0 = HUD::ADD_BLIP_FOR_RADIUS(vParam0, fParam3);
...
void func_80(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_132(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_129(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_81(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_81(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_115(iParam5, &Var0, vParam1, fParam4, func_121(iParam0));
...
void func_82(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_112(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_101();
			}
...
void func_83(int iParam0, int iParam1)
{
	...
	func_123(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_100(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_112(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_122(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_122(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_122(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_115(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_112(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_120(iParam0);
			func_119(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_129(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_130(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
float func_138(int iParam0, bool bParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_148()
{
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_241))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&bLocal_241);
	}
