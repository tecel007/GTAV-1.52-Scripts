...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBGR", 8);
	StringCopy(&cLocal_236, "GRIFF", 16);
	StringCopy(&cLocal_202, "Special_Ped@griff", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBGR_INTERACT";
	StringCopy(&cLocal_312, "PBGR_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBGR_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBGR_CONV_GF", 16);
