	...
	while (true)
	{
		...
		switch (iLocal_28)
		{
			...
			case 1:
				...
				if (iLocal_29 > 0)
				{
					ENTITY::_SET_ENTITY_COORDS_2(PLAYER::PLAYER_PED_ID(), CAM::GET_FINAL_RENDERED_CAM_COORD() + Vector(3f, 0f, 0f), true, false, false, true);
					ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
					ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true);
				}
				...
				if ((SYSTEM::TIMERA() > 40000 && bLocal_126) || func_1())
				{
...
int func_14()
{
	...
	switch (iLocal_31)
	{
		case 0:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				iLocal_120 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(12.629f, 4359.485f, -954.3553f) - vVar0, Vector(12.629f, 4359.485f, -954.3553f) + vVar0, false, true, true, true);
				CAM::DESTROY_ALL_CAMS(false);
				iLocal_30 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", false);
				CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(iLocal_30, 0);
...
void func_40(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_43(0) && Global_77079.f_1 == 1) && func_42(Global_77079))
		{
		}
		else
		{
	...
	if (Global_111858.f_9081 || func_43(0))
	{
		iVar0 = func_41();
...
void func_45(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if (iParam3 == 1)
	{
		UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), !bParam0, 64);
	}
	else
	{
...
void func_54(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_61(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
