...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_0))
	{
		...
		iLocal_316 = Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28;
		func_74(&Global_1297702, iLocal_316);
		vLocal_378 = { Global_1297702.f_146.f_82[5 /*102*/] };
		fLocal_381 = Global_1297702.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_381 < 0f)
		{
			fLocal_381 = (fLocal_381 + 360f);
		}
		vLocal_388 = { Global_1297702.f_146.f_82[5 /*102*/].f_16 };
		uLocal_391 = Global_1297702.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_382 = { Global_1297702.f_146.f_82[5 /*102*/].f_7 };
		vLocal_385 = { Global_1297702.f_146.f_82[5 /*102*/].f_10 };
	}
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_378, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 3f)
			{
				switch (iLocal_311)
				{
					case 0:
						...
						break;
					case 1:
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_61())
						{
							func_1();
						}
						else
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_378, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > (3f + 2f))
			{
				func_92();
			}
		}
...
void func_1()
{
	...
	vVar0 = { 1.5f, 1.5f, 2.5f };
	switch (iLocal_312)
	{
		case 0:
			if (((func_56(vLocal_378, vVar0) && !func_55()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_381 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_381 + 45f))
			{
				if (Global_1573337 == 13)
				{
					Global_1573337 = -1;
				}
				if (!func_54("SA_STRIP_CALL"))
				{
					func_53("SA_STRIP_CALL");
				}
				iLocal_312 = 1;
			}
			break;
			...
			if (func_52(1, 0, 1))
			{
				if (((func_56(vLocal_378, vVar0) && !func_55()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_381 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_381 + 45f))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_378, 2.5f, 0);
						func_32(PLAYER::PLAYER_ID(), 0, 256, 0);
						bLocal_36 = true;
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
						func_23(1, 1, 1, 0, 0, 0, 0);
						TASK::TASK_PED_SLIDE_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_378, fLocal_381, 0.75f);
						iLocal_312 = 2;
					}
				}
				else
		...
		case 2:
			...
			{
				func_15(104, 1, -1, 1);
				iLocal_317 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, false, false, 1f, 0f, 1f);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_317, sLocal_324, sLocal_325, 4f, -2f, 1, 0, 1000f, 0);
				if (!func_14(iLocal_322))
				{
		...
		case 3:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			func_19(1);
			iLocal_318 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_317);
		...
		case 4:
			...
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_317);
			if (!func_54("SA_STRIP_CAM"))
			{
				func_53("SA_STRIP_CAM");
			}
			iLocal_312 = 5;
			break;
		case 5:
		...
		case 6:
			...
			{
				iLocal_317 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, false, true, 1f, 0f, 1f);
				...
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_317);
				iLocal_319++;
				if (!func_54("SA_STRIP_MENU"))
				{
					func_53("SA_STRIP_MENU");
				}
				iLocal_312 = 7;
			}
			break;
		...
		case 11:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_318) > 0.5f)
			{
				...
				CAM::_RENDER_FIRST_PERSON_CAM(false, 1f, 3, 0);
...
void func_2()
{
	...
	iVar0 = Global_1590518;
	if (iVar0 > -1 && iVar0 != func_8())
	{
		iVar1 = 0;
		while (iVar1 < 25)
		{
			if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28 == Global_1590682[iVar0 /*883*/].f_274[iVar1])
			{
...
void func_6(int iParam0)
{
	...
	{
		case 0:
			Global_2097152[func_7() /*10931*/].f_5507.f_18++;
			break;
		case 1:
			Global_2097152[func_7() /*10931*/].f_5507.f_21++;
			break;
		case 2:
			Global_2097152[func_7() /*10931*/].f_5507.f_24++;
			break;
		case 3:
			Global_2097152[func_7() /*10931*/].f_5507.f_27++;
			break;
		case 4:
			Global_2097152[func_7() /*10931*/].f_5507.f_30++;
			break;
		case 99:
			Global_2097152[func_7() /*10931*/].f_5507.f_33++;
			break;
	}
	if (iParam0 >= 5 && iParam0 != 99)
	{
		Global_2097152[func_7() /*10931*/].f_5507.f_78[(iParam0 - 5)]++;
	}
}
...
{
	return MISC::IS_BIT_SET(Global_1377236.f_241.f_136[func_13(9) /*33*/][iParam0], func_12(9));
}
...
void func_15(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;

	if (func_18())
	{
		iVar0 = Global_2587834[iParam0 /*3*/][func_16(iParam2)];
		if (iVar0 != 0)
		{
...
void func_23(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		func_29(0, bParam3, bParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_27(PLAYER::PLAYER_ID())) && !func_25(PLAYER::PLAYER_ID(), 0)) && !func_24()) && !bParam4) && !bParam5)
			{
...
void func_32(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(bParam0) && (PLAYER::IS_PLAYER_PLAYING(bParam0) || bParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_25(PLAYER::PLAYER_ID(), 0) && !func_28()))
				{
...
void func_43()
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_322))
	{
		if (func_45(2, 0, 1))
		{
			...
			{
				if (func_44(&iLocal_322, 5, iLocal_320, vLocal_388, uLocal_391, 1, 1, 1) && func_44(&iLocal_323, 5, iLocal_321, vLocal_388, uLocal_391, 1, 1, 1))
				{
...
int func_44(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
...
{
	return func_46(0, iParam0, 1, bParam1, bParam2);
}

int func_46(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	if ((bParam2 && !bParam3) && iParam1 <= (func_50(iParam0) - func_49(iParam0, 0)))
	{
		return 1;
	}
	else
	{
		if (bParam3)
		{
			if (bParam2)
			{
				iVar0 = (iParam1 - func_49(iParam0, 0));
			}
			else
			{
				iVar0 = iParam1;
			}
			iVar1 = (func_50(iParam0) - func_48(iParam0));
		}
		else
		{
			if (bParam2)
			...
			iVar1 = (func_50(iParam0) - func_49(iParam0, 1));
		}
		if (!bParam4 && Global_1590682[PLAYER::PLAYER_ID() /*883*/] != 3)
		{
			iVar1 = (iVar1 - func_47(iParam0));
		}
		if (iVar0 < iVar1)
		{
			return 1;
...
int func_56(vector3 vParam0, Vector3 vParam3, var uParam4, var uParam5)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			...
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_60(0)) && !func_59())
				{
					if ((Global_95883 && Global_95884) || func_58())
					{
						return 0;
					}
					if (func_57(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, vParam3, 0))
					{
						return 1;
					}
				}
...
int func_57(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_75(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	switch (iParam0)
	{
		...
		case 84:
		case 85:
			func_86(iParam0, 40, &Var0, 83, 0);
			*uParam1 = { Var0 };
			*uParam2 = Var0.f_3.f_2;
			break;
		case 86:
			func_76(iParam3, 40, &Var0, 0);
			*uParam1 = { Var0 };
			*uParam2 = Var0.f_3.f_2;
			break;
		case 87:
...
void func_76(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	struct<6> Var0[2];
	vector3 vVar13;
	...
	*uParam2 = { func_78(iParam1, 86) };
	vVar13 = { *uParam2 - Var0[0 /*6*/] };
	vVar13 = { func_77(vVar13, -Var0[0 /*6*/].f_3.f_2) };
	vVar13 = { func_77(vVar13, Var0[1 /*6*/].f_3.f_2) };
...
struct<6> func_78(int iParam0, int iParam1)
{
	struct<6> Var0;
	bool bVar6;
	bool bVar23;
...
void func_81(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 42:
		case 43:
			func_86(iParam1, 4, &vVar0, -1, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, -1, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 19f;
			func_86(iParam1, 276, &vVar0, -1, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, -1, 0);
		...
		case 64:
		case 65:
			func_86(iParam1, 4, &vVar0, 61, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 61, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 21f;
			func_86(iParam1, 276, &vVar0, 61, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 61, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 14.5f;
			break;
		case 73:
		...
		case 75:
		case 76:
			func_86(iParam1, 4, &vVar0, 73, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 73, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_86(iParam1, 276, &vVar0, 73, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 73, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 10.25f;
			func_86(iParam1, 483, &vVar0, 73, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_86(iParam1, 484, &vVar0, 73, 0);
		...
		case 81:
		case 82:
			func_86(iParam1, 4, &vVar0, 77, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 77, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 9.75f;
			func_86(iParam1, 276, &vVar0, 77, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 77, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 5f;
			func_86(iParam1, 483, &vVar0, 77, 0);
			*(uParam0[2 /*8*/]) = { vVar0 };
			func_86(iParam1, 484, &vVar0, 77, 0);
			(uParam0[2 /*8*/])->f_3 = { vVar0 };
		...
		case 84:
		case 85:
			func_86(iParam1, 4, &vVar0, 83, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 83, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 26.75f;
			func_86(iParam1, 276, &vVar0, 83, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 83, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
			(uParam0[1 /*8*/])->f_6 = 18.25f;
			break;
		case 86:
			func_86(iParam1, 4, &vVar0, 86, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 86, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 14.75f;
			func_86(iParam1, 276, &vVar0, 86, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 86, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 89:
		case 90:
			func_86(iParam1, 4, &vVar0, 88, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 88, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 27.25f;
			func_86(iParam1, 276, &vVar0, 88, 0);
			*(uParam0[1 /*8*/]) = { vVar0 };
			func_86(iParam1, 277, &vVar0, 88, 0);
			(uParam0[1 /*8*/])->f_3 = { vVar0 };
		...
		case 95:
		case 96:
			func_86(iParam1, 4, &vVar0, 91, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 91, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
		...
		case 101:
		case 102:
			func_86(iParam1, 4, &vVar0, 97, 0);
			*(uParam0[0 /*8*/]) = { vVar0 };
			func_86(iParam1, 5, &vVar0, 97, 0);
			(uParam0[0 /*8*/])->f_3 = { vVar0 };
			(uParam0[0 /*8*/])->f_6 = 22f;
			break;
	}
...
void func_86(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<6> Var0[2];
	vector3 vVar13;

	Var0[0 /*6*/] = { func_87(iParam3, bParam4) };
	Var0[1 /*6*/] = { func_87(iParam0, bParam4) };
	*uParam2 = { func_78(iParam1, iParam3) };
	vVar13 = { *uParam2 - Var0[0 /*6*/] };
	vVar13 = { func_77(vVar13, -Var0[0 /*6*/].f_3.f_2) };
	vVar13 = { func_77(vVar13, Var0[1 /*6*/].f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var0[1 /*6*/], 0f, vVar13) };
...
struct<6> func_87(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_92()
{
	if (func_54("SA_SHWR_OUT") || func_54("SA_SHWR_IN"))
	{
		HUD::CLEAR_HELP(true);
	}
	if (bLocal_314)
	...
	if (bLocal_313)
	{
		UNK_0x1082C25039B168F8(sLocal_324);
		UNK_0x1082C25039B168F8(sLocal_330);
		UNK_0x1082C25039B168F8(sLocal_336);
		UNK_0x1082C25039B168F8(sLocal_342);
		UNK_0x1082C25039B168F8(sLocal_348);
		UNK_0x1082C25039B168F8(sLocal_354);
		UNK_0x1082C25039B168F8(sLocal_360);
		UNK_0x1082C25039B168F8(sLocal_366);
	}
...
{
	return func_97(iParam0, Global_41631);
}
