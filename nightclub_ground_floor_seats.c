...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			if ((iVar28 != 1 && iVar28 != 0) || func_34(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 5f))
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1000f, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar33 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar33))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar33) >= 1f)
				{
					...
					func_49(uParam0, &uVar16);
					uParam0->f_141.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 7:
			...
			break;
		case 8:
			iVar34 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
	func_50(uParam0, &uVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_65(uParam0, 8);
}
...
Vector3 func_47(var uParam0)
{
	...
	vVar0 = { (uParam0[uParam0->f_141.f_2 /*14*/])->f_8.f_3 };
...
int func_86()
{
	if (Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9, true, 0))
		{
			return 0;
		}
...
void func_87()
{
	func_88(0, &uLocal_85, 0, 2);
	func_88(1, &uLocal_85, 1, 1);
	func_88(2, &uLocal_85, 2, 2);
	func_88(3, &uLocal_85, 3, 1);
	func_88(5, &uLocal_85, 5, 1);
	func_88(6, &uLocal_85, 6, 2);
	func_88(7, &uLocal_85, 7, 1);
	func_88(8, &uLocal_85, 8, 2);
	func_88(9, &uLocal_85, 9, 1);
}
