...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_148 < 3 && bLocal_383)
		{
			...
			{
				if (func_317(Local_155))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155, 10f, 1))
					{
						func_297();
					}
				}
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76647[1 /*14*/] = { func_90(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_76647[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, 0);
		}
	}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_155(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_90(iVar10, iParam1, iParam2, -1) };
		if (!func_80(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_58(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_73(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_90(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) };
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
{
	Global_76647[1 /*14*/] = { func_90(iParam0, iParam1, iParam2, -1) };
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_155(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_92(int iParam0)
{
	...
	func_93(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_155(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_155(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_155(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_90(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_155(iParam0, 14, iVar4))
										{
											if (!func_46(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_90(iVar0, iVar2, iVar1, -1) };
						if (!func_46(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_229()
{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_371) == 1f)
				{
					if (func_317(Local_155))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(Local_155, iLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1000f, 0);
						...
						PED::_0x2208438012482A1A(Local_155, false, false);
		...
		else if (!bLocal_380)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_372) == 1f)
			{
				if (func_317(Local_155))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_155, iLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1000f, 0);
	...
	if (func_317(Local_155))
	{
		if (iVar0 < 3)
		{
			ENTITY::SET_ENTITY_HEALTH(Local_155, 101, 0);
			vVar4 = { ENTITY::GET_ENTITY_COORDS(Local_155, true) };
			if (vVar4.z > 155f)
			{
				fVar7 = 155f;
			}
			...
			ENTITY::SET_ENTITY_COORDS(Local_155, 1657.046f, -17.4571f, fVar7, true, false, false, true);
		}
	}
	...
	HUD::DISPLAY_HUD(true);
	HUD::DISPLAY_RADAR(true);
	UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), true, 128);
	MISC::SET_TIME_SCALE(1f);
	if (func_228(Local_155))
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373))
		...
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_155);
		PED::_0x2208438012482A1A(Local_155, false, false);
		ENTITY::SET_ENTITY_COORDS(Local_155, 1655.77f, -20.04f, 135.8f, true, false, false, true);
		ENTITY::SET_ENTITY_HEALTH(Local_155, 0, 0);
	}
...
int func_238(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	switch (iLocal_149)
	{
		case 0:
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!bLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						if (func_317(Local_155))
						{
							ENTITY::FREEZE_ENTITY_POSITION(Local_155, false);
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							func_251(1654.721f, 4.166876f, 172.5245f, 1662.562f, -8.920052f, 178.2742f, 6.25f, vLocal_348, fLocal_351, 1, 1, 1, 0, 0);
						}
						else
						{
							vLocal_348 = { 1649.793f, 11.7826f, 172.7745f };
							fLocal_351 = 220.9923f;
							func_250(vLocal_348, fLocal_351);
						}
					...
					if (!bLocal_154)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
						{
							if (func_317(Local_155))
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(Local_155, iLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1000f, 0);
...
void func_247(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_250(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			...
			{
				ENTITY::SET_ENTITY_COORDS(iVar0, vParam0, true, false, false, true);
...
void func_251(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_252(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}

void func_252(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_256(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_254(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_255(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_255(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_256(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		vVar0 = { func_258(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.f_1 = vVar3.x;
		vVar0.f_2 = 0f;
		...
		if (((((((((((((((func_257(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_257(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_257(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_257(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_257(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_257(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_257(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_257(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_257(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_257(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_257(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_257(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_257(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_257(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_257(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_257(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_264(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_267()
{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			iLocal_170 = func_277(Local_155, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_149 = 1;
			break;
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				if (func_317(Local_155))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155, 32f, 1))
					{
						if (func_271(Local_155, 1, 0, 0, 0))
						{
							if (iLocal_169 == 0)
							{
								if (!func_266())
						...
						else
						{
							if (!bLocal_378)
							{
								if (func_316(PLAYER::PLAYER_PED_ID(), Local_155, 30f, 1) && !func_266())
								{
							...
							{
								TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_155, -1, 0, 2);
							}
						}
					}
...
void func_268()
{
	if (func_317(Local_155))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(Local_155, 242628503) != 1)
		{
			TASK::TASK_PERFORM_SEQUENCE(Local_155, iLocal_171);
		}
	}
}
...
void func_269()
{
	...
	if (!func_266())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
		{
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_367))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_367, "DOM", Local_155, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}
...
int func_273(int iParam0, float fParam1)
{
	...
	{
		if (func_274(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_274(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_258(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_258(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_275(vVar3, vVar0);
...
void func_281()
{
	...
	MISC::CLEAR_AREA_OF_VEHICLES(Local_155.f_1, 20f, false, false, false, false, false, false);
	...
	if (func_317(Local_155))
	{
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_155, false);
		func_230(&uLocal_182, 4, Local_155, "DOM", 0, 1);
...
{
	func_283(iParam0, iLocal_81, vParam1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_283(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_284(iParam0);
...
int func_285(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_290(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_335())
	{
...
void func_291()
{
	switch (iLocal_150)
	{
		case 0:
			...
			if (func_293(1, 1093140480 /* Float: 10.5f */, 0))
			{
				if (!bLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3500)
				{
					func_292();
					RECORDING::_0x48621C9FCA3EBD28(1);
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_82.f_28[0])) && func_317(PLAYER::PLAYER_PED_ID())) && bLocal_383 == 1)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fVar1);
			CAM::_SET_GAMEPLAY_HINT_ANGLE(fVar2);
...
void func_297()
{
	...
	if (bLocal_383)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(true);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_155, 0f, 0f, 0f, true, 30000, 2000, 2000, 0);
			CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETZ(fVar1);
			CAM::_SET_GAMEPLAY_HINT_ANGLE(fVar2);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(fVar3);
...
void func_298()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_155, true), true);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
...
{
	if (((!func_313(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_315(iParam0, Global_41631);
}
...
void func_318()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_155))
	{
		...
		ENTITY::FREEZE_ENTITY_POSITION(Local_155, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_155, true);
		WEAPON::REMOVE_ALL_PED_WEAPONS(Local_155, true);
		PED::SET_PED_COMPONENT_VARIATION(Local_155, 8, 2, 0, 0);
		AUDIO::DISABLE_PED_PAIN_AUDIO(Local_155, true);
...
int func_319(int* iParam0, int iParam1, vector3 vParam2, int iParam5, char* sParam6, int iParam7)
{
	if (func_320(iParam0, iParam1, vParam2, iParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_320(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_325(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_325(iParam0) };
...
void func_349()
{
	...
	UNK_0x1082C25039B168F8("rcmextreme4");
}
...
int func_355()
{
	...
	iVar0 = func_356(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
