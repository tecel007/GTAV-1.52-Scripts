		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (bLocal_440 == 1)
				{
					...
					{
						func_52(Global_111583[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
...
void func_54()
{
	...
	func_57(Global_111583[iLocal_251] + 1, &uVar0, &Var8);
...
int func_106()
{
	if (MISC::IS_BIT_SET(Global_111638.f_18569[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (MISC::IS_BIT_SET(Global_111638.f_18569[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[60 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111638.f_18569[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111638.f_18569[61 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111638.f_18569[62 /*6*/], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_111638.f_18569[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_111638.f_18569[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_111638.f_18569[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_111638.f_20112, iParam0);
}
