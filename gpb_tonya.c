...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_240)) && fVar43 < 25f) && func_88(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED")) && func_85(iLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 0))
			{
				if (!func_89())
				{
					func_91();
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (bLocal_440 == 1)
				{
					...
					{
						func_52(Global_111803[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
				...
				bVar36 = func_61();
				bVar37 = func_62();
				func_51(Global_111803[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_503)
					{
						Global_111803[iLocal_251] = uLocal_502;
					}
					else
					{
			...
			case 13:
				...
				func_50(&uVar1);
				func_49(&uLocal_37, 0, PLAYER::PLAYER_PED_ID(), &uVar1, 0, 1);
				func_49(&uLocal_37, 3, iLocal_240, &cLocal_236, 0, 1);
				func_48(&cVar5);
...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_21(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(iVar0) && (!func_18(14) || Global_110809))
			{
...
void func_54()
{
	...
	func_57(Global_111803[iLocal_251] + 1, &uVar0, &Var8);
...
bool func_58()
{
	...
	{
		bVar4 = func_33(&uLocal_37, &cLocal_304, &Var0, 3, 0, 0, 0);
	}
	Local_498 = { Var0 };
	return bVar4;
}
...
void func_70(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
void func_97(int iParam0)
{
	...
	func_100(&(Global_111858.f_20113), iParam0);
...
void func_105()
{
	...
	StringCopy(&cLocal_234, "TOW", 8);
	StringCopy(&cLocal_236, "TONYA", 16);
	StringCopy(&cLocal_202, "special_ped@tonya", 64);
	...
	StringCopy(&cLocal_312, "TONYA_MIC", 16);
	StringCopy(&cLocal_316, "TONYA_TRE", 16);
	StringCopy(&cLocal_320, "", 16);
...
int func_106()
{
	if (MISC::IS_BIT_SET(Global_111858.f_18570[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111858.f_18570[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (MISC::IS_BIT_SET(Global_111858.f_18570[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111858.f_18570[60 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111858.f_18570[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111858.f_18570[61 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_111858.f_18570[62 /*6*/], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_111858.f_18570[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_111858.f_18570[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_111858.f_18570[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_111858.f_20113, iParam0);
}
