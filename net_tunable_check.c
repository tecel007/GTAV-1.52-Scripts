	...
	switch (iParam0)
	{
		...
		case 1014:
			*uParam1 = 0f;
			...
			uParam1->f_4 = 1;
			break;
		case 1015: /* GXTEntry: "You have been awarded the following liveries for the ~a~:~n~~a~~n~~a~~n~~a~~n~~a~" +
			...
			switch (iParam0)
			{
				...
				case 1403:
					*uParam1 = 7400f;
					...
					uParam1->f_2 = 7400;
					uParam1->f_3 = 44000;
					uParam1->f_5 = 1079257332; /* Float: 3.315f */
					uParam1->f_4 = 1;
					break;
				case 1404:
					*uParam1 = 7150f;
			...
			switch (iParam0)
			{
				...
				case 1653:
					*uParam1 = 0f;
					...
					uParam1->f_2 = 0;
					uParam1->f_3 = 3;
					uParam1->f_5 = 1180975104; /* Float: 14608f */
					uParam1->f_4 = 1;
					break;
				case 1654:
					*uParam1 = 0f;
