...
int func_85()
{
	if (Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9, true, 0))
		{
			return 0;
		}
...
void func_86()
{
	func_87(0, &uLocal_85, 0, 2);
	func_87(1, &uLocal_85, 1, 1);
	func_87(2, &uLocal_85, 2, 2);
	func_87(3, &uLocal_85, 3, 1);
	func_87(4, &uLocal_85, 4, 2);
	func_87(5, &uLocal_85, 5, 1);
	func_87(6, &uLocal_85, 6, 2);
	func_87(7, &uLocal_85, 7, 1);
	func_87(8, &uLocal_85, 8, 1);
}
...
void func_87(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_91(iParam0, &vVar0, &uVar3);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, uVar3 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_89(func_90(), uVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_89(func_88(), uVar3) + vVar0 };
