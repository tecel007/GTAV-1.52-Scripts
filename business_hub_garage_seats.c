...
int func_85()
{
	if (Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2425662[PLAYER::PLAYER_ID() /*421*/].f_310.f_8, true, 0))
		{
			return 0;
		}
...
void func_86()
{
	func_87(0, &uLocal_83, 0, 2);
	func_87(1, &uLocal_83, 1, 1);
	func_87(2, &uLocal_83, 2, 2);
	func_87(3, &uLocal_83, 3, 1);
	func_87(4, &uLocal_83, 4, 2);
	func_87(5, &uLocal_83, 5, 1);
	func_87(6, &uLocal_83, 6, 2);
	func_87(7, &uLocal_83, 7, 1);
	func_87(8, &uLocal_83, 8, 1);
}
