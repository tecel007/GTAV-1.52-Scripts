			...
			switch (Global_19681.f_1)
			{
				...
				case 8:
					...
					if (func_11(2, Global_19649, 0))
					{
						func_10();
						Global_19659 = 1;
						func_9(Global_19662, "DISPLAY_VIEW", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
						func_26();
...
void func_12()
{
	if (Global_19659 == 0)
	{
		if (func_11(2, Global_19650, 0))
		{
			...
			uLocal_36 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
			while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_36))
			{
				SYSTEM::WAIT(0);
			}
			Global_8356[Global_19681 /*2811*/][iLocal_38 /*281*/].f_259 = iLocal_18[GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_36)];
			...
			{
				func_9(Global_19662, "SET_SLEEP_MODE", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			}
			else
			{
				func_9(Global_19662, "SET_SLEEP_MODE", 0f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			}
			if (func_4(0))
			{
				func_3();
...
void func_19()
{
	...
	func_9(Global_19662, "DISPLAY_VIEW", 13f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_13(Global_19662, "SET_HEADER", &(Global_8356[Global_19681 /*2811*/][iLocal_38 /*281*/].f_7[Global_8356[Global_19681 /*2811*/][iLocal_38 /*281*/].f_259 /*4*/]), 0, 0, 0, 0);
	if (Global_19669)
	{
...
void func_22()
{
	func_9(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_24()
{
	func_9(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19670, true);
	func_25();
}
