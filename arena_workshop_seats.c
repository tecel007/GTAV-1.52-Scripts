...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 5:
			...
			if ((iVar28 != 1 && iVar28 != 0) || func_34(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 5f))
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_43.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1000f, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			iVar33 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar33))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar33) >= 1f)
				{
					...
					func_49(uParam0, &uVar16);
					uParam0->f_43.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_43.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
					func_33(&(uParam0->f_43), 8);
		...
		case 7:
			...
			break;
		case 8:
			iVar34 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_43.f_1);
...
void func_30(var uParam0)
{
	...
	uParam0->f_43.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, true, false, 1f, 0f, 1.12f);
	func_50(uParam0, &uVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_43.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
	func_7(&(uParam0->f_43.f_5));
	func_65(uParam0, 8);
}
...
Vector3 func_47(var uParam0)
{
	...
	vVar0 = { (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3 };
...
int func_72()
{
	if ((CAM::IS_SCREEN_FADED_OUT() && !func_85()) && !Global_2516796)
	{
		return 1;
	}
	if (!func_84())
...
bool func_85()
{
	return MISC::IS_BIT_SET(Global_1678288.f_4, 10);
}
...
int func_86()
{
	if (Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_9, true, 0))
		{
			return 0;
		}
...
void func_88(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	(uParam1[iParam2 /*14*/])->f_1 = { func_90(func_92(), func_91(iParam3, fVar3)) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_90(func_89(), func_91(iParam3, fVar3)) + vVar0 };
