...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBJE", 8);
	StringCopy(&cLocal_236, "JEROME", 16);
	StringCopy(&cLocal_202, "Special_Ped@jerome", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBJS_INTERACT";
	StringCopy(&cLocal_312, "", 16);
	StringCopy(&cLocal_316, "", 16);
