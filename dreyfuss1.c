...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76434[1 /*14*/] = { func_91(iVar0, iParam1, iParam2, -1) };
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76434[1 /*14*/] = { func_91(iVar10, iParam1, iParam2, -1) };
		if (!func_81(iParam3))
		{
...
{
	Global_76434[1 /*14*/] = { func_91(iParam0, iParam1, iParam2, -1) };
...
void func_93(int iParam0)
{
	...
	func_94(&(Global_76434[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_94(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_94(&(Global_76434[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_94(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_94(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_156(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_156(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76434[2 /*14*/] = { func_91(iVar0, 14, iVar4, -1) };
									if (Global_76434[2 /*14*/].f_12 == iVar3)
									{
										if (func_156(iParam0, 14, iVar4))
										{
											if (!func_47(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76434[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76434[2 /*14*/] = { func_91(iVar0, iVar2, iVar1, -1) };
						if (!func_47(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76434[2 /*14*/])))
						{
							return 0;
						}
					}
...
int func_213(int iParam0, int iParam1)
{
	...
	if (func_223(&Global_4270065))
	{
		if (func_221(&Global_4270065, iParam0))
		{
			return 0;
		}
		if (func_214(&Global_4270065, iParam0))
		{
			return 1;
		}
	}
...
void func_217(var uParam0)
{
	...
	func_219(uParam0, (Global_4270064 - 0.5f));
}
	...
	switch (iLocal_155)
	{
		...
		case 1:
			...
			if (!func_437(iLocal_156))
			{
				...
				if (!MISC::IS_BIT_SET(Global_111638.f_18569.f_382, 0))
				{
					MISC::SET_BIT(&(Global_111638.f_18569.f_382), 0);
				}
				func_295(4);
			}
...
int func_272(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_279() || func_278(Global_4456448.f_232883)) || func_277())
	{
...
int func_273(int iParam0)
{
	if (iParam0 != func_231())
	{
		...
		else if ((Global_1312877 && iParam0 == PLAYER::PLAYER_ID()) && func_274(iParam0, 1, 0))
		{
			return Global_2425662[iParam0 /*421*/].f_310.f_5 != -1;
		}
	}
...
void func_318(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
void func_329(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102203.f_4))
	{
		...
		{
			if (func_376(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_373(ENTITY::GET_ENTITY_COORDS(Global_102203.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_330(Global_102203.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_331(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_361(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111638.f_32744.f_4801 = func_350();
			}
...
void func_332(int iParam0, int iParam1)
{
	...
	func_368(iParam0, &(Global_111638.f_32744.f_5510));
}
...
int func_361(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_285(Global_111638.f_32744.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_285(Global_111638.f_2358.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_285(Global_111638.f_2358.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_364(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_361(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_366(iParam0);
			func_365(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_384(Global_102203.f_2890.f_12.f_66, vParam0, iParam3);
}
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_405(Global_76877, Global_76879, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_416(0) || Global_76891) || Global_76880 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76876)
...
{
	return func_418(iParam0, Global_41431);
}
...
void func_436()
{
	...
	func_432();
	MISC::CLEAR_BIT(&(Global_111638.f_18569.f_382), 0);
...
int func_468()
{
	...
	iVar0 = func_469(&(Global_98744.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_472()
{
	...
	{
		if (func_467(&(Global_98744.f_3)) > -1)
		{
			return 1;
		}
	}
