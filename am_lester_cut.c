...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_212(&Global_1663728);
		switch (func_211(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_210() == 2)
				{
					vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				}
				else if (func_210() == 6)
				{
					vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				}
				break;
			case 2:
				if (func_210() == 2)
				{
					...
					else if (HUD::DOES_BLIP_EXIST(Global_1663728))
					{
						func_12();
						HUD::SET_BLIP_ROUTE(Global_1663728, false);
						HUD::REMOVE_BLIP(&Global_1663728);
						if (MISC::IS_BIT_SET(iLocal_424, 3))
						{
							CUTSCENE::REMOVE_CUTSCENE();
						}
						MISC::SET_BIT(&(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
					if (func_8(PLAYER::PLAYER_ID()))
					{
						vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 3;
						Global_2540384.f_1777 = 0;
					}
				}
				else if (func_210() == 6)
				{
			...
			case 5:
				...
				{
					vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				}
				break;
			case 3:
				vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 6;
...
void func_3()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			if (!MISC::IS_BIT_SET(vLocal_155[iLocal_154 /*3*/].f_2, 0))
			{
				MISC::CLEAR_BIT(&iLocal_424, 1);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (MISC::IS_BIT_SET(vLocal_155[iLocal_154 /*3*/].f_2, 1))
				{
...
void func_19()
{
	...
	switch (vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			...
			if (!MISC::IS_BIT_SET(iLocal_424, 5))
			{
				if (((((func_201(PLAYER::PLAYER_ID(), 1, 0) || func_200()) || func_199() > 0) || func_198()) || func_196()) || func_195())
				{
					...
					func_12();
					if (HUD::DOES_BLIP_EXIST(Global_1663728))
					{
						HUD::SET_BLIP_ROUTE(Global_1663728, false);
						HUD::REMOVE_BLIP(&Global_1663728);
					}
				...
				else
				{
					if (HUD::DOES_BLIP_EXIST(Global_1663728))
					{
						if (!MISC::IS_BIT_SET(iLocal_424, 14))
						{
							if (Local_75.f_2 != -1)
							{
								...
								{
									HUD::SET_BLIP_COLOUR(Global_1663728, 39);
									HUD::SET_BLIP_SCALE(Global_1663728, 0.7f);
						...
						{
							HUD::SET_BLIP_COLOUR(Global_1663728, 0);
							HUD::SET_BLIP_SCALE(Global_1663728, 1f);
					...
					if (func_194())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							{
								if (!MISC::IS_BIT_SET(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									MISC::SET_BIT(&(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								}
								if (MISC::IS_BIT_SET(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (Local_75.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										{
											func_190();
											iLocal_432 = UNK_0x5DEA4192B46CB99B("SECURITY_CAM");
										}
										vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 1;
									}
					...
					else
					{
						if (!MISC::IS_BIT_SET(iLocal_424, 9))
						{
							if (func_184(0, 1, 1, 1))
							{
								if (!func_198())
								{
									...
									if (!HUD::DOES_BLIP_EXIST(Global_1663728))
									{
										Global_1663728 = HUD::ADD_BLIP_FOR_COORD(Global_1663729);
										HUD::SET_BLIP_SPRITE(Global_1663728, 77);
										HUD::SET_BLIP_FLASHES(Global_1663728, true);
										HUD::SET_BLIP_FLASH_TIMER(Global_1663728, 7000);
									}
						...
						if (MISC::IS_BIT_SET(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
						{
							MISC::CLEAR_BIT(&(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
						}
						if (MISC::IS_BIT_SET(iLocal_424, 13))
						{
		...
		case 1:
			if (bLocal_422)
			{
				if (func_178())
				{
					vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
				}
			}
			else if (func_138())
			{
		...
		case 2:
			if (func_83())
			{
				vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 3;
			}
			break;
		case 3:
			if (!MISC::IS_BIT_SET(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				MISC::SET_BIT(&(vLocal_155[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			}
			break;
...
void func_33(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (func_34())
	{
		iVar0 = Global_2587834[iParam0 /*3*/][func_81(iParam2)];
		if (iVar0 != 0)
		{
...
{
	return Global_1663920.f_16[iParam0 /*44*/].f_3;
}
...
void func_87()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_181(&Global_2549408))
	{
		if (!func_180(&Global_2549408, 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_92())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_91(&Global_2549408, 1, 0);
				}
...
void func_88(int iParam0)
{
	...
	{
		if (!func_180(&(Global_2549413[iParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(iParam0))
		{
			if (!func_92())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_91(&(Global_2549413[iParam0 /*2*/]), 1, 0);
				}
		...
		else
		{
			...
			func_179(&(Global_2549413[iParam0 /*2*/]));
...
void func_114()
{
	...
	UNK_0x1082C25039B168F8("missfinale_c2leadinoutfin_c_int");
}
		...
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_432) && func_190())
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_254))
				{
					...
					PED::FORCE_PED_MOTION_STATE(iLocal_254, joaat("MOTIONSTATE_WALK"), false, 0, false);
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_254))
			{
				if (!MISC::IS_BIT_SET(iLocal_424, 21))
				{
					...
					{
						TASK::TASK_LOOK_AT_COORD(iLocal_254, 1276.409f, -1719.918f, 56.1054f, NaNf, 0, 2);
...
void func_172()
{
	if ((!func_174() && !func_173()) && Global_2452678)
	{
