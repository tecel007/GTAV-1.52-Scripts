...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_310(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_293(&Var0, 1);
	}
	if (!func_290(&Var0, vVar61, 1f))
	{
		func_289();
	...
	while (true)
	{
		...
		func_213(Var0);
		func_206(&iLocal_93, &(Var0.f_9), vVar61);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_186()) || Global_110905) || Global_30970) || func_185()) || func_184(8, -1)) || func_93()) || func_183()) || func_182()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_186()) || Global_30970) || func_185()) || func_184(8, -1)) || func_182()) || func_93()) || func_183()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_186()) || Global_110905) || Global_30970) || func_185()) || func_184(8, -1)) || func_182()) || func_93()) || func_183()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_186()) || Global_110905) || Global_30970) || func_185()) || func_184(8, -1)) || func_93()) || func_183()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_186() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_184(8, -1)) || func_181()) || func_180()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_186()) || Global_30970) || func_185()) || func_184(8, -1)) || func_183()) || func_182()) || func_181()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_188(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5)
{
	switch (*uParam0)
	{
		case 0:
			...
			break;
		case 1:
			if (func_201(PLAYER::PLAYER_PED_ID(), vParam1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_201(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 25f)
			{
				func_143();
				*uParam0 = 0;
			}
...
void func_202(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	int iVar0;
	int iVar1;

	iVar1 = 32768;
	if (!func_205(uParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
	...
	TASK::TASK_PLAY_ANIM(0, uParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0f, false, false, false);
	TASK::TASK_PLAY_ANIM(0, uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0f, false, false, false);
	TASK::CLOSE_SEQUENCE_TASK(iVar0);
	TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[iParam10], iVar0);
	TASK::CLEAR_SEQUENCE_TASK(&iVar0);
}

int func_203(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_205(PLAYER::PLAYER_PED_ID()) && func_205(uParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_201(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_256(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
...
void func_206(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_201(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_209(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_201(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_211(iParam0);
				}
			}
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_177(iVar2))
						{
							...
							{
								if (func_177(iParam0->f_35[iVar0]))
								{
					...
					else
					{
						...
						if (*iParam0 == 16)
						{
							if (func_223(PLAYER::PLAYER_PED_ID(), iParam0->f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iParam0->f_28[iVar0]))
				{
					...
					if (func_243(*iParam0))
					{
						if (!func_157(*iParam0))
						{
							if (func_238(iParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_219(iParam0);
						...
						if (func_226(iParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_219(iParam0);
...
bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_229(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_229(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_230(iParam4, iParam7) };
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_234(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_234(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_233(vVar3, vVar0);
...
Vector3 func_234(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_240(int iParam0, float fParam1)
{
	...
	{
		if (func_241(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_241(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_234(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_250() && Global_98955.f_11 == 6) && iParam0 == func_166(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_252()
{
	...
	if (func_205(PLAYER::PLAYER_PED_ID()))
	{
		if (func_253(PLAYER::PLAYER_PED_ID(), vVar0, fVar3))
		{
			func_150();
		}
	}
...
bool func_253(int iParam0, vector3 vParam1, float fParam4)
{
...
void func_255(int iParam0)
{
	...
	if (*iParam0 == 2 || *iParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (func_205(iParam0->f_41[iVar0]))
			{
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[iVar0], false);
			}
			iVar0++;
		}
		if (func_205(iParam0->f_28[0]))
		{
			...
			TASK::TASK_SMART_FLEE_PED(iParam0->f_28[0], PLAYER::PLAYER_PED_ID(), 10000f, -1, false, false);
		}
		func_220(&(iParam0->f_41[2]));
	}
}
...
{
	iParam0->f_16 = 3;
	iParam0->f_17[0 /*3*/] = { 237.65f, -385.41f, 44.4f };
	iParam0->f_27 = 1;
	return 1;
}
...
int func_262(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -480.9929f, -1712.65f, 17.4524f };
			iParam0->f_17[1 /*3*/] = { -443.6129f, -1705.886f, 27.62214f };
			iParam0->f_24 = 31f;
			iParam0->f_27 = 1;
			iParam0->f_26 = 1;
			iVar18 = 0;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_264(&(iParam0->f_35[0]), iVar0[0], vVar4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_ALARM(iParam0->f_35[0], false);
					VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iVar0[0], true);
					VEHICLE::SET_VEHICLE_NAME_DEBUG(iParam0->f_35[0], "WEED STASH VEHICLE");
					...
					VEHICLE::SET_VEHICLE_UNDRIVEABLE(iParam0->f_35[0], true);
				}
				else
				{
					bVar19 = false;
			...
			{
				func_263(&(iParam0->f_41[0]), iVar0[1], vVar4 + vVar10, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[0], iParam0->f_35[0], 0, vVar10, vVar13, false, false, false, false, 2, true);
				}
				else
				{
					bVar19 = false;
			...
			{
				func_264(&(iParam0->f_35[1]), iVar0[2], vVar7, fVar17);
				VEHICLE::SET_VEHICLE_COLOURS(iParam0->f_35[1], 39, 43);
			}
			if (bVar19)
			{
				iLocal_91 = 3;
...
void func_263(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_220(iParam0);
...
void func_264(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_265(iParam0);
...
int func_267(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { 1198.367f, -1326.095f, 33.9683f };
			iParam0->f_17[1 /*3*/] = { 1202.237f, -1235.374f, 43.97641f };
			iParam0->f_24 = 31f;
			iParam0->f_27 = 1;
			iParam0->f_26 = 1;
			iVar16 = 0;
		...
		case 2:
			bVar17 = true;
			func_264(&(iParam0->f_35[0]), iVar0[0], vVar5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(iParam0->f_35[0], false);
				...
				VEHICLE::SET_VEHICLE_EXTRA(iParam0->f_35[0], 2, true);
				VEHICLE::SET_VEHICLE_EXTRA(iParam0->f_35[0], 3, true);
			}
			else
			{
				bVar17 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
			{
				func_263(&(iParam0->f_41[0]), iVar0[1], vVar5 + vVar8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[0], iParam0->f_35[0], 0, vVar8, 0f, 0f, 0f, false, false, true, false, 2, true);
				}
				else
				{
					bVar17 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[1]))
			{
				func_264(&(iParam0->f_35[1]), iVar0[2], vVar11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				func_268(&(iParam0->f_28[0]), iVar0[3], vVar11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[1]))
			{
				func_268(&(iParam0->f_28[1]), iVar0[3], vVar11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_91 = 3;
			...
			break;
		case 3:
			if (func_205(iParam0->f_35[1]))
			{
				if (func_205(iParam0->f_28[0]))
				{
					PED::SET_PED_AS_COP(iParam0->f_28[0], true);
					PED::SET_PED_INTO_VEHICLE(iParam0->f_28[0], iParam0->f_35[1], -1);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(iParam0->f_28[0], joaat("WEAPON_PISTOL"), 100, true);
				}
				if (func_205(iParam0->f_28[1]))
				{
					PED::SET_PED_AS_COP(iParam0->f_28[1], true);
					PED::SET_PED_INTO_VEHICLE(iParam0->f_28[1], iParam0->f_35[1], 0);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(iParam0->f_28[1], joaat("WEAPON_PISTOL"), 100, true);
				}
			}
			iVar16 = 0;
			while (iVar16 <= (iVar0 - 1))
...
void func_268(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_269(iParam0);
...
int func_270(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_27 = 0;
			iParam0->f_17[0 /*3*/] = { 415.4587f, -773.3615f, 27.8549f };
			iParam0->f_17[1 /*3*/] = { 415.5205f, -758.5715f, 31.34455f };
			iParam0->f_24 = 14.5f;
			StringCopy(&(iParam0->f_9), "BAR_5_RCM_P2", 24);
			iParam0->f_25 = 1;
			iVar7 = 0;
			while (iVar7 <= (iVar0 - 1))
			{
			...
			func_275(&(iParam0->f_48), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_266(&iVar0) || !func_274(&(iParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_271(&(iParam0->f_28[0]), 49, vVar3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
					PED::SET_PED_PROP_INDEX(iParam0->f_28[0], 1, 0, 0, false);
				}
				else
				{
					bVar8 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
			{
				func_263(&(iParam0->f_41[0]), iVar0[1], vVar3 + Vector(0f, 0f, 5f), -115.18f);
				if (func_205(iParam0->f_41[0]) && func_205(iParam0->f_28[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[0], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true);
				}
				else
				{
					bVar8 = false;
...
int func_271(int* iParam0, int iParam1, vector3 vParam2, int iParam5, char* sParam6, int iParam7)
{
	if (func_272(iParam0, iParam1, vParam2, iParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_272(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_276(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			StringCopy(&(iParam0->f_9), "BAR_3_RCM", 24);
			iParam0->f_25 = 1;
			iParam0->f_27 = 0;
			iParam0->f_17[0 /*3*/] = { 190.0315f, -956.3355f, 29.09192f };
			iParam0->f_17[1 /*3*/] = { 178.0458f, -950.6594f, 31.09358f };
			iParam0->f_24 = 23f;
			iVar10 = 0;
			...
			func_275(&(iParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_266(&iVar0) || !func_274(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_271(&(iParam0->f_28[0]), 49, vVar6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(iParam0->f_28[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
			{
				...
				func_263(&(iParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_278(-2.01f));
				if (func_205(iParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[0], true);
					func_263(&(iParam0->f_41[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_278(-2.01f));
					if (func_205(iParam0->f_41[2]))
					{
			...
			{
				func_263(&(iParam0->f_41[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_205(iParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(iParam0->f_41[1], false, false);
				}
				else
				{
					bVar11 = false;
		...
		case 3:
			if (func_205(iParam0->f_28[0]))
			{
				...
				ENTITY::SET_ENTITY_COORDS(iParam0->f_28[0], vVar6, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(iParam0->f_28[0], fVar9);
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_28[0], true);
				TASK::TASK_PLAY_ANIM(iParam0->f_28[0], iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 9, 0f, false, false, false);
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[1], true);
				ENTITY::SET_ENTITY_COLLISION(iParam0->f_41[1], true, false);
			}
			func_277(&(iParam0->f_41[3]), iVar0[4]);
			iVar10 = 0;
			while (iVar10 <= (iVar0 - 1))
			{
...
void func_277(int* iParam0, int iParam1)
{
	...
	fVar3 = 23.45f;
	func_263(iParam0, iParam1, vVar0, fVar3);
}
...
int func_279(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			StringCopy(&(iParam0->f_9), "BAR_1_RCM_P2", 24);
			iParam0->f_25 = 1;
			iParam0->f_27 = 0;
			iParam0->f_17[0 /*3*/] = { 190.0315f, -956.3355f, 29.09192f };
			iParam0->f_17[1 /*3*/] = { 178.0458f, -950.6594f, 31.09358f };
			...
			func_275(&(iParam0->f_48), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_266(&iVar0) || !func_274(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_271(&(iParam0->f_28[0]), 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(iParam0->f_28[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				func_263(&(iParam0->f_41[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_278(-1.68f));
				if (func_205(iParam0->f_41[1]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[1], true);
					ENTITY::SET_ENTITY_COLLISION(iParam0->f_41[1], false, false);
		...
		case 3:
			if (func_205(iParam0->f_28[0]))
			{
				...
				PED::SET_PED_CONFIG_FLAG(iParam0->f_28[0], 208, true);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0->f_28[0], joaat("PLAYER"));
				ENTITY::SET_ENTITY_COORDS(iParam0->f_28[0], vVar8, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(iParam0->f_28[0], fVar11);
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_28[0], true);
				TASK::TASK_PLAY_ANIM(iParam0->f_28[0], iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 9, 0f, false, false, false);
				TASK::TASK_LOOK_AT_ENTITY(iParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
			...
			func_263(&(iParam0->f_41[4]), iVar0[5], 189.895f, -955.945f, 29.818f, 0f);
			if (func_205(iParam0->f_41[4]))
			{
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[4], -90f, 0f, -30.8f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[4], true);
			}
			func_263(&(iParam0->f_41[3]), iVar0[4], 189.783f, -956.015f, 29.79f, 0f);
			if (func_205(iParam0->f_41[3]))
			{
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[3], -90f, 0f, 75f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[3], true);
			}
			func_277(&(iParam0->f_41[5]), iVar0[6]);
			iVar12 = 0;
			while (iVar12 <= (iVar0 - 1))
			{
...
int func_290(int iParam0, vector3 vParam1, float fParam4)
{
	int iVar0[4];
	int iVar5;
	...
	if (func_105() == 0)
	{
		if (func_291(2, vParam1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_291(3, vParam1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_291(iVar0[iVar5], vParam1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
...
int func_291(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_292(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_292(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_300(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_307(iParam0, iParam1);
	func_304(iParam0, bParam2);
	func_301(iParam0, bParam3);
}

void func_301(int iParam0, bool bParam1)
{
	func_302(&(iParam0->f_41), bParam1);
}
