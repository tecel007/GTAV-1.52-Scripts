...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar19 = func_144(uParam0, &vVar20, &vVar23, &vLocal_256, &vLocal_262, &vLocal_265, 0, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
	...
	{
		iVar19 = func_144(uParam0, &vVar20, &vVar23, &vLocal_244, &vLocal_250, &vLocal_253, 1, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
			func_143(uParam0, 0.5f);
			func_142(uParam0, 1f);
				...
				if ((uParam3[iVar32 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar24 == 0 && (iVar32 == 72 || iVar32 == 73))
						{
							...
							if (iVar32 == 72)
							{
								iVar37 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_256, &vLocal_262, &vLocal_265, 0, &fVar38, &fVar39, &vVar28);
							}
							else
							{
								iVar37 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_244, &vLocal_250, &vLocal_253, 1, &fVar38, &fVar39, &vVar28);
							}
							if (iVar37 != 0)
							{
...
void func_263(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_266(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_266(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam1 /*94*/]), 28422), vLocal_238, vLocal_241, false, false, false, false, 2, true);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam2 /*94*/]), 28422), vLocal_238, vLocal_241, false, false, false, false, 2, true);
		}
	}
}
...
void func_335(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_337(Global_111638.f_18528[iVar0], &vVar2, &fVar5))
			{
