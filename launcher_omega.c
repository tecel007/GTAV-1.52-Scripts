...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	if (!func_264(&iVar64, &Var0, vVar61, 1f))
	{
		func_263();
	...
	while (true)
	{
		...
		func_202(Var0);
		func_195(&iLocal_93, &(Var0.f_9), vVar61);
		if (Var0 == 44)
		{
			func_187(&Var0, vVar61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_186();
		}
		else if (Var0 == 45)
		{
			func_187(&Var0, vVar61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_184(&Var0);
		}
		if (func_169(&Var0, 0))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_110905) || Global_30970) || func_182()) || func_181(8, -1)) || func_93()) || func_180()) || func_179()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_183()) || Global_30970) || func_182()) || func_181(8, -1)) || func_179()) || func_93()) || func_180()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_110905) || Global_30970) || func_182()) || func_181(8, -1)) || func_179()) || func_93()) || func_180()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_110905) || Global_30970) || func_182()) || func_181(8, -1)) || func_93()) || func_180()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_183() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_181(8, -1)) || func_178()) || func_177()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_183()) || Global_30970) || func_182()) || func_181(8, -1)) || func_180()) || func_179()) || func_178()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_184(int iParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true) };
				vVar3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				fVar7 = (vVar3.x - vVar0.x);
				fVar8 = (vVar3.y - vVar0.y);
				if (fVar8 != 0f)
				{
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			if (func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_195(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_203(int iParam0, bool bParam1)
{
	...
	func_110(*iParam0, &Var0);
	if ((func_240(*iParam0) || func_238(*iParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_208(int iParam0)
{
	...
	if (*iParam0 == 52)
	{
		func_209(&(iParam0->f_41[1]));
		func_209(&(iParam0->f_41[2]));
	}
	if (func_127(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*iParam0 == 16)
						{
							if (func_212(PLAYER::PLAYER_PED_ID(), iParam0->f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iParam0->f_28[iVar0]))
				{
					...
					if (func_232(*iParam0))
					{
						if (!func_158(*iParam0))
						{
							if (func_227(iParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_208(iParam0);
						...
						if (func_215(iParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_208(iParam0);
...
bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_218(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_218(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_219(iParam4, iParam7) };
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_223(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_222(vVar3, vVar0);
...
Vector3 func_223(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_229(int iParam0, float fParam1)
{
	...
	{
		if (func_230(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_230(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_223(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_239() && Global_98955.f_11 == 6) && iParam0 == func_167(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_242()
{
	iLocal_96 = UNK_0x5DEA4192B46CB99B("digiscanner");
...
int func_244(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { 2337.376f, 2585.722f, 45.11065f };
			iParam0->f_17[1 /*3*/] = { 2302.158f, 2586.505f, 47.99957f };
			iParam0->f_24 = 26f;
			iParam0->f_27 = 0;
			StringCopy(&(iParam0->f_9), "SCRAP_2_RCM", 24);
			iParam0->f_25 = 1;
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
			...
			func_252(&(iParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_251(&iVar0) || !func_250(&(iParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_247(&(iParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_245(&(iParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar4)
			{
				iLocal_91 = 3;
...
void func_245(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_246(iParam0);
...
int func_253(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { 2463.225f, 3444.113f, 48.59399f };
			iParam0->f_17[1 /*3*/] = { 2475.22f, 3428.098f, 50.99095f };
			iParam0->f_24 = 17f;
			iParam0->f_27 = 0;
			StringCopy(&(iParam0->f_9), "SCRAP_1_RCM", 24);
			iParam0->f_25 = 1;
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
			...
			func_252(&(iParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_251(&iVar0) || !func_250(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (!func_247(&(iParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				iParam0->f_41[0] = OBJECT::CREATE_OBJECT(iVar0[1], 2468.51f, 3437.39f, 55f, true, true, false);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				iParam0->f_41[1] = OBJECT::CREATE_OBJECT(iVar0[2], 2468.51f, 3437.39f, 57f, true, true, false);
			}
			if ((func_127(iParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[0], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, false, false, false, false, 2, true);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_41[1], iParam0->f_28[0], PED::GET_PED_BONE_INDEX(iParam0->f_28[0], 64729), 0.1f, 0.08f, 0f, 162.72f, 5.4f, 1.8f, false, false, false, false, 2, true);
			}
			else
			{
				bVar5 = false;
...
int func_264(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_265((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_265((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_265(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_266(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_266(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
