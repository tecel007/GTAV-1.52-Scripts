...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_31231 + 10000 && !func_109())
	{
		func_116(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_240)) && fVar43 < 25f) && func_91(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED")) && func_88(iLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 0))
			{
				if (!func_92())
				{
					func_94();
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (bLocal_440 == 1)
				{
					...
					{
						func_56(Global_111803[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_504)
					{
						Global_111803[iLocal_251] = uLocal_503;
					}
					else
					{
			...
			case 13:
				...
				func_54(&uVar1);
				func_53(&uLocal_37, 0, PLAYER::PLAYER_PED_ID(), &uVar1, 0, 1);
				func_53(&uLocal_37, 3, iLocal_240, &cLocal_236, 0, 1);
				func_52(&cVar5);
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_58()
{
	...
	func_61(Global_111803[iLocal_251] + 1, &uVar0, &Var8);
	...
	PED::_0x2208438012482A1A(iLocal_240, false, false);
	func_59(Global_111803[iLocal_251]);
}
...
bool func_62()
{
	...
	{
		bVar4 = func_37(&uLocal_37, &cLocal_304, &Var0, 3, 0, 0, 0);
	}
	Local_499 = { Var0 };
	return bVar4;
}
...
void func_74(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_90(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_90(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_89(vVar3, vVar0);
...
void func_100(int iParam0)
{
	...
	func_103(&(Global_111858.f_20113), iParam0);
...
void func_108()
{
	...
	StringCopy(&cLocal_234, "PBBY", 8);
	StringCopy(&cLocal_236, "BAYGOR", 16);
	StringCopy(&cLocal_202, "Special_Ped@baygor", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBBY_INTERACT";
	StringCopy(&cLocal_312, "PBBY_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBBY_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBBY_CONV_GF", 16);
...
{
	return func_114(Global_111858.f_20113, iParam0);
}
