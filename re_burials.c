						...
						switch (iLocal_49)
						{
								...
								if ((!func_133(iLocal_54[0], &iLocal_128, &uLocal_127, iLocal_126, bLocal_129, 7f, 0) && !func_133(iLocal_54[1], &iLocal_128, &uLocal_127, iLocal_126, bLocal_129, 7f, 0)) && !func_132())
								{
									switch (iLocal_50)
									{
										case 0:
											...
											{
												if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 281.9148f, 6816.345f, 4.3197f, 48.3924f, 6885.921f, 43.0037f, 226.5f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_88 - Vector(0f, 0f, 7f), 20f, 15f, 50f, false, true, 0))
												{
													func_128();
							...
							case 4:
								...
								if (!PED::IS_PED_INJURED(iLocal_53))
								{
									...
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_139, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_53, PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0))
									{
										if (PED::IS_PED_IN_GROUP(iLocal_53))
										{
								...
								if (bLocal_147)
								{
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_58, false))
									{
										if (!PED::IS_PED_INJURED(iLocal_54[0]))
										{
											...
											if (VEHICLE::_0x639431E895B9AA57(iLocal_54[0], iLocal_58, -1, false, false) || VEHICLE::_0x639431E895B9AA57(iLocal_54[0], iLocal_58, false, false, false))
											{
												if (!bLocal_164)
												{
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[0], 242628503) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54[0], PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_54[0], vLocal_88, 10f, 10f, 10f, false, true, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_54[0]));
														}
													}
										...
										if (!PED::IS_PED_INJURED(iLocal_54[1]))
										{
											...
											if (VEHICLE::_0x639431E895B9AA57(iLocal_54[1], iLocal_58, -1, false, false) || VEHICLE::_0x639431E895B9AA57(iLocal_54[1], iLocal_58, false, false, false))
											{
												if (!bLocal_164)
												{
												...
												else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[1], 242628503) == 1)
												{
													...
													{
														if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54[1], PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_54[1], vLocal_88, 10f, 10f, 10f, false, true, 0))
														{
															ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_54[1]));
														}
													}
	...
	if ((iLocal_175 - iLocal_174) > 120000)
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_53))
			{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_53, vLocal_139, 100f, 100f, 100f, false, true, 0))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_53, vLocal_139, 1f, -1, 0.25f, false, 40000f);
					PED::SET_PED_KEEP_TASK(iLocal_53, true);
				}
				else
				{
...
void func_92()
{
		...
		if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_53, 1.2f, 1.2f, 5f, false, true, 0) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_49(1, 0, 1))
			{
				...
				if (!bLocal_115)
				{
					...
					UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), false, 24);
					HUD::CLEAR_HELP(true);
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						...
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_53, 5f, 5f, 5f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), vLocal_88, 5f, 5f, 5f, false, true, 0))
						{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_58))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_58, vLocal_88, false, false, false, true);
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_58, false))
							{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(vLocal_78, 4.5f, false, false, false, false, false, false);
					ENTITY::SET_ENTITY_COORDS(iLocal_53, vLocal_78, true, false, false, true);
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_78, true, false, false, true);
					if (!PED::IS_PED_INJURED(iLocal_53))
					{
					}
					iVar0 = 0;
					...
					if (!PED::IS_PED_INJURED(iLocal_53))
					{
						...
						PED::_0x2208438012482A1A(iLocal_53, false, false);
	...
	if (bLocal_115 && !bLocal_117)
	{
		...
		if (((iLocal_119 - iLocal_120) > 9700 && !bLocal_123) && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
		{
...
void func_99(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_105(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_109(iParam2), true);
}
...
void func_112()
{
	if (!bLocal_67 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_107, 30f, 30f, 30f, false, true, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_54[1]))
		{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_60))
				{
					...
					if (ENTITY::IS_ENTITY_ATTACHED(iLocal_60))
					{
						if (!bLocal_70)
						{
							...
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_65);
							PED::SET_PED_KEEP_TASK(iLocal_54[0], true);
							PED::_0x2208438012482A1A(iLocal_54[0], false, false);
							bLocal_145 = true;
						}
					}
					else
...
int func_119(bool bParam0)
{
	if (func_122())
	{
		...
		if (bParam0 && func_25(Global_111847))
		{
...
int func_132()
{
	if (!bLocal_129)
	{
		if (MISC::IS_BULLET_IN_AREA(vLocal_88, 100f, true) || MISC::IS_BULLET_IN_AREA(vLocal_88, 100f, true))
		{
			if (PED::IS_PED_INJURED(iLocal_54[0]) || PED::IS_PED_INJURED(iLocal_54[1]))
			{
				iLocal_51 = 1;
...
int func_133(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_140()
{
	...
	func_142(43, 1);
	func_142(44, 1);
	PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_139 - Vector(20f, 40f, 40f), vLocal_139 + Vector(20f, 40f, 40f), false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_78 - Vector(20f, 50f, 60f), vLocal_78 + Vector(20f, 50f, 50f), false, true, true, true);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_105, true);
	MISC::ENABLE_DISPATCH_SERVICE(5, false);
	MISC::ENABLE_DISPATCH_SERVICE(3, false);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
	iLocal_53 = PED::CREATE_PED(26, iLocal_102, vLocal_78, fLocal_97, true, true);
	...
	while (iLocal_64 <= 1)
	{
		iLocal_54[iLocal_64] = PED::CREATE_PED(26, iLocal_103, vLocal_81[iLocal_64 /*3*/], fLocal_98[iLocal_64], true, true);
	...
	PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_54[0], vLocal_91, vLocal_94, 2.75f, false, false);
	PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_54[1], vLocal_91, vLocal_94, 2.75f, false, false);
	if (func_45() == 0)
	{
...
void func_156(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_170(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
void func_175(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_176(func_187(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_176(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_110905) || Global_30970) || func_203()) || func_84(8, -1)) || func_202()) || func_201()) || func_200()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204()) || Global_30970) || func_203()) || func_84(8, -1)) || func_200()) || func_202()) || func_201()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_110905) || Global_30970) || func_203()) || func_84(8, -1)) || func_200()) || func_202()) || func_201()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_110905) || Global_30970) || func_203()) || func_84(8, -1)) || func_202()) || func_201()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_204() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_84(8, -1)) || func_199()) || func_198()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_204()) || Global_30970) || func_203()) || func_84(8, -1)) || func_201()) || func_200()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_204()) || func_201()) || Global_110905) || Global_30970) || func_203()) || Global_42801) || func_84(8, -1)) || func_200()) || func_198()) || func_199()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_204()) || Global_110905) || Global_30970) || func_203()) || func_84(8, -1)) || func_200()) || func_198()) || func_202()) || func_201()) || func_199())
						{
							return 0;
						}
						break;
...
void func_218(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_187();
	func_221(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_220(iParam0, &iVar0);
	Var1 = { func_219(&iVar0) };
}

struct<16> func_219(int iParam0)
{
	struct<16> Var0;
	int iVar16;
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_183(*iParam0), 64);
	return Var0;
}
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 + iParam6);
	func_222(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_222(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
