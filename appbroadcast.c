...
int func_18(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2587834[iParam0 /*3*/][func_19(iParam1)];
...
void func_35()
{
	...
	func_43(Global_19662, "SET_DATA_SLOT_EMPTY", SYSTEM::TO_FLOAT(13), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	if (func_16())
	{
		if (Global_2462172)
		{
			func_42(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &cLocal_46, 0, 0, 0, 0);
		}
		else
		{
	...
	{
		func_42(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &cLocal_50, 0, 0, 0, 0);
	}
	func_43(Global_19662, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(13), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	func_39(&cLocal_38);
	if (func_16())
	{
