...
void func_2()
{
	...
	if (!bVar1)
	{
		if (((((((((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_73(iLocal_58))) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || func_72()) || CUTSCENE::IS_CUTSCENE_PLAYING()) || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || Global_76831) || Global_96239) || bLocal_61)
		{
			bLocal_82 = true;
...
void func_4(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_7())
	{
		iVar0 = Global_2587834[iParam0 /*3*/][func_5(bParam2)];
		if (iVar0 != 0)
		{
...
int func_45(int iParam0, bool bParam1)
{
	...
	iVar0 = Global_2587834[iParam0 /*3*/][func_5(bParam1)];
...
int func_53(int iParam0, int iParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			{
				case 1:
					return func_70(1224, bParam2, 0);
				case 3:
					return func_70(1230, bParam2, 0);
				case 2:
					return func_70(1226, bParam2, 0);
				case 4:
					return func_70(1229, bParam2, 0);
				case 5:
					return func_70(1228, bParam2, 0);
				case 6:
					return func_70(1225, bParam2, 0);
				case 7:
					return func_70(1227, bParam2, 0);
			}
			break;
	}
	return 0;
...
void func_55(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2551832[iParam0 /*3*/][func_5(bParam2)];
	if (iVar0 != 0)
	{
...
int func_58(int iParam0, int iParam1, bool bParam2)
{
	switch (iParam0)
	{
		...
		case 3:
			...
			{
				case 1:
					return func_70(72, bParam2, 0);
				case 3:
					return func_70(74, bParam2, 0);
				case 2:
					return func_70(73, bParam2, 0);
				case 4:
					return func_70(75, bParam2, 0);
				case 5:
					return func_70(76, bParam2, 0);
				case 6:
					return func_70(77, bParam2, 0);
				case 7:
					return func_70(78, bParam2, 0);
			}
			break;
	}
	return 0;
...
{
	return Global_2551832[iParam0 /*3*/][func_5(bParam1)];
}
...
float func_68(int iParam0, bool bParam1)
{
	...
	iVar0 = Global_2587146[iParam0 /*3*/][func_5(bParam1)];
...
int func_70(int iParam0, bool bParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_5(bParam1)];
		if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
		{
			return uVar1;
		}
