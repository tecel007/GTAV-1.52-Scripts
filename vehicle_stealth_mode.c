...
int func_10(int iParam0)
{
	if (iParam0->f_2 != 0)
	{
		if (func_14("STEALTH_OFF", func_15(iParam0->f_2), func_15(iParam0->f_2)) || func_13("STEALTH_ON_P", func_15(iParam0->f_2)))
		{
			return 1;
		}
	}
...
void func_25(int* iParam0, int iParam1)
{
	...
	if (func_54(iParam0))
	{
		switch (iParam0->f_2)
		{
			case joaat("AKULA"):
			case 295054921:
				bVar0 = (func_28(19004, -1, -1) + iParam1);
				if (bVar0 >= 0)
				{
					func_26(19004, bVar0, -1, 1);
				}
				break;
		}
	}
