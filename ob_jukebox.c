#region Local Var
	...
	struct<5> Local_156 = { 1, 1056964608, -1, -1, 0 } ;
	vector3 vLocal_161[32] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
#endregion
...
void __EntryFunction__()
{
	...
	iLocal_130 = -1;
	bLocal_137 = 4;
	sLocal_138 = "anim@amb@clubhouse@jukebox@";
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY("ob_jukebox")) > 1)
	{
		func_206(0);
	}
	iLocal_128 = Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28;
	...
	if (func_189(Var0))
	{
		...
		{
			iLocal_124 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&Var0);
		}
	}
	if (iLocal_128 == 126)
	{
		iLocal_124 = func_182(PLAYER::PLAYER_ID());
		AUDIO::START_AUDIO_SCENE("dlc_ch_arcade_music_volume");
		AUDIO::SET_AUDIO_SCENE_VARIABLE("dlc_ch_arcade_music_volume", "ArcadeRadioVolumeDucking", Local_156.f_1);
	}
	if (iLocal_124 == func_181())
	{
		func_206(0);
	}
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_128 == 126)
		{
			if (Global_1590682[iLocal_124 /*883*/].f_274.f_350 != bLocal_137 && func_178(iLocal_124))
			{
				func_175(Global_1590682[iLocal_124 /*883*/].f_274.f_350);
				func_172(1);
				Local_156.f_1 = 0.5f;
				Local_156 = 1;
				Local_156.f_3 = bLocal_125;
				func_171();
			}
			else
			{
		...
		else if (Global_1590682[iLocal_124 /*883*/].f_274.f_348 != bLocal_137)
		{
			func_175(Global_1590682[iLocal_124 /*883*/].f_274.f_348);
			func_172(1);
			Local_156 = 1;
			Local_156.f_3 = bLocal_125;
			func_171();
	...
	while (true)
	{
		...
		if (iLocal_123 != 0 && !func_169(vLocal_153, 0f, 0f, 0f, 0))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_168();
		...
		else if (iLocal_128 != -1 && iLocal_128 <= 126)
		{
			vLocal_147 = { func_1() };
			...
			if (iLocal_128 == 126)
			{
				iLocal_123 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_147, 2f, 1150719273, true, false, false);
			}
			else
			{
				iLocal_123 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_147, 2f, joaat("BKR_PROP_CLUBHOUSE_JUKEBOX_01A"), true, false, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_123))
			{
				vLocal_150 = { ENTITY::GET_ENTITY_COORDS(iLocal_123, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_123) * Vector(0.6f, 0.6f, 0.6f) };
				vLocal_150.f_2 = (vLocal_150.z + 0.5f);
				vLocal_153 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_123, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
Vector3 func_1()
{
	if (func_5(iLocal_128, -1))
	{
		return func_3(iLocal_128);
	}
	else if (iLocal_128 == 126)
	{
		return func_2();
	}
	return 0f, 0f, 0f;
...
void func_6()
{
	if (iLocal_124 == PLAYER::PLAYER_ID() && func_170())
	{
		if (!func_20(&uLocal_145))
		{
			func_19(&uLocal_145, 0, 0);
		}
		else if (func_18(&uLocal_145, 180000, 0))
		{
			func_8(bLocal_125);
...
void func_8(bool bParam0)
{
	...
	if (iLocal_128 == 126)
	{
		...
		iVar1 = (UNK_0x5A002C4821A13338() - iLocal_134);
		func_13(func_17(bParam0), (iVar0 + iVar1), -1, 1, 0);
		if (iLocal_135 < (iVar0 + iVar1))
		{
			func_11(func_12());
		}
	}
	else
	{
		...
		iVar3 = (UNK_0x5A002C4821A13338() - iLocal_134);
		func_13(func_10(bParam0), (iVar2 + iVar3), -1, 1, 0);
		if (iLocal_135 < (iVar2 + iVar3))
		{
			func_11(func_9());
		}
	}
	iLocal_134 = UNK_0x5A002C4821A13338();
}
...
{
	Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_349 = iParam0;
}
...
void func_21()
{
	...
	bVar0 = func_170();
	if (Local_156.f_3 != bLocal_125)
	{
		func_175(Local_156.f_3);
		if (iLocal_124 == PLAYER::PLAYER_ID() && Local_156.f_4)
		{
			if (iLocal_128 == 126)
			{
				func_22(26808, bLocal_125, -1, 1);
				Global_1590682[iLocal_124 /*883*/].f_274.f_350 = bLocal_125;
			}
			else
			{
				func_22(9355, bLocal_125, -1, 1);
				Global_1590682[iLocal_124 /*883*/].f_274.f_348 = bLocal_125;
			}
		}
	}
	if (MISC::IS_BIT_SET(iLocal_133, 6) != bVar0)
	{
		func_172(bVar0);
		if ((iLocal_124 == PLAYER::PLAYER_ID() && Local_156.f_4) && !bVar0)
		{
			if (iLocal_128 == 126)
			{
				func_22(26808, bLocal_137, -1, 1);
				Global_1590682[iLocal_124 /*883*/].f_274.f_350 = bLocal_137;
			}
			else
			{
				func_22(9355, bLocal_137, -1, 1);
				Global_1590682[iLocal_124 /*883*/].f_274.f_348 = bLocal_137;
			}
		}
	}
}
	...
	switch (iLocal_140)
	{
		case 0:
			if (func_159() && func_158())
			{
				...
				if (iLocal_130 == -1)
				{
					func_155(&iLocal_130, 4, "JBOX_INTERACT", 0, 0, 0, 0);
				}
				else if ((iLocal_130 != -1 && func_154(iLocal_130, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					func_153(2);
					func_151(&iLocal_130);
					func_141(PLAYER::PLAYER_ID(), 0, 256, 0);
					MISC::SET_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 0);
					MISC::SET_BIT(&Global_2515369, 4);
				}
				MISC::SET_BIT(&Global_2515369, 3);
			}
			else if (iLocal_130 != -1)
			{
				func_151(&iLocal_130);
				MISC::CLEAR_BIT(&Global_2515369, 3);
			}
			...
			break;
		case 2:
			if (Local_156.f_2 == PLAYER::PLAYER_ID() && func_138())
			{
				iLocal_131 = 0;
				func_153(1);
				MISC::CLEAR_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::SET_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 1);
				func_137(&uLocal_143);
			}
			else if (Local_156.f_2 != -1 || !func_138())
			{
				func_153(0);
				MISC::CLEAR_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::CLEAR_BIT(&Global_2515369, 4);
		...
		case 4:
			...
			iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_132);
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "EXIT", 3))
			{
				func_30(MISC::IS_BIT_SET(iLocal_133, 5));
				if (bLocal_126 != -1)
				{
					if ((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "INSERT_COINS", 3) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.82f) || !MISC::IS_BIT_SET(iLocal_133, 5))
					{
						func_29(bLocal_126);
					}
				}
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f)
			{
				...
				MISC::CLEAR_BIT(&iLocal_133, 4);
				MISC::CLEAR_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 1);
				MISC::CLEAR_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 2);
				MISC::CLEAR_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 3);
				func_141(PLAYER::PLAYER_ID(), 1, 0, 0);
				MISC::CLEAR_BIT(&Global_2515369, 4);
				iLocal_139 = 0;
				if (iLocal_128 == 126)
				{
					iLocal_136 = Global_1590682[iLocal_124 /*883*/].f_274.f_348;
				}
				else
				{
					iLocal_136 = Global_1590682[iLocal_124 /*883*/].f_274.f_350;
				}
				STATS::_0x8989CBD7B4E82534(func_27(func_28()), func_26(func_28()), func_25(), func_24(), 4, iLocal_136, 0);
				func_153(0);
			}
			break;
	}
...
{
	vLocal_161[PLAYER::PLAYER_ID() /*3*/].f_1 = bParam0;
	MISC::SET_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 2);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		switch (iLocal_131)
		{
			...
			case 1:
				...
				{
					UNK_0x1082C25039B168F8(sLocal_138);
					iLocal_131 = 0;
					return 1;
				}
				break;
...
int func_38(char* sParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_132);
	STREAMING::REQUEST_ANIM_DICT(sLocal_138);
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_138))
	{
		if ((!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar0) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f) || bParam1)
		{
			...
			{
				PED::DETACH_SYNCHRONIZED_SCENE(iLocal_132);
				iLocal_132 = -1;
			}
			iLocal_132 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_153, ENTITY::GET_ENTITY_ROTATION(iLocal_123, 2), 2, false, bParam2, 1f, 0f, 1f);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_132, sLocal_138, sParam0, 4f, -2f, 5, 0, 2f, 0);
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_132);
			return 1;
		}
	}
	return 0;
...
void func_39(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		func_40(&(Global_22550.f_5660[iVar0 /*10*/]));
...
int func_41(int iParam0, bool bParam1, int iParam2)
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
void func_42()
{
	if (!func_130())
	{
		...
		if (func_97("SNK_MNU", -1, 1))
		{
			...
			{
				func_86();
				MISC::CLEAR_BIT(&iLocal_133, 1);
			}
			else
			{
				func_85(iLocal_127, 1, 1);
			}
			func_80();
...
void func_44(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_70(Global_22550.f_5218 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0);
		...
		if (iVar5 == 1 && Global_22550.f_5728)
		{
			...
			else
			{
				if (Global_22550)
				{
					...
					{
						func_65(Global_22547, Global_22548, fParam5, (fVar57 - 0f), 0, 0, 0, 255);
				...
				func_65(Global_22547, (Global_22548 + fVar57), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_64();
					func_62((((Global_22547 + fParam5) - 0.00390625f) - func_63("CM_ITEM_COUNT", Global_22550.f_5736, Global_22550.f_5737)), ((Global_22548 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_22550.f_5736, Global_22550.f_5737);
				}
				else if (Global_22550.f_5731 > Global_22550.f_5225)
				{
					...
					{
						func_64();
						func_62((((Global_22547 + fParam5) - 0.00390625f) - func_63("CM_ITEM_COUNT", Global_22550.f_5734, Global_22550.f_5733)), ((Global_22548 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_22550.f_5734, Global_22550.f_5733);
					}
				}
			}
			...
			if (Global_22550.f_5731 > Global_22550.f_5225)
			{
				...
				func_65(Global_22547, (fVar51 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (MISC::GET_HASH_KEY(&(Global_22550.f_4690)) != 0 && Global_22550.f_4766 != -1)
			{
				...
				{
					func_75(Global_22550.f_4768, 1, 1, &fVar36, &fVar37, bParam7);
				...
				func_65(Global_22547, (fVar51 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_75(Global_22550.f_4768, 1, 1, &fVar36, &fVar37, bParam7);
					func_60(Global_22550.f_4768, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4768), func_66(Global_22550.f_4768, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4269680.f_21)) != 0 && Global_4269680.f_65 != -1)
			{
				...
				{
					func_75(Global_4269680.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					fVar42 = (((Global_22547 + fVar36) + (0.00078125f * 4f)) - (0.00078125f * 1f));
				}
				func_61(fVar42);
				...
				{
					func_75(Global_4269680.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_60(Global_4269680.f_67, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_69(Global_4269680.f_67), func_66(Global_4269680.f_67, 1), ((Global_22547 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
				}
				fVar51 = (fVar51 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
						...
						switch (Global_22550.f_5056[iVar8])
						{
								...
								if (bVar33)
								{
									if (!Global_22550.f_5729)
									{
										...
										if (MISC::GET_HASH_KEY(&(Global_22550.f_73[iVar24 /*6*/])) != 0)
										{
											...
											func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, iVar106, bVar53, bVar52);
										...
										if (iVar28 > 0)
										{
											...
											while (iVar14 < iVar28)
											{
												if (func_75(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
									...
									if (MISC::GET_HASH_KEY(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, 0, bVar53, bVar52);
									...
									while (iVar14 < 4)
									{
										...
										else if (Global_22550.f_2124[iVar24 /*5*/][iVar14] == 4)
										{
											...
											{
												if (func_75(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													fVar42 = (fVar42 + (fVar36 * 0.5f));
													if (func_75(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														func_60(Global_22550.f_4433[(iVar22 + iVar28)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
														if (iVar5 == 1)
														{
															if (Global_22550.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar28)]), func_66(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar28)]), func_66(Global_22550.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
														}
									...
									if (MISC::GET_HASH_KEY(&(Global_22550.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_49() && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("FM_MISSION_CREATOR")) > 0)
											{
												if (iVar8 == 0)
												{
													func_51(0, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, 0, bVar53, bVar52);
										...
										while (iVar14 < iVar28)
										{
											if ((Global_22550.f_4433[(iVar22 + iVar14)] != 2 && Global_22550.f_4433[(iVar22 + iVar14)] != 51) && Global_22550.f_4433[(iVar22 + iVar14)] != 61)
											{
												if (func_75(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_75(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															func_60(Global_22550.f_4433[(iVar22 + iVar14)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
															if (Global_22550.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (Global_22547 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else if (Global_22550.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[(iVar22 + iVar14)]), func_66(Global_22550.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
														}
													}
							...
							case 2:
								if (bVar33)
								{
									if (!Global_22550.f_5729)
									{
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, 0, 0, 0);
										if (Global_22550.f_8413 && Global_22550.f_8414 == iVar6)
										{
											func_50(bVar32);
										}
									...
									{
										func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, 0, 0, 0);
										func_48((fVar34 + fVar42), fVar35, "NUMBER", Global_22550.f_3918[iVar20], 0);
									}
								}
								bVar41 = true;
								iVar20++;
							...
							case 3:
								if (bVar33)
								{
									...
									func_51(bVar32, Global_22550.f_1610[iVar24], Global_22550.f_1867[iVar24], bVar55, 0, 0, 0);
									func_47((fVar34 + fVar42), fVar35, "NUMBER", Global_22550.f_4175[iVar21], Global_22550.f_4304[iVar21]);
								}
								bVar41 = true;
								iVar21++;
								break;
							case 4:
								if (bVar33)
								{
									if (func_75(Global_22550.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										if (!Global_22550.f_5729)
										{
											fVar44 = fVar36;
										...
										if (iVar5 == 1)
										{
											if (func_75(Global_22550.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												func_60(Global_22550.f_4433[iVar22], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
												GRAPHICS::DRAW_SPRITE(func_69(Global_22550.f_4433[iVar22]), func_66(Global_22550.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_46(Global_22550.f_4433[iVar22])), (fVar37 * func_46(Global_22550.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, false);
											}
										}
									}
								}
...
void func_51(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_52(Global_22550.f_6011[iParam4], &iVar0, &iVar1, &iVar2);
	...
	if (Global_22550.f_4769 != 0)
	{
		...
		if (!Global_22550.f_4770)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4269680.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_55(&Global_4269680);
				if (Global_4269680.f_20 == -1)
				{
					func_54(&(Global_4269680.f_16));
				}
				else
				{
...
var func_66(int iParam0, bool bParam1)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_22550.f_7029[iParam0 /*16*/])))
	{
		...
		{
			return func_67(&(Global_22550.f_7029[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
char* func_69(int iParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_22550.f_6020[iParam0 /*16*/])))
	{
		...
		{
			return func_67(&(Global_22550.f_6020[iParam0 /*16*/]));
		}
	}
	if (iParam0 == 51)
	{
...
void func_70(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!bParam3)
	{
		func_73(Global_22550.f_5218, 1);
	}
	else
	{
		func_73(Global_22550.f_5218, 0);
	}
	if (iParam2 == 0)
	{
		fVar1 = func_72(&(Global_22550.f_73[Global_22550.f_5220 /*6*/]));
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			fVar4 = func_71(&(Global_22550.f_73[Global_22550.f_5220 /*6*/]));
...
int func_77(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_79(8, -1) && func_78() != 65)) || (HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::IS_COMMERCE_STORE_OPEN()) || Global_77093) || Global_22550.f_8416) || HUD::IS_WARNING_MESSAGE_ACTIVE()) || Global_99007.f_1425)
	{
		return 0;
	}
	return 1;
...
void func_83()
{
	...
	if (iLocal_127 == Local_156.f_3 && func_170())
	{
		func_82("JBOX_PLIST_PLY", 0, 0);
	}
	else if (iLocal_127 == bLocal_137)
	{
	...
	else
	{
		...
		StringIntConCat(&cVar0, iLocal_127, 16);
		func_82(&cVar0, 0, 0);
	}
}
...
bool func_97(char* sParam0, int iParam1, bool bParam2)
{
	...
	bVar2 = func_98(&(Global_22550.f_5660[iVar0 /*10*/]));
	if (!bVar1 || !bVar2)
	{
	}
	return (bVar1 && bVar2);
...
void func_99()
{
	...
	if (!MISC::IS_BIT_SET(iLocal_133, 0))
	{
		if (PAD::_IS_USING_KEYBOARD_2(2))
		{
		...
		{
			func_19(&uLocal_141, 0, 0);
			MISC::SET_BIT(&iLocal_133, 0);
		}
	}
	else if (func_18(&uLocal_141, iVar1, 0))
	{
		func_137(&uLocal_141);
		MISC::CLEAR_BIT(&iLocal_133, 0);
	}
	if (bVar3)
	{
		iLocal_127++;
		if (iLocal_127 > func_117())
		{
			iLocal_127 = 0;
		}
	...
	if (bVar6)
	{
		...
		switch (iLocal_139)
		{
			...
			case 0:
				if (iLocal_127 != Local_156.f_3 || !func_170())
				{
					bLocal_126 = iLocal_127;
					iLocal_139 = 2;
					iLocal_127 = 0;
					MISC::SET_BIT(&iLocal_133, 1);
					MISC::SET_BIT(&iLocal_133, 4);
				}
				else
				{
					bVar8 = true;
...
void func_104(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_105(&(Global_4264051[iParam0 /*85*/]));
	}
}
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	while (iVar0 < 15)
	{
		if (Global_4264051[iVar0 /*85*/].f_66.f_2 == 0)
		{
			...
			{
				func_110(Global_4264051[iVar0 /*85*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
{
	vLocal_161[PLAYER::PLAYER_ID() /*3*/].f_2 = fParam0;
	MISC::SET_BIT(&(vLocal_161[PLAYER::PLAYER_ID() /*3*/]), 3);
}
...
void func_118(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (MISC::IS_PC_VERSION() && !NETWORK::_NETWORK_IS_TEXT_CHAT_ACTIVE())
	{
		...
		if (func_122())
		{
			if (Global_4269756 == iLocal_127)
			{
				*bParam2 = 1;
			}
			else
			{
				iLocal_127 = Global_4269756;
				func_85(iLocal_127, 1, 1);
			}
		}
		if (func_121())
...
int func_119(bool bParam0, bool bParam1, int iParam2)
{
...
int func_120(bool bParam0, bool bParam1, int iParam2)
{
	if (PAD::_IS_USING_KEYBOARD(2))
	{
		if (Global_4269756 == -2)
	...
	if (((fVar7 >= fVar0 && fVar7 <= fVar2) && fVar8 >= fVar1) && fVar8 <= fVar3)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || iVar13 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_65(fVar4, (fVar5 + (IntToFloat(iVar13) * 0.034722f)), Global_22549, (0.034722f - 0.0015f), 255, 255, 255, iVar10);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_125(bool bParam0)
{
	...
	if (Global_4269756 == -2)
	{
		func_65(fVar0, fVar1, Global_22549, fVar2, 255, 255, 255, iVar3);
	}
	else if (Global_4269756 == -3)
	{
		func_65(fVar0, (fVar1 + fVar2), Global_22549, fVar2, 255, 255, 255, iVar3);
	}
	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
}
...
int func_132()
{
	...
	switch (iLocal_131)
	{
		case 0:
			func_31(0);
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_123, 0.06f, -0.8958f, 0.2f) };
			if (!func_20(&uLocal_143))
			{
				func_19(&uLocal_143, 0, 0);
			}
			else if (func_18(&uLocal_143, 2000, 0))
			{
				iLocal_131 = 1;
			}
			if (!func_136(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar0, 0.8f, 0))
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar0, 1f, 4000, ENTITY::GET_ENTITY_HEADING(iLocal_123), 0.125f);
				}
			}
			else
			{
...
int func_136(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(bParam0) && (PLAYER::IS_PLAYER_PLAYING(bParam0) || bParam3 == 1))
		{
			...
			else
			{
				if (!func_145(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_142(Global_4456448.f_129348))
					{
...
int func_159()
{
	...
	bVar0 = true;
	if (func_205(PLAYER::PLAYER_ID()) && !func_178(iLocal_124))
	{
		bVar0 = false;
	}
	if ((((((((((((((!MISC::IS_BIT_SET(Global_2515369, 5) && !func_166()) && !func_36(0)) && !func_165()) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_123)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_150, 0.55f, 0.8f, 1.5f, false, true, 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "EXIT", 3)) && !func_164(PLAYER::PLAYER_ID())) && !func_163()) && bVar0) && !MISC::IS_BIT_SET(Global_1678288.f_4, 2)) && func_160(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2405074.f_2674) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
void func_168()
{
	if (func_163())
	{
		if (MISC::IS_BIT_SET(vLocal_161[Local_156.f_2 /*3*/], 2))
		{
			if (vLocal_161[Local_156.f_2 /*3*/].f_1 == bLocal_137)
			{
				if (func_170())
				{
					Local_156 = 0;
					Local_156.f_3 = bLocal_137;
					if (iLocal_124 == Local_156.f_2)
					{
						Local_156.f_4 = 1;
					}
				}
			}
			else if (Local_156.f_3 != vLocal_161[Local_156.f_2 /*3*/].f_1)
			{
				Local_156.f_3 = vLocal_161[Local_156.f_2 /*3*/].f_1;
				if (iLocal_124 == Local_156.f_2)
				{
					Local_156.f_4 = 1;
				}
		...
		if (MISC::IS_BIT_SET(vLocal_161[Local_156.f_2 /*3*/], 3))
		{
			if (Local_156.f_1 != vLocal_161[Local_156.f_2 /*3*/].f_2)
			{
				Local_156.f_1 = vLocal_161[Local_156.f_2 /*3*/].f_2;
			}
		}
		if (!MISC::IS_BIT_SET(vLocal_161[Local_156.f_2 /*3*/], 1) && !MISC::IS_BIT_SET(vLocal_161[Local_156.f_2 /*3*/], 0))
		{
			Local_156.f_2 = -1;
		}
	}
	else if (MISC::IS_BIT_SET(vLocal_161[iLocal_129 /*3*/], 0))
	{
		if (!func_163())
		{
			Local_156.f_2 = iLocal_129;
		}
	}
	if (!func_163())
	{
		if (iLocal_128 == 126)
		{
			if (Global_1590682[iLocal_124 /*883*/].f_274.f_350 == Local_156.f_3 && (!func_170() && Global_1590682[iLocal_124 /*883*/].f_274.f_350 == bLocal_137))
			{
				Local_156.f_4 = 0;
			}
		}
		else if (Global_1590682[iLocal_124 /*883*/].f_274.f_348 == Local_156.f_3 && (!func_170() && Global_1590682[iLocal_124 /*883*/].f_274.f_348 == bLocal_137))
		{
			Local_156.f_4 = 0;
		}
	}
...
void func_171()
{
	...
	if (iLocal_128 == 126)
	{
		bVar0 = func_12();
		iLocal_134 = UNK_0x5A002C4821A13338();
		iLocal_135 = func_16(func_17(bVar0), -1, 0);
	}
	else
	{
		bVar1 = func_9();
		iLocal_134 = UNK_0x5A002C4821A13338();
		iLocal_135 = func_16(func_10(bVar1), -1, 0);
	}
}
...
void func_172(bool bParam0)
{
	...
	{
		MISC::CLEAR_BIT(&iLocal_133, 6);
	}
	if (func_5(iLocal_128, -1))
	{
		func_174(iLocal_128, bParam0);
	}
	else if (iLocal_128 == 126)
	{
		func_173(bParam0);
...
void func_175(bool bParam0)
{
	if (func_5(iLocal_128, -1))
	{
		if (bParam0 != bLocal_137 && bParam0 != -1)
		{
			if (iLocal_124 == PLAYER::PLAYER_ID() && iLocal_134 != 0)
			{
				func_8(bLocal_125);
			}
			func_177(iLocal_128, bParam0);
		}
		if (bParam0 != -1)
		{
			bLocal_125 = bParam0;
...
int func_180(int iParam0)
{
	if (iParam0 != func_181())
	{
		return MISC::IS_BIT_SET(Global_1590682[iParam0 /*883*/].f_274.f_393.f_1, 2);
	}
	return 0;
}
...
bool func_184(int iParam0, bool bParam1)
{
	...
	return Global_1630317[iParam0 /*595*/].f_11 != func_181();
}
...
int func_185(int iParam0)
{
	if (iParam0 != func_181())
	{
		if (Global_1630317[iParam0 /*595*/].f_11 != func_181())
		{
...
int func_187(int iParam0)
{
	if (iParam0 != func_181())
	{
		...
		else if (((Global_1312896 || Global_2405074.f_2673) && iParam0 == PLAYER::PLAYER_ID()) && func_188(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6;
		}
	}
...
{
	*uParam1 = { Global_1590682[iParam0 /*883*/].f_274.f_65 };
}
...
void func_191()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !MISC::IS_BIT_SET(iLocal_133, 2))
	{
		...
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_156, 5);
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_161, 97);
		if (!func_192())
		{
			func_206(0);
		}
...
int func_198()
{
	...
	uVar0 = Global_2425869[PLAYER::PLAYER_ID() /*443*/].f_314.f_7;
	return uVar0;
}
...
int func_199(int iParam0)
{
	if (iParam0 != func_181())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_188(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_200()
{
	if (iLocal_128 == 126)
	{
		...
		else if (MISC::IS_BIT_SET(Global_2515369, 1))
		{
			MISC::CLEAR_BIT(&Global_2515369, 1);
			func_206(0);
		}
		else if (MISC::IS_BIT_SET(Global_1678288.f_6, 10))
		{
			if (iLocal_140 != 0)
			{
				if (MISC::IS_BIT_SET(iLocal_133, 3))
	...
	else if (iLocal_128 != Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_28)
	{
		func_206(0);
	}
}
...
int func_205(int iParam0)
{
	if (iParam0 != func_181())
	{
		if (func_188(iParam0, 1, 1))
		{
			...
			{
				return func_186(Global_2425869[iParam0 /*443*/].f_314.f_6) == 17;
			}
		}
	}
	return 0;
...
void func_207()
{
	...
	{
		if (((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "IDLE", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "EXIT", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "INSERT_COINS", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_138, "SELECT_TRACK", 3))
		{
