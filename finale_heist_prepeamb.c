...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_110278) && !MISC::IS_BIT_SET(iLocal_105, 15))
			{
				MISC::SET_BIT(&iLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
		}
		else if ((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110278) && !MISC::IS_BIT_SET(iLocal_105, 15))
		{
			MISC::SET_BIT(&iLocal_105, 15);
			HUD::CLEAR_HELP(true);
		}
	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19467) == 1)
	{
		if (func_11())
		{
			if (func_10())
			{
				...
				while ((!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_19467) == 1)
				{
					SYSTEM::WAIT(0);
...
void func_92()
{
	...
	if (iLocal_42 == 0)
	{
		STATS::STAT_SET_INT(joaat("FL_CO_FB4P3"), Global_111638.f_10011.f_21, true);
		if (func_101())
		{
...
void func_151()
{
	...
	if ((Global_41431 == 15 && !func_169()) || func_103(35))
	{
		if (iLocal_38 == 0)
		{
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_194(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_194(iParam0) };
...
{
	return func_204(iParam0, Global_41431);
}
...
void func_209()
{
	...
	if (((((((Global_41431 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_169()) && Global_76619 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
	...
	else if (((((((Global_41431 != 15 || Global_41431 != 0) || Global_41431 != 2) || Global_41431 != 4) || Global_41431 != 17) || func_169()) || Global_76619 == -1) || Global_110693)
	{
		iVar1 = 0;
		if (func_210())
		{
...
bool func_210()
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_111638.f_18098.f_395);
}
...
int func_215(int iParam0)
{
	...
	{
		if (MISC::IS_BIT_SET(Global_111638.f_7683.f_651[iVar0 /*14*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (MISC::IS_BIT_SET(Global_111638.f_7683.f_765[iVar0 /*10*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_210()) && !Global_110278)
					{
						MISC::SET_BIT(&iLocal_105, 15);
						HUD::CLEAR_HELP(true);
					}
...
void func_222()
{
	if (iLocal_37 != 4)
	{
		if (iLocal_37 != 2)
		{
			if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110278)
			{
				MISC::SET_BIT(&iLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
...
int func_227()
{
	if (((((Global_41431 == 15 && !func_169()) && Global_76619 == -1) && !func_210()) && !func_228(1112014848 /* Float: 50f */)) && !Global_110693)
	{
		return 1;
	}
	return 0;
...
int func_228(int iParam0)
{
	if (iLocal_42 == 1)
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94690[1 /*15*/], iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94690[0 /*15*/], iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_76(PLAYER::PLAYER_PED_ID(), Global_94690[3 /*15*/], iParam0))
		{
			return 1;
		}
	}
...
int func_233(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0 /*3*/][func_234(iParam1)];
...
void func_237(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_111638.f_20405.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_111638.f_20405[iVar0 /*16*/])))
		{
			...
			func_239((Global_111638.f_20405.f_145 - 1));
