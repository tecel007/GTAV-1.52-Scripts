...
void func_134()
{
	if (!func_77(vLocal_110, 0f, 0f, 0f, 0) && func_133() != func_135())
	{
...
void func_137()
{
	...
	func_144();
	func_109();
	if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_106, 150f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, false, true, 0))
	{
		MISC::CLEAR_AREA_OF_VEHICLES(vLocal_106, 6f, false, true, false, false, false, false);
...
void func_144()
{
	switch (iLocal_38)
	{
		case 0:
			...
			{
				iLocal_1438 = func_145(vLocal_106, 1);
...
int func_145(vector3 vParam0, bool bParam3)
{
	int iVar0;
	...
	if (func_103(35))
	{
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 1))
			{
				if (func_85(iLocal_109))
				{
					ENTITY::IS_ENTITY_AT_COORD(iLocal_109, vLocal_106, 4f, 4f, 2f, true, true, 0);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_109, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, false, true, 0))
					{
						...
						{
							if (func_148(1077936128 /* Float: 3f */, 1))
							{
			...
			{
				if (!func_76(iLocal_109, vLocal_106, 10f) || ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_109))
				{
					MISC::CLEAR_BIT(&iLocal_105, 1);
				}
			}
...
void func_151()
{
	...
	if ((Global_41631 == 15 && !func_169()) || func_103(35))
	{
		if (iLocal_38 == 0)
		{
...
void func_190(int iParam0, var uParam1)
{
	...
	func_191(&uLocal_1273, Local_44, PLAYER::PLAYER_PED_ID(), Local_44.f_1, 0, 1);
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_194(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_194(iParam0) };
...
{
	return func_204(iParam0, Global_41631);
}
...
void func_209()
{
	...
	if (((((((Global_41631 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_169()) && Global_76830 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
	...
	else if (((((((Global_41631 != 15 || Global_41631 != 0) || Global_41631 != 2) || Global_41631 != 4) || Global_41631 != 17) || func_169()) || Global_76830 == -1) || Global_110913)
	{
		iVar1 = 0;
		if (func_210())
		{
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_210()) && !Global_110498)
					{
						MISC::SET_BIT(&iLocal_105, 15);
						HUD::CLEAR_HELP(true);
					}
...
int func_227()
{
	if (((((Global_41631 == 15 && !func_169()) && Global_76830 == -1) && !func_210()) && !func_228(1112014848 /* Float: 50f */)) && !Global_110913)
	{
		return 1;
	}
	return 0;
...
int func_233(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_234(iParam1)];
...
void func_237(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_111858.f_20406.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_111858.f_20406[iVar0 /*16*/])))
		{
			...
			func_239((Global_111858.f_20406.f_145 - 1));
...
struct<8> func_246(char* sParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	struct<8> Var0;
...
void func_260(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
