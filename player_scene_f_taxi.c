...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_72, false) };
		fVar4 = SYSTEM::VDIST2(vLocal_176 + vLocal_181, vVar1);
		if (fVar4 < (4.5f * 4.5f))
		{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
		{
			...
			if (!func_5(Global_98676, iLocal_74, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_98676, iLocal_74, 2);
				}
			}
			if (!bLocal_180)
			{
		...
		else
		{
			...
			if (!func_3(&uVar0))
			{
				...
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_74, vLocal_176 + vLocal_181, fLocal_179, 0, iLocal_75, 786599, ((4.5f / 2f) - 1f), 10f);
...
int func_8(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
...
void func_12()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_17(14) || Global_110809))
			{
...
void func_22()
{
	...
	iLocal_74 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_181 + vLocal_173, 15f, iLocal_75, 2);
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_98676) || !ENTITY::DOES_ENTITY_EXIST(iLocal_74)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_73) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_98676, Global_93959);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_98676, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
void func_23()
{
	...
	Var9 = 0;
	Var9.f_2 = iLocal_70;
	Var9.f_3 = Global_96433.f_45;
	func_26(Var9, &Var118);
	func_24(iLocal_70, &uLocal_185, &cLocal_201, &cLocal_201, &uVar238, &uVar239);
}
	...
	switch (Param0.f_2)
	{
		...
		case 99:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_27(uParam109, 15, -982327190, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		case 100:
			*uParam109 = { Param0 };
		...
		case 101:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_27(uParam109, 14, -982327190, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		case 102:
			*uParam109 = { Param0 };
...
int func_29(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, float fParam6)
{
	iParam2->f_3 = 1000;
	iParam2->f_1 = 0;
	iParam2->f_84 = 255;
	...
	{
		case 5:
			*iParam2 = { Global_98359[iParam0 /*98*/] };
		...
		case 8:
			...
			*uParam4 = (1.27f - 194.1887f);
			return 1;
		case 9:
			return func_29(iParam0, 8, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 10:
			return func_29(iParam0, 8, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 13:
			func_31(iParam0, iParam2, 0);
		...
		case 20:
			...
			*fParam6 = 25f;
			return 1;
		case 23:
			return func_29(iParam0, 208, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 24:
			func_31(iParam0, iParam2, 0);
			*uParam5 = { 0f, 25f, 0f };
			*fParam6 = 25f;
		...
		case 112:
			...
			*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			return 1;
		case 113:
			if (func_29(iParam0, 112, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 118:
			...
			*fParam6 = 5f;
			return 1;
		case 119:
			if (func_29(iParam0, 118, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
				*uParam5 = { 5f, 20f, 0f };
				*fParam6 = 5f;
				return 1;
		...
		case 105:
			...
			*fParam6 = 0.5f;
			return 1;
		case 106:
			return func_29(iParam0, 105, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 107:
			return func_29(iParam0, 105, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 98:
			func_30(iParam0, iParam2, 1);
		...
		case 99:
			...
			*fParam6 = 0f;
			return 1;
		case 100:
			return func_29(iParam0, 99, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 101:
			return func_29(iParam0, 99, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 102:
			return func_29(iParam0, 99, iParam2, uParam3, uParam4, uParam5, fParam6);
		...
		case 91:
			...
			*uParam4 = 2.4942f;
			return 1;
		case 93:
			if (func_29(iParam0, 91, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
		...
		case 135:
			...
			*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			return 1;
		case 136:
			if (func_29(iParam0, 135, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 139:
			...
			break;
		case 140:
			if (func_29(iParam0, 142, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
				*uParam5 = { 0f, 15f, 0f };
				*fParam6 = 10f;
				return 1;
		...
		case 149:
			...
			break;
		case 151:
			if (func_29(iParam0, 94, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
			...
			break;
		case 162:
			if (func_29(iParam0, 115, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
		...
		case 158:
			...
			*uParam4 = 2.52f;
			return 1;
		case 166:
			return func_29(iParam0, 98, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 170:
			func_30(iParam0, iParam2, 1);
			iParam2->f_91 = 1;
			*uParam3 = { 0f, 0f, 0f };
		...
		case 212:
			...
			*uParam4 = 177.8041f;
			return 1;
		case 213:
			if (func_29(iParam0, 211, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
		...
		case 193:
			...
			*uParam4 = (302.182f - 172.9187f);
			return 1;
		case 194:
			if (func_29(iParam0, 193, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
		...
		case 222:
			...
			*uParam4 = 14.3405f;
			return 1;
		case 223:
			if (func_29(iParam0, 222, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
			...
			break;
		case 224:
			return func_29(iParam0, 222, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 226:
			func_31(iParam0, iParam2, 0);
		...
		case 250:
			...
			*uParam4 = 160.56f;
			return 1;
		case 251:
			if (func_29(iParam0, 250, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
		...
		case 281:
			...
			*fParam6 = 15f;
			return 1;
		case 282:
			if (func_29(iParam0, 281, iParam2, uParam3, uParam4, uParam5, fParam6))
			{
				return 1;
			}
			break;
		...
		case 275:
			...
			*fParam6 = 15f;
			return 1;
		case 276:
			return func_29(iParam0, 275, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 277:
			return func_29(iParam0, 275, iParam2, uParam3, uParam4, uParam5, fParam6);
		case 280:
			if (!Global_3)
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	{
		func_30(iParam0, iParam1, iParam2);
	...
	if (!func_32(Global_98359[iParam0 /*98*/], 0))
	{
		func_30(iParam0, iParam1, iParam2);
		iParam1->f_91 = iParam2;
		return 1;
	...
	if (iParam2 != 0)
	{
		func_30(iParam0, iParam1, iParam2);
		iParam1->f_91 = iParam2;
		if (Global_98359[iParam0 /*98*/] != *iParam1)
		{
			*iParam1 = { Global_98359[iParam0 /*98*/] };
			iParam1->f_91 = 0;
			return 0;
		}
	}
		...
		switch (iParam0)
		{
			...
			case 1:
				...
				if (iVar0 < 5)
				{
					...
					*uParam2 = Global_94158[iVar0 /*9*/].f_6;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_49(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_49(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_49(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
