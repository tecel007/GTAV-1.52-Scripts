...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBJS", 8);
	StringCopy(&cLocal_236, "JESSE", 16);
	StringCopy(&cLocal_202, "Special_Ped@jessie", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = true;
	iLocal_252 = 15;
	sLocal_303 = "PBJS_INTERACT";
	StringCopy(&cLocal_312, "PBJS_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBJS_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBJS_CONV_GF", 16);
