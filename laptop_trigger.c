...
void __EntryFunction__()
{
	...
	vLocal_133 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, vLocal_130) };
	Global_1676237 = 0;
	Global_1676347 = 0;
	while (bVar28)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_127))
		{
			if (bLocal_118)
			{
				...
				{
					if (!func_238(&uLocal_121))
					{
						func_237(&uLocal_121, 1, 0);
					}
				}
			}
			if (Global_1676237 && (func_236(PLAYER::PLAYER_ID()) || func_235(PLAYER::PLAYER_ID())))
			{
				if (!func_238(&uLocal_125))
				{
					func_237(&uLocal_125, 0, 0);
				}
				else if (func_234(&uLocal_125, 10000, 0))
				{
					func_233(&uLocal_125);
					Global_1676237 = 0;
				}
			...
			if (Global_1590386)
			{
				if (!bVar0)
				{
					iVar32 = ENTITY::GET_ENTITY_MODEL(iLocal_127);
					if (iVar32 == joaat("PROP_LAPTOP_01A"))
					{
						...
						vVar33 = { ENTITY::GET_ENTITY_ROTATION(iLocal_127, 2) };
						iLocal_127 = OBJECT::CREATE_OBJECT(joaat("PROP_LAPTOP_LESTER2"), ENTITY::GET_ENTITY_COORDS(iLocal_127, true), false, true, false);
						ENTITY::SET_ENTITY_ROTATION(iLocal_127, vVar33, 2, true);
						bVar0 = true;
					}
				}
			}
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(iLocal_127, 0))
			{
				func_242();
				SCRIPT::TERMINATE_THIS_THREAD();
			}
		}
		if (((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::DOES_ENTITY_EXIST(iLocal_127)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_127))
			{
				bVar36 = false;
				...
				if (((func_226() || func_225(PLAYER::PLAYER_ID())) || func_235(PLAYER::PLAYER_ID())) || func_224())
				{
					vVar39 = { 1f, 1f, 0.9f };
				}
				else if (func_223())
				...
				bVar42 = func_222(PLAYER::PLAYER_ID());
				if (((((((((((((((((!bVar36 && !Global_31037) && !func_221(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && !func_220()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar29, vVar39, false, true, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_127)) && !MISC::IS_BIT_SET(Global_2359302, 15)) && !func_219()) && !(Global_76622 && func_218())) && !(!Global_76622 && func_217())) && !((Global_76622 && MISC::IS_BIT_SET(Global_4456448.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_76622 && func_216()) && func_215())) && !(Global_76622 && func_213(PLAYER::PLAYER_ID()) == 5)) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) && !Global_75434) && !func_210()) && (!func_223() || func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 90f)))
				{
					if ((!func_208(Global_1590535[PLAYER::PLAYER_ID() /*876*/].f_274.f_28) && !func_207(Global_1590535[PLAYER::PLAYER_ID() /*876*/].f_274.f_28, -1)) && !func_206(PLAYER::PLAYER_ID()))
					{
						if (bLocal_119 != bVar42)
						{
							if ((func_236(PLAYER::PLAYER_ID()) || func_205(PLAYER::PLAYER_ID())) || func_235(PLAYER::PLAYER_ID()))
							{
								if (iLocal_116 != -1)
								{
									func_204(&iLocal_116);
						...
						if (iLocal_116 == -1)
						{
							if (bVar0)
							{
								func_201(&iLocal_116, 1, "MPLA_BILL", 0, 0, 0, 0);
							}
							else if (func_226())
							{
								func_200(bVar42);
							...
							{
								func_201(&iLocal_116, 1, "BROWSEINPUTTRIG", 0, 0, 0, 0);
							}
						}
					}
					if (((iLocal_116 != -1 && func_180(iLocal_116, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179())
					{
						if (iLocal_116 != -1)
						{
							func_204(&iLocal_116);
						...
						if (!bVar0)
						{
							...
							if ((func_178() || func_177()) || func_176())
							{
								func_21(&uLocal_123, 0, 0);
								while (!func_234(&uLocal_123, 500, 0))
								{
									func_227(0);
									SYSTEM::WAIT(0);
								}
							...
							while (bVar43)
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_127) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_127, true), 1.5f, 1.5f, 4f, false, true, 1))
								{
									Global_73828 = 1;
								}
								if (((func_178() || func_177()) || func_206(PLAYER::PLAYER_ID())) || func_176())
								{
									if (!func_20() && !Global_75434)
									{
										bVar43 = false;
									}
								}
								else if (func_20() || Global_73828)
								{
									bVar43 = false;
								}
								if (func_178())
					...
					else if ((((iLocal_116 != -1 && PAD::IS_CONTROL_JUST_PRESSED(2, 52)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_179()) && func_176())
					{
						if (iLocal_116 != -1)
						{
							func_204(&iLocal_116);
						...
						func_170();
						MISC::SET_BIT(&(Global_1676377.f_4), 28);
						while (MISC::IS_BIT_SET(Global_1676377.f_4, 28))
						{
							SYSTEM::WAIT(0);
						}
						func_3();
				...
				else
				{
					...
					if (func_236(PLAYER::PLAYER_ID()) || func_205(PLAYER::PLAYER_ID()))
					{
						if (func_202())
						{
							HUD::CLEAR_HELP(true);
...
void func_3()
{
	...
	if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true) && ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_4(2, &uVar0))
				{
					if (iLocal_128 != 0)
					{
						...
						iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iLocal_127, 2), 2, false, false, 1f, 0f, 1f);
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar0, "exit", 8f, -4f, 5, 0, 1000f, 0);
...
int func_4(int iParam0, char* sParam1)
{
	...
	if ((!func_236(PLAYER::PLAYER_ID()) && !func_235(PLAYER::PLAYER_ID())) && !func_5(PLAYER::PLAYER_ID()))
	{
		StringCopy(sParam1, "", 64);
		return 0;
	}
...
int func_5(int iParam0)
{
	if (iParam0 != func_8())
	{
		if (func_7(iParam0, 1, 1))
		{
			...
			{
				return func_6(Global_2425662[iParam0 /*421*/].f_310.f_5) == 13;
			}
		}
	}
	return 0;
...
void func_23()
{
	if ((!func_25() && !func_24()) && Global_2451425)
	{
...
int func_29(int iParam0, bool bParam1, int iParam2)
{
	...
	if (Global_76622 && func_218())
	{
		return 0;
	}
	if (!Global_76622 && func_217())
	{
		return 0;
	}
	if (bVar0)
...
int func_32(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	...
	if (func_34(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		...
		{
			Global_8063 = iParam6;
			Global_7966[3 /*6*/] = { func_33(iParam0) };
			Global_8043 = iParam0;
...
int func_34(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_19665)
	{
		...
		{
			func_42(Global_19467, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_39(1);
			func_42(Global_19467, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19466), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	func_35(iParam0, sParam1);
	return 1;
}

void func_35(int iParam0, char* sParam1)
{
	if (!func_36())
	{
		return;
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2460675)
							{
								if (iVar1 == 14)
								{
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_21868), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1 /*15*/].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_21873), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76622)
								{
									...
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_40(Global_19467, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7363[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7363[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
void func_46()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_47(Global_111638.f_14136[iVar2 /*104*/].f_18, Global_111638.f_14136[Global_21872 /*104*/].f_18))
		{
			Global_21872 = iVar2;
		}
		iVar2++;
...
void func_51()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_54(Global_111638.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_52(iVar0) && (!func_241(14) || Global_110589))
			{
...
int func_72(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (MISC::IS_BIT_SET(Global_1590535[bParam0 /*876*/].f_142, 2) || MISC::IS_BIT_SET(Global_1590535[bParam0 /*876*/].f_142, 5))
	{
		return 0;
	}
	if (func_80(bParam0))
...
int func_78(bool bParam0, int iParam1, bool bParam2)
{
	if (iParam1 != func_8())
	{
		...
		if (Global_1628237[bParam0 /*615*/].f_11 != func_8())
		{
...
{
	return Global_1628237[bParam0 /*615*/].f_11.f_23;
}
...
int func_85()
{
	...
	while (iVar0 < 7)
	{
		if (Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11.f_11[iVar0] == func_8())
		{
			StringCopy(&Var17, "", 64);
...
void func_97(char* sParam0, bool bParam1)
{
	struct<16> Var0;
	bool bVar16;
...
void func_102(int iParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
	...
	if (func_104())
	{
		iVar0 = Global_2584899[iParam0 /*3*/][func_103(iParam3)];
		iVar1 = Global_2584899[iParam1 /*3*/][func_103(iParam3)];
		if (iVar0 != 0 && iVar1 != 0)
		{
			StringCopy(&cVar2, "", 32);
...
struct<16> func_107(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2584899[iParam0 /*3*/][func_103(iParam2)];
	iVar1 = Global_2584899[iParam1 /*3*/][func_103(iParam2)];
...
void func_108()
{
	...
	while (iVar0 <= 3)
	{
		if (Global_2439138.f_2723[iVar0 /*80*/].f_2 != 0)
		{
			...
			func_109(&(Global_2439138.f_2723[iVar0 /*80*/].f_69), 1);
		}
		iVar0++;
	}
}
...
void func_112(bool bParam0, bool bParam1, int iParam2)
{
	...
	if (Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11 != PLAYER::PLAYER_ID())
	{
		...
		func_153(Var11);
		func_152();
		if (func_151(10017, -1, 0) <= 0)
		{
			iVar6 = NETWORK::GET_CLOUD_TIME_AS_INT();
		}
		else
		{
			iVar6 = (func_151(10017, -1, 0) - 43200);
		}
		func_148(iVar6);
		...
		if (Global_2537071.f_5124.f_255 != func_8())
		{
			Global_2537071.f_5124.f_255 = func_8();
		}
		...
		if (iParam2 != 1)
		{
			...
			{
				bVar27 = false;
				iVar28 = func_151(10014, -1, 0);
				if (!MISC::IS_BIT_SET(iVar28, 11))
				{
					MISC::SET_BIT(&iVar28, 11);
					func_128(10014, iVar28, -1, 1, 0);
					bVar27 = true;
				}
		...
		if (iParam2 == 1)
		{
			STATS::_0x0B565B0AAE56A0E8(func_116(func_117()), func_115(func_117()), func_114(), func_113(), Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11.f_451, 4, Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11.f_489);
		}
	}
}
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_33(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_33(iParam0) };
...
void func_128(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0 /*3*/][func_103(iParam2)];
	if (iVar0 != 0)
	{
...
void func_134(int iParam0, int iParam1, bool bParam2)
{
	if (func_141())
	{
		if (iParam1 == 1)
		{
			...
			func_21(&(Global_2537071.f_4393), 0, 0);
			if (bParam2)
			{
				...
				func_21(&(Global_2537071.f_4396), 0, 0);
			}
			else
			{
				Global_1312418 = 0;
...
void func_143(bool bParam0)
{
	...
	if (MISC::IS_BIT_SET(Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11.f_100, bParam0))
	{
		...
		func_144(1, bParam0);
		MISC::CLEAR_BIT(&(Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_11.f_100), bParam0);
	}
}
...
int func_147(bool bParam0, int iParam1)
{
	if (iParam1 != func_8())
	{
		if (Global_1628237[bParam0 /*615*/].f_11.f_26 != func_8())
		{
			return iParam1 == Global_1628237[bParam0 /*615*/].f_11.f_26;
		}
	}
	return 0;
}
...
void func_148(int iParam0)
{
	...
	if (func_151(10017, -1, 0) != func_149(PLAYER::PLAYER_ID()))
	{
		func_128(10017, func_149(PLAYER::PLAYER_ID()), -1, 1, 0);
	}
}
...
int func_151(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0 /*3*/][func_103(iParam1)];
...
void func_156(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (func_104())
	{
		iVar0 = Global_2583656[iParam0 /*3*/][func_103(iParam2)];
		if (iVar0 != 0)
		{
...
int func_164(bool bParam0)
{
	...
	if (func_7(bParam0, 0, 1))
	{
		if (Global_1628237[bParam0 /*615*/].f_11.f_180 != -1)
		{
			iVar0 = Global_1628237[bParam0 /*615*/].f_11.f_180;
		}
		else
		{
...
bool func_169(bool bParam0, bool bParam1)
{
	...
	return Global_1628237[bParam0 /*615*/].f_11 != func_8();
}
...
void func_170()
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
		vVar16 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_127, 0.0328f, -0.8f, 0.3f) };
		bVar19 = false;
		func_233(&uLocal_123);
		if (func_4(0, &uVar0))
		{
			...
			{
				func_227(0);
				if (!func_238(&uLocal_123))
				{
					func_237(&uLocal_123, 0, 0);
				}
				else if (func_234(&uLocal_123, 4000, 0))
				{
					bVar19 = true;
				}
				if (!func_175(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar16, 0.05f, 0) && !func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 5f))
				{
					if (!func_172(PLAYER::PLAYER_PED_ID(), 2106541073))
					{
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar16, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iLocal_127), 0.25f);
					}
				}
				else
				{
				...
				GRAPHICS::DRAW_DEBUG_LINE(vVar16, ENTITY::GET_ENTITY_COORDS(iLocal_127, true), 0, 255, 0, 255);
...
void func_171(int iParam0)
{
	...
	switch (iLocal_128)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&uVar0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&uVar0))
				{
					...
					iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar0, "enter", 4f, -2f, 5, 0, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
					STREAMING::REMOVE_ANIM_DICT(&uVar0);
					iLocal_128 = 1;
				}
		...
		case 1:
			...
			iVar50 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_129);
			if (!bLocal_120)
			{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&uVar16) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar50) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar50) >= 0.96f))
			{
				...
				if ((((MISC::ARE_STRINGS_EQUAL(&cLocal_136, "idle_a") && iVar51 == 0) || (MISC::ARE_STRINGS_EQUAL(&cLocal_136, "idle_b") && iVar51 == 1)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_136, "idle_c") && iVar51 == 2)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_136, "idle_d") && iVar51 == 3))
				{
					iVar51++;
					if (iVar51 >= iVar49)
					{
				...
				iLocal_129 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1f, 0f, 1f);
				switch (iVar51)
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar16, "idle_a", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
						StringCopy(&cLocal_136, "idle_a", 16);
						iLocal_128 = 3;
						break;
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar16, "idle_b", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
						StringCopy(&cLocal_136, "idle_b", 16);
						iLocal_128 = 3;
						break;
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar16, "idle_c", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
						StringCopy(&cLocal_136, "idle_c", 16);
						iLocal_128 = 3;
						break;
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar16, "idle_d", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
						StringCopy(&cLocal_136, "idle_d", 16);
						iLocal_128 = 3;
						break;
					default:
						StringCopy(&cLocal_136, "idle_XXX", 16);
						break;
				}
			}
			break;
		case 3:
			...
			iVar50 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_129);
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_129) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar50))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_129))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(iLocal_129);
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_129, &uVar16, sVar48, 4f, -2f, 5, 0, 1000f, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_129);
				iLocal_128 = 3;
				return;
			}
...
bool func_176()
{
	return MISC::IS_BIT_SET(Global_1676377.f_461, 30);
}
...
int func_177()
{
	...
	{
		if (MISC::IS_BIT_SET(Global_1676377.f_461, 0) || MISC::IS_BIT_SET(Global_1676377.f_461, 2))
		{
			return 1;
		}
	}
...
{
	if (((func_176() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
		func_201(&iLocal_116, 2, "ARENAWHINPUT", 0, 0, 0, 0);
	}
}
...
{
	if ((((func_206(PLAYER::PLAYER_ID()) && func_193(PLAYER::PLAYER_ID()) == func_192(PLAYER::PLAYER_ID())) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
		if (func_190())
		{
		...
		else if (!bParam0)
		{
			...
			{
				func_201(&iLocal_116, 1, "WHSECUROMAXVIP", 0, 0, 0, 0);
			}
			else if (func_163(PLAYER::PLAYER_ID()))
			{
				func_201(&iLocal_116, 1, "PIM_EXECH0x1", 0, 0, 0, 0);
			}
			...
			{
				func_201(&iLocal_116, 1, "SECINPUTTREGLAP", 0, 0, 0, 0);
			}
		}
		...
		else if ((func_238(&uLocal_121) && func_234(&uLocal_121, 10000, 1)) || !bLocal_118)
		{
			if (func_185(PLAYER::PLAYER_ID()) || Global_1676237 == 1)
			{
				bLocal_118 = true;
				if (!Global_1676237)
				{
			...
			else
			{
				...
				bLocal_118 = false;
				func_233(&uLocal_121);
				func_201(&iLocal_116, 1, "WHSECUROINPUT", 0, 0, 0, 0);
			}
		}
		else if (bLocal_118)
		{
...
int func_193(int iParam0)
{
	if (func_206(iParam0))
	{
		return func_194(Global_2425662[iParam0 /*421*/].f_310.f_5);
	}
	return 0;
}
...
{
	if (((((func_205(PLAYER::PLAYER_ID()) || func_177()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237) && func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 90f))
	{
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		{
			func_189("WHSECUROBLCK");
		...
		{
			if ((func_238(&uLocal_121) && func_234(&uLocal_121, 10000, 1)) || !bLocal_118)
			{
				if (func_196(PLAYER::PLAYER_ID()) || Global_1676237 == 1)
				{
					bLocal_118 = true;
					if (!Global_1676237)
					{
				...
				else
				{
					...
					bLocal_118 = false;
					func_233(&uLocal_121);
					func_201(&iLocal_116, 1, "BIKERWHINPUT", 0, 0, 0, 0);
				}
			}
			else if (bLocal_118)
			{
		...
		{
			func_201(&iLocal_116, 1, "BIKERWHBLCKA", 0, 0, 0, 0);
		}
		else
		{
...
int func_198()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
		if (func_235(PLAYER::PLAYER_ID()) || func_199(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
...
{
	if (func_207(Global_1590535[iParam0 /*876*/].f_274.f_28, -1))
	{
		return 1;
	}
	return 0;
...
{
	if (((func_178() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
		if (func_190())
		{
			func_189("WHPRIVSESLAP");
		...
		{
			if (func_239(PLAYER::PLAYER_ID()) || Global_1676237 == 1)
			{
				bLocal_118 = true;
				if (!Global_1676237)
				{
...
{
	if (func_207(Global_1590535[iParam0 /*876*/].f_274.f_28, -1) && !MISC::IS_BIT_SET(Global_1590535[iParam0 /*876*/].f_274.f_26, 1))
	{
		return 1;
	}
	return 0;
...
int func_206(bool bParam0)
{
	if (bParam0 != func_8())
	{
		if (func_7(bParam0, 1, 1))
		{
			...
			{
				return func_6(Global_2425662[bParam0 /*421*/].f_310.f_5) == 1;
			}
		}
	}
	return 0;
...
int func_209(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
int func_210()
{
	if (func_212(PLAYER::PLAYER_ID()) == 150 && func_211(PLAYER::PLAYER_PED_ID(), 3084.511f, -4686.664f, 26.2522f, 50f))
	{
		return 1;
	}
	return 0;
...
bool func_211(int iParam0, vector3 vParam1, float fParam4)
{
...
int func_223()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127) && func_5(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_224()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127) && func_206(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
int func_226()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
		if (ENTITY::GET_ENTITY_MODEL(iLocal_127) == joaat("EX_PROP_MONITOR_01_EX") || func_236(PLAYER::PLAYER_ID()))
		{
			return 1;
		}
	}
...
int func_235(bool bParam0)
{
	if (bParam0 != func_8())
	{
		if (func_7(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_6(Global_2425662[bParam0 /*421*/].f_310.f_5) == 2;
			}
		}
	}
	return 0;
...
int func_236(bool bParam0)
{
	if (bParam0 != func_8())
	{
		if (func_7(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_6(Global_2425662[bParam0 /*421*/].f_310.f_5) == 0;
			}
		}
	}
	return 0;
...
{
	return func_240(func_187(iParam0));
}
