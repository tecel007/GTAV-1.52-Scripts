...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_269(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
	iVar64[0] = 31;
	if (!func_250(&iVar64, &Var0, vVar61, 1f))
	{
		func_249();
	...
	while (true)
	{
		...
		func_192(Var0);
		func_184(&iLocal_93, &(Var0.f_9), vVar61);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
void func_184(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_188(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_187(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_188(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_190(iParam0);
				}
			}
...
int func_193(var uParam0, bool bParam1)
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_222(*uParam0))
					{
						...
						if (func_205(uParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_198(uParam0);
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_208(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_208(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_209(iParam4, iParam7) };
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_213(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_213(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_212(vVar3, vVar0);
...
int func_219(int iParam0, float fParam1)
{
	...
	{
		if (func_220(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_220(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_213(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_229() && Global_98955.f_11 == 6) && iParam0 == func_167(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_232(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { 2729.092f, 4143.17f, 41.36332f };
			iParam0->f_17[1 /*3*/] = { 2714.735f, 4145.382f, 45.30732f };
			iParam0->f_24 = 12.8f;
			iParam0->f_27 = 0;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "MAUDE_MCS_1", 24);
			func_238(31, 1, 1);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
		...
		case 2:
			...
			{
				func_236(&(iParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				func_236(&(iParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (!func_233(&(iParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
			...
			break;
		case 3:
			if (func_126(iParam0->f_28[0]) && func_127(iParam0->f_41[0]))
			{
				iParam0->f_59 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iParam0->f_59, true);
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iParam0->f_59, false);
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], iParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1000f, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iParam0->f_41[0], iParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1000f);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
int func_233(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_234(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_234(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_236(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_199(iParam0);
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, false, true, true, true);
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_251((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_251((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_251(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_252(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_252(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_255(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_263(iParam0, iParam1);
	func_259(iParam0, bParam2);
	func_256(iParam0, bParam3);
}

void func_256(int iParam0, bool bParam1)
{
	func_257(&(iParam0->f_41), bParam1);
}
...
void func_267(int iParam0)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iParam0->f_59))
	{
		...
		{
			if (func_268(iParam0->f_28[0], 1785177548))
			{
		...
		{
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iParam0->f_41[0], -1000f, true);
		}
	}
}
