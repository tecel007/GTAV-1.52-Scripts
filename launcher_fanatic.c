	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0 /*10*/].f_9 != -1)
			{
				...
				func_289(&(Global_110725[Var0 /*10*/].f_9));
			}
		}
		func_274(&Var0, 1);
	}
...
int func_207(var uParam0, bool bParam1)
{
	...
	if ((func_244(*uParam0) || func_242(*uParam0)) || Global_76867 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_243() && Global_98744.f_11 == 6) && iParam0 == func_166(&(Global_98744.f_3), 0))
	{
		return 1;
	}
	return 0;
