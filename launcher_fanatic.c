...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_289(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_274(&Var0, 1);
	}
	if (!func_271(&iVar64, &Var0, vVar61, 1f))
	{
		func_270();
	...
	while (true)
	{
		...
		func_206(Var0);
		func_199(&iLocal_94, &(Var0.f_9), vVar61);
		if (iLocal_95 == 0)
		{
			if (Var0 == 22)
			{
		...
		if (Var0 == 21)
		{
			func_195(&Var0, vVar61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_190(&Var0, vVar61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800 /* Float: 20f */);
		}
		else if (Var0 == 23)
		{
			if (iLocal_96 == 0)
			{
				if (func_195(&Var0, vVar61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_96 = 1;
				}
			}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_189(iParam3), false);
}
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(PLAYER::PLAYER_PED_ID()) && func_198(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		else if (func_196(sParam5))
		{
			...
			{
				if (func_194(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_143();
				}
			}
...
void func_199(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_194(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_202(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_194(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_204(iParam0);
				}
			}
...
int func_207(var uParam0, bool bParam1)
{
	...
	if ((func_244(*uParam0) || func_242(*uParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_236(*uParam0))
					{
						...
						if (func_219(uParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_212(uParam0);
...
bool func_221(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_222(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_222(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_223(iParam4, iParam7) };
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_227(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_227(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_226(vVar3, vVar0);
...
Vector3 func_227(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_234(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_227(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_243() && Global_98955.f_11 == 6) && iParam0 == func_166(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_247(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_15 = 14f;
			iParam0->f_27 = 1;
			StringCopy(&(iParam0->f_9), "EF_3_RCM_CONCAT", 24);
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
			...
			func_253(&(iParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_252(&iVar0) || !func_251(&(iParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (func_248(&(iParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
					ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0->f_28[0], -915.6f, 6139.192f, 5.525f, true, false, true);
					ENTITY::SET_ENTITY_ROTATION(iParam0->f_28[0], 2.52f, 0f, 111.24f, 0, false);
				}
				else
				{
					bVar7 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[0]))
			{
				...
				iParam0->f_41[0] = OBJECT::CREATE_OBJECT(iVar0[1], vVar8, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0->f_41[0], -916.6389f, 6137.046f, 4.7157f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[0], 1.7f, 19.1067f, 79.515f, 0, true);
				ENTITY::SET_ENTITY_QUATERNION(iParam0->f_41[0], -0.0949f, 0.1369f, 0.6325f, 0.7564f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
			{
				...
				iParam0->f_41[1] = OBJECT::CREATE_OBJECT(iVar0[2], vVar8, true, true, false);
				ENTITY::FREEZE_ENTITY_POSITION(iParam0->f_41[1], true);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[1], -6.625818f, 1.30159f, -1.248891f, 0, false);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[2]))
			{
				vVar8 = { -915.6122f, 6137.662f, 4.6129f };
				iParam0->f_41[2] = OBJECT::CREATE_OBJECT(iVar0[3], vVar8, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0->f_41[2], -915.6122f, 6137.662f, 4.6129f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[2], -1.6843f, 2.1363f, -0.0913f, 0, true);
				ENTITY::SET_ENTITY_QUATERNION(iParam0->f_41[2], -0.0147f, 0.0187f, -0.0011f, 0.9997f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[3]))
			{
				...
				iParam0->f_41[3] = OBJECT::CREATE_OBJECT(iVar0[4], vVar8, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0->f_41[3], -915.4199f, 6137.855f, 4.6221f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_41[3], -5.793f, 1.496f, -36.333f, 2, true);
				ENTITY::SET_ENTITY_QUATERNION(iParam0->f_41[3], -0.0439f, 0.0281f, -0.312f, 0.9487f);
...
int func_248(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
int func_249(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_254(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_25 = 1;
			iParam0->f_26 = 1;
			StringCopy(&(iParam0->f_9), "EF_2_RCM", 24);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
			...
			func_253(&(iParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_252(&iVar0) || !func_251(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (!func_248(&(iParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_258(&(iParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_198(iParam0->f_28[1]))
				{
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[1], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(iParam0->f_28[1], 4, 1, 0, 0);
					PED::SET_PED_PROP_INDEX(iParam0->f_28[1], 0, 0, 0, false);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iParam0->f_28[1], true);
					PED::SET_PED_LOD_MULTIPLIER(iParam0->f_28[1], 3.5f);
				}
				else
				{
					bVar5 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				func_256(&(iParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[1]))
			{
				func_256(&(iParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_198(iParam0->f_35[iVar4]))
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[iVar4], iVar4);
				}
				iVar4++;
			}
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_198(iParam0->f_28[1]))
				{
					TASK::TASK_PLAY_ANIM(iParam0->f_28[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0f, false, false, false);
...
void func_256(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_257(iParam0);
...
void func_258(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_259(iParam0);
...
int func_260(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_15 = 14f;
			iParam0->f_27 = 1;
			StringCopy(&(iParam0->f_9), "EF_1_RCM", 24);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
			...
			func_253(&(iParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
			iParam0->f_48.f_5 = { -1878.223f, -440.5181f, 46.03983f };
			iParam0->f_48.f_8 = { 0f, 0f, 159.97f };
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_252(&iVar0) || !func_251(&(iParam0->f_48)))
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (func_248(&(iParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_271(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_272((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_272((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_272(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_273(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_273(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_279(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_286(iParam0, iParam1);
	func_283(iParam0, bParam2);
	func_280(iParam0, bParam3);
}

void func_280(int iParam0, bool bParam1)
{
	func_281(&(iParam0->f_41), bParam1);
}
