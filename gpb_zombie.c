...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_31231 + 10000 && !func_107())
	{
		func_114(0);
	}
	StringCopy(&cLocal_404, "", 64);
	iLocal_299[0] = 1;
	iLocal_299[1] = 1;
	iLocal_299[2] = 1;
	func_106();
	...
	Global_31231 = MISC::GET_GAME_TIMER();
	MISC::CLEAR_AREA_OF_PEDS(vLocal_242, 0.5f, 0);
	iLocal_240 = PED::CREATE_PED(25, iLocal_36, vLocal_242, ScriptParam_0.f_17[0], false, true);
	func_104();
	...
	MemCopy(&cLocal_304, {cLocal_234}, 4);
	StringConCat(&cLocal_304, "AUD", 16);
	MemCopy(&cLocal_308, {cLocal_234}, 4);
	StringConCat(&cLocal_308, "_RAND_", 16);
	iLocal_250 = 0;
	iLocal_298 = -1;
	iVar0 = 1;
	iVar30 = 0;
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_506)
		{
			...
			StringIntConCat(&cVar44, Global_111803[iLocal_251], 64);
			...
			StringIntConCat(&cVar44, iLocal_255[Global_111803[iLocal_251]], 64);
			GRAPHICS::DRAW_DEBUG_TEXT_2D(&cVar44, 0.02f, 0.83f, 0f, 0, 0, 255, 255);
		}
		vVar76 = { ENTITY::GET_ENTITY_COORDS(iLocal_240, true) };
		if (((ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_240) && !iLocal_250 == 25) && !iLocal_250 == 5) && !iLocal_250 == 6)
		{
			...
			{
				func_92();
				TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &cLocal_218, 2f, -2f, -1, 0, 0f, false, false, false);
				iLocal_250 = 25;
			}
			else
			{
			...
			AUDIO::_PLAY_AMBIENT_SPEECH1(iLocal_240, "GENERIC_CURSE_MED", "SPEECH_PARAMS_FORCE", true);
		}
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_240)) && fVar43 < 25f) && func_89(PLAYER::PLAYER_PED_ID()) != joaat("WEAPON_UNARMED")) && func_86(iLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 0))
			{
				if (!func_90())
				{
					func_92();
		...
		if (((((PED::IS_PED_INJURED(iLocal_240) || MISC::IS_BULLET_IN_AREA(vVar76, 50f, true)) || MISC::IS_BULLET_IN_AREA(vVar76, 50f, false)) || MISC::IS_PROJECTILE_IN_AREA(vVar76, 20f, 20f, 20f, false)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar76, 50f)) || GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(vVar76, 1f))
		{
			if (!func_90())
			{
				func_92();
		...
		switch (iLocal_250)
		{
			...
			case 5:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_240, vLocal_242, 1f, -1, 1f, 1024, ScriptParam_0.f_17[0]);
					iLocal_250 = 6;
				}
				break;
			case 6:
			...
			case 8:
				...
				else if (!func_63())
				{
					...
					if (iLocal_297 < iLocal_255[Global_111803[iLocal_251]] && bVar39)
					{
						func_64();
						iLocal_250 = 7;
					}
				...
				else if (bLocal_440 == 1)
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_240, &Local_372, &Local_356, 3))
					{
						func_53(Global_111803[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_111803[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_111803[iLocal_251] = uLocal_504;
					}
					else
					{
						Global_111803[iLocal_251]++;
					}
					if (!Global_111803[iLocal_251] < iLocal_252)
					{
						Global_111803[iLocal_251] = 0;
					}
					func_102(0, 1);
					iLocal_250 = 0;
				}
			...
			case 13:
				...
				func_51(&uVar1);
				func_50(&uLocal_37, 0, PLAYER::PLAYER_PED_ID(), &uVar1, 0, 1);
				func_50(&uLocal_37, 3, iLocal_240, &cLocal_236, 0, 1);
				func_49(&cVar5);
			...
			case 10:
				...
				{
					func_28(&cLocal_404);
					func_27(iLocal_246, &cVar31);
					StringConCat(&cLocal_404, &cVar31, 64);
				}
				else
				{
					func_26(&cLocal_404);
				...
				STREAMING::REQUEST_ANIM_DICT(&cLocal_404);
				iVar35 = 0;
				if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_404))
				{
					if (bLocal_437)
					{
						iVar35 = 1;
			...
			case 11:
				...
				{
					func_24(&uVar13);
					TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_404, &uVar13, 2f, -2f, -1, 0, 0f, false, false, false);
					iLocal_250 = 12;
				}
				else
				{
			...
			case 15:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_404))
				{
					...
					if (!func_63())
					{
						...
						UNK_0x1082C25039B168F8(&Local_420);
						if (!bLocal_438)
						{
							func_28(&cLocal_404);
							func_27(iLocal_246, &cVar31);
						...
						func_24(&uVar13);
						TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_404, &uVar13, 1000f, -1000f, -1, 0, 0f, false, false, false);
						PED::_0x2208438012482A1A(iLocal_240, false, false);
						iLocal_250 = 12;
					}
				}
...
int func_8()
{
	if (Global_111803[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_110809))
			{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_53(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
		if ((iParam1 == 3 && !bLocal_449) && fParam2 >= 0.773f)
		{
		...
		if ((iParam1 == 12 && bLocal_449) && fParam2 >= 0.116f)
		{
			ENTITY::DETACH_ENTITY(iLocal_448, true, true);
			OBJECT::DELETE_OBJECT(&iLocal_448);
			bLocal_449 = false;
...
void func_54()
{
	UNK_0x1082C25039B168F8(&Local_388);
}
...
void func_55()
{
	...
	func_58(Global_111803[iLocal_251] + 1, &uVar0, &Var8);
	...
	PED::_0x2208438012482A1A(iLocal_240, false, false);
	func_56(Global_111803[iLocal_251]);
}
...
bool func_59()
{
	...
	Var0 = { cLocal_308 };
	StringIntConCat(&Var0, Global_111803[iLocal_251] + 1, 16);
	func_50(&uLocal_37, 3, iLocal_240, &cLocal_236, 0, 1);
	if (bLocal_437)
	{
		bVar4 = true;
	...
	{
		bVar4 = func_34(&uLocal_37, &cLocal_304, &Var0, 3, 0, 0, 0);
	}
	Local_500 = { Var0 };
	return bVar4;
}
...
void func_67(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_111803[iLocal_251] + 1, 16);
}
...
void func_69(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_78(iParam0))
		{
			if (!func_76(iParam0))
			{
				MISC::SET_BIT(&(Global_111858.f_26430.f_2), iVar0);
				if (!bParam1)
				{
...
void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	int iVar0;
...
int func_76(int iParam0)
{
	if (func_78(iParam0))
	{
		return MISC::IS_BIT_SET(Global_111858.f_26430.f_2, iParam0);
	}
	return 0;
}
...
int func_77(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return MISC::IS_BIT_SET(Global_111858.f_26430.f_2, iVar0);
	}
	return 0;
}
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_88(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_88(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_87(vVar3, vVar0);
...
Vector3 func_88(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_98(int iParam0)
{
	...
	func_101(&(Global_111858.f_20113), iParam0);
...
void func_102(int iParam0, bool bParam1)
{
	...
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &cLocal_218, 1000f, 1000f, -1, 0, 0f, false, false, false);
	}
	Local_356 = { cLocal_218 };
	if (bParam1)
	{
...
void func_106()
{
	...
	StringCopy(&cLocal_234, "PBZB", 8);
	StringCopy(&cLocal_236, "ZOMBIE", 16);
	StringCopy(&cLocal_202, "Special_Ped@zombie", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBZB_INTERACT";
	StringCopy(&cLocal_312, "PBZB_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBZB_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBZB_CONV_GF", 16);
...
{
	return func_112(Global_111858.f_20113, iParam0);
}
...
void func_114(int iParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_404))
	{
		UNK_0x1082C25039B168F8(&cLocal_404);
	}
	if (iLocal_249 == 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_324))
		{
			...
			{
				UNK_0x1082C25039B168F8(&cLocal_324);
			}
		}
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_340))
		{
			...
			{
				UNK_0x1082C25039B168F8(&cLocal_340);
			}
		}
	}
	if (iLocal_298 != -1)
...
void func_119()
{
	if (iLocal_245 == -1)
	{
		iLocal_245 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(vLocal_242, 2f, 2f, 2f, 0f, false, 1);
	}
}
