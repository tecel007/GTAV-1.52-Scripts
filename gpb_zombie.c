...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_31031 + 10000 && !func_107())
	{
		func_114(0);
	}
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (!func_63())
				{
					...
					if (iLocal_297 < iLocal_255[Global_111583[iLocal_251]] && bVar39)
					{
						func_64();
						iLocal_250 = 7;
					}
				...
				else if (bLocal_440 == 1)
				{
					...
					{
						func_53(Global_111583[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_111583[iLocal_251] = uLocal_504;
					}
					else
					{
...
int func_8()
{
	if (Global_111583[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_111638.f_2358.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_110589))
			{
...
void func_55()
{
	...
	func_58(Global_111583[iLocal_251] + 1, &uVar0, &Var8);
...
{
	return func_112(Global_111638.f_20112, iParam0);
}
...
void func_114(int iParam0)
{
	...
	{
		STREAMING::REMOVE_ANIM_DICT(&cLocal_404);
	}
	if (iLocal_249 == 1)
	{
