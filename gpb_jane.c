...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_31231 + 10000 && !func_106())
	{
		func_114(0);
	}
...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBJA", 8);
	StringCopy(&cLocal_236, "JANE", 16);
	StringCopy(&cLocal_202, "Special_Ped@jane", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 7;
	sLocal_303 = "PBJA_INTERACT";
	StringCopy(&cLocal_312, "PBJA_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBJA_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBJA_CONV_GF", 16);
...
void func_118()
{
	if (iLocal_449 == 1)
	{
		...
		{
			UNK_0x1082C25039B168F8(sLocal_448);
		}
	}
}
