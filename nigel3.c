...
void __EntryFunction__()
{
	...
	{
		func_582(&bLocal_176, &(Local_96.f_28[0]));
	}
...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_176))
	{
		if (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_176) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_176))
		{
			func_581(&bLocal_176);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_177))
	{
		if (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_177) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_177))
		{
			func_205(&iLocal_178);
			func_581(&bLocal_177);
		}
...
void func_51(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			iVar0 = func_56(bParam0, iParam2, iParam3, iParam1);
			if (func_52(ENTITY::GET_ENTITY_MODEL(bParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(bParam0, 0, iParam2, iParam3)))
			{
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (bVar1 != -1 && bVar1 != 0)
	{
		...
		{
			return func_58(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 3);
		}
		else if (iVar0 == joaat("MP_F_FREEMODE_01"))
		{
			return func_58(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 4);
		}
	}
...
void func_228(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_232(int iParam0, struct<2> Param1, Vector3 vParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	switch (iLocal_158)
	{
		case 0:
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_283) && STREAMING::HAS_MODEL_LOADED(iLocal_292)) && func_235(Local_165))
			{
				...
				if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(bLocal_175))
				{
					MISC::SET_INSTANCE_PRIORITY_HINT(0);
					func_281();
					VEHICLE::_0xBE5C1255A1830FF5(Local_165, true);
					ENTITY::DETACH_ENTITY(bLocal_175, false, true);
					ENTITY::SET_ENTITY_VISIBLE(bLocal_175, true, false);
					...
					iLocal_290 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_284, vLocal_287, 2);
					...
					TASK::TASK_SYNCHRONIZED_SCENE(bLocal_175, iLocal_290, sLocal_283, "out_trunk_al", 1000f, -2f, 0, 0, 1000f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_165, iLocal_290, "out_trunk_car", sLocal_283, 1000f, 8f, 0, 1000f);
		...
		case 1:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_290) >= 0.852f && !bLocal_282)
			{
				bVar0 = true;
				...
				if (bVar0)
				{
					vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_283, "out_trunk_trevor", vLocal_284, vLocal_287, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_290), 2) };
			...
			break;
		case 2:
			if ((func_235(PLAYER::PLAYER_PED_ID()) && func_235(bLocal_175)) && func_235(Local_165))
			{
				if (bLocal_281)
				{
					func_281();
				...
				TASK::CLEAR_PED_TASKS(bLocal_175);
				TASK::TASK_SMART_FLEE_PED(bLocal_175, PLAYER::PLAYER_PED_ID(), 3000f, -1, false, false);
				PED::SET_PED_KEEP_TASK(bLocal_175, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_175, true);
...
void func_254(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_256() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_256() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_258(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_256() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_264(int iParam0, int iParam1)
{
	...
	if (func_274(&Global_4271324))
	{
		if (func_272(&Global_4271324, iParam0))
		{
			return 0;
		}
		if (func_265(&Global_4271324, iParam0))
		{
			return 1;
		}
	}
...
void func_268(var uParam0)
{
	...
	func_270(uParam0, (Global_4271323 - 0.5f));
}
						...
						if ((fLocal_633[0] + uLocal_636[0]) > 14f)
						{
							if (bLocal_639[1])
							{
								...
								else
								{
									...
									UNK_0x369FC9C428863FC8(Local_165, 1, 0);
...
void func_285()
{
	...
	switch (iLocal_620)
	{
		case 0:
			...
			break;
		case 1:
			if (func_235(bLocal_175) && MISC::GET_GAME_TIMER() > iLocal_621)
			{
...
void func_286()
{
	if (func_235(bLocal_175))
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_516, "TRUNK_THUMPS", bLocal_175, 0, false, 0);
		iLocal_518 = 0;
	}
}
...
float func_296(bool bParam0, bool bParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_301(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_308() || func_307(Global_4456448.f_129348)) || func_306())
	{
...
int func_302(int iParam0)
{
	if (iParam0 != func_217())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_303(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
bool func_319(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
...
int func_322(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
void func_323(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_393(&(Global_98955.f_3));
				if (iVar10 > -1)
				{
...
{
	func_325(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, sParam1, iParam3, iParam2);
}
...
int func_340(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	char* sVar0;
...
int func_342(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_348(bool bParam0, bool bParam1)
{
	...
	if (func_152(iVar0) && !PED::IS_PED_INJURED(bParam0))
	{
		if (bParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_349(bParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_349(bool bParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(bParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_351(Var11.f_1)) && iVar72 < 51)
			{
...
int func_357(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
Vector3 func_366(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 44:
			...
			break;
		case 45:
			return func_376(Global_101058);
		case 46:
			if (Global_1590519 != func_217())
			{
				if (func_375(Global_1590519))
				{
					return func_368(2, 2);
				}
				else if (func_367(Global_1590519))
				{
...
int func_369(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
int func_394(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_395(Global_111858.f_9081.f_99.f_205[10]);
		case 74:
		case 75:
			return func_395(Global_111858.f_9081.f_99.f_205[8]);
		case 84:
		case 85:
			return func_395(Global_111858.f_9081.f_99.f_205[11]);
		case 90:
			return func_395(Global_111858.f_9081.f_99.f_205[7]);
		case 93:
			return func_395(Global_111858.f_9081.f_99.f_205[9]);
	}
	return 0;
}
...
bool func_401(bool bParam0, vector3 vParam1, float fParam4)
{
				...
				if (!bLocal_534)
				{
					if (iLocal_349 == 3)
					{
						if (!func_401(PLAYER::PLAYER_PED_ID(), vLocal_295, 150f))
						{
							...
							{
								if (ENTITY::DOES_ENTITY_EXIST(bLocal_175))
								{
									AUDIO::ADD_PED_TO_CONVERSATION(5, bLocal_175, "DINAPOLI");
								}
								if (iLocal_349 == 0)
								{
...
bool func_407(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	...
	switch (iLocal_158)
	{
		...
		case 2:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_165, vLocal_295, 6f, 6f, 2f, false, true, 0))
			{
				...
				ENTITY::SET_ENTITY_VISIBLE(bLocal_175, false, false);
			}
			iLocal_158 = 0;
			break;
	}
...
void func_421()
{
	...
	if (STREAMING::HAS_MODEL_LOADED(joaat("U_M_M_ALDINAPOLI")))
	{
		if (func_235(Local_165))
		{
			bLocal_175 = PED::CREATE_PED(26, joaat("U_M_M_ALDINAPOLI"), -59.7094f, -1330.129f, 32.1963f, 0f, true, true);
			PED::SET_PED_NAME_DEBUG(bLocal_175, "NIGEL3_CELEB");
			PED::SET_PED_COMPONENT_VARIATION(bLocal_175, 4, 1, 0, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_175, true);
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_165, -0.2f, -1.8f, -1f) };
			fVar6 = (-90f + ENTITY::GET_ENTITY_HEADING(Local_165));
			vVar3 = { 0f, 0f, fVar6 };
			ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_175, vVar0, false, false, true);
			ENTITY::SET_ENTITY_ROTATION(bLocal_175, vVar3, 2, true);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(bLocal_175, Local_165, 0, 0.2f, -1.8f, 0f, 0f, 0f, 90f, false, false, false, false, 2, true);
			ENTITY::SET_ENTITY_VISIBLE(bLocal_175, false, false);
			func_228(&uLocal_350, 5, bLocal_175, "DINAPOLI", 0, 1);
			iLocal_518 = 2;
		}
	}
}
	...
	switch (iLocal_158)
	{
		case 0:
			...
			if (func_480(1, 1093140480 /* Float: 10.5f */, 0))
			{
				...
				if (func_235(bLocal_176))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_176, "Nigel", 0, 0, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_176, "Nigel", 2, joaat("IG_NIGEL"), 0);
				}
				if (func_235(bLocal_177))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_177, "MRS_Thornhill", 0, joaat("IG_MRS_THORNHILL"), 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_177, "MRS_Thornhill", 2, joaat("IG_MRS_THORNHILL"), 0);
				}
				if (!ENTITY::DOES_ENTITY_EXIST(bLocal_194))
				{
					bLocal_194 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-45.93f, -1290.67f, 29.67f, 10f, joaat("V_ILEV_GC_DOOR01"), true, false, true);
				}
				func_477();
				RECORDING::_0x48621C9FCA3EBD28(1);
				...
				if (func_235(bLocal_194))
				{
					ENTITY::SET_ENTITY_VISIBLE(bLocal_194, false, false);
				}
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(bLocal_177))
			{
				...
				{
					bLocal_177 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("MRS_Thornhill", 0));
				}
			}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(bLocal_176))
			{
				...
				{
					bLocal_176 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Nigel", 0));
				}
			}
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				if (func_235(bLocal_194))
				{
					ENTITY::SET_ENTITY_VISIBLE(bLocal_194, true, false);
					func_425(&bLocal_194, 0);
				}
				func_585(1, 1, 1, 1);
				func_424(&Local_96, 0, 1);
				iLocal_158 = 2;
			}
			else if (func_235(bLocal_194) && CUTSCENE::GET_CUTSCENE_TIME() > 45000)
			{
				ENTITY::SET_ENTITY_VISIBLE(bLocal_194, true, false);
				func_425(&bLocal_194, 0);
			}
...
void func_425(bool bParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(*bParam0))
	{
		...
		if (!bParam1)
		{
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(bParam0);
		}
		else
		{
			OBJECT::_MARK_OBJECT_FOR_DELETION(*bParam0);
		}
	}
}
...
void func_426()
{
	if (func_235(bLocal_176))
	{
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_176, -44.83f, -1289.11f, 29.17f, false, false, true);
		TASK::TASK_PLAY_ANIM(bLocal_176, sLocal_179, sLocal_180, 1000f, -16f, -1, 1, 0f, false, false, false);
		PED::_0x2208438012482A1A(bLocal_176, true, false);
		TASK::TASK_LOOK_AT_ENTITY(bLocal_176, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
void func_427()
{
	if (func_235(bLocal_177))
	{
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_177, -45f, -1289.83f, 29.177f, false, false, true);
		TASK::TASK_PLAY_ANIM(bLocal_177, sLocal_179, sLocal_182, 1000f, -16f, -1, 1, 0f, false, false, false);
		PED::_0x2208438012482A1A(bLocal_177, true, false);
		TASK::TASK_LOOK_AT_ENTITY(bLocal_177, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
		PED::SET_PED_KEEP_TASK(bLocal_177, true);
		iLocal_178 = OBJECT::CREATE_OBJECT(joaat("PROP_LD_HANDBAG_S"), -45f, -1289.83f, 49.177f, true, true, false);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_178, bLocal_177, PED::GET_PED_BONE_INDEX(bLocal_177, 64729), vLocal_184, vLocal_187, false, false, false, false, 2, true);
		bLocal_183 = false;
	}
}
...
int func_437(bool bParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6)
{
	...
	func_438(bParam0, iLocal_83, vParam1, iParam4);
	if (func_235(*bParam0))
	{
		VEHICLE::SET_VEHICLE_COLOURS(*bParam0, 65, 0);
		VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(*bParam0, 5, false);
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*bParam0, "28BNT310");
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*bParam0, 0);
		if (iParam5 == 1)
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(*bParam0, 10);
		}
	}
...
void func_438(bool bParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_439(bParam0);
...
void func_442(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_469(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_466(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_443(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_444(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_461(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_382();
			}
...
void func_445(int iParam0, int iParam1)
{
	...
	func_336(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_461(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_359(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_359(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_359(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_462(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_461(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_464(iParam0);
			func_463(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_466(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_467(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_473(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
{
	Global_77091 = iParam0;
}

int func_480(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_485(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_488()
{
	...
	if (func_235(bLocal_176))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(bLocal_176, "rcmnigel3", "base", 3))
		{
			fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(bLocal_176, "rcmnigel3", "base");
			if (fVar0 > 0.97f || fVar0 < 0.03f)
			{
				iLocal_157 = 2;
				iLocal_158 = 0;
			}
			else if (func_319(PLAYER::PLAYER_PED_ID(), bLocal_176, 2.5f, 1))
			{
				iLocal_157 = 2;
				iLocal_158 = 0;
			}
		}
		else if (func_319(PLAYER::PLAYER_PED_ID(), bLocal_176, 5f, 1))
		{
			iLocal_157 = 2;
			iLocal_158 = 0;
		}
	...
	if (bLocal_568 && iLocal_157 != 14)
	{
		switch (iLocal_566)
		{
			case 0:
				...
				{
					if (func_235(bLocal_176) && func_235(bLocal_177))
					{
						func_228(&uLocal_350, 4, bLocal_176, "NIGEL", 0, 1);
						PED::SET_PED_CONFIG_FLAG(bLocal_176, 185, true);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(bLocal_176, false);
						TASK::TASK_LOOK_AT_ENTITY(bLocal_176, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						PED::SET_PED_KEEP_TASK(bLocal_176, true);
						func_228(&uLocal_350, 3, bLocal_177, "MRSTHORNHILL", 0, 1);
						PED::SET_PED_CONFIG_FLAG(bLocal_177, 185, true);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(bLocal_177, false);
						...
						if (PED::IS_PED_IN_GROUP(bLocal_176))
						{
							PED::REMOVE_PED_FROM_GROUP(bLocal_176);
						}
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_176, iLocal_192);
						if (PED::IS_PED_IN_GROUP(bLocal_177))
						{
							PED::REMOVE_PED_FROM_GROUP(bLocal_177);
						}
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_177, iLocal_192);
						bLocal_193 = true;
						iLocal_594 = 0;
						iLocal_603 = 0;
						iLocal_566 = 1;
			...
			case 1:
				...
				else if (!func_319(PLAYER::PLAYER_PED_ID(), bLocal_176, 100f, 1) && !func_319(PLAYER::PLAYER_PED_ID(), bLocal_177, 100f, 1))
				{
					iLocal_567 = 0;
					iLocal_566 = 2;
				}
				...
				{
					if (func_505(bLocal_176, 1, 1116471296 /* Float: 70f */, 1126825984 /* Float: 170f */, 0, 0, 0, 0) || func_505(bLocal_177, 1, 1116471296 /* Float: 70f */, 1126825984 /* Float: 170f */, 0, 0, 0, 0))
					{
						TASK::CLEAR_PED_TASKS(bLocal_176);
						TASK::TASK_SMART_FLEE_PED(bLocal_176, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
						PED::SET_PED_KEEP_TASK(bLocal_176, true);
						TASK::TASK_PLAY_ANIM(bLocal_177, sLocal_179, "Cower_Enter_MsT", 16f, -16f, -1, 0, 0f, false, false, false);
						PED::SET_PED_KEEP_TASK(bLocal_177, true);
					...
					else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(bLocal_176, Local_165))
					{
						if (func_210())
						{
						...
						PED::SET_PED_TO_RAGDOLL(bLocal_176, 750, 2000, 1, true, true, false);
						TASK::TASK_SMART_FLEE_PED(bLocal_176, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
						TASK::TASK_SMART_FLEE_PED(bLocal_177, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
						iLocal_567 = 1;
						iLocal_566 = 2;
					}
					else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(bLocal_177, Local_165))
					{
						if (func_210())
						{
							if (func_503() == 3 || func_503() == 4)
						...
						PED::SET_PED_TO_RAGDOLL(bLocal_177, 750, 2000, 1, true, true, false);
						TASK::TASK_SMART_FLEE_PED(bLocal_176, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
						TASK::TASK_SMART_FLEE_PED(bLocal_177, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
						iLocal_567 = 1;
						iLocal_566 = 2;
...
void func_501()
{
	UNK_0x1082C25039B168F8(sLocal_179);
}

bool func_502(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_227(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
int func_505(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;

	if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(bParam0))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bParam0, PLAYER::PLAYER_PED_ID(), true))
		{
			return 1;
		}
		if (func_518(bParam0, bParam1, bParam5, bParam6, bParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_517(PLAYER::PLAYER_PED_ID(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
		...
		else if (func_506(bParam0, fParam3))
		{
			return 1;
		}
	}
...
int func_506(bool bParam0, float fParam1)
{
	float fVar0;

	if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(bParam0))
	{
		if (func_516(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
bool func_507(bool bParam0, float fParam1)
{
	return func_508(bParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_508(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_515(bParam0, bParam1);
	if (!func_235(bParam0) || !func_235(bParam1))
	{
		if (iVar4 != -1)
		{
	...
	if (!func_512(bParam0, bParam1, fParam2, iParam3))
	{
		return false;
	}
	if (iVar4 == -1)
	...
	bVar0 = func_509(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_509(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_510(bParam4, iParam7) };
...
Vector3 func_510(bool bParam0, int iParam1)
{
	int iVar0;
...
int func_512(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_475(ENTITY::GET_ENTITY_COORDS(bParam1, true) - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
	...
	{
		vVar3 = { func_475(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_515(bool bParam0, int iParam1)
{
	int iVar0;
	...
	while (iVar0 < Local_37)
	{
		if (Local_37[iVar0 /*4*/].f_1 == bParam0 && Local_37[iVar0 /*4*/].f_2 == iParam1)
		{
			return iVar0;
		}
		iVar0++;
...
bool func_517(int iParam0, bool bParam1, float fParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_518(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_522(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_519(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_519(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_520(bool bParam0, float fParam1)
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_521(bParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_521(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_475(vParam1 - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
...
int func_522(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_523()
{
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_176))
	{
		if (ENTITY::IS_ENTITY_DEAD(bLocal_176, false))
		{
			iLocal_567 = 3;
			return 0;
		}
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_176, PLAYER::PLAYER_PED_ID(), true))
		{
			iLocal_567 = 2;
			return 0;
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_177))
	{
		if (ENTITY::IS_ENTITY_DEAD(bLocal_177, false))
		{
			iLocal_567 = 5;
			return 0;
		}
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_177, PLAYER::PLAYER_PED_ID(), true))
		{
			iLocal_567 = 4;
			return 0;
		}
...
int func_524()
{
	...
	if ((((((iLocal_157 != 0 && iLocal_157 != 1) && iLocal_157 != 2) && iLocal_157 != 9) && iLocal_157 != 7) && iLocal_157 != 10) && iLocal_157 != 14)
	{
		...
		else if (ENTITY::DOES_ENTITY_EXIST(bLocal_175) && !func_235(bLocal_175))
		{
			iLocal_157 = 12;
			iLocal_158 = 0;
			return 0;
...
{
	if (func_359(Global_77073, 0f, 0f, 0f, 0))
	{
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_533(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
int func_542(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_544(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_546(iParam0, Global_41631);
}
...
void func_550(bool bParam0, int iParam1, int iParam2)
{
...
void func_555(bool bParam0)
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(bLocal_175))
	{
		func_421();
		SYSTEM::WAIT(0);
	}
	...
	else
	{
		if (func_235(PLAYER::PLAYER_PED_ID()) && func_235(Local_165))
		{
			func_556(PLAYER::PLAYER_PED_ID(), Local_165, -1, 0);
		}
...
void func_556(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (func_484(bParam0))
	{
		if (func_235(bParam1))
		{
			if (ENTITY::IS_ENTITY_ATTACHED(bParam0))
			{
				if (bParam3)
				{
					if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(ENTITY::GET_ENTITY_ATTACHED_TO(bParam0)))
					{
						ENTITY::FREEZE_ENTITY_POSITION(ENTITY::GET_ENTITY_ATTACHED_TO(bParam0), false);
					}
				}
				else
				{
...
void func_557(bool bParam0)
{
	...
	if (!func_235(bLocal_176))
	{
		while (!func_559(&bLocal_176, 64, -44.76f, -1289.19f, 29.22f, -109.3f, "RC_NIGEL", 1))
		{
			SYSTEM::WAIT(0);
		}
	}
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_176, -44.76f, -1289.19f, 29.22f, false, false, true);
	ENTITY::SET_ENTITY_HEADING(bLocal_176, -109.3f);
	if (!func_235(bLocal_177))
	{
		while (!func_559(&bLocal_177, 63, -45.11f, -1289.77f, 29.24f, -96.8f, "RC_MRS_THORNHILL", 1))
		{
			SYSTEM::WAIT(0);
		}
	}
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bLocal_177, -45.11f, -1289.77f, 29.24f, false, false, true);
	ENTITY::SET_ENTITY_HEADING(bLocal_177, -96.8f);
	bLocal_190 = false;
	while (!func_558())
	{
		SYSTEM::WAIT(0);
...
int func_559(bool bParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_560(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*bParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*bParam0, false))
			{
				...
				PED::SET_PED_MONEY(*bParam0, 0);
				if (iParam7 == 1)
				{
					PED::SET_PED_CAN_BE_TARGETTED(*bParam0, false);
				}
			}
			PED::SET_PED_NAME_DEBUG(*bParam0, sParam6);
		}
		return 1;
	}
	return 0;
...
int func_560(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	...
	if (!func_152(iParam1))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			...
			*bParam0 = PED::CREATE_PED(26, iVar0, vParam2, fParam5, false, false);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*bParam0);
			if (iVar0 == joaat("IG_LAMARDAVIS"))
			{
				if (PED::GET_PED_DRAWABLE_VARIATION(*bParam0, 3) == 0)
				{
					PED::SET_PED_COMPONENT_VARIATION(*bParam0, 5, 2, 0, 0);
				}
			}
			func_561(*bParam0, iParam1);
			if (bParam6)
			{
...
void func_564()
{
	...
	func_572(64, 2, 0);
	MISC::CLEAR_BIT(&(Global_111858.f_18570.f_382), 5);
	if (func_235(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_574(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_574(iParam0) };
...
void func_579(bool bParam0, int iParam1, vector3 vParam2, float fParam5)
{
	bParam0->f_1 = iParam1;
	bParam0->f_2 = { vParam2 };
	bParam0->f_5 = fParam5;
...
void func_582(bool bParam0, var uParam1)
{
	*bParam0 = *uParam1;
	*uParam1 = 0;
}
...
void func_583()
{
	...
	func_565(0);
	func_248(&iLocal_294);
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_175) && !bLocal_532)
	{
		func_581(&bLocal_175);
	}
	...
	if (bLocal_191)
	{
		UNK_0x1082C25039B168F8("amb@world_human_stand_impatient@female@no_sign@idle_a");
		UNK_0x1082C25039B168F8("amb@world_human_stand_impatient@male@no_sign@idle_a");
	}
	func_425(&bLocal_194, 0);
...
int func_588(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_589()
{
	...
	iVar0 = func_396(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_591()
{
	...
	{
		if (func_393(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
