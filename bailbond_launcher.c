...
int func_105(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2587834[iParam0 /*3*/][func_103(iParam1)];
...
void func_111(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_113(Var11.f_1)) && iVar72 < 51)
			{
...
void func_250()
{
	...
	if (iLocal_225 != 0)
	{
		...
		{
			case 1:
				iLocal_220 = UNK_0x5DEA4192B46CB99B("MIDSIZED_MESSAGE");
				iLocal_225 = 2;
				break;
			case 2:
				if (bLocal_222)
