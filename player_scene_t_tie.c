...
bool func_8(int iParam0, var uParam1)
{
...
int func_29(int iParam0, float fParam1, char* sParam2)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_30(int iParam0, int iParam1, var uParam2, float fParam3)
{
	switch (iParam1)
	{
		case 0:
...
int func_32(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_34()
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_117))
	{
		UNK_0x1082C25039B168F8(&cLocal_117);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_159)
	{
