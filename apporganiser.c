	...
	while (true)
	{
		...
		if (Global_19681.f_1 != 9)
		{
			...
			else if (Global_19663)
			{
				...
				{
					bLocal_19 = true;
					func_7(Global_19662, "SET_DATA_SLOT_EMPTY", 5f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
					func_4(Global_19662, 1);
					func_7(Global_19662, "DISPLAY_VIEW", 5f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				}
				else
				{
					func_3();
...
void func_3()
{
	if (!bLocal_20)
	{
		...
		{
			bLocal_20 = true;
			func_7(Global_19662, "SET_INPUT_EVENT", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	...
	if (!bLocal_21)
	{
		...
		{
			bLocal_21 = true;
			func_7(Global_19662, "SET_INPUT_EVENT", 3f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	...
	if (!bLocal_22)
	{
		...
		{
			bLocal_22 = true;
			func_7(Global_19662, "SET_INPUT_EVENT", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	...
	if (!bLocal_23)
	{
		...
		{
			bLocal_23 = true;
			func_7(Global_19662, "SET_INPUT_EVENT", 2f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		iVar4 = iVar3;
		iVar3 = Global_96047[iVar0 /*25*/][iVar1];
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
		...
		if (iVar0 == Global_96046 && iVar1 == Global_96045)
		{
			bVar2 = false;
		}
	}
	Global_96043 = Global_96042;
}
...
void func_8()
{
	...
	if (!Global_96041)
	{
		Global_96225 = CLOCK::GET_CLOCK_MONTH();
		Global_96224 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_96223 = CLOCK::GET_CLOCK_HOURS();
		Global_96041 = 1;
		Global_96046 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_96045 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
	...
	if (iVar11 > 0)
	{
		...
		if (iVar11 > 7)
		{
			...
			while (iVar8 < 7)
			{
				...
				while (iVar9 < 24)
				{
					if (!Global_96047[iVar6 /*25*/][iVar7] == 0)
					{
						Global_96042++;
						Global_96044 = (Global_96044 - 1);
					}
					Global_96047[iVar6 /*25*/][iVar7] = 0;
					iVar9++;
				}
				iVar8++;
			}
