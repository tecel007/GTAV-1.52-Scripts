...
{
	Global_4254512 = iParam0;
	Global_4254512.f_1 = iParam1;
}
...
void func_70(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*uParam2 = { func_72(iParam1, iParam3) };
	...
	vVar13 = { func_71(vVar13, -Var0[0 /*6*/].f_3.f_2) };
	vVar13 = { func_71(vVar13, Var0[1 /*6*/].f_3.f_2) };
...
Vector3 func_71(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_81(var uParam0, int iParam1, float fParam2)
{
	...
	{
		vVar0 = { func_84(PLAYER::PLAYER_ID()) };
...
Vector3 func_83(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 42:
		case 43:
			vVar6 = { Global_1049922[iParam0 /*1951*/].f_146.f_47 };
			break;
		case 8:
		case 9:
		case 10:
	...
	if (func_103() == 7)
	{
		...
		*uParam0 = 11;
		if (iParam1 != -1)
		{
			...
			{
				case 0:
					vVar0 = { 799.4338f, 4489.434f, 50.1044f };
					fVar3 = 234.7151f;
					break;
				case 1:
					vVar0 = { -1780.224f, -898.138f, 5.523f };
					fVar3 = 0f;
					break;
				case 2:
					vVar0 = { 548.493f, 2675.173f, 42.1963f };
					fVar3 = -29.16f;
					break;
				case 3:
					vVar0 = { -2510.704f, 1715.879f, 153.946f };
					fVar3 = 0f;
					break;
			}
		}
		else
		{
			...
			{
				case 0:
					vVar0 = { 1095.78f, 42.0084f, 79.8909f };
					fVar3 = 4.1868f;
					break;
				case 1:
					vVar0 = { 1234.744f, 348.742f, 80.9909f };
					fVar3 = 64.0722f;
					break;
				case 2:
					vVar0 = { 1078.318f, 203.7619f, 86.9908f };
					fVar3 = 287.8687f;
					break;
				case 3:
					vVar0 = { 882.1516f, -280.3958f, 65.4134f };
					fVar3 = 322.2067f;
					break;
				case 4:
					vVar0 = { 1101.12f, -706.6118f, 55.8202f };
					fVar3 = 302.1545f;
					break;
				case 5:
					vVar0 = { 958.2682f, 72.5168f, 111.554f };
					fVar3 = 235.6346f;
					break;
				case 6:
					vVar0 = { 919.9286f, 23.3805f, 113.1937f };
					fVar3 = 128.1919f;
					break;
			}
		}
		func_129(vVar0, fVar3, 50f, 1, 0f, 1, 0, 65f, 1, 1, 0, 1, -1082130432 /* Float: -1f */);
	}
	else if (func_103() == 0)
	{
		*uParam0 = 23;
...
void func_129(vector3 vParam0, float fParam3, float fParam4, int iParam5, float fParam6, int iParam7, int iParam8, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	struct<28> Var0;
...
void func_144(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	struct<7> Var0;
...
int func_296(int iParam0, int iParam1)
{
	if (func_254(iParam0, iParam1))
	{
		return (func_253(iParam0, iParam1) + func_297(iParam0, iParam1));
	}
	return 0;
}
...
int func_310(int iParam0, int iParam1)
{
	if (func_275(iParam0))
	{
		return (func_274(iParam0) + func_311(iParam0, iParam1));
	}
	return 0;
}
