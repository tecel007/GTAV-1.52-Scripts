#region Local Var
	...
	vector3 vLocal_570[5] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
void __EntryFunction__()
{
	...
	iLocal_103 = 1;
	bLocal_104 = true;
	vLocal_106 = { -1102.906f, 284.731f, 63.0602f };
	fLocal_109 = 9.4866f;
	...
	if (func_454())
	{
		...
		func_453(vLocal_106, fLocal_109, 1, 0);
	...
	bLocal_507 = Local_443.f_35[0];
	bLocal_508 = Local_443.f_35[1];
	...
	if (func_454())
	{
		...
		func_332(&uLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("ASTEROPE"), 0, 145, 1);
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			func_441(&Local_443, 0, 1);
			if (func_440(bLocal_507))
			{
				ENTITY::SET_ENTITY_PROOFS(bLocal_507, false, false, false, false, false, false, false, false);
			}
			if (func_440(bLocal_508))
			{
				ENTITY::SET_ENTITY_PROOFS(bLocal_508, false, false, false, false, false, false, false, false);
			}
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_206())
			{
				...
				if (func_204(bLocal_507))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_507, false))
					{
						func_203(777);
					}
				}
...
int func_33(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_148(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_35(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
				...
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							...
							func_51(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_66(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_76647[1 /*14*/] = { func_83(iVar10, iVar0, func_41(iParam0, iVar0, -1), -1) };
...
int func_43(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (iParam4 == 0)
	{
		switch (iParam2)
		{
			case 2:
				...
				iVar0 = func_50(iParam1, bParam3, iVar1);
				break;
			case 1:
	...
	switch (iParam1)
	{
		...
		case 2:
			...
			switch (SYSTEM::FLOOR((SYSTEM::TO_FLOAT(iVar0) / 32f)))
			{
				...
				case 132:
					*iParam2 = 6146;
					Jump @8065; //curOff = 7459
					*iParam2 = 6147;
					Jump @8065; //curOff = 7468
					*iParam2 = 6148;
					Jump @8065; //curOff = 7477
					*iParam2 = 6149;
					Jump @8065; //curOff = 7486
					*iParam2 = 6150;
					Jump @8065; //curOff = 7495
					*iParam2 = 6151;
					Jump @8065; //curOff = 7504
					*iParam2 = 6152;
					Jump @8065; //curOff = 7513
					*iParam2 = 6451;
					Jump @8065; //curOff = 7522
					*iParam2 = 6452;
					Jump @8065; //curOff = 7531
					*iParam2 = 6453;
					Jump @8065; //curOff = 7540
					*iParam2 = 6454;
					Jump @8065; //curOff = 7549
					*iParam2 = 6455;
					Jump @8065; //curOff = 7558
					*iParam2 = 6456;
					Jump @8065; //curOff = 7567
					*iParam2 = 6457;
					Jump @8065; //curOff = 7576
					*iParam2 = 6458;
					Jump @8065; //curOff = 7585
					*iParam2 = 6459;
					Jump @8065; //curOff = 7594
					*iParam2 = 6460;
					Jump @8065; //curOff = 7603
					*iParam2 = 6461;
					Jump @8065; //curOff = 7612
					*iParam2 = 6462;
					Jump @8065; //curOff = 7621
					*iParam2 = 6463;
					Jump @8065; //curOff = 7630
					*iParam2 = 6464;
					Jump @8065; //curOff = 7639
					*iParam2 = 6465;
					Jump @8065; //curOff = 7648
					*iParam2 = 7274;
					Jump @8065; //curOff = 7657
					*iParam2 = 7275;
					Jump @8065; //curOff = 7666
					*iParam2 = 7276;
					Jump @8065; //curOff = 7675
					*iParam2 = 7277;
					Jump @8065; //curOff = 7684
					*iParam2 = 7278;
					Jump @8065; //curOff = 7693
					*iParam2 = 7279;
					Jump @8065; //curOff = 7702
					*iParam2 = 7280;
					Jump @8065; //curOff = 7711
					*iParam2 = 7895;
					Jump @8065; //curOff = 7720
					*iParam2 = 7896;
					Jump @8065; //curOff = 7729
					*iParam2 = 7897;
					Jump @8065; //curOff = 7738
					*iParam2 = 7898;
					Jump @8065; //curOff = 7747
					*iParam2 = 7899;
					Jump @8065; //curOff = 7756
					*iParam2 = 7900;
					Jump @8065; //curOff = 7765
					*iParam2 = 7901;
					Jump @8065; //curOff = 7774
					*iParam2 = 7902;
					Jump @8065; //curOff = 7783
					*iParam2 = 7903;
					Jump @8065; //curOff = 7792
					*iParam2 = 7904;
					Jump @8065; //curOff = 7801
					*iParam2 = 7905;
					Jump @8065; //curOff = 7810
					*iParam2 = 7906;
					Jump @8065; //curOff = 7819
					*iParam2 = 7907;
					Jump @8065; //curOff = 7828
					*iParam2 = 7908;
					Jump @8065; //curOff = 7837
					*iParam2 = 7909;
					Jump @8065; //curOff = 7846
					*iParam2 = 8325;
					Jump @8065; //curOff = 7855
					*iParam2 = 8326;
					Jump @8065; //curOff = 7864
					*iParam2 = 8327;
					Jump @8065; //curOff = 7873
					*iParam2 = 8328;
					Jump @8065; //curOff = 7882
					*iParam2 = 8329;
					Jump @8065; //curOff = 7891
					*iParam2 = 8330;
					Jump @8065; //curOff = 7900
					*iParam2 = 8331;
					Jump @8065; //curOff = 7909
					*iParam2 = 8332;
					Jump @8065; //curOff = 7918
					*iParam2 = 8333;
					Jump @8065; //curOff = 7927
					*iParam2 = 8334;
					Jump @8065; //curOff = 7936
					*iParam2 = 8335;
					Jump @8065; //curOff = 7945
					*iParam2 = 8336;
					Jump @8065; //curOff = 7954
					*iParam2 = 8337;
					Jump @8065; //curOff = 7963
					*iParam2 = 8338;
					Jump @8065; //curOff = 7972
					*iParam2 = 8339;
					Jump @8065; //curOff = 7981
					*iParam2 = 8340;
					Jump @8065; //curOff = 7990
					*iParam2 = 8341;
					Jump @8065; //curOff = 7999
					*iParam2 = 8342;
					Jump @8065; //curOff = 8008
					*iParam2 = 8343;
					Jump @8065; //curOff = 8017
					*iParam2 = 8344;
					Jump @8065; //curOff = 8026
					*iParam2 = 8345;
					Jump @8065; //curOff = 8035
					*iParam2 = 8346;
					Jump @8065; //curOff = 8044
					*iParam2 = 8347;
					Jump @8065; //curOff = 8053
					*iParam2 = 8348;
					switch (SYSTEM::FLOOR((SYSTEM::TO_FLOAT(iVar0) / 32f)))
					{
						case 200:
...
int func_74(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	{
		if (!func_148(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_440(Local_443.f_28[0]))
				{
					...
					if (func_204(bLocal_508))
					{
						if (MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, false, true, false, false, false, bLocal_508, false))
						{
							func_488("Back gate blocked");
							vLocal_110 = { -1130.35f, 307.92f, 65.19f };
							TASK::OPEN_SEQUENCE_TASK(&iLocal_506);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_110, 2f, 20000, 1f, true, 40000f);
						...
						else
						{
							...
							if (func_204(bLocal_508))
							{
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, true);
							}
							else
							{
								TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
					...
					else
					{
						...
						if (func_204(bLocal_508))
						{
							TASK::TASK_ENTER_VEHICLE(0, bLocal_508, 20000, -1, 2f, 1, 0);
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, bLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, true);
						}
						else
						{
		...
		case 1:
			if (func_440(Local_443.f_28[0]))
			{
				...
				if (func_204(bLocal_508))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_443.f_28[0], bLocal_508, true))
					{
						if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bLocal_508) < 20f)
						{
							TASK::CLEAR_PED_TASKS(Local_443.f_28[0]);
					...
					if (func_440(PLAYER::PLAYER_PED_ID()))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_508, true))
						{
							TASK::CLEAR_PED_TASKS(Local_443.f_28[0]);
							TASK::TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, false, false);
							func_234(&bLocal_508);
		...
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, false, true, 2))
				{
					...
					Local_89 = { vLocal_570[iLocal_510 /*3*/] };
		...
		case 4:
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_440(Local_443.f_28[iVar0]))
				{
					...
					else if (func_240(Local_443.f_28[iVar0], 1, 1116471296 /* Float: 70f */, 1126825984 /* Float: 170f */, 0, 0, 0, 0))
					{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= (Local_443.f_28 - 1))
		{
			if (func_440(Local_443.f_28[iVar0]))
			{
				...
				if (func_240(Local_443.f_28[iVar0], 1, 1116471296 /* Float: 70f */, 1126825984 /* Float: 170f */, 0, 0, 0, 0))
				{
...
int func_240(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	...
	if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(bParam0))
	{
		...
		if (func_254(bParam0, bParam1, bParam5, bParam6, bParam7))
		{
			return 1;
		}
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_253(PLAYER::PLAYER_PED_ID(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
		...
		else if (func_241(bParam0, fParam3))
		{
			return 1;
		}
	}
...
int func_241(bool bParam0, float fParam1)
{
	float fVar0;

	if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(bParam0))
	{
		if (func_252(bParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), bParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
bool func_242(bool bParam0, float fParam1)
{
	return func_243(bParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_243(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_251(bParam0, bParam1);
	...
	if (!func_247(bParam0, bParam1, fParam2, iParam3))
	{
		return false;
	}
	if (iVar4 == -1)
	...
	bVar0 = func_244(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_244(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_245(bParam4, iParam7) };
...
Vector3 func_245(bool bParam0, int iParam1)
{
	int iVar0;
...
int func_247(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_249(ENTITY::GET_ENTITY_COORDS(bParam1, true) - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
	...
	{
		vVar3 = { func_249(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_253(int iParam0, bool bParam1, float fParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_254(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_440(PLAYER::PLAYER_PED_ID()) && func_440(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_258(bParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_255(bParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_255(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_256(bool bParam0, float fParam1)
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_257(bParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_257(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_249(vParam1 - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
...
int func_258(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_261()
{
	if (iLocal_87 == 1)
	{
		...
		{
			if (CUTSCENE::GET_CUTSCENE_TIME() > 14000 && !bLocal_522)
			{
				...
				case 0:
					if (func_290(1, 1093140480 /* Float: 10.5f */, 0))
					{
						...
						if (func_204(bVar0))
						{
							...
							{
								vVar1 = { -1089.27f, 283.76f, 64.22f };
								fVar4 = 132.53f;
							}
							else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, false, true, 0))
							{
								vVar1 = { -1101.694f, 280.5019f, 63.38352f };
								fVar4 = 85.45f;
							}
							else
							{
								vVar1 = { -1095.231f, 279.3389f, 62.7919f };
								fVar4 = 84.67f;
							}
						}
						else
						...
						if (func_204(bVar0))
						{
							if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(bVar0)))
							{
								func_280(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								func_280(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, func_279(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
						...
						if (func_204(bLocal_507))
						{
							ENTITY::SET_ENTITY_COORDS(bLocal_507, -1107.5f, 280.33f, 64.01f, true, false, false, true);
							ENTITY::SET_ENTITY_HEADING(bLocal_507, 97.97f);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_507, 5f);
						}
						iLocal_527++;
					}
					break;
...
void func_273()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_440(Local_443.f_28[0]))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[0], iLocal_506);
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_506);
			PED::FORCE_PED_MOTION_STATE(Local_443.f_28[0], 247561816, false, 1, false);
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Security_guard_pistol", 0))
	{
		if (func_440(bLocal_504) && func_440(Local_443.f_28[1]))
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(bLocal_504, Local_443.f_28[1]);
			func_488("*** Gave idle cop gun");
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FBI_Agent_1_Gun", 0))
	{
		if (func_440(bLocal_505) && func_440(Local_443.f_28[2]))
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(bLocal_505, Local_443.f_28[2]);
...
void func_275(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_280(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, int iParam17, float fParam18)
{
	func_281(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, iParam17, fParam18);
}

void func_281(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_283(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_284(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_284(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_289()
{
	...
	if (func_440(Local_443.f_28[1]))
	{
		bLocal_504 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_PISTOL"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[1], true), true, 1f, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_488("*** Registered Cop standing");
	}
	if (func_440(Local_443.f_28[2]))
	{
		bLocal_505 = WEAPON::CREATE_WEAPON_OBJECT(joaat("WEAPON_PISTOL"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[2], true), true, 1f, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_488("*** Registered Cop with notepad");
	}
	if (func_440(bLocal_504))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_504, "Security_guard_pistol", 0, 0, 0);
		func_488("*** Registered idle cop gun");
	}
	if (func_440(bLocal_505))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(bLocal_505, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_294(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_302()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_294(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_311(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_322(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_324(iParam0, Global_41631);
}
...
void func_325()
{
	...
	if (!func_331())
	{
		func_330(PLAYER::PLAYER_PED_ID(), vLocal_106, fLocal_109, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_297(1);
...
int func_330(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_332(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_406(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_405(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_105407.f_2890 };
			fParam4 = Global_105407.f_2890.f_6;
		}
		MISC::CLEAR_AREA(vParam1, 5f, true, false, false, false);
		func_399(vParam1, 5f, 0);
		if (func_152(iParam12))
		{
			func_397(iParam12, 0);
			while (!func_333(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_333(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_391(iParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_391(iParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_338(iParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_337(*iParam1);
				...
				func_335(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111858.f_20114[iParam0 /*43*/].f_1));
				...
				func_335(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111858.f_20114[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_335(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_336(iVar0, &uVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_336(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
...
int func_341(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_346(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_347(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_351(int iParam0)
{
	...
	if (func_352(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_364(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_217())
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_365(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_217())
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_366(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_342(Global_2425869[iParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
...
void func_369(int iParam0, int iParam1)
{
	...
	func_370(iParam0, &(Global_111858.f_32745.f_5510));
}
...
void func_397(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96286[iVar0]) == func_398(iParam0, iParam1))
				{
...
void func_399(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_404(&(Global_75654.f_555[0 /*21*/]), iVar0))
		{
...
void func_400(int iParam0)
{
	...
	if (func_404(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_76563.f_66 == 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] != 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] > 3) && (!func_402(0, Global_75654.f_555[0 /*21*/].f_12) || !func_402(1, Global_75654.f_555[0 /*21*/].f_12)))
			{
				func_401(&(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]), &Global_76563);
...
int func_402(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_403(&(Global_111858.f_32745.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_375(Global_111858.f_32745.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_404(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_405(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_405(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_406(vector3 vParam0, float fParam3)
{
	return func_407(&(Global_105407.f_2890), vParam0, fParam3, 0);
}

int func_407(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_409(int iParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_411(iParam0, Global_75654.f_139[38], 0))
			{
				func_400(38);
				return 1;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_411(iParam0, Global_75654.f_139[43], 1))
			{
				func_400(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_405(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_410(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_424(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("STUNT") && func_410(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608 /* Float: 0.5f */, 0))
	{
		return 0;
	}
	return 1;
...
int func_428(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_430(Global_105407.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_431()
{
	return func_424(&(Global_105407.f_2890));
}
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_434(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_434(iParam0) };
...
void func_439()
{
	vLocal_106 = { -1102.906f, 284.731f, 63.0602f };
	fLocal_109 = 9.4866f;
	vLocal_110 = { -1140.98f, 297.59f, 65.89f };
...
void func_443(int* iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		vVar0 = { -1129.18f, 300.55f, 65.92f };
		fVar3 = 86.97f;
	}
	else
	{
		vVar0 = { -1139.759f, 291.483f, 66.327f };
		fVar3 = 6.077003f;
	}
	func_444(iParam0, iLocal_81, vVar0, fVar3);
...
void func_444(bool bParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_232(bParam0);
...
void func_445(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_233(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, false, false);
}

int func_446(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_447(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
