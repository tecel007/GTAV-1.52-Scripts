...
void __EntryFunction__()
{
	...
	else if (func_430(0))
	{
		...
		{
			func_428(PLAYER::PLAYER_PED_ID(), vLocal_692, fLocal_457, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_680 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_417();
			func_416();
			switch (iLocal_98)
			{
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_695, fLocal_458, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_698, fLocal_459, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_444 == 0)
						{
			...
			case 2:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_71())
					{
						...
						func_428(PLAYER::PLAYER_PED_ID(), vLocal_686 + Vector(0f, -2f, -1f), -27.29f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_444 == 0)
						{
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_71())
					{
						func_428(PLAYER::PLAYER_PED_ID(), vLocal_677, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_444 == 0)
						{
	...
	if (func_59(vLocal_680, Local_385.f_1, 210f))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_405))
		{
			if (func_59(vLocal_680, Local_405.f_1, 150f))
			{
				...
				{
					Local_405 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_405.f_1, 10f, func_48(), true, false, true);
					if (func_429(Local_405))
					{
						ENTITY::SET_ENTITY_COORDS(Local_405, func_47(), true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(Local_405, func_46());
						ENTITY::FREEZE_ENTITY_POSITION(Local_405, true);
					}
				}
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_411))
		{
			if (func_59(vLocal_680, Local_411.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_411.f_1, 10f, func_45(), false))
				{
					Local_411 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_411.f_1, 10f, func_45(), true, false, true);
				}
			}
		}
	}
	...
	if (func_23(Local_385))
	{
		if (func_429(Local_393))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_385, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_393, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1000f);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_385, true);
				PED::SET_PED_MONEY(Local_385, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_385, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_385, joaat("PLAYER"));
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_385, false);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_385, false);
				PED::SET_PED_KEEP_TASK(Local_385, true);
				PED::SET_PED_CONFIG_FLAG(Local_385, 118, false);
			}
		}
	}
}
...
void func_67()
{
	...
	if (func_429(Local_385))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_495, Local_385, 0);
		}
	}
}
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_385))
				{
					...
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_385))
					{
						if (func_116(Local_385, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(Local_385, false);
			...
			else
			{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_23(Local_385))
					{
						...
						{
							if (!PED::IS_PED_FLEEING(Local_385))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_385, func_113(), func_74(), 3))
								{
									func_73(&Local_385);
									TASK::TASK_SMART_FLEE_PED(Local_385, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
									PED::SET_PED_KEEP_TASK(Local_385, true);
								}
							}
						}
...
void func_98(bool bParam0)
{
	...
	if (func_23(Local_385))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_385, false);
		PED::SET_PED_KEEP_TASK(Local_385, true);
	}
...
{
	func_105(&(Global_105407.f_2890), vParam0, fParam3);
}
...
{
	if (func_107(Global_77073, 0f, 0f, 0f, 0))
	{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_115(iParam3), false);
}
...
void func_127()
{
	...
	{
		func_130(13, SYSTEM::FLOOR(Global_111858.f_10190.f_3853));
	}
...
bool func_131(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_100)
	{
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					if (func_429(Local_385))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_385, sLocal_495, 0, 0, 0);
					}
					if (func_429(Local_112.f_9))
					{
					...
					if (func_429(Local_393))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_393, sLocal_497, 0, 0, 0);
					}
					if (func_429(Local_399))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_399, sLocal_498, 0, 0, 0);
					}
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_385))
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_385, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_385, true);
				}
...
void func_135(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_186(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_183(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_136(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_136(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_170(iParam5, &Var0, vParam1, fParam4, func_176(iParam0));
...
void func_137(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_167(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_156();
			}
...
void func_138(int iParam0, int iParam1)
{
	...
	func_177(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_155(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_167(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_107(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_170(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_167(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_175(iParam0);
			func_174(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_183(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_184(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_187(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_188(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}

void func_188(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_190(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_190(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
{
	return func_195(Global_102423.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_195(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_251(iVar10, iParam1, iParam2, -1) };
		if (!func_250(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_251(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_251(iVar10, 14, uVar28[iVar1], -1) };
							func_221(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_243(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_211(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_243(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_251(iVar10, iVar0, func_210(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_251(iVar10, 14, uVar69[iVar1], -1) };
			func_221(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_243(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_211(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_211(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
int func_202(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_315(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76647[1 /*14*/] = { func_251(iParam0, iParam1, iParam2, -1) };
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_315(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_211(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_211(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_224(iParam0, func_211(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_228(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_236(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_236(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_236(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_235(vVar16.z)] = func_228(iParam1, vVar16.x, func_235(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
void func_243(int iParam0)
{
	...
	{
		func_249(iParam0, Global_76647[1 /*14*/].f_5, Global_76647[1 /*14*/].f_2, 2, Global_76647[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_245(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2551832[iParam0 /*3*/][func_246(iParam2)];
	if (iVar0 != 0)
	{
...
int func_247(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_246(iParam1)];
...
bool func_248(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_253(int iParam0)
{
	...
	func_254(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_247(func_257(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_247(func_256(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_247(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_260(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_254(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_254(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_254(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_254(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_211(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_315(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_251(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_315(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_315(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_251(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_315(iParam0, 14, iVar4))
										{
											if (!func_207(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_251(iVar0, iVar2, iVar1, -1) };
						if (!func_207(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_211(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_211(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				bLocal_476 = ENTITY::GET_ENTITY_HEALTH(Local_112.f_9);
				vLocal_701 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, false) };
...
void func_321(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_325(int iParam0, vector3 vParam1, int iParam4, float fParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_329(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	...
	if (func_23(iParam0))
	{
		...
		if (bParam5)
		{
			if (func_330(iParam0, vParam1, 1112014848 /* Float: 50f */, 1084227584 /* Float: 5f */))
			{
				return 1;
			}
		}
		...
		if (bParam4)
		{
			if (func_116(iParam0, vParam1, 5f))
			{
				if (PED::IS_PED_RAGDOLL(iParam0))
				{
					return 1;
				}
				if (func_116(iParam0, vParam1, 1f))
				{
					return 1;
				}
			}
...
{
	if (func_116(iParam0, vParam1, fParam4))
	{
...
int func_331(int iParam0, vector3 vParam1)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (func_116(iParam0, vParam1, 3.5f) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam0))
			{
				return 1;
			}
		}
...
{
	func_333(uParam0, iParam1, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_333(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6)
{
	func_334(uParam0, iParam1, 0f, 0f, 0f, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_334(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, char* sParam7, int iParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_335(uParam0, iParam1, vParam2, iParam5, iParam6, sParam7, iParam8, bParam9);
}

void func_335(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
...
int func_341(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_348() || func_347(Global_4456448.f_129348)) || func_346())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_342(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_343(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_350(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_360(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 16:
					...
					if ((!PED::IS_PED_FALLING(Local_112.f_9) && !PED::IS_PED_RAGDOLL(Local_112.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0))
					{
						if (func_124(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							PED::SET_PED_RESET_FLAG(Local_112.f_9, 222, true);
							vLocal_689 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_112.f_9) };
							TASK::OPEN_SEQUENCE_TASK(&iLocal_484);
					...
					if (!PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot", 3))
						{
							...
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot") > 0.413f)
							{
								...
								ENTITY::APPLY_FORCE_TO_ENTITY(Local_112.f_9, 1, Vector(fVar7, fVar7, fVar7) * vLocal_689, vVar4, 0, false, true, true, false, true);
								Local_112.f_18 = MISC::GET_GAME_TIMER();
								Local_112.f_10 = 19;
							}
						}
				...
				case 18:
					...
					break;
				case 19:
					PED::FORCE_PED_MOTION_STATE(Local_112.f_9, -1161760501, false, 0, false);
					if (func_124(Local_112.f_18, 500))
					{
						if (PED::IS_PED_IN_PARACHUTE_FREE_FALL(Local_112.f_9))
						{
							...
							TASK::TASK_PARACHUTE_TO_TARGET(Local_112.f_9, vLocal_683);
							Local_112.f_10 = 20;
						}
					}
					break;
				case 20:
					...
					else if (PED::GET_PED_PARACHUTE_STATE(Local_112.f_9) == 2)
					{
						if (!bLocal_445)
						{
							...
							{
								TASK::SET_PARACHUTE_TASK_TARGET(Local_112.f_9, vLocal_686);
								bLocal_445 = true;
							}
						}
					}
				...
				case 22:
					if (func_124(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_112.f_9, vLocal_680);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, true);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
...
int func_369(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		if (func_116(iParam0, vLocal_680, fParam2))
		{
...
bool func_377(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_378(&(Local_56[iVar4 /*4*/]), vVar1, iParam1, &(Local_56[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar4 /*4*/].f_3) < iParam4);
}

int func_378(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_379(iParam4, iParam7) };
...
int func_381(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_192(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_192(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_385()
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_677, 100f))
	{
		if (!func_386())
		{
			CUTSCENE::REQUEST_CUTSCENE(&cLocal_671, 8);
			func_67();
			bLocal_452 = true;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_677, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
int func_388(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
			...
			case 1:
				if (!bLocal_449)
				{
					...
					else
					{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_677, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_116(PLAYER::PLAYER_PED_ID(), vLocal_677, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_116(PLAYER::PLAYER_PED_ID(), vLocal_677, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
	...
	if (func_429(iParam0))
	{
		if (!func_365(iParam1, 10))
		{
			if (bParam2)
			{
				...
				if (!func_408(iParam0, vLocal_680, fParam4))
				{
					return 0;
				}
			}
...
int func_408(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	float fVar3;
...
void func_418()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_385))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_385, false) || PED::IS_PED_INJURED(Local_385))
		{
			iLocal_102 = 3;
			return;
		}
...
int func_419(bool bParam0)
{
	if (func_23(Local_385))
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_385) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_385)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(Local_385))
		{
			return 1;
		}
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_385))
			{
				return 1;
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_393))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_393))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_405))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_405))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_399))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_399))
				{
					return 1;
				}
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_385, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(Local_385))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_385, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_385, 51))
		{
			return 1;
		}
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_385, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_385, 73))
		{
			return 1;
		}
		if (bParam0)
...
int func_422(int iParam0, float fParam1)
{
	...
	{
		if (func_423(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_423(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_192(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_428(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
...
void func_434(bool bParam0)
{
	...
	UNK_0x1082C25039B168F8("oddjobs@bailbond_mountain");
	UNK_0x1082C25039B168F8(func_113());
	func_435();
}
...
void func_443(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_490(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_107(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_485(iParam12, 0);
			while (!func_444(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_444(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_445(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_179(iParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_448(*iParam1);
				...
				func_446(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111858.f_20114[iParam0 /*43*/].f_1));
				...
				func_446(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111858.f_20114[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_450(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_454(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_455(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	...
	if (func_460(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_472(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_473(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_82())
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_474(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_451(Global_2425869[iParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
...
void func_485(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96286[iVar0]) == func_168(iParam0, iParam1))
				{
...
void func_486(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_167(&(Global_75654.f_555[0 /*21*/]), iVar0))
		{
...
void func_487(int iParam0)
{
	...
	if (func_167(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_75654.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_173(iParam0, 0)) && Global_76563.f_66 == 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] != 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] > 3) && (!func_488(0, Global_75654.f_555[0 /*21*/].f_12) || !func_488(1, Global_75654.f_555[0 /*21*/].f_12)))
			{
				func_174(&(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]), &Global_76563);
...
int func_488(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_489(&(Global_111858.f_32745.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_141(Global_111858.f_32745.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_490(vector3 vParam0, float fParam3)
{
	return func_491(&(Global_105407.f_2890), vParam0, fParam3, 0);
}

int func_491(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_493(int iParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_495(iParam0, Global_75654.f_139[38], 0))
			{
				func_487(38);
				return 1;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_495(iParam0, Global_75654.f_139[43], 1))
			{
				func_487(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_107(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_494(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_509()
{
	return func_507(&(Global_105407.f_2890));
}

void func_510()
{
	func_511(&(Global_105407.f_2890));
}
...
int func_512(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_514(Global_105407.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_515()
{
	return func_508(&(Global_105407.f_2890));
}
...
void func_518()
{
	...
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	iLocal_482 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, false, true, true, true);
...
int func_522(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_523(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_541()) || Global_110905) || Global_30970) || func_547()) || func_95(8, -1)) || func_546()) || func_545()) || func_539()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_541()) || Global_30970) || func_547()) || func_95(8, -1)) || func_539()) || func_546()) || func_545()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_541()) || Global_110905) || Global_30970) || func_547()) || func_95(8, -1)) || func_539()) || func_546()) || func_545()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_541()) || Global_110905) || Global_30970) || func_547()) || func_95(8, -1)) || func_546()) || func_545()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_541() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_540()) || func_544()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_541()) || Global_30970) || func_547()) || func_95(8, -1)) || func_545()) || func_539()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_541()) || func_545()) || Global_110905) || Global_30970) || func_547()) || Global_42801) || func_95(8, -1)) || func_539()) || func_544()) || func_540()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_541()) || Global_110905) || Global_30970) || func_547()) || func_95(8, -1)) || func_539()) || func_544()) || func_546()) || func_545()) || func_540())
						{
							return 0;
						}
						break;
...
{
	return func_549(iParam0, Global_41631);
}
...
void func_555(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_559()
{
	...
	iVar0 = func_560(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_563()
{
	...
	{
		if (func_553(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
