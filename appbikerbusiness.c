...
void __EntryFunction__()
{
	...
	iLocal_685 = UNK_0x5DEA4192B46CB99B("BIKER_BUSINESSES");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_685))
	{
		SYSTEM::WAIT(0);
	}
	func_505(1);
	...
	{
		iLocal_514 = func_498(PLAYER::PLAYER_ID());
	}
	else if (func_497())
	{
		iLocal_514 = Global_1695697;
	}
	else
	{
	...
	{
		vLocal_497 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	}
	...
	if (iLocal_514 != 0)
	{
		iVar0 = func_459(iLocal_514);
		if (iVar0 != -1)
		{
			if (func_458(PLAYER::PLAYER_ID(), iLocal_514) == func_457(iLocal_514))
			{
				if (!MISC::IS_BIT_SET(Global_1370236, iVar0))
				{
					func_456(iVar0, 1, 0);
					MISC::SET_BIT(&Global_1370236, iVar0);
				}
			}
			else
			{
				MISC::CLEAR_BIT(&Global_1370236, iVar0);
			}
		}
	}
	while (func_455())
	{
		if (MISC::IS_BIT_SET(Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_26, 14) || func_454(PLAYER::PLAYER_PED_ID(), vLocal_497, 1) > 5f)
		{
			func_508(0);
		}
		...
		if (iLocal_514 != 0)
		{
			iVar1 = func_459(iLocal_514);
			if ((iVar1 > -1 && iVar1 < 6) && iLocal_512 != Global_1370228[iVar1])
			{
				func_467();
			}
		}
		if (iLocal_515 == -1 && !Global_1678143)
		{
			func_11();
		}
		else if (iLocal_511 != 190)
		{
			if (!func_10(&uLocal_516))
			{
				func_9(&uLocal_516, 0, 0);
			}
			else if (func_8(&uLocal_516, 200, 0))
			{
				if (!Global_1678143)
				{
					func_3(PLAYER::PLAYER_ID(), iLocal_514, iLocal_515, 1);
					Global_1678143 = 1;
					func_508(0);
				}
				else if (!Global_1678288.f_3140)
				{
					func_1();
				}
			}
		}
		else if (!func_10(&uLocal_518))
		{
			func_9(&uLocal_518, 0, 0);
			CAM::DO_SCREEN_FADE_OUT(800);
		}
		else if (!Global_1678288.f_3140)
		{
			if (MISC::IS_BIT_SET(Global_1370203, 0))
			{
				func_1();
			}
			else if (func_8(&uLocal_518, 15000, 0))
			{
				func_1();
			}
		}
...
void func_11()
{
	...
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "GET_CURRENT_SELECTION");
		uLocal_686 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "GET_SELECTED_BUSINESS_ID");
		uLocal_688 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "GET_CURRENT_SCREEN_ID");
		uLocal_689 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		bLocal_502 = false;
		bLocal_501 = false;
	}
	if ((PAD::IS_CONTROL_JUST_PRESSED(2, 202) || PAD::IS_CONTROL_JUST_PRESSED(2, 238)) && bLocal_502)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "GET_CURRENT_SCREEN_ID");
		uLocal_689 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		bLocal_502 = false;
	}
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_689) && !bLocal_502)
	{
		iLocal_510 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_689);
		bLocal_502 = true;
	}
	if (bLocal_506 && !bLocal_507)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "GET_CURRENT_ROLLOVER");
		uLocal_687 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
		bLocal_507 = true;
	}
	if (bLocal_507)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_687))
		{
			iLocal_508 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_687);
			bLocal_507 = false;
		}
	}
	if (iLocal_508 == 3014 && func_413())
	{
	...
	if (!bLocal_501)
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_686) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_688))
		{
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_686);
			iVar2 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_688);
			iVar3 = -1;
			if (iLocal_514 != 0)
			{
				iVar3 = func_459(iLocal_514);
			}
			switch (iVar1)
			{
				case 101:
				...
				case 2001:
					...
					break;
				case 3001:
					if (Global_1370228[iVar3] >= Global_262145.f_17924)
					{
					...
					break;
				case 3002:
					if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar3 /*12*/].f_4 <= 0)
					{
						func_216(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_204(iLocal_514) == 2)
					{
				...
				case 3006:
					...
					else if (Global_1370228[iVar3] <= 0)
					{
				...
				case 3013:
					...
					break;
				case 3014:
					iVar6 = Global_1370228[iVar3];
					iVar7 = func_13(0, iVar6, 0);
					if (Global_262145.f_18488)
					{
						func_216(0, "OR_BS_PAY_NA", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (Global_1370228[iVar3] >= Global_262145.f_17924)
					{
						func_216(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
					}
					else if (func_215(iVar3))
...
void func_12(int iParam0)
{
	...
	if (Global_1370228[func_459(iLocal_514)] >= Global_262145.f_17924)
	{
		func_216(0, "OR_MIS_NA_B", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_215(func_459(iLocal_514)))
	{
		func_216(0, "OR_MIS_NA_C", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (!func_201(192))
...
void func_18(int iParam0, int iParam1)
{
	...
	else if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_4 <= 0)
	{
		func_216(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_29(iParam0, iLocal_514))
	{
		func_216(0, "OR_UPGR_NA", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (func_28(PLAYER::PLAYER_ID(), iLocal_514, iParam0))
	{
		func_216(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (MONEY::NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iLocal_514), false, true, false, -1, 0))
	{
	...
	switch (iVar0)
	{
		...
		case 5:
			...
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_25())
			{
				...
				func_20(&uVar4, iVar0, iParam0, iVar2, iVar3);
...
{
	return Global_1652336.f_11.f_147[func_63(iParam0)];
}
...
int func_174(int iParam0, int iParam1)
{
	if (func_132(iParam0, iParam1))
	{
		return (func_131(iParam0, iParam1) + func_175(iParam0, iParam1));
	}
	return 0;
}
...
int func_188(int iParam0, int iParam1)
{
	if (func_153(iParam0))
	{
		return (func_152(iParam0) + func_189(iParam0, iParam1));
	}
	return 0;
}
...
int func_205(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1370228[iParam0] > 0 && (!func_210(iParam1) || !func_206(PLAYER::PLAYER_ID(), iParam1)))
		{
			if (!Global_262145.f_21086 || func_200(PLAYER::PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1370228[iParam0] > 0 && !func_210(iParam1)) && (!Global_262145.f_18487 || func_64(PLAYER::PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
int func_211(int iParam0, int iParam1)
{
	...
	if (iParam0 != func_5() && func_7(iParam0, iParam1))
	{
		...
		if (func_30(iVar0))
		{
			return Global_1590682[iParam0 /*883*/].f_274.f_183[iVar0 /*12*/].f_1 >= func_457(iParam1);
		}
	}
	return 0;
}
...
int func_214(int iParam0, int iParam1)
{
	...
	if (func_6(Global_1590682[iParam0 /*883*/].f_274.f_183[iParam1 /*12*/]))
	{
...
{
	iLocal_509 = iParam0;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SHOW_OVERLAY");
...
int func_220(int iParam0)
{
	...
	if (func_209(iParam0))
	{
		...
		{
			iVar4 = (Global_262145.f_20964 / 2);
			iVar0 = (iVar0 + iVar4);
		}
		if (func_224(PLAYER::PLAYER_ID()))
		{
			iVar5 = (Global_262145.f_20964 / 2);
			iVar0 = (iVar0 + iVar5);
		}
...
int func_234(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_25())
	{
		...
		func_236(&uVar1, iParam0, bVar0);
		iVar17 = MISC::GET_HASH_KEY(&uVar1);
...
void func_241(bool bParam0, int iParam1)
{
	...
	GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_685, "HIDE_OVERLAY");
	bLocal_504 = false;
	if (bParam0)
	{
		switch (iLocal_509)
		{
			case 2001:
				if (bLocal_503)
				{
					GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(iLocal_685, "SHOW_HOMEPAGE");
					bLocal_503 = false;
				}
			...
			case 1003:
				...
				break;
			case 3003:
				if (func_348(iLocal_514))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_344(iLocal_514);
					func_342(func_459(iLocal_514));
				}
				break;
			case 3005:
				...
				{
					iVar2 = func_326(func_27(iLocal_514));
					if (func_325(iVar2))
					{
						iVar3 = func_323(iVar2);
						func_311(iVar3, 1);
						MISC::SET_BIT(&Global_1678138, iVar0);
					}
				}
				break;
			case 3006:
				...
				iVar0 = func_459(iLocal_514);
				func_309(func_459(iLocal_514));
				func_467();
				func_405(iVar0, 0);
				break;
			case 3008:
				if (func_308(0, iLocal_514))
				{
					if (func_304(0))
					{
						func_300(0);
			...
			case 3010:
				...
				break;
			case 3011:
				if (func_285(iLocal_514))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_283(func_459(iLocal_514), !Global_262145.f_16989);
					func_264(190, iLocal_514, 0);
					func_260(iLocal_514, 0);
				}
				else
				{
					func_216(0, func_259(iLocal_696), "OR_OVRLY_OK", "", -1, 1);
				}
				break;
			case 3012:
				if (func_285(iLocal_514))
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_283(func_459(iLocal_514), !Global_262145.f_16989);
					func_264(190, iLocal_514, 1);
					func_260(iLocal_514, 1);
				}
				else
				{
					func_216(0, func_259(iLocal_696), "OR_OVRLY_OK", "", -1, 1);
			...
			case 3015:
				if (func_348(iLocal_514))
				{
					Global_1678139 = iLocal_514;
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", true);
					func_264(192, iLocal_514, -1);
					func_283(func_459(iLocal_514), !Global_262145.f_16989);
					func_342(func_459(iLocal_514));
				}
				break;
...
int func_245()
{
	...
	while (!func_8(&uVar7, 15000, 0))
	{
		if (iLocal_699 == -1)
		{
			if (Global_4264051[iLocal_698 /*85*/].f_66 != 2147483647)
			{
				iLocal_699 = Global_4264051[iLocal_698 /*85*/].f_66;
			}
		}
		iVar10 = 0;
		while (iVar10 < SCRIPT::GET_NUMBER_OF_EVENTS(1))
		{
			if (SCRIPT::GET_EVENT_AT_INDEX(1, iVar10) == 226)
			{
				...
				{
					if (vVar0.x == iLocal_699 && vVar0.x != -1)
					{
						if (vVar0.z == 0)
						{
							return 1;
...
void func_246(int iParam0, int iParam1)
{
	...
	iVar0 = Global_1370228[func_459(iParam0)];
...
void func_247(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 1815541181:
			...
			{
				func_248(iParam2, -1135378931, 537254313, 1474183246, iParam0, iParam1, iVar0, 7);
			}
			break;
		case -31156877:
		case -1027218631:
		...
		case 1138089938:
		case -561012053:
			func_248(iParam2, -1135378931, 1445302971, 1474183246, iParam0, iParam1, iVar0, 7);
			break;
	}
	switch (iParam0)
	{
...
int func_248(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	*iParam0 = 15;
	...
	if ((bVar0 || bVar1) || NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(&iVar4, iParam3, iParam4, iParam2, iParam5, iParam6))
	{
		...
		{
			*iParam0 = func_255(iVar4, iParam1, iParam4, iParam2, iParam3, iParam5, 0, iParam6, iParam7, 1, 1);
			if (bVar1 && !bVar0)
			{
			}
			if (bVar0)
...
int func_265(int iParam0)
{
	if (iParam0 != func_5())
	{
		if (func_267(iParam0, 1, 1))
		{
			...
			{
				return func_266(Global_2425869[iParam0 /*443*/].f_314.f_6) == 17;
			}
		}
	}
	return 0;
...
{
	if (func_281() || !func_280(1))
	{
		if (!func_278(PLAYER::PLAYER_ID(), 0))
		{
			func_277(iParam0);
			func_270(iParam0, func_274(1, 1), func_273(), func_272(), func_271(), iParam1);
		}
	}
}

void func_270(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	struct<7> Var0;
...
int func_278(int iParam0, int iParam1)
{
	...
	{
		return func_53(Global_1630317[iParam0 /*595*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
void func_283(int iParam0, bool bParam1)
{
	...
	func_428(func_284(iParam0), bParam1, -1, 1);
...
int func_285(int iParam0)
{
	...
	if (func_25())
	{
		...
		iLocal_695 = 0;
		iVar1 = func_298(1);
		while (!func_287(iVar0, iVar1, &iLocal_697))
		{
			SYSTEM::WAIT(0);
			func_415();
		}
...
int func_290()
{
	...
	if (!bVar0)
	{
		if (!NETSHOPPING::NET_GAMESERVER_IS_SESSION_VALID(func_24()) || NETSHOPPING::NET_GAMESERVER_IS_SESSION_REFRESH_PENDING())
		{
			if (func_292(Global_4264051[iVar2 /*85*/].f_66.f_6, Global_4264051[iVar2 /*85*/].f_66.f_4, Global_4264051[iVar2 /*85*/].f_66.f_1) == 1)
			{
				Global_4265553 = 1;
			}
			return 0;
	...
	if (iVar3 != 2147483647)
	{
		if ((bVar0 || bVar1) || NETSHOPPING::NET_GAMESERVER_CHECKOUT_START(iVar3))
		{
			...
			if (bVar0 || bVar1)
			{
				func_256(Global_4264051[iVar2 /*85*/], iVar2);
			}
			Global_4265538 = 1;
			return 1;
		}
...
int func_295(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_255(iVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, iParam5, 0, bVar0);
		return 1;
	}
	return 0;
}
...
int func_304(int iParam0)
{
	...
	bVar0 = true;
	bVar1 = true;
	iVar2 = func_19(iParam0, iLocal_514);
	iVar3 = iParam0;
	iVar4 = func_459(iLocal_514);
	iVar5 = func_307(iVar4, iVar3 + 1);
	iVar6 = func_27(iLocal_514);
	iVar7 = func_306(iVar6, iVar3 + 1, 1);
	if (func_25())
	{
		bVar0 = false;
		while (!func_305(-103880010, 235173372, iVar7, 1, iVar2, &iLocal_513, iVar5, 3, 0, 0, 0))
		{
			SYSTEM::WAIT(0);
			func_415();
			if (iLocal_513 == 1 && func_297() == -1)
			{
				iLocal_513 = 3;
				bVar1 = false;
			}
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			vVar8.x = MISC::GET_HASH_KEY(func_235(iLocal_514));
			vVar8.f_1 = iVar6;
			vVar8.f_2 = iParam0;
			MONEY::_0x675D19C6067CAE08(iVar2, &vVar8, 0, 1);
		}
		bLocal_500 = true;
		if (func_25())
		{
...
bool func_305(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
...
int func_306(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					StringCopy(&cVar0, "FA_UPGRADE_FAKEID_SETUP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 1:
					StringCopy(&cVar0, "FA_UPGRADE_FAKEID_EQUIP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 2:
					StringCopy(&cVar0, "FA_UPGRADE_FAKEID_STAFF_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 3:
					StringCopy(&cVar0, "FA_UPGRADE_FAKEID_SEC_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
			}
		...
		case 1:
			...
			{
				case 0:
					StringCopy(&cVar0, "FA_UPGRADE_WEED_SETUP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 1:
					StringCopy(&cVar0, "FA_UPGRADE_WEED_EQUIP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 2:
					StringCopy(&cVar0, "FA_UPGRADE_WEED_STAFF_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 3:
					StringCopy(&cVar0, "FA_UPGRADE_WEED_SEC_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
			}
		...
		case 2:
			...
			{
				case 0:
					StringCopy(&cVar0, "FA_UPGRADE_CASH_SETUP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 1:
					StringCopy(&cVar0, "FA_UPGRADE_CASH_EQUIP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 2:
					StringCopy(&cVar0, "FA_UPGRADE_CASH_STAFF_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 3:
					StringCopy(&cVar0, "FA_UPGRADE_CASH_SEC_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
			}
		...
		case 3:
			...
			{
				case 0:
					StringCopy(&cVar0, "FA_UPGRADE_METH_SETUP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 1:
					StringCopy(&cVar0, "FA_UPGRADE_METH_EQUIP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 2:
					StringCopy(&cVar0, "FA_UPGRADE_METH_STAFF_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 3:
					StringCopy(&cVar0, "FA_UPGRADE_METH_SEC_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
			}
		...
		case 4:
			...
			{
				case 0:
					StringCopy(&cVar0, "FA_UPGRADE_COKE_SETUP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 1:
					StringCopy(&cVar0, "FA_UPGRADE_COKE_EQUIP_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 2:
					StringCopy(&cVar0, "FA_UPGRADE_COKE_STAFF_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
				case 3:
					StringCopy(&cVar0, "FA_UPGRADE_COKE_SEC_", 64);
					StringIntConCat(&cVar0, iParam2, 64);
					StringConCat(&cVar0, "_t0_v0", 64);
					break;
			}
		...
		case 5:
			if (iParam1 == 0)
			{
				StringCopy(&cVar0, "FA_UPGRADE_WEAPONS_SETUP_", 64);
				StringIntConCat(&cVar0, iParam2, 64);
				StringConCat(&cVar0, "_t0_v0", 64);
				Jump @768; //curOff = 746
			}
			...
			{
				func_20(&cVar0, iParam0, iParam1, iParam2, 0);
			}
			break;
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(&cVar0))
...
void func_311(int iParam0, bool bParam1)
{
	...
	func_316(&(Global_2515521[iParam0 /*2*/]));
	iVar1 = iVar0;
...
void func_317(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		func_316(&(Global_2515521[iParam1 /*2*/]));
	}
	if (bParam3)
	{
		iVar1 = iVar0;
...
void func_328()
{
	...
	iVar0 = func_459(iLocal_514);
	if (func_25() && func_458(PLAYER::PLAYER_ID(), iLocal_514) > 0)
	{
		iVar1 = func_298(1);
		bLocal_694 = true;
		while (!func_287(iVar0, iVar1, &iLocal_697))
		...
		{
			iLocal_697 = 0;
			iVar2 = func_458(PLAYER::PLAYER_ID(), iLocal_514);
			while (!func_338(iVar0, iVar2, 0, 0, &iLocal_697, 0))
			{
				SYSTEM::WAIT(0);
				func_415();
			}
			...
			if (iLocal_697 == 2)
			{
				func_329(PLAYER::PLAYER_ID(), iLocal_514, 1, 0, 0, 0);
				func_456(iVar0, 0, 0);
			}
		}
	}
...
{
	MISC::CLEAR_BIT(&Global_1370235, iParam0);
	MISC::CLEAR_BIT(&Global_1370235, iParam0 + 6);
}
...
{
	if (iParam0 != -1 && iParam1 != Global_1370228[iParam0])
	{
		Global_1370228[iParam0] = iParam1;
	}
}
...
void func_350(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar2 /*12*/] == 0)
		{
			iVar1 = iVar2;
		}
		else
...
void func_353()
{
	...
	Global_1370225 = UNK_0x5A002C4821A13338();
}
...
void func_354(int iParam0)
{
	...
	if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iParam0 /*12*/] != 0 && Global_1370218[iParam0] != 0)
	{
		iVar0 = (UNK_0x5A002C4821A13338() - Global_1370218[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
...
{
	Global_1370218[iParam0] = UNK_0x5A002C4821A13338();
...
void func_358(int iParam0)
{
	...
	if (func_7(PLAYER::PLAYER_ID(), iVar0))
	{
		...
		iVar17 = Global_1370228[iVar11];
		iVar22 = func_13(0, iVar17, 0);
		bVar4 = Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar11 /*12*/].f_4 > 0;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "ADD_BUSINESS");
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "ADD_BUSINESS_STATS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_START_PRODUCTION_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
int func_362(int iParam0)
{
	...
	iVar0 = func_459(iParam0);
	if ((func_7(PLAYER::PLAYER_ID(), iParam0) && Global_1370228[iVar0] < Global_262145.f_17924) && !func_215(iVar0))
	{
		return 1;
	}
	return 0;
...
Vector3 func_382(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			vVar0[0 /*3*/] = { 46.57f, 6298.997f, 30.2003f };
			break;
		case 2:
			vVar0[0 /*3*/] = { 405.3243f, 6493.409f, 26.71f };
			break;
		case 3:
			vVar0[0 /*3*/] = { 58.64f, 6469.08f, 30.3094f };
			break;
		case 4:
			vVar0[0 /*3*/] = { -441.42f, 6144.01f, 30.44f };
			break;
		case 5:
			vVar0[0 /*3*/] = { -179.1551f, 6317.944f, 30.2184f };
			break;
		case 6:
			vVar0[0 /*3*/] = { 1453.143f, -1686.121f, 64.9563f };
			break;
		case 7:
			vVar0[0 /*3*/] = { 114.6697f, 164.4655f, 103.4672f };
			break;
		case 8:
			vVar0[0 /*3*/] = { -1464.77f, -390.1486f, 37.3017f };
			break;
		case 9:
			vVar0[0 /*3*/] = { -1172.126f, -1390.925f, 3.7783f };
			break;
		case 10:
			vVar0[0 /*3*/] = { 311.3521f, -760.6975f, 28.0504f };
			vVar0[1 /*3*/] = { 307.7254f, -699.9282f, 28.3096f };
			break;
		case 11:
			vVar0[0 /*3*/] = { 208.0649f, 2456.774f, 54.8342f };
			break;
		case 12:
			vVar0[0 /*3*/] = { 2878.758f, 4459.61f, 47.3484f };
			break;
		case 13:
			vVar0[0 /*3*/] = { 376.971f, 3590.405f, 32.2221f };
			break;
		case 14:
			vVar0[0 /*3*/] = { 646.3618f, 2792.016f, 40.6392f };
			break;
		case 15:
			vVar0[0 /*3*/] = { 1642.669f, 4839.135f, 40.9704f };
			break;
		case 16:
			vVar0[0 /*3*/] = { 1189.591f, -3098.619f, 4.7346f };
			break;
		case 17:
			vVar0[0 /*3*/] = { 140.2878f, -2477.946f, 4.94f };
			break;
		case 18:
			vVar0[0 /*3*/] = { -256.8373f, -2586.215f, 4.9106f };
			break;
		case 19:
			vVar0[0 /*3*/] = { 666.0431f, -2672.718f, 4.9612f };
			break;
		case 20:
			vVar0[0 /*3*/] = { -337.6264f, -2769.627f, 3.944f };
			break;
		case 21:
			vVar0[0 /*3*/] = { 494.0037f, 3015.448f, 40.0526f };
			break;
		case 22:
			vVar0[0 /*3*/] = { 849.5273f, 3023.794f, 40.2763f };
			break;
		case 23:
			vVar0[0 /*3*/] = { 40.4676f, 2928.654f, 54.7342f };
			break;
		case 24:
			vVar0[0 /*3*/] = { 1572.055f, 2224.068f, 77.3731f };
			break;
		case 25:
			vVar0[0 /*3*/] = { 2107.983f, 3324.722f, 44.3713f };
			break;
		case 26:
			vVar0[0 /*3*/] = { 2488.974f, 3164.124f, 48.0622f };
			break;
		case 27:
			vVar0[0 /*3*/] = { 1798.893f, 4705.239f, 38.955f };
			break;
		case 28:
			vVar0[0 /*3*/] = { -753.681f, 5944.054f, 18.8012f };
			break;
		case 29:
			vVar0[0 /*3*/] = { -388.6984f, 4338.543f, 55.1304f };
			break;
		case 30:
			vVar0[0 /*3*/] = { -3029.436f, 3334.414f, 9.0759f };
			break;
		case 31:
			vVar0[0 /*3*/] = { -3155.589f, 1376.788f, 16.0949f };
			break;
	}
	if (bParam1 && !func_383(vVar0[1 /*3*/], 0f, 0f, 0f, 0))
	{
		return vVar0[1 /*3*/];
	}
	return vVar0[0 /*3*/];
...
bool func_383(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
void func_384(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar1 /*12*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/] = iParam0;
		if (func_209(iParam0))
		{
			Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_11 = 0;
			func_409(9359, 0, -1, 1);
			func_243(5619, 0, -1, 1, 0);
		}
		func_393(iVar0);
...
int func_394(int iParam0, int iParam1, int iParam2)
{
	...
	vVar14.x = MISC::GET_HASH_KEY(func_235(iParam0));
	vVar14.f_1 = func_27(iParam0);
	vVar14.f_2 = -1;
	if (iVar1 > 0)
	{
	...
	if (iParam2 == 0 || iParam2 == 32)
	{
		...
		MONEY::_0x6FD97159FE3C971A(iVar7, &vVar14, 0, 1);
	}
	else
	{
		if (iVar2 > 0)
		...
		if (iVar7 > 0)
		{
			...
			MONEY::_0xA51B086B0B2C0F7A(iVar7, &vVar14, 0, 1);
		}
	}
	if (func_25())
	{
...
int func_401(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	...
	if (bLocal_694)
	{
		switch (iLocal_695)
		{
			case 0:
				...
				if (func_293(78225582, iParam3, iParam5, iParam4, 1, iParam1, iParam2, 4, iParam6, 3))
				{
...
int func_403(int iParam0, bool bParam1)
{
	...
	func_236(&uVar0, iParam0, bParam1);
	return MISC::GET_HASH_KEY(&uVar0);
}
...
void func_407(int iParam0, int iParam1)
{
	...
	if (func_408(iParam0, iParam1))
	{
		...
		func_334(iVar0, 0);
		func_243(func_335(iVar0), 0, -1, 1, 0);
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_1 = 0;
		func_243(func_336(iVar0), 0, -1, 1, 0);
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_4 = 0;
		func_409(func_337(iVar0), 0, -1, 1);
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_5 = 0;
		func_243(func_303(iVar0, 2), 0, -1, 1, 0);
		func_243(func_303(iVar0, 0), 0, -1, 1, 0);
		func_243(func_303(iVar0, 1), 0, -1, 1, 0);
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_6 = 0;
		func_428(func_284(iVar0), 0, -1, 1);
		if (iVar0 != 5)
		{
			func_393(iVar0);
		}
		Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_8 = 0;
		func_428(func_331(iVar0), 0, -1, 1);
		if (func_209(iParam0))
		{
			Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_11 = 0;
...
int func_413()
{
	if (!bLocal_505 && func_410(9356, -1, -1) < 3)
	{
		return 1;
	}
	return 0;
...
void func_414()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
	}
	if (PAD::_IS_USING_KEYBOARD_2(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
			bLocal_506 = true;
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
			bLocal_506 = true;
		}
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
		if (((iLocal_510 == 1 || iLocal_510 == -1) || iLocal_510 == 4) || iLocal_510 == 5)
		{
			if (!bLocal_504)
			{
				func_508(0);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1f, -1f, -1f, -1f);
	}
	if (PAD::_IS_USING_KEYBOARD_2(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_MOUSE_INPUT");
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_685, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
			if ((iLocal_510 == 1 || iLocal_510 == -1) || iLocal_510 == 4)
			{
				if (!bLocal_504)
				{
					func_508(0);
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_690 != 127) || iVar1 != 127) || iLocal_691 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_ANALOG_STICK_INPUT");
			iLocal_690 = iVar0;
			iLocal_691 = iVar1;
	...
	if (((iVar2 != 127 || iLocal_692 != 127) || iVar3 != 127) || iLocal_693 != 127)
	{
		...
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_692);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_693);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		if (!bVar4)
		{
...
void func_415()
{
	...
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_685, 255, 255, 255, 255, 0);
	func_422();
	func_419(0);
	func_416(1);
...
bool func_428(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_429()
{
	return func_430(&uLocal_520, "BPLESAU", "BPLES_TUT1", 8, 0, 0, 0);
}
...
void func_441()
{
	...
	{
		if (func_444(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_443(PLAYER::PLAYER_PED_ID());
			if (func_442(iVar0) && (!func_446(14) || Global_110809))
			{
				if (Global_111858.f_2359.f_539.f_4321 != iVar0 && func_442(Global_111858.f_2359.f_539.f_4321))
				{
...
void func_450(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
{
	if (func_452(Global_1590682[iParam0 /*883*/].f_274.f_28, -1) && !MISC::IS_BIT_SET(Global_1590682[iParam0 /*883*/].f_274.f_26, 1))
	{
		return 1;
	}
	return 0;
...
float func_454(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
int func_460(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
{
	func_463(1);
	func_462(&uLocal_520, 2, 0, "LJT", 0, 1);
}
...
void func_467()
{
	...
	if (func_484())
	{
		...
		iVar0 = func_459(iLocal_514);
		iVar1 = iLocal_514;
		iVar2 = func_27(iLocal_514);
		func_358(iVar1);
		if (!func_17(iLocal_514))
		{
			iVar3 = func_380(PLAYER::PLAYER_ID(), iLocal_514, func_458(PLAYER::PLAYER_ID(), iLocal_514));
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18602);
			iVar5 = SYSTEM::ROUND(fVar4);
			func_474(func_263(iLocal_514), &cVar10, &cVar6);
			func_473(iVar1, 1, &cVar6, &cVar10, iVar5, 1);
			func_474(!func_263(iLocal_514), &cVar10, &cVar6);
			fVar4 = (SYSTEM::TO_FLOAT(iVar3) * Global_262145.f_18603);
			iVar5 = SYSTEM::ROUND(fVar4);
		...
		while (iVar14 < 12)
		{
			...
			if (func_28(PLAYER::PLAYER_ID(), iLocal_514, iVar15) || Global_1590682[PLAYER::PLAYER_ID() /*883*/].f_274.f_183[iVar0 /*12*/].f_4 <= 0)
			{
				bVar16 = false;
			}
			iVar21 = func_19(iVar15, iLocal_514);
			iVar22 = -1;
			if (func_471(iLocal_514, iVar15) && bVar16)
			{
				iVar22 = iVar21;
				iVar21 = func_470(iVar15, iLocal_514);
			}
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "ADD_BUSINESS_UPGRADE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_BUSINESS_UPGRADE_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	...
	switch (iVar0)
	{
		...
		case 4:
			switch (iParam0)
			{
				...
				case 2:
					return Global_262145.f_17630;
				case 1:
					return Global_262145.f_17631;
				default:
					break;
			}
			break;
		case 3:
			...
			{
				case 0:
					return Global_262145.f_17632;
				case 2:
					return Global_262145.f_17633;
				case 1:
					return Global_262145.f_17634;
				default:
					break;
			}
			break;
		case 1:
			...
			{
				case 0:
					return Global_262145.f_17635;
				case 2:
					return Global_262145.f_17636;
				case 1:
					return Global_262145.f_17637;
				default:
					break;
			}
			break;
...
void func_473(int iParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, bool bParam5)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "ADD_BUSINESS_BUYER");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam2);
	GRAPHICS::_SCALEFORM_MOVIE_METHOD_ADD_PARAM_TEXTURE_NAME_STRING_2(sParam3);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam4);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_BUSINESS_BUYER_STATUS");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bParam5);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_475(bool bParam0)
{
	...
	sVar0 = func_477(PLAYER::PLAYER_ID());
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		sVar0 = func_476();
	}
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_685, "SET_PLAYER_DATA");
...
char* func_477(int iParam0)
{
	...
	if (func_479(iParam0, 1))
	{
		if (func_64(iParam0))
		{
			return func_478(&(Global_1630317[iParam0 /*595*/].f_11.f_104));
		}
		else
		{
			return func_478(&(Global_1630317[iParam0 /*595*/].f_11.f_349));
		}
	}
	else
	{
...
void func_485(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || bParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_275(PLAYER::PLAYER_ID(), 0) && !func_493()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_489(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					if (!bVar22)
					{
			...
			else
			{
				if (!func_489(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_486(Global_4456448.f_129348))
					{
...
void func_490(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		func_491(joaat("MPPLY_IS_CHAR_SPECTATING"), bParam0);
	}
}
...
int func_498(int iParam0)
{
	if (func_500(iParam0))
	{
		return func_499(Global_2425869[iParam0 /*443*/].f_314.f_6);
	}
	return 0;
}
...
int func_500(int iParam0)
{
	if (iParam0 != func_5())
	{
		if (func_267(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_266(Global_2425869[iParam0 /*443*/].f_314.f_6) == 2;
			}
		}
	}
	return 0;
...
void func_508(int iParam0)
{
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_685);
	func_501(iParam0);
	func_503(0);
	func_512();
	...
	if (!func_500(PLAYER::PLAYER_ID()) && !func_265(PLAYER::PLAYER_ID()))
	{
