...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBMN", 8);
	StringCopy(&cLocal_236, "MANI", 16);
	StringCopy(&cLocal_202, "Special_Ped@mani", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBMN_INTERACT";
	StringCopy(&cLocal_312, "PBMN_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBMN_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBMN_CONV_GF", 16);
