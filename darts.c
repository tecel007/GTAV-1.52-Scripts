...
void __EntryFunction__()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(ScriptParam_0.f_4))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ScriptParam_0, 5f, joaat("PROP_DART_BD_CAB_01"), false))
			{
				...
				OBJECT::GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(ScriptParam_0, 5f, joaat("PROP_DART_BD_CAB_01"), &ScriptParam_0, &vVar1784, 0);
	...
	{
		vVar1784 = { ENTITY::GET_ENTITY_COORDS(ScriptParam_0.f_4, true) };
	}
		...
		if (!PED::IS_PED_INJURED(iLocal_263[0]))
		{
			...
			switch (Var0)
			{
				case 0:
					...
					{
						vLocal_334 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Var0.f_243, 0.7792f, -1.138f, 0.1814f) };
						vLocal_337 = { -7.9947f, 0f, (Var0.f_243.f_4 + 36.19176f) };
						iLocal_129 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vLocal_334, vLocal_337, 65f, false, 2);
				...
				case 3:
					if (func_449(&Var477, &Var508))
					{
						...
						iLocal_59 = OBJECT::CREATE_OBJECT(iLocal_60, vVar471, true, true, false);
						Var0.f_446[0] = 0;
						Var0.f_446[1] = 0;
						Var0 = 4;
					}
				...
				case 4:
					...
					{
						iVar1824 = OBJECT::CREATE_OBJECT(joaat("PROP_DART_1"), vVar471, true, true, false);
						func_439(Var0.f_243.f_4, Var465, &iVar1803, &ScriptParam_0);
						func_438(&Var477, cLocal_358, sLocal_359);
						...
						func_437(&(Var0.f_257), 0, PLAYER::PLAYER_PED_ID(), cLocal_358, 0, 1);
						if (ENTITY::IS_ENTITY_DEAD(func_498(), false))
						{
							if (iLocal_302 == 2)
							{
				...
				case 9:
					if (func_333(&Var0, &Var477, &Var508))
					{
						...
						if (func_332(Global_111638.f_18965.f_5, &iLocal_294))
						{
					...
					switch (iVar1774)
					{
						case 0:
							if (func_423(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar1830 = func_240();
								iLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(vVar1787, vVar1790, 2);
								iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_4(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	if (!ENTITY::IS_ENTITY_DEAD(func_498(), false) || bParam2)
	{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_6(iParam3), false);
}
...
int func_10(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, bool bParam5)
{
	bool bVar0;
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (bLocal_268)
	{
		...
		if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_295) >= 0.995f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295))
		{
			...
			if (CAM::DOES_CAM_EXIST(iLocal_301))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_263[0]) && !PED::IS_PED_INJURED(iLocal_263[1]))
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_263[0]);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_263[1]);
					PED::_0x2208438012482A1A(iLocal_263[0], false, false);
					PED::_0x2208438012482A1A(iLocal_263[1], false, false);
				}
			}
			func_108();
		}
		...
		else if (((PAD::IS_CONTROL_JUST_PRESSED(0, 234) || PAD::IS_CONTROL_JUST_PRESSED(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			...
			if (bLocal_267)
			{
				vVar3 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_290 /*26*/], true) };
		...
		else if (((PAD::IS_CONTROL_JUST_PRESSED(0, 211) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (bLocal_286 || !PLAYER::IS_PLAYER_ONLINE()))
		{
			uParam1->f_680 = 1;
			func_120(&(uParam1->f_509), 0, 0, 1, 1);
			func_119(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if (!uParam0->f_457)
	{
		...
		iVar13 = func_240();
		iLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(vVar7, vVar10, 2);
		iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_1835392.f_2780.f_1)))
				{
					if (!func_192(uParam1->f_44))
					{
						if (Global_1835392.f_2780.f_26 > 0)
						{
							...
							func_191(*uParam0, &(Global_1835392.f_2780.f_1), &cVar25, &cVar9, Global_1835392.f_2780.f_25, Global_1835392.f_2780.f_26);
						}
						else
						{
			...
			if (!func_153(uParam1))
			{
				...
				if (!MISC::IS_BIT_SET(uParam1->f_42, 0))
				{
					...
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_1835392.f_2780.f_1)))
					{
						if (!func_192(uParam1->f_44))
						{
							...
							{
								cVar9 = { Global_1835392.f_2780.f_9 };
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &cVar25, &cVar9, 1, Global_1835392.f_2780.f_26);
							}
							else
							{
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &cVar25, &(Global_1835392.f_2780.f_9), Global_1835392.f_2780.f_25, -1);
				...
				if (Global_1835392.f_2825 == -1)
				{
					...
					while (iVar0 < 3)
					{
						...
						func_152(*uParam0, iVar6, iVar31, &cVar51);
						iVar6++;
						iVar0++;
					}
					Global_1835392.f_2825 = 1;
				...
				else if (func_150(&(Global_1835392.f_2823), 300, 0))
				{
					...
					while (iVar0 < 3)
					{
						...
						iVar31 = 0;
						MISC::SET_BIT(&iVar31, 7);
						func_152(*uParam0, iVar6, iVar31, &cVar57);
						iVar6++;
						iVar0++;
					}
							...
							if (func_144(Global_1839723[iVar0 /*100*/].f_32))
							{
								...
								if (!bVar63)
								{
									...
									if (func_192(uParam1->f_44))
									{
										...
										func_142(*uParam0, iVar6, iVar31, Global_1839723[iVar0 /*100*/].f_59, &cVar9, &(Global_1839723[iVar0 /*100*/].f_80));
...
int func_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, int iParam6, int iParam7)
{
	switch (*uParam0)
	{
		case 0:
...
int func_224(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<68> Var0;
	int iVar68;
	struct<13> Var69;
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_303("DARTS_SHT_USE") && !func_303("DARTS_INSTR_W")) && !func_303("DARTS_INSTR_B")) && !func_303("DARTS_AIM_HLP")) && !func_303("DARTS_STD_HLP")) && !func_303("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						MISC::SET_BIT(&(Global_111638.f_18965.f_6), iLocal_294);
						func_331(&(uParam3->f_666), 24, 0);
					}
				}
				if ((((uParam0->f_422[iLocal_30] % 2) == 0 && uParam0->f_422[iLocal_30] < 41) && iLocal_31 == 0) && !bLocal_272)
				{
				...
				else if (uParam0->f_422[iLocal_30] == 50 && !bLocal_272)
				{
					if (!func_3(&(uParam3->f_666), 6))
					{
						func_331(&(uParam3->f_666), 6, 1);
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			...
			else
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, true, false, false, true);
				}
			}
			func_270(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), 0);
			func_255(uParam0, uParam1);
			if (bLocal_275)
			{
				if (bLocal_277)
				{
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_1, vLocal_79, true, true, false);
					vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_55), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, true, false, false, true);
			...
			if (bLocal_275)
			{
				if (bLocal_277)
				{
					...
					while (iVar4 < iLocal_31 + 1)
					{
						...
						{
							uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_1, vLocal_79, true, true, false);
							...
							{
								ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/], vVar0, true, false, false, true);
							}
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
			{
				...
				vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_290 /*26*/], true) };
				func_50(vVar0);
			}
			...
			break;
		case 2:
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 201) || (bLocal_276 && bLocal_275))
			{
				bLocal_266 = true;
			}
...
int func_261(int iParam0)
{
	...
	if (iVar0 < 75)
	{
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			func_4(iParam0, "DARTS_MISS_BOARD", bVar1, 4);
		}
		return 1;
	}
	return 0;
...
int func_264(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		func_4(iParam0, "DARTS_BUST", bVar0, 4);
	}
	return 1;
}
...
int func_273(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (uParam0->f_2.f_1 > (uParam0->f_8.f_1 - 0.04f))
	{
		...
		ENTITY::SET_ENTITY_COORDS(*uParam0, vVar0, true, false, false, true);
		return 1;
	}
...
void func_274(char* sParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<9> Var0;
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else
	{
		...
		uParam0->f_24 = 1;
		func_287(uParam0);
		*uParam0 = OBJECT::CREATE_OBJECT(uParam0->f_1, vLocal_79, false, false, false);
		...
		fVar2 = MISC::GET_HEADING_FROM_VECTOR_2D((vVar7.x - vVar10.x), (vVar7.y - vVar10.y));
		fVar2 = (fVar2 - 180f);
...
int func_293(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	switch (iParam6)
	{
		case 0:
			...
			{
				if (!(PAD::IS_CONTROL_JUST_PRESSED(2, 223) && bLocal_101) && !bParam4)
				{
					bLocal_98 = true;
					bLocal_99 = true;
					if (!bLocal_100)
...
void func_301(var uParam0, struct<4> Param1, var uParam5, var uParam6)
{
	...
	vVar0.f_2 = (vVar0.z + MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f));
...
int func_302(var uParam0, var uParam1, bool bParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		ENTITY::SET_ENTITY_COORDS(*uParam0, vLocal_79, true, false, false, true);
	}
	else
	{
		*uParam0 = OBJECT::CREATE_OBJECT(uParam0->f_1, vLocal_79, false, false, false);
	...
	fVar11 = MISC::GET_HEADING_FROM_VECTOR_2D((vVar3.x - vVar6.x), (vVar3.y - vVar6.y));
	fVar11 = (fVar11 - 180f);
	fVar9 = 90f;
...
void func_304(int iParam0, bool bParam1)
{
	if (iParam0 == 0)
	{
		...
		else if (bParam1 && !MISC::IS_BIT_SET(Global_111599, 7))
		{
...
void func_307(vector3 vParam0)
{
	...
	iLocal_132 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vParam0, vVar0, 65f, false, 2);
...
void func_316(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	...
	*iParam0 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
	...
	if (fParam14 > 0f)
	{
		CAM::SET_CAM_NEAR_CLIP(*iParam0, fParam14);
	}
	if (iParam0->f_23)
	{
...
void func_323(var uParam0)
{
	...
	{
		if ((PAD::IS_CONTROL_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 223)) && bLocal_99)
		{
			*uParam0 = 6;
		}
	}
...
int func_342(int iParam0, bool bParam1, int iParam2)
{
	char cVar0[64];
	int iVar16;
	int iVar17;
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			else
			{
				...
				func_365(Global_22347, (Global_22348 + fVar57), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (Global_22350.f_5731 > Global_22350.f_5225)
			{
				...
				func_365(Global_22347, (fVar51 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (MISC::GET_HASH_KEY(&(Global_22350.f_4690)) != 0 && Global_22350.f_4766 != -1)
			{
				...
				func_365(Global_22347, (fVar51 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_18(Global_22350.f_4768, 1, 1, &fVar36, &fVar37, bParam7);
					func_360(Global_22350.f_4768, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4768), func_21(Global_22350.f_4768, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4268421.f_21)) != 0 && Global_4268421.f_65 != -1)
			{
				...
				{
					func_18(Global_4268421.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_360(Global_4268421.f_67, 1, &iVar47, &iVar48, &iVar49, &iVar50);
					GRAPHICS::DRAW_SPRITE(func_24(Global_4268421.f_67), func_21(Global_4268421.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
				}
				fVar51 = (fVar51 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
										...
										else if (Global_22350.f_2124[iVar24 /*5*/][iVar14] == 4)
										{
											if ((Global_22350.f_4433[(iVar22 + iVar28)] == 2 || Global_22350.f_4433[(iVar22 + iVar28)] == 51) || Global_22350.f_4433[(iVar22 + iVar28)] == 61)
											{
												if (func_18(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													{
														func_360(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
														if (iVar5 == 1)
														{
															if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar28)]), func_21(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar28)]), func_21(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
														}
											...
											if ((Global_22350.f_4433[(iVar22 + iVar14)] != 2 && Global_22350.f_4433[(iVar22 + iVar14)] != 51) && Global_22350.f_4433[(iVar22 + iVar14)] != 61)
											{
												if (func_18(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														...
														{
															func_360(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
															if (Global_22350.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (Global_22347 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[(iVar22 + iVar14)]), func_21(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, false);
															}
														}
													}
								...
								if (bVar33)
								{
									if (func_18(Global_22350.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											...
											{
												func_360(Global_22350.f_4433[iVar22], bVar32, &iVar47, &iVar48, &iVar49, &iVar50);
												GRAPHICS::DRAW_SPRITE(func_24(Global_22350.f_4433[iVar22]), func_21(Global_22350.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_348(Global_22350.f_4433[iVar22])), (fVar37 * func_348(Global_22350.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, false);
											}
										}
									}
								}
...
void func_355(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_408(int* iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		ENTITY::SET_ENTITY_COORDS(*iParam0, vVar0, true, false, false, true);
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(iParam0);
		OBJECT::DELETE_OBJECT(iParam0);
	}
}

void func_409(vector3 vParam0, float fParam3, vector3 vParam4, vector3 vParam7, int iParam10)
{
...
void func_415(vector3 vParam0, float fParam3, vector3 vParam4, vector3 vParam7, int iParam10, bool bParam11)
{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_6(iParam2), true);
}
...
int func_432(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (!func_433(iVar0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), vLocal_260, false, true, 0))
			{
...
void func_455(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	int iVar1;
	...
	if (!func_456(vParam2) && fParam5 != 0f)
	{
...
void func_460(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	iLocal_120 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vVar0, vVar6, fVar21, false, 2);
	iLocal_121 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vVar3, vVar9, fVar21, false, 2);
	iLocal_122 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vVar12, vVar15, 65f, false, 2);
	iLocal_123 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vVar35, vVar18, 65f, false, 2);
	...
	iLocal_126 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, false, 2);
...
void func_478(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0))
	{
		...
		if (bLocal_278)
		{
			if (!MISC::IS_BIT_SET(Global_111599, 10))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_302 == 2, vLocal_343, vLocal_349), 1f, 20000, 0.25f, false, func_123(iLocal_302 == 2, fLocal_353, fLocal_355));
			}
			else
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_302 == 2, vLocal_340, vLocal_346), 1f, 20000, 0.25f, false, func_123(iLocal_302 == 2, fLocal_352, fLocal_354));
			}
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, true);
		}
		else
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_302 == 2, vLocal_340, vLocal_346), 1f, 20000, 0.25f, false, func_123(iLocal_302 == 2, 172.6813f, 142.6717f));
