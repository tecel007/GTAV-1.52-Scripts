...
int func_204(int* iParam0, bool bParam1)
{
	...
	if ((UNK_0xDCA0815D900F27F8() && (((iVar1 == 4 || iVar1 == 2) || iVar1 == 1) || iVar1 == 5)) || (!func_210() && NETWORK::NETWORK_IS_SIGNED_ONLINE()))
	{
...
void func_304(int iParam0, bool bParam1)
{
	if (iParam0 == 0)
	{
		...
		else if (bParam1 && !MISC::IS_BIT_SET(Global_111819, 7))
		{
...
void func_490(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_492(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
int func_492(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 63:
			...
			*fParam2 = 120f;
			return 1;
			Jump @2416; //curOff = 2184
			*uParam1 = { 0f, 0f, 0f };
			*fParam2 = 0f;
			return 1;
			Jump @2416; //curOff = 2202
			*uParam1 = { -818.7374f, 6.4824f, 41.2432f };
			*fParam2 = 211.8223f;
			return 1;
			Jump @2416; //curOff = 2236
			*uParam1 = { 2091.258f, 4714.852f, 40.1936f };
			*fParam2 = 136.0867f;
			return 1;
			Jump @2416; //curOff = 2270
			*uParam1 = { 1762.59f, 3247.212f, 40.735f };
			*fParam2 = 27.0648f;
			return 1;
			Jump @2416; //curOff = 2304
			*uParam1 = { 1764.013f, 3252.902f, 40.735f };
			*fParam2 = 27.0648f;
			return 1;
			Jump @2416; //curOff = 2338
			*uParam1 = { 0f, 0f, 0f };
			*fParam2 = 0f;
			return 1;
			Jump @2416; //curOff = 2356
			*uParam1 = { 0f, 0f, 0f };
			*fParam2 = 0f;
			return 1;
			Jump @2416; //curOff = 2374
			*uParam1 = { 0f, 0f, 0f };
			*fParam2 = 0f;
			return 1;
			Jump @2416; //curOff = 2392
			*uParam1 = { 0f, 0f, 0f };
			*fParam2 = 0f;
			return 1;
			return 0;
