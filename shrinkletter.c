	...
	while (true)
	{
		switch (iLocal_52)
		{
			...
			case 1:
				...
				iLocal_53 = UNK_0x5DEA4192B46CB99B("PSYCHOLOGY_REPORT");
				...
				func_42(&Var0);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				while (!func_13(&uLocal_70, &bLocal_71, &uLocal_54))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
			...
			case 2:
				GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
				GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_53, 255, 255, 255, 255, 0);
				func_1(&iLocal_72, 1128792064 /* Float: 200f */, 1, 0, 1, 1065353216 /* Float: 1f */);
...
int func_13(var uParam0, bool bParam1, var uParam2)
{
	char* sVar0;
...
{
	if (!DATAFILE::DATAFILE_UPDATE_SAVE_TO_CLOUD(bParam0))
	{
		if (*bParam0)
		{
			if (DATAFILE::DATAFILE_GET_FILE_DICT() != 0 && bParam1)
			{
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return MISC::IS_BIT_SET(Global_111858.f_18099.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
int func_36(int iParam0)
{
	...
	{
		case 0:
			return Global_111858.f_10045.f_90[0];
		case 1:
			return Global_111858.f_10045.f_90[1];
		case 2:
			return Global_111858.f_10045.f_90[2];
	}
	return 0;
}
