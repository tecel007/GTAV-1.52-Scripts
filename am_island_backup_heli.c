#region Local Var
	...
	var uLocal_81 = 745926877;
	var uLocal_82 = 0;
	var uLocal_83 = 2;
	var uLocal_84 = 0;
	var uLocal_85 = 2064532783;
	var uLocal_86 = 0;
	var uLocal_87 = 2064532783;
	var uLocal_88 = 0;
	var uLocal_89 = 0;
	var uLocal_90 = 0;
	var uLocal_91 = 0;
	...
	switch (Local_79.f_1.f_2)
	{
		...
		case 2:
			...
			else
			{
				...
				{
					if (func_4(&(Local_79.f_1.f_15), Global_262145.f_10618, 0))
					{
						func_60(3);
					}
				}
...
{
	Global_2540384.f_443 = iParam0;
}

bool func_15()
{
	return Global_2540384.f_443;
}

void func_16()
{
	if (Global_2440049.f_4119)
	{
		func_17(1, 600000);
		bLocal_63 = true;
	}
	if (Global_2440049.f_4118 >= 250f)
	{
		func_17(1, 600000);
		bLocal_63 = true;
	}
		...
		if (func_39(Local_79.f_1.f_3[1 /*2*/].f_1) && func_39(iVar0))
		{
			if (!func_12(Local_79.f_1))
			{
				if (func_36(&(Local_79.f_1), Local_79.f_1.f_1, Local_79.f_1.f_8, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					func_35(iVar1, 4);
					Global_2440049.f_4120 = iVar1;
					ENTITY::SET_ENTITY_HEALTH(iVar1, Global_262145.f_10619, 0);
					if (func_34(&(Local_79.f_1.f_3[0 /*2*/]), Local_79.f_1, 4, iVar0, -1, 1, 1, 1))
					{
						...
						func_35(iVar2, 4);
						Global_2440049.f_4120.f_1[0] = iVar2;
						...
						if (func_34(&(Local_79.f_1.f_3[1 /*2*/]), Local_79.f_1, 4, Local_79.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							Global_2440049.f_4120.f_1[1] = NETWORK::NET_TO_PED(Local_79.f_1.f_3[1 /*2*/]);
...
int func_36(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	float fVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = NETWORK::VEH_TO_NET(iVar1);
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_37(vParam2, fParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_37(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	int iVar0;

	if (func_38(PLAYER::PLAYER_ID(), vParam0, iParam4) > -1)
	{
...
int func_38(int iParam0, vector3 vParam1, int iParam4)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_40()
{
	...
	if (func_59(Local_79.f_1.f_8))
	{
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				vVar0 = { func_57(func_58(PLAYER::PLAYER_ID()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_79.f_1.f_13) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_79.f_1.f_13) * 30f))), 0f) };
				vVar0.f_2 = PATHFIND::_GET_HEIGHTMAP_TOP_Z_FOR_POSITION(vVar0.x, vVar0.y);
				vVar0.f_2 = (vVar0.z + 30f);
				if (func_41(vVar0, 20f, 1f, 1f, 15f, 1, 1, 1, 180f, 0, -1, 1, 0, 0, 0, 0, 0))
				{
					Local_79.f_1.f_8 = { vVar0 };
					return 1;
				}
				else
				{
...
int func_41(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	if (fParam14 > 0f)
	{
		if (func_50(vParam0, fParam14, 1, 1, bParam15, bParam17, bParam11, bParam15))
		{
			return 0;
		}
	}
	...
	if (bParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_42(vParam0, fParam6, iParam7, fParam9, bParam10, bParam11, bParam12, bParam16, bParam17))
			{
				return 0;
			}
		}
...
int func_42(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam4 && !bParam7)
	{
		if (func_49(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_47(PLAYER::PLAYER_ID()), vParam0, true) <= (bVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_49(iVar1, 1, 1))
		{
			if (!func_44(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_43(iVar1) || !bParam10) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						bVar2 = bParam6;
						if (bParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_47(iVar1), vParam0, true) <= (bVar2 + fParam3))
								{
...
Vector3 func_47(int iParam0)
{
	...
	iVar0 = iParam0;
	if ((func_48() && Global_1590682[iVar0 /*883*/].f_854) && !func_59(Global_1590682[iVar0 /*883*/].f_855))
	{
...
int func_50(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
			...
			if (func_49(iVar1, bParam4, bParam5))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_43(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && bParam9) && bParam6) && func_51(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_58(iVar1), vParam0, true) < fParam3)
								{
									return 1;
								}
							}
...
int func_51(int iParam0)
{
	...
	Global_2515173 = { func_55(iParam0) };
...
int func_56(int iParam0, int iParam1)
{
	...
	{
		Global_2515173 = { func_55(iParam0) };
		Global_2515186 = { func_55(iParam1) };
...
Vector3 func_57(vector3 vParam0, float fParam3, struct<2> Param4, float fParam6)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_69()
{
	...
	if (!func_4(&uLocal_75, Global_1689719, 0))
	{
		return;
	}
	func_70(&uLocal_75);
...
void func_71()
{
	...
	if (func_77(iVar6))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar6, true), ENTITY::GET_ENTITY_COORDS(iVar2, true), false) > Global_1689721)
		{
			return;
		}
	}
...
int func_74(int iParam0)
{
	...
	{
		return Global_1630317[func_54(iParam0) /*595*/].f_11.f_457;
	}
	return func_53();
}
...
bool func_75(int iParam0, bool bParam1)
{
	...
	return Global_1630317[iParam0 /*595*/].f_11 != func_53();
}
...
int func_76(int iParam0)
{
	if (iParam0 != func_53())
	{
		if (Global_1630317[iParam0 /*595*/].f_11 != func_53())
		{
...
void func_83()
{
	...
	if (bVar0)
	{
		vVar1 = { func_58(PLAYER::PLAYER_ID()) };
		fLocal_68 = PATHFIND::_GET_HEIGHTMAP_TOP_Z_FOR_POSITION(vVar1.x, vVar1.y);
		if (fLocal_68 < Global_262145.f_10620)
		{
			fLocal_68 = Global_262145.f_10620;
		}
		func_70(&uLocal_69);
	}
}
...
void func_84()
{
	Global_2440049.f_4120 = 0;
	Global_2440049.f_4120.f_1[0] = 0;
	Global_2440049.f_4120.f_1[1] = 0;
	Global_2440049.f_4120.f_5 = 0f;
	Global_2440049.f_4120.f_6 = 0;
	Global_2440049.f_4120.f_7 = 0;
	func_85();
}
...
void func_98(struct<21> Param0)
{
	func_102(32, Param0);
	NETWORK::RESERVE_NETWORK_MISSION_PEDS(2);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	func_100(0, -1, 0);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_79, 20);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&iLocal_99, 33);
...
void func_102(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_85();
