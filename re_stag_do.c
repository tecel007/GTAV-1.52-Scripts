...
int func_3()
{
	...
	if (iLocal_49 == 3)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_57))
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, false, true, 0) && bLocal_310)
			{
				if (!bLocal_127)
				{
					func_27();
...
bool func_42(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_58(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_64(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_95()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_55))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, false))
		{
			if (!PED::IS_PED_INJURED(iLocal_55))
			{
				if (!bLocal_129 && bLocal_118)
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_55, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, false, true, 0) || SYSTEM::TIMERA() > 5000)
					{
						...
						CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
						MISC::CLEAR_AREA_OF_VEHICLES(vLocal_99, 10f, false, false, false, false, false, false);
				...
				if (bLocal_129 && CAM::DOES_CAM_EXIST(iLocal_134))
				{
				...
				{
					MISC::CLEAR_AREA_OF_VEHICLES(vLocal_87, 5f, false, false, false, false, false, false);
				}
			}
			if (!bLocal_123)
			{
			...
			if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_70, vLocal_73, fLocal_76, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_55, vLocal_70, vLocal_73, fLocal_76, false, true, 0)) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_55, vLocal_67, 0f, 0f, 2f, true, true, 0) && func_66(1, 0, 1))) || bLocal_118)
			{
				switch (iLocal_49)
				{
					case 0:
						...
						if (!bLocal_118)
						{
							...
							if (!func_71())
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_55))
								{
									...
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_99, 3f, 20000, 0.25f, false, 40000f);
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_113);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_113);
						...
						{
							if ((bLocal_118 && ENTITY::IS_ENTITY_AT_COORD(iLocal_55, vLocal_99, 1f, 1f, 1f, false, true, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, false))
							{
								if (PED::IS_PED_IN_GROUP(iLocal_55))
								{
									if (!func_71())
								...
								if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_55))
								{
									...
									if (SYSTEM::TIMERA() > 15000)
									{
										if (!PED::IS_PED_INJURED(iLocal_55))
										{
											...
											ENTITY::SET_ENTITY_COORDS(iLocal_55, vLocal_99, true, false, false, true);
					...
					case 1:
						if (!PED::IS_PED_INJURED(iLocal_55) && !ENTITY::IS_ENTITY_DEAD(iLocal_59, false))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, iLocal_59, 5f, 5f, 5f, false, true, 0) && !bLocal_128)
							{
...
void func_97()
{
	if ((bLocal_310 && iLocal_307 != func_80(func_81())) && !CAM::DOES_CAM_EXIST(iLocal_134))
	{
...
void func_107()
{
	...
	if (((((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, false, true, 0) || iLocal_49 == 1) || bLocal_126) || bLocal_127) || bLocal_125) || bLocal_118)
	{
...
int func_112(bool bParam0)
{
	if (func_116())
	{
		...
		if (bParam0 && func_45(Global_111847))
		{
...
void func_122()
{
					...
					if (func_66(1, 0, 1))
					{
						if (!bLocal_311)
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_55))
							{
								...
								PED::_0x2208438012482A1A(iLocal_55, false, false);
	...
	if (bLocal_311 && !bLocal_312)
	{
		...
		if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_318) > 0.4647059f && !bLocal_317)
		{
	...
	if (bLocal_314 && !PED::IS_PED_INJURED(iLocal_55))
	{
...
void func_127()
{
	...
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_87 - Vector(10f, 10f, 10f), vLocal_87 + Vector(10f, 10f, 10f), false, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_87 - Vector(20f, 20f, 20f), vLocal_87 + Vector(20f, 20f, 20f), false, true, true, true);
...
int func_153(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_176(Global_111858.f_24991.f_43[iParam3]))
		{
			return 0;
		}
...
void func_158(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_159(func_81(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_159(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_110905) || Global_30970) || func_173()) || func_24(8, -1)) || func_172()) || func_171()) || func_170()) || func_169()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						...
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_110905) || Global_30970) || func_173()) || func_24(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_110905) || Global_30970) || func_173()) || func_24(8, -1)) || func_172()) || func_171()) || func_169()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_174() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_24(8, -1)) || func_169()) || func_168()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_174()) || Global_30970) || func_173()) || func_24(8, -1)) || func_171()) || func_170()) || func_169()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_174()) || func_171()) || Global_110905) || Global_30970) || func_173()) || Global_42801) || func_24(8, -1)) || func_170()) || func_168()) || func_169()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_174()) || Global_110905) || Global_30970) || func_173()) || func_24(8, -1)) || func_170()) || func_168()) || func_172()) || func_171()) || func_169())
						{
							return 0;
						}
						break;
...
void func_183()
{
	...
	{
		func_219(0);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_87 - Vector(10f, 10f, 10f), vLocal_87 + Vector(10f, 10f, 10f), true, true);
...
void func_189(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_81();
	func_192(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
...
struct<16> func_190(int iParam0)
{
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_86(*iParam0), 64);
	return Var0;
}
...
void func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 + iParam6);
	func_193(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_218(int iParam0, int iParam1, char* sParam2, int iParam3)
{
