...
void __EntryFunction__()
{
	...
	vLocal_309 = { ScriptParam_0.f_1[0 /*3*/] };
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_309, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_308)
	{
		case 0:
			...
			{
				if (PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), vLocal_312, 90f) || bLocal_317)
				{
					func_32("TV_HLP0");
		...
		case 1:
			if (func_31(1, 0, 1))
			{
				if (func_35(vLocal_309, vVar0) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_309, 3f, joaat("PROP_CS_REMOTE_01"), false))
				{
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_CONTROL_PRESSED(0, 51))
						{
							...
							MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_312, 3f, 0);
		...
		case 2:
			...
			iLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
			if (Global_31028[1 /*11*/].f_2)
			{
...
int func_18()
{
	...
	iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 3f, joaat("PROP_CS_REMOTE_01"), false, false, true);
	return iVar0;
}
...
int func_35(vector3 vParam0, Vector3 vParam3, var uParam4, var uParam5)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95883 && Global_95884) || func_37())
					{
						return 0;
					}
					if (func_36(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, vParam3, 0))
					{
						return 1;
					}
				}
...
int func_41()
{
	...
	iVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 10f, joaat("PROP_CS_REMOTE_01"), false, false, true);
...
{
	return func_48(iParam0, Global_41631);
}
...
void func_50()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_54(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_52(iVar0) && (!func_51(14) || Global_110809))
			{
...
void func_57()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && func_31(1, 0, 1)) && bLocal_51)
		{
			func_21(0, 1, 1, 0, 0, 0, 0);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
