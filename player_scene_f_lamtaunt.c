	...
	while (bLocal_261 && func_138(2, 0))
	{
		...
		switch (iLocal_70)
		{
			...
			case 2:
				if (func_134())
				{
					func_133(&uLocal_72, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_133(&uLocal_72, 2, Global_98676, "LAMAR", 0, 1);
					iLocal_70 = 3;
				}
				break;
			case 3:
...
int func_2()
{
	...
	func_126(&Global_98676, iLocal_262);
	func_3(Global_98676);
	return 0;
}
...
void func_3(int iParam0)
{
	...
	{
		if (!bLocal_517 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), true))
		{
			bVar0 = func_125(iParam0);
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_109(75, ENTITY::GET_ENTITY_COORDS(iParam0, false), 250f, -1);
						if (func_41(Global_94689, bVar0, 2, 0, iVar3, iVar2, 75))
						{
							bLocal_517 = true;
						}
					}
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int* iParam5, int iParam6)
{
	...
	switch (iVar7)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (Global_93961[2] == 65 || Global_93961[2] == 66)
			{
				return 0;
			}
	...
	if (iVar18 || func_31(sParam3, &Var8, uParam4))
	{
		if (iVar7 == 5)
		{
			if (iVar6 == 0)
			{
				func_133(uParam2, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (iVar6 == 1)
			{
				func_133(uParam2, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (iVar6 == 2)
			{
				func_133(uParam2, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)
{
	...
	if (func_29(sParam0, 7))
	{
		...
		{
			func_133(uParam2, 0, PLAYER::PLAYER_PED_ID(), sVar0, 0, 1);
...
void func_39()
{
	...
	{
		if (func_34(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_40(PLAYER::PLAYER_PED_ID());
			if (func_36(iVar0) && (!func_24(14) || Global_110809))
			{
...
int func_41(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam3 == 0)
	{
		if (func_106(iVar1, iParam2, -1, &iVar4, &iVar5))
		{
			...
			if (func_102(iParam5, iVar4, iVar5, iVar0, iVar2, bParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6, 1))
			{
				return 1;
			}
			else
...
void func_47(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_49() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_49() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_53(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_55(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_49() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_84(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_86(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (bParam7 == 1)
		{
			Global_8258 = iParam6;
			Global_8161[3 /*6*/] = { func_85(bParam0) };
			Global_8238 = bParam0;
...
int func_86(bool bParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	if (!Global_19865)
	{
		...
		{
			func_91(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_88(1);
			func_91(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19661), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	func_87(bParam0, sParam1);
	return 1;
}

void func_87(bool bParam0, char* sParam1)
{
	if (!func_15())
	{
		return;
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (Global_2462245)
							{
								if (iVar1 == 14)
								{
									func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22068), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8120[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7558[iVar1 /*15*/].f_4)
					{
						if (Global_8120[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22073), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76833)
								{
									...
									func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19681)
									...
									func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7558[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_89(Global_19662, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7558[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7558[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8120[iVar0] = 1;
						}
					}
...
void func_95()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_96(Global_111858.f_14137[iVar2 /*104*/].f_18, Global_111858.f_14137[Global_22072 /*104*/].f_18))
		{
			Global_22072 = iVar2;
		}
		iVar2++;
...
void func_109(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	Global_41632[iParam0 /*5*/] = { vParam1 };
	Global_41632[iParam0 /*5*/].f_3 = fParam4;
	Global_41632[iParam0 /*5*/].f_4 = iParam5;
}
...
int func_111(int iParam0, int iParam1)
{
	...
	bVar10 = false;
	if (MISC::IS_BIT_SET(Var0.f_2, func_112()))
	{
		bVar10 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar10)
	{
		if (Var0.f_3 < Global_111858.f_7684.f_919[func_112()])
		{
			return 5;
		}
	}
...
int func_120(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (5 - 1))
	{
		if (Global_94158[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_94158[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
		...
		switch (iLocal_270[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_361, &(Local_442[iParam1 /*16*/]), 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285) > fVar1)
					{
						...
						if (PED::IS_PED_INJURED(*iParam0))
						{
							...
							TASK::TASK_GO_STRAIGHT_TO_COORD(*iParam0, vLocal_277 + vLocal_291[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 40000f, 0.5f);
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96284) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
				{
					SYSTEM::WAIT(0);
					if (PED::IS_PED_INJURED(*iParam0))
					{
			...
			case 1:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_277 + vLocal_291[iParam1 /*3*/], 1f, -1, 0.25f, bVar0, 40000f);
					iLocal_270[iParam1] = 2;
					return 1;
				}
				fVar7 = SYSTEM::VMAG(vLocal_291[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_277) >= fVar7)
				{
					if (!func_131() && !ENTITY::IS_ENTITY_ON_SCREEN(*iParam0))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_277 + vLocal_291[iParam1 /*3*/], 1f, -1, 0.25f, bVar0, 40000f);
						iLocal_270[iParam1] = 2;
						return 1;
			...
			case 2:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 713668775) != 1)
				{
					...
					TASK::TASK_WANDER_IN_AREA(*iParam0, vLocal_277 + vLocal_291[iParam1 /*3*/], fLocal_308[iParam1], 3f, 6f);
			...
			case 3:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_277 + vLocal_291[iParam1 /*3*/]) < (fLocal_308[iParam1] * fLocal_308[iParam1]))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_277 + vLocal_291[iParam1 /*3*/], fLocal_308[iParam1], true))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_277 + vLocal_291[iParam1 /*3*/], fLocal_308[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					else if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar8, false, &vVar11, 14))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vVar11) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar11, 1f, -1, 0.25f, bVar0, 40000f);
							iLocal_270[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_275, Global_93959);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_93959, iLocal_275);
...
Vector3 func_128(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_129(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_134()
{
	...
	if (!func_135())
	{
		...
		{
			fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285);
			if (!bLocal_512)
			{
				if (fVar0 < fLocal_511)
				{
	...
	if (!func_135())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
		{
			...
			while (iVar0 < iLocal_262)
			{
				...
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_96285, &cLocal_361, &(Local_442[iVar0 /*16*/]), 8f, -4f, 3, 0, 1000f, 0);
					iLocal_270[iVar0] = 0;
				}
				else
				{
...
int func_137()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96284))
	{
		...
		while (iVar0 < iLocal_262)
		{
			if (!PED::IS_PED_INJURED(iLocal_262[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_96284, &cLocal_361, &(Local_377[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			func_133(&uLocal_72, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_98676))
		{
			func_133(&uLocal_72, 4, Global_98676, "LAMAR", 0, 1);
		}
...
int func_138(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_139(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
...
void func_146()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_98676))
	{
		if (func_37(19) == ENTITY::GET_ENTITY_MODEL(Global_98676))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_98676, true, true);
		}
		func_147(&Global_98676, Global_93959);
		PED::SET_PED_CONFIG_FLAG(Global_98676, 132, true);
		PED::SET_PED_CONFIG_FLAG(Global_98676, 317, true);
		func_147(&Global_98676, Global_93959);
	}
	...
	while (iVar0 < iLocal_262)
	{
		if (iLocal_266[iVar0] != 0)
		{
			iLocal_262[iVar0] = PED::CREATE_PED(iLocal_276, iLocal_266[iVar0], vLocal_277 + vLocal_281[iVar0 /*3*/], 0f, true, true);
...
void func_148()
{
	...
	iLocal_71 = Global_98358;
	func_152(iLocal_71, &vLocal_277, &fLocal_280, &cVar0);
	func_150(iLocal_71, &uLocal_313, &cLocal_329, &cLocal_345, &uVar8, &uVar9);
	switch (iLocal_71)
	{
		case 218:
			vLocal_281[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_281[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
...
int func_152(int iParam0, var uParam1, float fParam2, char* sParam3)
{
	int iVar0;

	if (func_154(iParam0, fParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_158(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_158(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_158(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
