...
void func_2()
{
	...
	switch (iLocal_327)
	{
		...
		case 7:
			...
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338)) && !func_8()) && !func_6()) && Global_1312467.f_8 == 0)
			{
				bLocal_329 = true;
				MISC::CLEAR_BIT(&iLocal_325, 0);
				iLocal_331 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, false, false, 1f, 0f, 1f);
...
void func_17(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
{
	return MISC::IS_BIT_SET(Global_1377170.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
