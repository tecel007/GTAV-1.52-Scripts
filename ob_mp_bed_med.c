...
void __EntryFunction__()
{
	...
	vLocal_338 = { ScriptParam_0.f_1[0 /*3*/] };
	vLocal_338 = { 349.9853f, -997.8344f, -99.1952f };
	if ((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18) || func_83()) || Global_2540384.f_1913)
	{
		func_82();
	}
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_338, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_326)
				{
					case 0:
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_338, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 6f)
			{
				func_82();
			}
		}
...
void func_1()
{
	iLocal_332 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_331);
	switch (iLocal_327)
	{
		case 0:
			break;
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (func_73() == 5)
			{
				...
				iLocal_331 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, false, true, 1f, 0f, 1f);
			...
			{
				if ((((func_50(vLocal_338, vVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_342, vLocal_345, 2f, false, true, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (iLocal_333 == -1)
					{
			...
			break;
		case 1:
			vLocal_354 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) };
			if (func_44(1, 0, 1))
			{
				if ((((((func_50(vLocal_338, vVar0) && vLocal_354.z < (vLocal_338.z + 1f)) && func_54(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_342, vLocal_345, 2f, false, true, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (func_42(iLocal_333, 1))
					{
						...
						func_37();
						MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_338, 3f, 0);
						Global_1573337 = 9;
						func_27(PLAYER::PLAYER_ID(), 0, 256, 0);
						bLocal_36 = true;
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
						func_17(1, 1, 1, 0, 0, 0, 0);
						vLocal_338 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_334, sLocal_335, vLocal_348, vLocal_351, 0f, 2) };
						vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_334, sLocal_335, vLocal_348, vLocal_351, 0f, 2) };
						fLocal_341 = vVar3.z;
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_338, 1f, 5000, fLocal_341, 0.05f);
		...
		case 2:
			...
			{
				MISC::CLEAR_BIT(&iLocal_325, 0);
				iLocal_331 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, false, false, 1f, 0f, 1f);
		...
		case 6:
			...
			break;
		case 7:
			if ((!func_8() && INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338))) && iLocal_330 == 1)
			{
				CAM::_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
			}
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338)) && !func_8()) && !func_6()) && Global_1312485.f_8 == 0)
			{
				bLocal_329 = true;
				MISC::CLEAR_BIT(&iLocal_325, 0);
				iLocal_331 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, false, false, 1f, 0f, 1f);
...
{
	if (!Global_2409291 == iParam0)
	{
		Global_2409291.f_1 = 0;
	}
	Global_2409291 = iParam0;
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2409291.f_3 = NETWORK::GET_NETWORK_TIME();
	}
}
...
float func_16(struct<2> Param0, int iParam2, struct<2> Param3, Vector3 vParam5)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

void func_17(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_24(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_27(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
{
	return MISC::IS_BIT_SET(Global_1377236.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
int func_49()
{
	...
	if (iVar9 > 0)
	{
		...
		while (iVar10 <= 7)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar10], vLocal_342, vLocal_345, 2f, false, true, 0))
				{
					return 0;
				}
			}
...
int func_50(vector3 vParam0, Vector3 vParam3, var uParam4, var uParam5)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95883 && Global_95884) || func_52())
					{
						return 0;
					}
					if (func_51(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, vParam3, 0))
					{
						return 1;
					}
				}
...
{
	if ((((((MISC::IS_BIT_SET(Global_1573336, iParam0) || Global_1573337 != -1) || func_59()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_58()) || func_55(iParam0))
	{
		return 0;
	}
	return 1;
...
{
	return func_81(iParam0, Global_41631);
}
...
void func_82()
{
	...
	if (bLocal_328)
	{
		UNK_0x1082C25039B168F8(sLocal_334);
	}
	func_4();
