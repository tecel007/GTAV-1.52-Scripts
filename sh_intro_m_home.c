		...
		switch (iLocal_37)
		{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					vVar3 = { -808.7974f, 169.3193f, 70.9558f };
					vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (func_219(vVar0, vVar3, 100f) || bLocal_40)
					{
						if (func_216() || bLocal_40)
						{
							...
							if ((vVar0.z > 59f && vVar0.z < 90f) || bLocal_40)
							{
								if (func_220(&uLocal_53, vVar0) || bLocal_40)
								{
									if (func_210() || bLocal_40)
									{
										if (!bLocal_40)
										{
											func_209(1);
			...
			case 5:
				func_1(25);
				MISC::SET_BIT(&(Global_2621447[17]), 1);
				MISC::SET_BIT(&(Global_2621447[18]), 1);
				MISC::SET_BIT(&(Global_2621447[19]), 1);
				func_224();
				break;
		}
		SYSTEM::WAIT(0);
...
void func_2()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			case 0:
				if (func_199(0, 1093140480 /* Float: 10.5f */, 0))
				{
					...
					vVar0[0 /*3*/] = { -842.1f, 178.6f, 72.2f };
					vVar7[0 /*3*/] = { 6.6f, 0f, -96.1f };
					fVar14[0] = 39.8f;
					vVar0[1 /*3*/] = { -842f, 178.8f, 72.2f };
					vVar7[1 /*3*/] = { 6.6f, 0f, -96.1f };
					fVar14[1] = 39.8f;
					vVar17 = { func_61(vVar7[0 /*3*/]) };
					...
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 0, 0, 2);
					}
				...
				break;
			case 1:
				vVar0[0 /*3*/] = { -810.7f, 179.2f, 77.3f };
				vVar7[0 /*3*/] = { -10.7f, 0f, 60.7f };
				fVar14[0] = 50f;
				vVar0[1 /*3*/] = { -810.7f, 179.2f, 77.2f };
				vVar7[1 /*3*/] = { -10.7f, 0f, 60.7f };
				fVar14[1] = 50f;
				vVar17 = { func_61(vVar7[0 /*3*/]) };
				fVar20 = 12f;
				...
				{
					STREAMING::NEW_LOAD_SCENE_START(vVar0[0 /*3*/], vVar17, fVar20, 2);
				}
				break;
			case 2:
				vVar0[0 /*3*/] = { -814.4f, 174.1f, 76.7f };
				vVar7[0 /*3*/] = { -1.2f, 0f, -70.6f };
				fVar14[0] = 50.1f;
				vVar0[1 /*3*/] = { -814.4f, 174.1f, 76.7f };
				vVar7[1 /*3*/] = { 18.9f, 0f, -70.6f };
				fVar14[1] = 50.1f;
				vVar17 = { func_61(vVar7[0 /*3*/]) };
				fVar20 = 10f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar21) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar22)
				{
					...
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
				...
				break;
			case 3:
				vVar0[0 /*3*/] = { -803.8f, 168.2f, 73.4f };
				vVar7[0 /*3*/] = { -10.5f, 0f, -18.4f };
				fVar14[0] = 54f;
				vVar0[1 /*3*/] = { -803.8f, 168.3f, 73.6f };
				vVar7[1 /*3*/] = { -10.5f, 0f, -18.4f };
				fVar14[1] = 54f;
				vVar17 = { func_61(vVar7[0 /*3*/]) };
				fVar20 = 25f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_48) > iVar21) || (MISC::GET_GAME_TIMER() - iLocal_50) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_46))
					{
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], (iVar21 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(iLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], (iVar21 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
				...
				break;
			case 4:
				vVar0[0 /*3*/] = { -803.574f, 181.4357f, 73.2662f };
				vVar7[0 /*3*/] = { -8.1845f, 0f, -48.1518f };
				fVar14[0] = 41.6f;
				vVar0[1 /*3*/] = { -803.6697f, 181.5426f, 73.2662f };
				vVar7[1 /*3*/] = { -8.1845f, 0f, -48.1518f };
				fVar14[1] = 41.6f;
				vVar17 = { func_61(vVar7[0 /*3*/]) };
				fVar20 = 12f;
			...
			case 5:
				if (iLocal_44 == 0)
				{
					if (UNK_0xF7B3A1430308F92B(CAM::_0x19CAFA3C87F7C2FF()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_48) >= (iVar21 - 300))
					{
...
void func_11(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_47(iParam5, &Var0, vParam1, fParam4, func_53(iParam0));
...
void func_12(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_43(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_32();
			}
...
void func_13(int iParam0, int iParam1)
{
	...
	func_55(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_29(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_30(iParam1, iVar0, &uVar1, &iVar9))
	{
...
int func_30(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_43(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_54(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_47(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_43(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_52(iParam0);
			func_51(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_66(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_181(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_73(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	{
		if (!func_181(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_74(int iParam0, int iParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (iParam1 == 12)
		{
			...
			while (bVar0 <= 53)
			{
				if (func_181(iParam0, iParam1, bVar0))
				{
					return bVar0;
				}
				bVar0++;
		...
		else if (iParam1 == 13)
		{
			...
			while (bVar1 <= 19)
			{
				if (func_181(iParam0, iParam1, bVar1))
				{
					return bVar1;
				}
				bVar1++;
...
void func_183()
{
	...
	{
		if (func_185(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_184(PLAYER::PLAYER_PED_ID());
			if (func_46(iVar0) && (!func_124(14) || Global_110809))
			{
...
void func_188(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_199(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_206(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_216()
{
	...
	if (Global_42178 != -1)
	{
		if (Global_111858.f_7684[Global_42178 /*15*/].f_3 >= 2)
		{
			return 0;
		}
	}
...
bool func_219(vector3 vParam0, vector3 vParam3, float fParam6)
{
	vector3 vVar0;
