...
void __EntryFunction__()
{
	...
	vLocal_92 = { -1593.813f, 5221.235f, 1.94482f };
	vLocal_95 = { -1603.986f, 5243.624f, 4.940323f };
	iLocal_98 = func_296(16);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0 /*10*/].f_9 != -1)
			{
				...
				func_292(&(Global_110725[Var0 /*10*/].f_9));
			}
		}
		func_275(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_272(&iVar231, &Var0, vVar61, 1f))
	{
		func_271();
	...
	while (true)
	{
		...
		func_213(Var0);
		func_206(&iLocal_100, &(Var0.f_9), vVar61);
		switch (Var0)
		{
			case 0:
				...
				break;
			case 1:
				func_188(&Var0, vVar61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800 /* Float: 20f */);
				break;
		}
		if (func_173(&Var0, 0))
		{
...
void func_131(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		...
		{
			ENTITY::SET_ENTITY_PROOFS(iParam0->f_28[iVar0], bParam1, bParam1, bParam1, bParam1, bParam1, false, false, false);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (func_127(iParam0->f_35[iVar0]))
		{
			ENTITY::SET_ENTITY_PROOFS(iParam0->f_35[iVar0], bParam1, bParam1, bParam1, bParam1, bParam1, false, false, false);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 6)
	{
		if (func_127(iParam0->f_41[iVar0]))
		{
			ENTITY::SET_ENTITY_PROOFS(iParam0->f_41[iVar0], bParam1, bParam1, bParam1, bParam1, bParam1, false, false, false);
		}
		iVar0++;
	}
...
int func_188(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;

	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	if (func_127(*uParam1) && func_127(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, false, true, 0))
					{
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						if (func_178(iVar2))
						{
							...
							{
								if (func_178(iParam0->f_35[iVar0]))
								{
...
{
	if ((func_250() && Global_98744.f_11 == 6) && iParam0 == func_167(&(Global_98744.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -1588.664f, 5210.44f, 2.488135f };
			iParam0->f_17[1 /*3*/] = { -1596.975f, 5228.684f, 5.966843f };
			iParam0->f_24 = 8f;
			iParam0->f_27 = 0;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "ABIGAIL_MCS_2", 24);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
			...
			func_260(&(iParam0->f_48), cLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
		case 1:
		...
		case 2:
			...
			{
				if (!func_256(&(iParam0->f_28[0]), 16, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
				{
					bVar4 = false;
				}
			}
			...
			{
				func_254(&(iParam0->f_35[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_35[0], 3);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_DISABLE_TOWING(iParam0->f_35[0], true);
			}
			if (bVar4)
			{
				iLocal_91 = 3;
...
void func_254(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_255(iParam0);
...
int func_256(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_257(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_257(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_261(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			iParam0->f_16 = 5;
			iParam0->f_17[0 /*3*/] = { -1598.57f, 5231.605f, 1.969029f };
			iParam0->f_17[1 /*3*/] = { -1610.413f, 5257.687f, 5.965584f };
			iParam0->f_24 = 8f;
			iParam0->f_27 = 0;
			iParam0->f_25 = 1;
			StringCopy(&(iParam0->f_9), "ABIGAIL_MCS_1_CONCAT", 24);
			STREAMING::REQUEST_MODEL(iVar0);
			STREAMING::REQUEST_ANIM_DICT(cLocal_99);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[0]))
			{
				if (!func_256(&(iParam0->f_28[0]), 16, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
				{
					bVar1 = false;
				}
			}
...
int func_272(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_273((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_273((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_273(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	if (func_274(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_274(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_281(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_288(iParam0, iParam1);
	func_285(iParam0, bParam2);
	func_282(iParam0, bParam3);
}

void func_282(int iParam0, bool bParam1)
{
	func_283(&(iParam0->f_41), bParam1);
}
