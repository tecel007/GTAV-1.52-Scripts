...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_268(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_198(Var0);
		func_191(&iLocal_93, &uLocal_94, &(Var0.f_9), vVar61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_184(&Var0, vVar61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_184(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_185(sParam5))
		{
			...
			{
				if (func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_144();
				}
			}
...
void func_191(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_190(PLAYER::PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_190(PLAYER::PLAYER_PED_ID(), vParam6, 1);
					fVar1 = func_190(PLAYER::PLAYER_PED_ID(), vParam9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_190(PLAYER::PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_238(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			iParam0->f_27 = 0;
			iParam0->f_26 = 1;
			StringCopy(&(iParam0->f_9), "sas_1_rcm_concat", 24);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
		...
		case 2:
			bVar5 = true;
			iParam0->f_28[0] = PED::CREATE_PED(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, true, true);
			if (func_126(iParam0->f_28[0]))
			{
				WEAPON::GIVE_WEAPON_TO_PED(iParam0->f_28[0], joaat("WEAPON_SNIPERRIFLE"), 100, true, true);
				TASK::TASK_PLAY_ANIM(iParam0->f_28[0], "rcmlastone1", "idle_action_01", 8f, -8f, -1, 1, 0f, false, false, false);
			...
			{
				func_239(&(iParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
				{
...
int func_253(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_254(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_257(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_261(iParam0, bParam2);
	func_258(iParam0, bParam3);
}

void func_258(int iParam0, bool bParam1)
{
	func_259(&(iParam0->f_41), bParam1);
}
