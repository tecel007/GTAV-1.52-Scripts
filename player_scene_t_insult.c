#region Local Var
	...
	vector3 vLocal_266[2] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f } };
	vector3 vLocal_273 = { 0f, 0f, 0f };
	float fLocal_276 = 0f;
	vector3 vLocal_277[2] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f } };
	vector3 vLocal_284[2] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
int func_2()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
	{
		fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285);
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_725))
		{
			if (!bLocal_730)
			{
				if (fVar1 < fLocal_729)
				...
				else if (func_3(&uLocal_71, "PRSAUD", &cLocal_725, 3, 0, 0, 0))
				{
					bLocal_730 = true;
				}
			}
	...
	if (SYSTEM::VDIST(vVar2, vLocal_273) < 100f)
	{
		return 0;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_237)
	{
		...
		{
			vVar5 = { ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], true) };
			if (SYSTEM::VDIST(vVar2, vVar5) < 100f)
			{
				return 0;
			}
		}
...
void func_26(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &cLocal_345, &(Local_394[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285);
						if (fVar2 > fVar0)
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), false, 40000f);
				...
				else
				{
					...
					{
						if (func_32(vLocal_284[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							vVar5 = { ENTITY::GET_ENTITY_COORDS(iParam0, true) };
							vLocal_284[iParam1 /*3*/] = { vVar5 - vLocal_273 * Vector(4f, 4f, 4f) };
						}
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_691[iParam1 /*16*/])))
						{
							PED::SET_PED_MOVEMENT_CLIPSET(iParam0, &(Local_691[iParam1 /*16*/]), 0.25f);
						}
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], 1f, -1, 0.25f, false, 40000f);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						...
						{
							iLocal_724 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, fLocal_276, 2);
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar8, iVar9, 1000f, iVar10);
						iVar11 = 0;
						while (iVar11 < iLocal_253)
						{
							if (iLocal_256[iVar11] != 0)
							{
								...
								{
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &cLocal_345, 8f, 8f, 0, 1000f);
								}
							}
							iVar11++;
						}
						vLocal_284[iParam1 /*3*/] = { vLocal_277[iParam1 /*3*/] };
			...
			case 1:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					{
						fLocal_294[iParam1] = (SYSTEM::VMAG(vLocal_284[iParam1 /*3*/]) * 0.75f);
					}
					TASK::TASK_WANDER_IN_AREA(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fLocal_294[iParam1], 3f, 6f);
					iLocal_240[iParam1] = 2;
				}
				else if (func_29(iParam0))
				{
					iLocal_240[iParam1] = 3;
				}
				else
				{
					Jump @2699; //curOff = 1179
					if (func_29(iParam0))
					{
						iLocal_240[iParam1] = 3;
					}
					else
					{
						...
						else
						{
							...
							PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, true);
							PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, true);
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_427[iParam1 /*16*/]), 2))
							{
								if (iLocal_70 == 288)
								{
									if (iLocal_731 <= 0)
							...
							else
							{
								...
								TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar13, iVar14, 1000f, iVar15);
								iVar16 = 0;
								while (iVar16 < iLocal_253)
								{
									if (iLocal_256[iVar16] != 0)
									{
										...
										{
											ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &cLocal_345, 8f, 8f, 0, 1000f);
										}
									}
									iVar16++;
								}
							...
							if (bVar18)
							{
								...
								iVar20 = 4276;
								iVar21 = 0;
								TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_460[iParam1 /*16*/]), 8f, -1000f, iVar19, iVar20, 8f, iVar21);
								...
								while (iVar22 < iLocal_253)
								{
									if (iLocal_256[iVar22] != 0)
									{
										...
										{
											ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &cLocal_345, 8f, 8f, 0, 1000f);
							...
							else
							{
								...
								if (!bVar23)
								{
									...
									iVar25 = 180;
									iVar26 = 0;
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, iVar24, iVar25, 1000f, iVar26);
									iVar27 = 0;
									while (iVar27 < iLocal_253)
									{
										if (iLocal_256[iVar27] != 0)
										{
											...
											{
												ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &cLocal_345, 8f, 8f, 0, 1000f);
											}
										}
										iVar27++;
									}
								...
								{
									Jump @2699; //curOff = 2470
									PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 64, true);
									PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, true);
									PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, true);
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_493[iParam1 /*16*/]), 2))
									{
										if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724))
										{
											iLocal_724 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, fLocal_276, 2);
										}
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1000f, 0);
										iVar28 = 0;
										while (iVar28 < iLocal_253)
										{
											if (iLocal_256[iVar28] != 0)
											{
												...
												{
													ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &cLocal_345, 8f, 8f, 0, 1000f);
												}
											}
											iVar28++;
										}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_34(iParam3), false);
}
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96285, &cLocal_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_253)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96285, &(Local_559[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1000f);
					}
				}
				iVar0++;
			}
			PED::_DISPOSE_SYNCHRONIZED_SCENE(Global_96285);
			return 1;
		}
	}
	return 0;
...
int func_38()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96284))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96284, &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96284, &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1000f);
				}
			}
			iVar0++;
		}
...
int func_39(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_40(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
...
void func_47()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		STREAMING::REQUEST_ANIM_DICT(&cLocal_345);
		if (!STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_345))
		{
			bVar2 = false;
			STREAMING::REQUEST_ANIM_DICT(&cLocal_345);
		}
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = PED::CREATE_PED(26, iLocal_243[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/], 0f, true, true);
			...
			TASK::TASK_PLAY_ANIM(iLocal_237[iVar0], &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, false, false, false);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			iLocal_253[iVar0] = OBJECT::CREATE_OBJECT(iLocal_256[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/] + vLocal_259[iVar0 /*3*/], true, true, false);
			ENTITY::SET_ENTITY_ROTATION(iLocal_253[iVar0], Vector((fLocal_276 + fLocal_291[iVar0]), 0f, 0f) + vLocal_266[iVar0 /*3*/], 2, true);
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/])))
			{
				ENTITY::PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, true, false, false, 0f, 0);
			}
		}
		iVar0++;
	}
...
void func_48()
{
	...
	iLocal_70 = Global_98358;
	func_51(iLocal_70, &vLocal_273, &fLocal_276, &cVar0);
	func_49(iLocal_70, &uLocal_297, &cLocal_313, &cLocal_329, &uVar8, &uVar9);
	...
	{
		case 237:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@CHASE_STRIPPERS", 64);
			...
			StringCopy(&cLocal_725, "TRVS_IG_35", 16);
			fLocal_729 = 0.15f;
			vLocal_277[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_277[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_284[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			vLocal_284[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			...
			break;
		case 235:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@MOCKS_LAPDANCE", 64);
			...
			vLocal_277[0 /*3*/] = { -1.5421f, 0.8274f, -1.0288f };
			vLocal_277[1 /*3*/] = { -0.9636f, 1.1757f, -1.0243f };
			vLocal_284[0 /*3*/] = { 0f, 0f, 0f };
			vLocal_284[1 /*3*/] = { 0f, 0f, 0f };
			fLocal_291[0] = -130f;
			fLocal_291[1] = -130f;
			fLocal_294[0] = 0f;
			fLocal_294[1] = 0f;
			...
			break;
		case 247:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@ANNOYS_SUNBATHERS", 64);
			...
			vLocal_277[0 /*3*/] = { -0.3866f, 0.1726f, 1f };
			vLocal_277[1 /*3*/] = { -0.0726f, -0.4742f, 1f };
			vLocal_284[0 /*3*/] = { Vector(1.5806f, -1719.606f, -1291.475f) - vLocal_273 };
			vLocal_284[1 /*3*/] = { vLocal_284[0 /*3*/] };
			fLocal_291[0] = 0f;
			fLocal_291[1] = 0f;
			fLocal_294[0] = 20f;
			...
			vLocal_259[0 /*3*/] = { 0f, 0f, -1f };
			vLocal_266[0 /*3*/] = { 0f, 0f, 2.16f };
			iLocal_256[1] = joaat("PROP_CS_BEACHTOWEL_01");
			vLocal_259[1 /*3*/] = { 0f, 0f, -1f };
			vLocal_266[1 /*3*/] = { 0f, 0f, -4.32f };
			break;
		case 286:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@RUDE_AT_CAFE", 64);
			...
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			vLocal_277[0 /*3*/] = { 4.261f, -2.388f, 0.5f };
			vLocal_284[0 /*3*/] = { 10.5918f, -34.5146f, 0f };
			...
			break;
		case 263:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@SCARES_TRAMP", 64);
			StringCopy(&(Local_361[0 /*16*/]), "trev_scares_tramp_idle_tramp", 64);
			StringCopy(&(Local_394[0 /*16*/]), "trev_scares_tramp_exit_tramp", 64);
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			vLocal_277[0 /*3*/] = { 2.0921f, -1.5872f, 0f };
			vLocal_284[0 /*3*/] = { Vector(10.9545f, -1419.537f, -605.8271f) - vLocal_273 };
			fLocal_291[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_294[0] = 40f;
			...
			break;
		case 244:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@THROW_FOOD", 64);
			StringCopy(&(Local_361[0 /*16*/]), "LOOP_Ped", 64);
			StringCopy(&(Local_394[0 /*16*/]), "EXIT_Ped", 64);
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			vLocal_277[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
			vLocal_284[0 /*3*/] = { Vector(28.2925f, -1451.728f, 507.6885f) - vLocal_273 };
			fLocal_291[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_294[0] = 40f;
			...
			break;
		case 288:
			StringCopy(&cLocal_345, "SWITCH@TREVOR@UNDER_PIER", 64);
			StringCopy(&(Local_361[0 /*16*/]), "LOOP_Ped", 64);
			StringCopy(&(Local_394[0 /*16*/]), "EXIT_Ped", 64);
...
int func_51(int iParam0, var uParam1, float fParam2, char* sParam3)
{
	int iVar0;

	if (func_53(iParam0, fParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
			...
			case 1:
				...
				if (iVar0 < 5)
				{
					*uParam1 = { Global_94158[iVar0 /*9*/].f_3 };
					*fParam2 = Global_94158[iVar0 /*9*/].f_6;
					StringCopy(sParam3, "", 32);
					return 1;
				}
				else
				{
					*uParam1 = { Global_94158[0 /*9*/].f_3 };
					*fParam2 = Global_94158[0 /*9*/].f_6;
					StringCopy(sParam3, "", 32);
					return 1;
				}
				break;
			case 2:
				*uParam1 = { Global_97066[0 /*109*/].f_4 };
				*fParam2 = Global_97066[0 /*109*/].f_7;
				StringCopy(sParam3, "", 32);
				return 1;
			case 3:
				*uParam1 = { Global_97066[1 /*109*/].f_4 };
				*fParam2 = Global_97066[1 /*109*/].f_7;
				StringCopy(sParam3, "", 32);
				return 1;
			case 4:
				*uParam1 = { Global_97066[2 /*109*/].f_4 };
				*fParam2 = Global_97066[2 /*109*/].f_7;
				StringCopy(sParam3, "", 32);
				return 1;
			case 5:
				*uParam1 = { Global_111858.f_2359.f_539.f_2300[0 /*3*/] + Vector(-1f, 0f, 0f) };
				*fParam2 = Global_111858.f_2359.f_539.f_2310[0];
				StringCopy(sParam3, "", 32);
				return 1;
			case 6:
				*uParam1 = { Global_111858.f_2359.f_539.f_2300[1 /*3*/] + Vector(-1f, 0f, 0f) };
				*fParam2 = Global_111858.f_2359.f_539.f_2310[1];
				StringCopy(sParam3, "", 32);
				return 1;
			case 7:
				*uParam1 = { Global_111858.f_2359.f_539.f_2300[2 /*3*/] + Vector(-1f, 0f, 0f) };
				*fParam2 = Global_111858.f_2359.f_539.f_2310[2];
				StringCopy(sParam3, "", 32);
				return 1;
		}
		*uParam1 = { Global_97394[iParam0 /*3*/] };
		return 1;
	}
	return 0;
}
...
bool func_52(var uParam0)
{
	...
	iVar0 = Global_111858.f_2359.f_539.f_4323;
	vVar1 = { Global_111858.f_2359.f_539.f_2300[iVar0 /*3*/] };
	...
	*uParam0 = 5;
	...
	while (iVar5 < 5)
	{
		if (MISC::IS_BIT_SET(Global_111858.f_7225.f_11[iVar5], 0))
		{
			vVar6 = { Global_94158[iVar5 /*9*/].f_3 };
...
int func_53(int iParam0, var uParam1, char* sParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			if (iVar3 < 5)
			{
				*uParam1 = Global_94158[iVar3 /*9*/].f_6;
				StringCopy(sParam2, "", 32);
				return 1;
			}
			else
			{
				*uParam1 = Global_94158[0 /*9*/].f_6;
				StringCopy(sParam2, "", 32);
				return 1;
			}
			break;
		case 2:
			*uParam1 = Global_97066[0 /*109*/].f_7;
			StringCopy(sParam2, "", 32);
			return 1;
		case 3:
			*uParam1 = Global_97066[1 /*109*/].f_7;
			StringCopy(sParam2, "", 32);
			return 1;
		case 4:
			*uParam1 = Global_97066[2 /*109*/].f_7;
			StringCopy(sParam2, "", 32);
			return 1;
		case 5:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_57(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_57(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*uParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_57(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
	...
	switch (iParam0)
	{
		...
		case 306:
			...
			*uParam1 = MISC::GET_HEADING_FROM_VECTOR_2D(-vVar8.x, -vVar8.y);
			StringCopy(sParam2, "", 32);
			return 1;
		case 307:
			vVar11 = { 10.6345f, 0.7246f, 1.2508f };
			*uParam1 = MISC::GET_HEADING_FROM_VECTOR_2D(-vVar11.x, -vVar11.y);
			StringCopy(sParam2, "", 32);
			return 1;
		case 308:
			vVar14 = { -3.4271f, -13.6787f, -1.4107f };
			*uParam1 = MISC::GET_HEADING_FROM_VECTOR_2D(-vVar14.x, -vVar14.y);
			StringCopy(sParam2, "", 32);
			return 1;
		case 309:
			vVar17 = { -19.6582f, 7.896f, 0.1334f };
			*uParam1 = MISC::GET_HEADING_FROM_VECTOR_2D(-vVar17.x, -vVar17.y);
			StringCopy(sParam2, "", 32);
			return 1;
		case 310:
			*uParam1 = -87.7215f;
			...
			switch (iParam0)
			{
				case 8:
					...
					*uParam3 = 136.309f;
					...
					Jump @7967; //curOff = 7034
					switch (iParam0)
					{
						case 13:
							if (Global_111858.f_18529[2] == 299)
							{
								*uParam2 = { Vector(9.6327f, -1521.394f, -1158.133f) - Vector(9.6346f, -1517.601f, -1152.571f) };
								*uParam3 = (34.661f - 90.6729f);
								return 1;
							}
							else if (((Global_111858.f_18529[2] == 300 || Global_111858.f_18529[2] == 301) || Global_111858.f_18529[2] == 302) || Global_111858.f_18529[2] == 303)
							{
					...
					Jump @7967; //curOff = 7875
					*uParam2 = { 0f, 0f, 0f };
					*uParam3 = 0f;
					return 0;
					Jump @7967; //curOff = 7893
					*uParam2 = { 0f, 0f, 0f };
					*uParam3 = 0f;
					return 0;
					Jump @7967; //curOff = 7911
...
void func_58()
{
	...
	UNK_0x1082C25039B168F8(&cLocal_345);
	if (PED::DOES_GROUP_EXIST(iLocal_252))
	{
