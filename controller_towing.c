...
void func_1()
{
	UNK_0x1082C25039B168F8("amb@world_human_smoking@male@male_a@base");
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, false))
	{
		...
		func_149(Global_111858.f_19969.f_3, &vVar3, &uVar7, &uVar0, &uVar6);
		if (Global_111858.f_19969.f_3 >= 5 || bLocal_263)
		{
			func_148(iParam1, vVar3, uVar7, iParam0);
		...
		switch (*iParam0)
		{
			case 0:
				...
				func_144(&(Global_111858.f_19969.f_1), 2048);
				func_144(&(Global_111858.f_19969.f_1), 4096);
				func_144(&(Global_111858.f_19969.f_1), 8192);
				func_144(&(Global_111858.f_19969.f_1), 16384);
			...
			case 16:
				...
				*iParam3 = 0;
				iVar8 = func_107();
				func_144(&(Global_111858.f_19969.f_1), 1073741824 /* Float: 2f */);
				if (iVar8 == 1)
				{
					if (!bParam4)
					{
			...
			case 17:
				if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_249))
				{
					...
					else
					{
						func_21(&iLocal_45);
						func_3();
						func_144(&Global_110509, 3);
						func_1();
						func_23();
						iLocal_275 = 0;
						iLocal_274 = 0;
						if (func_22(Global_111858.f_19969.f_1, 2048))
						{
							iLocal_253 = 0;
						}
						else if (func_22(Global_111858.f_19969.f_1, 4096))
						{
							iLocal_253 = 10000;
						}
						else if (func_22(Global_111858.f_19969.f_1, 8192))
						{
							iLocal_253 = 60000;
						}
						else if (func_22(Global_111858.f_19969.f_1, 16384))
						{
							iLocal_253 = 120000;
						}
						else
...
void func_25(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_98955 != 10 && Global_98955 != 9)
	{
		...
		func_27(&Global_102423, cParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_93133 = 0;
	}
}
...
void func_57()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_47(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(iVar0) && (!func_58(14) || Global_110809))
			{
...
int func_107()
{
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_53.f_2 = 1;
			iLocal_249 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_53, 9, 37500);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
...
{
	return func_113(iParam0, Global_41631);
}
...
void func_118()
{
	switch (iLocal_74)
	{
		...
		case 4:
			...
			{
				if (!func_22(Global_111858.f_19969.f_1, 1024))
				{
					func_119("TOW_MISSEDJOB", -1);
					func_108(&(Global_111858.f_19969.f_1), 1024);
				}
				iLocal_74 = 5;
			}
			break;
...
void func_134(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_148(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;

	fVar0 = SYSTEM::VDIST2(vParam1, ENTITY::GET_ENTITY_COORDS(iParam0, true));
	switch (iLocal_75)
	{
		case 0:
			...
			if (fVar0 < 25f && !func_22(Global_111858.f_19969.f_1, 1073741824 /* Float: 2f */))
			{
				return;
			}
			if (bLocal_268)
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_258, fLocal_261) || func_22(Global_111858.f_19969.f_1, 1073741824 /* Float: 2f */))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_275))
					{
						iLocal_275 = VEHICLE::CREATE_VEHICLE(joaat("TOWTRUCK"), vParam1, fParam4, true, true, false);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("TOWTRUCK"));
						iLocal_75 = 3;
					}
				}
