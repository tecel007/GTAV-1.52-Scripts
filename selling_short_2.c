#region Local Var
	...
	int iLocal_6203 = 0;
	int iLocal_6204 = 0;
	bool bLocal_6205 = false;
	bool bLocal_6206 = false;
	int iLocal_6207 = 0;
	int iLocal_6208 = 0;
	int iLocal_6209 = 0;
	int iLocal_6210 = 0;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, int iParam9, int iParam10)
{
	...
	func_24(uParam0[uParam0->f_154 /*17*/], iParam1, vParam2, vParam5, iParam8, iParam9, iParam10);
	uParam0->f_154++;
}

void func_24(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, int iParam9, int iParam10)
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam5 };
	uParam0->f_6 = iParam8;
...
int func_28(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	...
	if (*iParam1 == 0)
	{
		*iParam1 = UNK_0x5DEA4192B46CB99B(sParam0);
	}
