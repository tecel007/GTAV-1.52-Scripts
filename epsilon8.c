...
void __EntryFunction__()
{
	...
	MISC::CLEAR_BIT(&(Global_111858.f_18570.f_382), 1);
...
void func_31(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111858.f_20560.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_33() /*10931*/].f_6175.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111858.f_20560.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_33() /*10931*/].f_6175.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_39(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_33() /*10931*/].f_6175.f_10, iParam0);
}
...
int func_46(int iParam0, int iParam1)
{
	...
	if (func_56(&Global_4271324))
	{
		if (func_54(&Global_4271324, iParam0))
		{
			return 0;
		}
		if (func_47(&Global_4271324, iParam0))
		{
			return 1;
		}
	}
...
void func_50(var uParam0)
{
	...
	func_52(uParam0, (Global_4271323 - 0.5f));
}
...
void func_64()
{
	...
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_615, true) };
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 0f, 0f, (vVar1.z - 200f)), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 500f, 0f, (vVar1.z + 200f)), 1000f, false, true, 0))
		{
			if (func_296(iLocal_579, iLocal_615, 2) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_615, 1, false))
			{
		...
		else if (func_296(iLocal_579, iLocal_615, 1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_615, 2, false))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_579, 242628503) != 1 || TASK::GET_SEQUENCE_PROGRESS(iLocal_579) > 0)
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
	...
	if (func_95(iLocal_578))
	{
		...
		if (MISC::GET_GAME_TIMER() > iLocal_290 + 8000)
		{
			...
			if (PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
			{
				if (iLocal_355 == 0)
				{
					if (func_66(PLAYER::PLAYER_PED_ID(), iLocal_615, 200f, 1))
					{
						if (!func_299())
						{
							if (iLocal_360 == 0)
...
{
	return func_68(PED::GET_VEHICLE_PED_IS_IN(iParam0, false), PLAYER::PLAYER_PED_ID(), 250, 7);
}
...
bool func_68(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	bVar1 = func_69(&(Local_37[iVar0 /*4*/]), ENTITY::GET_ENTITY_COORDS(iParam0, true), iParam1, &(Local_37[iVar0 /*4*/].f_3), iParam0, iParam3);
	return (bVar1 || (MISC::GET_GAME_TIMER() - Local_37[iVar0 /*4*/].f_3) < iParam2);
}

int func_69(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
void func_86()
{
	...
	{
		if (func_89(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_88(PLAYER::PLAYER_PED_ID());
			if (func_87(iVar0) && (!func_58(14) || Global_110809))
			{
				if (Global_111858.f_2359.f_539.f_4321 != iVar0 && func_87(Global_111858.f_2359.f_539.f_4321))
				{
...
void func_97()
{
	...
	if (iLocal_311 == 1)
	{
		...
		Global_111858.f_18570.f_388 = 1;
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("EPS8_PASS");
		Global_111858.f_18570.f_388 = 0;
	}
...
void func_98(int iParam0, bool bParam1)
{
	...
	{
		func_254(&(Global_110945[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
int func_124(int iParam0, int iParam1, int iParam2)
{
	...
	Global_76647[1 /*14*/] = { func_172(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_76647[1 /*14*/] = { func_172(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_164(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_164(iParam1), Global_76647[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, 0);
		}
	}
...
int func_125(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_236(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_172(iVar10, iParam1, iParam2, -1) };
		if (!func_162(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_172(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_172(iVar10, 14, uVar28[iVar1], -1) };
							func_143(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_158(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_164(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_158(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_172(iVar10, iVar0, func_133(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_172(iVar10, 14, uVar69[iVar1], -1) };
			func_143(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_158(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_164(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_164(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
{
	Global_76647[1 /*14*/] = { func_172(iParam0, iParam1, iParam2, -1) };
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_164(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (fVar1 != -1)
		{
			return (func_146(iParam0, func_164(iParam2)) + fVar1);
		}
	}
	return -99;
}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_158(int iParam0)
{
	...
	{
		func_161(iParam0, Global_76647[1 /*14*/].f_5, Global_76647[1 /*14*/].f_2, 2, Global_76647[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_236(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_171(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_171(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_171(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
...
void func_174(int iParam0)
{
	...
	func_175(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_40(func_178(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_40(func_177(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_40(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_175(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_175(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_175(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_175(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_164(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_236(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_236(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_236(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_172(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_236(iParam0, 14, iVar4))
										{
											if (!func_131(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_172(iVar0, iVar2, iVar1, -1) };
						if (!func_131(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_164(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_164(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_243(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_244(&uVar32, Var0.f_3, Global_98992, bParam1, bParam2);
	}
}
...
void func_246(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
void func_249()
{
	...
	{
		func_86();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_250(Global_111858.f_2359.f_539.f_4321));
	}
	else
	{
...
{
	func_259(iParam0, 1);
	Global_111858.f_18570[iParam0 /*6*/].f_3 = func_258();
				...
				if (iLocal_333 == 0)
				{
					...
					if (iLocal_270 < 2)
					{
						if (iLocal_272 == 0)
						{
							if (iLocal_360 == 0)
							{
								if (iLocal_364 == 0)
								{
									if (func_18(iLocal_632))
									{
										TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, iLocal_632, 0, 0f, 0f, 0f, 4, fLocal_153, 50f, -1f, -1, 40, -1082130432, 0);
									}
								}
							}
							else
							{
								TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, ENTITY::GET_ENTITY_COORDS(iLocal_615, true), 4, 0.1f, -1f, -1f, iLocal_260 + 100, 100, -1082130432, 0);
							}
						...
						else if (iLocal_272 == 1)
						{
							if (MISC::GET_GAME_TIMER() > iLocal_290 + 10000)
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_297(PLAYER::PLAYER_PED_ID(), iLocal_615, 0) < 85f)
								{
									if (iLocal_279 < 25)
									{
						...
						else if (iLocal_272 == 2)
						{
							...
							if ((iLocal_274 > iLocal_273 + 20000 || !func_66(PLAYER::PLAYER_PED_ID(), iLocal_615, 85f, 1)) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							{
								iLocal_272 = 0;
							}
						}
							...
							if (iLocal_257 == iLocal_258 + 1 || iLocal_364 == 1)
							{
								...
								if (iLocal_281 > 3)
								{
									if (func_67(iLocal_578))
									{
										...
										if (iLocal_360 == 1)
										{
											TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, PLAYER::PLAYER_PED_ID(), vLocal_209, 9, 200f, 2f, -1f, iLocal_260 + 10, 50, -1082130432, 0);
											if (iLocal_262 > 0)
											{
												if (!func_299())
												{
									...
									else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, false))
									{
										...
										else if (iLocal_270 == 1)
										{
											...
											if (iLocal_269 > iLocal_268 + 4000)
											{
												...
												if (iLocal_360 == 0)
												{
													TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, ENTITY::GET_ENTITY_COORDS(iLocal_615, true), 4, 0.1f, -1f, -1f, -1, 100, -1082130432, 0);
												}
												iLocal_360 = 1;
											}
											if (!func_299())
					...
					{
						TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, (vLocal_209.x + 600f), (vLocal_209.y + 600f), (vLocal_209.z + 100f), 4, 200f, -1f, -1f, -1, 100, -1082130432, 0);
...
bool func_289(int iParam0, vector3 vParam1, float fParam4)
{
...
void func_292()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_570[iLocal_256]))
	{
		...
		else if (iLocal_256 != 5)
		{
			if (iLocal_374 == 0)
			{
				if (iLocal_336 == 0)
				{
					if (func_66(iLocal_570[iLocal_256], iLocal_632, 60f, 1))
					{
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_632, 30f, 1))
						{
							if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, false))
							{
	...
	if (iLocal_256 == 1 || iLocal_256 == 4)
	{
		...
		else if (!func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), fLocal_145, 1))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_936))
			{
				func_26(&iLocal_936);
	...
	if (iLocal_256 == 2 || iLocal_256 == 6)
	{
		...
		else if (!func_66(iLocal_578, PLAYER::PLAYER_PED_ID(), fLocal_146, 1) && MISC::GET_GAME_TIMER() > iLocal_290 + 15000)
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_937))
			{
...
void func_294()
{
	...
	if (func_95(iLocal_596))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_936))
		{
			if (func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), fLocal_145, 1))
			{
...
void func_303()
{
	...
	if ((func_95(iLocal_570[5]) && func_18(iLocal_632)) && func_18(iLocal_615))
	{
		switch (iLocal_387)
		{
			case 0:
			...
			case 2:
				...
				break;
			case 3:
				if ((func_289(iLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, -1.5f, 0f, 0f), 0.5f) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 0)
				{
...
void func_304()
{
	if (iLocal_362 == 1)
	{
		if (func_95(iLocal_596))
		{
			if (!PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_596, 90f) || func_66(PLAYER::PLAYER_PED_ID(), iLocal_596, 50f, 1))
			{
...
void func_305()
{
	...
	if (iLocal_336 == 0)
	{
		if (iLocal_298 == 0)
		{
			vLocal_218 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, true) };
	...
	if (func_95(iLocal_596) && func_19(iLocal_633))
	{
		...
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, false))
		{
			...
			if (iLocal_338 == 0)
			{
				if (func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), 9f, 1))
				{
				...
				{
					if (func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), 6f, 1))
					{
						if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_596))
						{
					...
					if (func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), 9f, 1) && !func_66(iLocal_596, PLAYER::PLAYER_PED_ID(), 6f, 1))
					{
...
void func_308()
{
	...
	{
		fLocal_252 = (40f - func_297(iLocal_580[0], iLocal_632, 1));
		if (fLocal_252 > 0f)
		{
...
void func_310()
{
	...
	if (func_95(iLocal_580[0]))
	{
		if (!func_66(iLocal_632, iLocal_580[0], 50f, 1))
		{
			if (iLocal_328 == 0)
			{
				iLocal_311 = 1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_615, false))
	{
		if ((func_66(iLocal_615, PLAYER::PLAYER_PED_ID(), 3f, 1) || func_66(iLocal_615, iLocal_632, 3f, 1)) || func_297(iLocal_615, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) <= 3f)
		{
			PHYSICS::ACTIVATE_PHYSICS(iLocal_615);
		}
		if (func_311(PLAYER::PLAYER_PED_ID(), iLocal_615))
		{
			iLocal_311 = 1;
		}
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("TRACTOR")))
		{
			if (!func_299())
			{
				if (func_288(&uLocal_390, "EPS8AU", "EPS8_ESC", 7, 0, 0, 0))
				{
					...
					func_5(0);
					vLocal_215 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, true) };
					iLocal_940 = func_295(iLocal_596, 1, 1, 5);
					iLocal_369 = 1;
					HUD::SET_BLIP_SCALE(iLocal_940, fLocal_147);
...
void func_318()
{
	...
	func_310();
	func_308();
	if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, false, true, 0))
	{
		func_290();
	}
	if (!PED::IS_PED_HEADTRACKING_PED(iLocal_596, PLAYER::PLAYER_PED_ID()))
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, false, true, 0) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_632))
	{
		func_26(&iLocal_935);
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, false, true, 0))
	{
		func_26(&iLocal_935);
		if (!VEHICLE::IS_VEHICLE_STOPPED(iLocal_632))
		{
			if (iLocal_382 == 0)
			{
				func_319(iLocal_632, 4f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0);
			}
		}
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_935))
	{
		iLocal_382 = 0;
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 6f, 6f, 2f, true, true, 0))
		{
		}
	}
}

int func_319(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_321(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	func_322(uParam0, iParam1, sParam2, iParam3, bParam4, bParam5, bParam6);
}

void func_322(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	uParam0->f_6 = 0;
	func_323(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, bParam5, bParam6);
}

void func_323(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
	...
	if (func_347(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		bVar1 = false;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_338(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_329(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_336() || func_335(Global_4456448.f_129348)) || func_334())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_330(int iParam0)
{
	if (iParam0 != func_80())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_331(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_338(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				else if (iLocal_261 == 4)
				{
					if (MISC::GET_GAME_TIMER() > iLocal_291 + 14000)
					{
						if (!func_299())
						{
							...
							{
								if (!func_289(iLocal_616[0], -696.0367f, 40.7954f, 42.2066f, 80f) && !func_289(iLocal_615, -355.8568f, -89.7074f, 44.6341f, 50f))
								{
...
void func_352()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("TAXI")) && STREAMING::HAS_MODEL_LOADED(joaat("SADLER"))) && STREAMING::HAS_MODEL_LOADED(joaat("HABANERO"))) && STREAMING::HAS_MODEL_LOADED(joaat("SCHAFTER2"))) && STREAMING::HAS_MODEL_LOADED(joaat("RUMPO")))
	{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_650[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_650[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_696[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_696[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 220f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_742[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_788[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_788[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_834[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_880[iLocal_910 /*3*/], 15f, false, true, false, false, false, 0, false))
				{
...
void func_356()
{
	iLocal_615 = VEHICLE::CREATE_VEHICLE(joaat("MAVERICK"), vLocal_206, fLocal_250, true, true, false);
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_359(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_359(iParam0) };
...
void func_366()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_632))
	{
		iLocal_632 = VEHICLE::CREATE_VEHICLE(joaat("TAILGATER"), vLocal_212, fLocal_251, true, true, false);
...
void func_368()
{
	...
	switch (iLocal_567)
	{
		...
		case 2:
			...
			if (Global_111858.f_18570.f_387 == 0)
			{
				func_378(0, 29, 50000);
				Global_111858.f_18570.f_387 = 1;
			}
			func_369(1, 1, 1, 1);
			if (func_19(iLocal_632))
			{
...
void func_383(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_430(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_427(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_384(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_385(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_415(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_404();
			}
...
void func_386(int iParam0, int iParam1)
{
	...
	func_422(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_415(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_341(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_341(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_418(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_415(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_420(iParam0);
			func_419(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_427(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_428(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_431(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_432(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}
...
int func_434(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_446(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_449()
{
	...
	if (func_19(Local_83.f_35[0]))
	{
		...
		vVar3 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, true) };
	...
	if ((((iLocal_568 == 3 || iLocal_568 == 4) || iLocal_568 == 5) || iLocal_568 == 6) || iLocal_568 == 7)
	{
		...
		if (!func_299() || !bLocal_353 == 1)
		{
			if (iLocal_311 == 1)
			{
				...
				if (!MISC::IS_BIT_SET(Global_111858.f_18570.f_382, 1))
				{
					MISC::SET_BIT(&(Global_111858.f_18570.f_382), 1);
				}
				iLocal_568 = 8;
			}
		}
	...
	if (func_19(iLocal_615))
	{
		if (func_95(iLocal_578))
		{
			if (iLocal_313 == 0)
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				TASK::TASK_HELI_MISSION(0, iLocal_615, 0, 0, -582.5234f, -363.9155f, 498.4256f, 4, 200f, 2f, 130.0071f, 100, 30, -1082130432, 0);
				TASK::TASK_HELI_MISSION(0, iLocal_615, 0, 0, -1352.705f, -2861.194f, 498.4256f, 4, 200f, 2f, 183.7912f, 100, 30, -1082130432, 0);
				TASK::CLOSE_SEQUENCE_TASK(iVar0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_632))
			{
				...
				else
				{
					...
					if (iLocal_568 != 7)
					{
						if (iLocal_329 == 0)
						{
							if (!func_66(iLocal_632, PLAYER::PLAYER_PED_ID(), 150f, 1))
							{
								if ((iLocal_299 != -1 && func_95(iLocal_570[iLocal_299])) && PED::IS_PED_IN_VEHICLE(iLocal_570[iLocal_299], iLocal_632, false))
								{
						...
						{
							if (!func_66(iLocal_632, PLAYER::PLAYER_PED_ID(), 230f, 1))
							{
								if ((iLocal_299 != -1 && func_95(iLocal_570[iLocal_299])) && PED::IS_PED_IN_VEHICLE(iLocal_570[iLocal_299], iLocal_632, false))
								{
									sLocal_386 = "EPS8_26";
							...
							else if (func_66(iLocal_632, PLAYER::PLAYER_PED_ID(), 100f, 1))
							{
							}
						}
					}
		...
		else if (ENTITY::DOES_ENTITY_EXIST(iLocal_615))
		{
			...
			else
			{
				...
				if (iLocal_568 != 7)
				{
					if (iLocal_329 == 0)
					{
						if (!func_66(iLocal_615, PLAYER::PLAYER_PED_ID(), 150f, 1))
						{
							func_298("EPS8_16", 7500, 0);
							iLocal_329 = 1;
						}
					}
					else if (!func_66(iLocal_615, PLAYER::PLAYER_PED_ID(), 230f, 1))
					{
						sLocal_386 = "EPS8_17";
						iLocal_568 = 10;
					}
					else if (func_66(iLocal_615, PLAYER::PLAYER_PED_ID(), 100f, 1))
					{
						iLocal_329 = 0;
					}
				}
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_464(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_475(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_477(iParam0, Global_41631);
}
...
void func_487(int* iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_20(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, false, false);
}

void func_488(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_17(iParam0);
...
void func_491()
{
	...
	UNK_0x1082C25039B168F8("rcmepsilonism8");
...
int func_509()
{
	...
	iVar0 = func_510(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_513()
{
	...
	{
		if (func_508(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
