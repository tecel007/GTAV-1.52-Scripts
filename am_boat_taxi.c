		...
		switch (func_135(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_134() == 1)
				{
					func_133();
					func_132();
					vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 1;
				}
				else if (func_134() == 4)
				{
					vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 3;
				}
				break;
			case 1:
				func_100();
				...
				if (func_72(Local_63.f_2))
				{
					...
					{
						vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 4;
					}
				}
				break;
			case 3:
...
int func_15(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
bool func_25()
{
	return MISC::IS_BIT_SET(func_26(6425, -1, 0), 19);
}
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_72(Local_63.f_2))
				{
					...
					{
						if (MISC::IS_BIT_SET(vLocal_85[iVar0 /*3*/].f_1, 6))
						{
							MISC::SET_BIT(&Local_63, 9);
							MISC::CLEAR_BIT(&(vLocal_85[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_63.f_20 != 3)
					{
						if (MISC::IS_BIT_SET(vLocal_85[iVar0 /*3*/].f_1, 5))
						{
							Local_63.f_20 = 3;
							MISC::CLEAR_BIT(&(vLocal_85[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
	...
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_63.f_3) && func_64(joaat("S_M_Y_BLACKOPS_01"))) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_63.f_2))
	{
		if (func_72(Local_63.f_2))
		{
			if (func_40(&(Local_63.f_3), Local_63.f_2, 22, joaat("S_M_Y_BLACKOPS_01"), -1, 1, 1, 1))
			{
				...
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_63.f_3), Global_1575006);
				}
				else
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_63.f_3), Global_1574689[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_63.f_2))
	{
		if (func_64(joaat("DINGHY2")))
		{
			if (!MISC::IS_BIT_SET(iLocal_182, 10))
			{
				...
				if (WATER::TEST_PROBE_AGAINST_WATER(vLocal_891 + Vector(2f, 0f, 0f), vLocal_891 - Vector(10f, 0f, 0f), &vLocal_891))
				{
					if (func_45(vLocal_891, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896 /* Float: 120f */, 0, -1, 1, 0, 0, 0, 0, 0))
					{
						vVar4 = { vLocal_891 + Vector(12f, 0f, 0f) };
						iLocal_889 = SHAPETEST::START_SHAPE_TEST_BOX(vVar4, 10f, 10f, 25f, 0f, 0f, -1f, 2, 1, 0, 4);
						if (iLocal_889 == 0)
						{
							return 0;
						}
			...
			else if (SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_889, &iLocal_890, &uVar0, &uVar0, &uVar3) == 2)
			{
				...
				if (iLocal_890 == 0)
				{
					if (func_42(&(Local_63.f_2), joaat("DINGHY2"), vLocal_891, uLocal_894, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
					{
						...
						ENTITY::_SET_ENTITY_SOMETHING(NETWORK::NET_TO_VEH(Local_63.f_2), false);
					}
				}
				else
				{
...
int func_42(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	float fVar0;
	int iVar1;
...
void func_43(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_45(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	if (bParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_46(vParam0, fParam6, iParam7, fParam9, bParam10, bParam11, bParam12, bParam16, bParam17))
			{
				return 0;
			}
		}
...
int func_46(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam4 && !bParam7)
	{
		if (func_3(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_50(PLAYER::PLAYER_ID()), vParam0, true) <= (bVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_3(iVar1, 1, 1))
		{
			if (!func_48(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_47(iVar1) || !bParam10) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						bVar2 = bParam6;
						if (bParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_50(iVar1), vParam0, true) <= (bVar2 + fParam3))
								{
			...
			if (func_3(iVar1, bParam4, bParam5))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_47(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && bParam9) && bParam6) && func_55(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_51(iVar1), vParam0, true) < fParam3)
								{
									return 1;
								}
							}
...
void func_74()
{
	if (func_3(PLAYER::PLAYER_ID(), 1, 1))
	{
		if (Local_63.f_21 == 5)
		{
			vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
		}
		switch (vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2)
		{
			case 0:
				func_97();
				if (Local_63.f_21 > 0)
				{
					vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
				}
				break;
			case 1:
				if (func_72(Local_63.f_2))
				{
					...
					{
						func_96();
						vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						MISC::CLEAR_BIT(&(vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
					}
				}
				break;
			case 2:
				if (func_72(Local_63.f_2))
				{
					...
					{
						vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						MISC::CLEAR_BIT(&(vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 5);
						MISC::SET_BIT(&(vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 6);
						if (Local_63.f_21 >= 4)
						{
							vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 4;
						}
					}
					else
					{
...
void func_75()
{
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_188))
	{
		if (func_90(1, 1))
		{
			if (((vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				iVar0 = 1;
				Var1 = { func_89() };
				func_87(&uLocal_189);
				if (vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_72(Local_63.f_2))
					{
	...
	{
		iLocal_188 = UNK_0x5DEA4192B46CB99B("instructional_buttons");
	}
}
		...
		if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_63.f_3) || (!NETWORK::IS_NETWORK_ID_OWNED_BY_PARTICIPANT(Local_63.f_3) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()))
		{
			...
			switch (Local_63.f_20)
			{
				...
				case 3:
					...
					break;
				case 1:
					if (!MISC::IS_BIT_SET(vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1, 7))
					{
						...
						MISC::SET_BIT(&(vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), 7);
					}
					break;
				case 6:
					if (TASK::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_63.f_3), 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_63.f_3), 242628503) != 0)
...
void func_120()
{
	...
	{
		if (func_123(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_153(struct<21> Param0)
{
	...
	vLocal_85[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	return 1;
}
