...
void func_1()
{
	switch (iLocal_93)
	{
		case 0:
			...
			HUD::CLEAR_HELP(true);
			func_26();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(iLocal_211))
			{
				func_24(iLocal_211);
			}
			else
...
void func_8(int iParam0)
{
	...
	if (Global_111858.f_9081 || func_23(0))
	{
		iVar0 = func_22();
		if (!func_9(iVar0))
		{
...
void func_28()
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_95(PLAYER::PLAYER_PED_ID(), vLocal_224, 270f))
			{
				iLocal_93 = 2;
			}
...
void func_32(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_39(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_49(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_23(0) && Global_77079.f_1 == 1) && func_50(Global_77079))
		{
		}
		else
		{
...
int func_68(int iParam0)
{
	...
	return Global_96433[func_69(iParam0)];
}
...
void func_96()
{
	func_131(&iLocal_268, &iLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, vLocal_224, Local_282, 0, 11f);
	switch (iLocal_93)
	{
		case 0:
			...
			break;
		case 1:
			func_108(&iLocal_218, vLocal_224, &iLocal_94, iLocal_95, &iLocal_213, &iLocal_240);
			if (func_101(iLocal_268, vLocal_224, &iLocal_218, iLocal_95, iLocal_94, &uLocal_229, &iLocal_241, &uLocal_238, &uLocal_237, &iLocal_213, 11f))
			{
				if (!func_100())
				{
					if (func_56(&uLocal_105, &cLocal_214, &uLocal_293))
		...
		case 3:
			if (func_6(Local_282))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_282, false))
				{
...
int func_97(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_101(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, var uParam7, int iParam8, var uParam9, float fParam10, int iParam11, float fParam12)
{
	float fVar0;
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_95(PLAYER::PLAYER_PED_ID(), vParam1, fVar0))
					{
						*uParam7 = 0;
...
void func_105(int iParam0, vector3 vParam1, int iParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_106(vParam1, 5, iParam4);
	}
}
...
void func_108(int* iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	switch (*iParam4)
	{
		case 0:
...
int func_110(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
				...
				if (!func_459())
				{
					...
					else if ((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, Local_252.f_1, Local_252.f_4)) && func_124(4, vLocal_221, 0))
					{
						...
						if (func_446(Local_252))
						{
							...
							{
								TASK::TASK_PLAY_ANIM_ADVANCED(Local_252, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, vLocal_249), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_270), 1000f, -1.5f, -1, 1, 0f, 2, 0);
								PED::_0x2208438012482A1A(Local_252, false, false);
							}
							func_120();
							func_118();
						...
						if (HUD::GET_BLIP_FROM_ENTITY(Local_282) != 0)
						{
							iVar0 = HUD::GET_BLIP_FROM_ENTITY(Local_282);
							MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(true);
							func_27(&iVar0);
							MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(false);
						}
						func_116(&iLocal_219, Local_282, 1);
						AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Tow_truck_damage", Local_270, "FBI_04_HEAT_SOUNDS", false, 0);
						return 1;
					}
				}
				else
		...
		case 1:
			if (bParam1)
			{
				if ((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(4, vLocal_221, 0)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, vLocal_249), -ENTITY::GET_ENTITY_HEADING(Local_270)))
				{
...
void func_114(int iParam0, vector3 vParam1, float fParam4)
{
	if (func_446(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_97(iParam0, vParam1, fParam4, 0, 1);
}
...
int func_124(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_6(Global_95452[0]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[0], true, true);
				Local_282 = Global_95452[0];
				if (func_6(Local_282))
				{
					func_129(Local_282, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_282, true);
					return 1;
				}
			}
		...
		case 3:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95452.f_9[0], true))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452.f_9[0], true, true);
					Local_252 = Global_95452.f_9[0];
					if (func_446(Local_252))
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_252, true);
						PED::SET_PED_CAPSULE(Local_252, 0.1f);
						AUDIO::STOP_PED_SPEAKING(Local_252, true);
						TASK::SET_PED_PATH_MAY_ENTER_WATER(Local_252, false);
						return 1;
					}
				}
				else
		...
		case 5:
			...
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_270, 0);
				VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_270, 4, false, false);
				VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_270, 0, true, false);
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(Local_270, 100f);
				return 1;
			}
			break;
		case 6:
			if (func_6(Global_95452[2]))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[2], true, true);
				Local_276 = Global_95452[2];
				if (func_6(Local_276))
				{
...
int func_125(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_128(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_127(iParam1, "Loading", 0))
...
void func_131(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, vector3 vParam5, int iParam8, bool bParam9, float fParam10)
{
	if (func_6(*iParam0))
	{
		switch (*iParam2)
...
void func_138()
{
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_110(iLocal_92, bLocal_40))
			{
				func_105(&iLocal_218, vLocal_224, 1);
				func_155(1);
				iLocal_93 = 1;
			}
			break;
		case 1:
			...
			if (!bLocal_243)
			{
				if (func_143(iLocal_268, vLocal_224, &iLocal_218, iLocal_94, iLocal_95, &iLocal_213, &iLocal_241, 0, 0, 11f))
				{
					iLocal_93 = 2;
				}
			}
			else if (!bLocal_242)
			{
				if (!func_142())
				{
					if (func_446(Local_252))
					{
						if (func_137(PED::GET_VEHICLE_PED_IS_IN(Local_252, false)))
						{
		...
		case 3:
			if (func_6(iLocal_268))
			{
				...
				{
					func_97(iLocal_268, vLocal_224, 146.5443f, 0, 1);
					func_29(1, 1, 1);
					iLocal_93 = 1;
				}
			}
...
int func_143(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{
...
int func_146(int iParam0, int iParam1)
{
	switch (iLocal_97[iParam0])
	{
		case 0:
			...
			if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA(-632.498f, -2424.908f, 1710.123f, -1791.79f))
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, false), vLocal_224, 4, 20f, 786469, 2f, 10f, true);
				iLocal_97[iParam0] = 5;
			}
			break;
		case 5:
			if (!func_150(iParam0, iParam1) || func_95(PLAYER::PLAYER_PED_ID(), vLocal_224, 1.5f))
			{
				iLocal_97[iParam0] = 6;
			}
			break;
	...
	if (func_446(Local_252))
	{
		...
		switch (iLocal_97[iParam0])
		{
			case 0:
				...
				if (!MISC::IS_POSITION_OCCUPIED(vVar0, 1.5f, false, false, true, false, false, Local_252, false))
				{
					if (!bLocal_248)
					{
						if (iParam0 == 0)
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, vVar0, 1f, 20000, 0.25f, false, 82.7989f);
			...
			case 1:
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252, vVar3) };
				if (!func_121(iParam1, 713668775) && func_95(iParam1, vVar0, 3f))
				{
					TASK::TASK_STEALTH_KILL(iParam1, Local_252, MISC::GET_HASH_KEY("AR_stealth_kill_a"), 1f, 0);
					TASK::CLEAR_PED_TASKS(Local_252);
					iLocal_96 = 18;
					iLocal_97[iParam0] = 4;
				}
				break;
			case 2:
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252, vVar3) };
				if (!func_121(iParam1, 713668775) && func_95(iParam1, vVar0, 1.5f))
				{
					TASK::TASK_STEALTH_KILL(iParam1, Local_252, MISC::GET_HASH_KEY("AR_stealth_kill_knife"), 1f, 0);
					TASK::CLEAR_PED_TASKS(Local_252);
					iLocal_96 = 18;
					iLocal_97[iParam0] = 4;
				}
...
int func_150(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(iLocal_268) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_268, false)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_268, vLocal_224, 2f, 2f, 2f, false, true, 0))
		{
...
int func_152(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if (func_446(Local_252))
		{
			if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, false, true, 0) && !func_153(iParam0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_252)) && !PED::IS_PED_IN_ANY_VEHICLE(iParam1, false))
			{
...
void func_156()
{
	...
	if (func_446(Local_252))
	{
		...
		switch (iLocal_96)
		{
			...
			case 3:
				if (func_6(Local_282))
				{
					if (func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_282, -1f, 0.5f, 0f), 3f))
					{
						func_210(15);
						return;
					}
			...
			case 2:
				if (func_6(Local_270))
				{
					...
					{
						if (func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, -1f, 0.5f, 0f), 2f))
						{
							func_210(4);
							return;
						}
			...
			case 8:
				...
				break;
			case 9:
				if (func_209(Local_252, PLAYER::PLAYER_PED_ID(), 20f, 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					func_210(10);
					return;
				}
				...
				if (MISC::GET_GAME_TIMER() - Local_252.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
				{
					if (!func_121(Local_252, 780511057))
					{
						...
						{
							if (func_209(Local_252, PLAYER::PLAYER_PED_ID(), 10f, 1))
							{
								func_210(10);
							}
			...
			case 10:
				if (MISC::GET_GAME_TIMER() - Local_252.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500)
				{
					...
					{
						if (!func_209(Local_252, Local_276, 15f, 1) && !PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
						{
							func_210(8);
						}
					}
			...
			case 11:
				...
				break;
			case 14:
				if (!func_209(Local_252, PLAYER::PLAYER_PED_ID(), 118f, 1))
				{
			...
			case 13:
				if (MISC::GET_GAME_TIMER() - Local_252.f_14) > MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_252, PLAYER::PLAYER_PED_ID(), true))
					{
						func_210(14);
					}
					else
			...
			case 15:
				...
				{
					if (func_195(Local_252, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 1, 250, 7))
					{
						func_194();
						return;
					}
			...
			case 5:
				if (func_6(Local_270))
				{
					if (func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, vLocal_249), 2f))
					{
			...
			case 16:
				if (func_6(Local_282))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_252, Local_282, false))
					{
						if (func_190(Local_282, &uLocal_230, &uLocal_231, &uLocal_232, &uLocal_233, 3, 2f))
						{
							...
							TASK::TASK_PERFORM_SEQUENCE(Local_252, iVar0);
	...
	else
	{
		...
		if (func_6(Local_270))
		{
			if (!func_95(Local_270, Local_270.f_1, 50f) || !func_209(PLAYER::PLAYER_PED_ID(), Local_270, 250f, 1))
			{
				func_133(&Local_270);
			}
		}
...
int func_158(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_160(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	func_161(uParam0, iParam1, sParam2, iParam3, bParam4, bParam5, bParam6);
}

void func_161(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	uParam0->f_6 = 0;
	func_162(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, bParam5, bParam6);
}
...
void func_162(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (func_186(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_177(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_168(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_175() || func_174(Global_4456448.f_129348)) || func_173())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
int func_169(int iParam0)
{
	if (iParam0 != func_77())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_170(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_177(var uParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		vVar1 = { func_192(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_193()
{
	if (func_6(Local_270))
	{
		if (!func_121(Local_252, -2017877118))
		{
			if (!func_95(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, vLocal_249), 0.5f))
			{
				if (!func_121(Local_252, 713668775))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, vLocal_249), 1f, 60000, 0.3f, 512, -ENTITY::GET_ENTITY_HEADING(Local_270));
				}
			}
			else if (!func_121(Local_252, 1920390111))
			{
				TASK::TASK_ACHIEVE_HEADING(Local_252, -ENTITY::GET_ENTITY_HEADING(Local_270), 0);
			}
		}
		PED::SET_PED_CAPSULE(Local_252, 0.1f);
	}
...
void func_194()
{
	if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		if (!func_209(PLAYER::PLAYER_PED_ID(), Local_252, 10f, 1))
		{
			func_210(14);
		}
		else
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_196(&(Local_50[iVar4 /*4*/]), vVar1, iParam1, &(Local_50[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_50[iVar4 /*4*/].f_3) < iParam4);
}

int func_196(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_197(iParam4, iParam7) };
...
int func_204(int iParam0, float fParam1)
{
	...
	{
		if (func_205(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_205(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_208()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (func_209(Local_252, PLAYER::PLAYER_PED_ID(), 20f, 1))
		{
			return 1;
		}
	...
	else if (func_209(Local_252, PLAYER::PLAYER_PED_ID(), 10f, 1))
	{
	...
	switch (iParam0)
	{
		case 1:
			if (!func_121(Local_252, -2017877118))
			{
				if (func_6(Local_270))
				{
					TASK::TASK_PLAY_ANIM(Local_252, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, -1, 1, 0f, false, false, false);
				}
			}
			break;
		case 3:
			if (!func_121(Local_252, -1794415470))
			{
				if (func_6(Local_282))
				{
					TASK::TASK_ENTER_VEHICLE(Local_252, Local_282, 60000, -1, 2f, 524296, 0);
				}
			}
			break;
		case 2:
			if (!func_121(Local_252, 713668775))
			{
				if (func_6(Local_282))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_252, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270, -1f, 0.5f, 0f), 1f, 30000, 0.25f, false, 141.2603f);
				}
			}
			break;
		case 5:
		...
		case 6:
			if (!func_121(Local_252, -1794415470))
			{
				if (func_6(Local_270))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_252, false))
					{
						TASK::TASK_ENTER_VEHICLE(Local_252, Local_270, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		case 7:
			if (!func_121(Local_252, -1794415470))
			{
				if (func_6(Local_282))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_252, false))
					{
						TASK::TASK_ENTER_VEHICLE(Local_252, Local_282, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
		case 8:
			if (func_121(Local_252, 242628503) || TASK::GET_SCRIPT_TASK_STATUS(Local_252, 242628503) == 2)
			{
				TASK::CLEAR_PED_TASKS(Local_252);
			}
			if (func_6(Local_276))
			{
				if (!func_121(Local_252, -1794415470))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_252, false))
					{
						TASK::TASK_ENTER_VEHICLE(Local_252, Local_276, 60000, -1, 2f, 1, 0);
					}
				}
			}
			break;
			...
			if (!func_121(Local_252, -1273030092))
			{
				if (func_6(Local_276))
				{
					if (func_6(Local_270) && func_6(Local_282))
					{
						if (bLocal_227)
						{
							...
							{
								TASK::TASK_VEHICLE_MISSION(Local_252, Local_276, Local_270, 11, 30f, 34341156, 1f, -1f, true);
							}
							else
							{
								func_213();
						...
						else if (iLocal_95 == 1)
						{
							if (!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_276))
							{
								TASK::TASK_VEHICLE_MISSION(Local_252, Local_276, Local_282, 11, 30f, 34341156, 1f, -1f, true);
							}
							else
							{
								func_213();
				...
				else if (func_6(Local_270) && func_6(Local_282))
				{
					if (bLocal_227)
					{
						...
						{
							TASK::TASK_VEHICLE_MISSION(Local_252, Local_282, Local_270, 11, 30f, 34341156, 1f, -1f, true);
						}
						else
						{
							func_213();
					...
					else if (iLocal_95 == 1)
					{
						...
						{
							TASK::TASK_VEHICLE_MISSION(Local_252, Local_270, Local_282, 11, 30f, 34341156, 1f, -1f, true);
						}
						else
						{
							func_213();
		...
		case 11:
			...
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_252, PLAYER::PLAYER_PED_ID(), 0);
			}
			break;
		case 12:
			break;
		...
		case 14:
			if (!func_121(Local_252, 1805844857))
			{
				...
				TASK::TASK_SMART_FLEE_PED(Local_252, PLAYER::PLAYER_PED_ID(), 120f, -1, false, false);
			}
			break;
		case 15:
			if (!func_121(Local_252, 780511057))
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_288, joaat("PLAYER"));
				TASK::TASK_COMBAT_PED(Local_252, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
			break;
		case 16:
			if (!func_121(Local_252, 242628503))
			{
				if (func_6(Local_282))
				{
					...
					if (!PED::IS_PED_IN_VEHICLE(Local_252, Local_282, false))
					{
						TASK::TASK_ENTER_VEHICLE(0, Local_282, 60000, -1, 2f, 1, 0);
					}
					TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_282, 30f, 786469);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(Local_252, iVar1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_252, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", false);
}
...
void func_228()
{
	if (iLocal_96 != 14 && iLocal_96 != 13)
	{
		...
		if (!func_235() || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_252, PLAYER::PLAYER_PED_ID(), true))
		{
			if (func_209(PLAYER::PLAYER_PED_ID(), Local_252, 30f, 1))
			{
...
void func_229()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(Local_252, true))
	{
		func_194();
	}
	else
	{
		if (func_6(Local_282))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_252, Local_282, false))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252, Local_282, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, true);
				iLocal_96 = 14;
				return;
			}
		}
		if (func_6(Local_270))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_252, Local_270, false))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252, Local_270, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, true);
				iLocal_96 = 14;
				return;
			}
		}
		if (func_6(Local_276))
		{
			if (PED::IS_PED_IN_VEHICLE(Local_252, Local_276, false))
			{
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252, Local_276, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, true);
				iLocal_96 = 14;
			}
		}
	}
...
int func_235()
{
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252, 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
	{
		return 1;
	}
	return 0;
...
void func_238()
{
	if (func_6(Local_282))
	{
		if (((func_241() && iLocal_96 != 6) && iLocal_96 != 11) && iLocal_96 != 8)
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (func_209(Local_282, PLAYER::PLAYER_PED_ID(), 6f, 1))
				{
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_282, PLAYER::PLAYER_PED_ID(), true))
			{
		...
		if ((func_241() && iLocal_96 != 7) && iLocal_96 != 8)
		{
			if (iLocal_96 != 2)
			{
				if (iLocal_96 != 4)
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if (func_209(Local_270, PLAYER::PLAYER_PED_ID(), 6f, 1))
						{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_270, PLAYER::PLAYER_PED_ID(), true))
					{
						if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4))
						{
							func_210(15);
...
int func_239()
{
	if (func_240())
	{
		...
		{
			if (iLocal_96 == 11 && func_209(Local_252, PLAYER::PLAYER_PED_ID(), 5f, 1))
			{
				return 0;
			}
			return 1;
...
{
	if (func_209(Local_252, PLAYER::PLAYER_PED_ID(), 2f, 1) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
void func_246()
{
	if (iLocal_96 != 20)
	{
		if (func_209(PLAYER::PLAYER_PED_ID(), Local_252, 15f, 1))
		{
...
void func_249()
{
	if (func_95(PLAYER::PLAYER_PED_ID(), vLocal_224, 220f))
	{
		if (!bLocal_290 && !func_95(PLAYER::PLAYER_PED_ID(), vLocal_224, 100f))
		{
			bLocal_290 = func_128(&iLocal_289, joaat("SADLER"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_95(PLAYER::PLAYER_PED_ID(), vLocal_224, 240f))
	{
		if (bLocal_290)
		{
			func_133(&iLocal_289);
...
void func_250()
{
	if (func_446(Local_252) && iLocal_96 != 15)
	{
		...
		if (!func_209(Local_252, PLAYER::PLAYER_PED_ID(), 150f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_252))
		{
		...
		else if (!func_209(Local_252, PLAYER::PLAYER_PED_ID(), 200f, 1))
		{
			if (ENTITY::IS_ENTITY_ON_SCREEN(Local_252))
			{
				func_207(&Local_252, 0, 1, 1);
...
{
	func_252();
	func_131(&iLocal_268, &iLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, vLocal_224, Local_282, 0, 1090519040 /* Float: 8f */);
	func_156();
	func_145();
	switch (iLocal_93)
	{
...
void func_252()
{
	if (func_6(Local_270))
	{
		if (!bLocal_227)
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_270, false))
			{
				bLocal_227 = true;
			}
		}
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_110(iLocal_92, 0))
			{
				...
				if (func_459())
				{
					MISC::CLEAR_AREA_OF_VEHICLES(-399.8117f, -2172.942f, 9.3184f, 50f, false, false, true, true, false, false);
...
void func_254(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
void func_265()
{
	UNK_0x1082C25039B168F8("mini@repair");
	UNK_0x1082C25039B168F8("amb@code_human_cower@male@react_cowering");
}
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_322(iVar10, iParam1, iParam2, -1) };
		if (!func_321(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_322(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_322(iVar10, 14, uVar28[iVar1], -1) };
							func_292(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_314(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_314(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_322(iVar10, iVar0, func_281(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_322(iVar10, 14, uVar69[iVar1], -1) };
			func_292(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_314(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_282(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_282(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_386(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76647[1 /*14*/] = { func_322(iParam0, iParam1, iParam2, -1) };
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_386(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_285(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_282(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_282(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_295(iParam0, func_282(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_299(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_307(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_307(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_307(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_306(vVar16.z)] = func_299(iParam1, vVar16.x, func_306(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
void func_314(int iParam0)
{
	...
	{
		func_320(iParam0, Global_76647[1 /*14*/].f_5, Global_76647[1 /*14*/].f_2, 2, Global_76647[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_316(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2551832[iParam0 /*3*/][func_317(iParam2)];
	if (iVar0 != 0)
	{
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_317(iParam1)];
...
bool func_319(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_324(int iParam0)
{
	...
	func_325(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_318(func_328(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_318(func_327(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_318(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_331(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_325(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_325(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_325(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_325(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_282(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_386(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_322(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_386(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_386(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_322(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_386(iParam0, 14, iVar4))
										{
											if (!func_278(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_322(iVar0, iVar2, iVar1, -1) };
						if (!func_278(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_391(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_426(iParam5, &Var0, vParam1, fParam4, func_432(iParam0));
...
void func_392(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_412();
			}
...
void func_393(int iParam0, int iParam1)
{
	...
	func_433(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_423(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_180(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_426(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_423(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_431(iParam0);
			func_430(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_443()
{
	...
	if (!func_6(iLocal_268))
	{
		if (!func_6(iLocal_269) && !func_6(Local_282))
		{
			func_445(1);
			return;
		}
		if (func_6(Local_282))
		{
			if (!func_209(PLAYER::PLAYER_PED_ID(), Local_282, 500f, 1))
			{
				iVar0++;
			}
		}
...
void func_445(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			break;
		case 1:
			iLocal_211 = "PRB_FWRECK";
			break;
		case 2:
			iLocal_211 = "PRB_FFAR";
			break;
		case 3:
			iLocal_211 = "PRB_FSTUCK";
			break;
	}
	iLocal_92 = 5;
	iLocal_93 = 0;
