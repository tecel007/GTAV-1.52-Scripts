...
void __EntryFunction__()
{
	...
	Var0.f_41 = 6;
	func_285(&Var0);
	vLocal_92 = { ScriptParam_0.f_1[0 /*3*/] };
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_265(&iVar61, &Var0, vLocal_92, 1f))
	{
	...
	MISC::CLEAR_AREA(vLocal_92, 5f, true, false, false, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_215(&Var0, 1) || func_256(Var0))
		{
			func_268(&Var0, 1);
		}
		if (func_255(43))
		...
		func_214(Var0);
		func_206(&iLocal_269, &(Var0.f_9), vLocal_92);
		func_184(&Var0);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
...
void func_184(var uParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_92);
		if (fVar0 < (20f * 20f) && bLocal_98)
		{
			switch (iLocal_99)
			{
				case 0:
...
void func_206(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_210(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_209(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_210(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_212(iParam0);
				}
			}
...
int func_215(int iParam0, bool bParam1)
{
	...
	func_110(*iParam0, &Var0);
	if ((func_252(*iParam0) || func_250(*iParam0)) || Global_77078 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*iParam0 == 16)
						{
							if (func_224(PLAYER::PLAYER_PED_ID(), iParam0->f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iParam0->f_28[iVar0]))
				{
					...
					if (func_244(*iParam0))
					{
						if (!func_158(*iParam0))
						{
							if (func_239(iParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_220(iParam0);
						...
						if (func_227(iParam0->f_28[iVar0], 1126825984 /* Float: 170f */))
						{
							if (iParam2 == 0)
							{
								func_220(iParam0);
...
bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_230(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_230(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_235(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_235(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_241(int iParam0, float fParam1)
{
	...
	{
		if (func_242(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_242(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_235(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_251() && Global_98955.f_11 == 6) && iParam0 == func_167(&(Global_98955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0)
{
	...
	iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_92 - Vector(10f, 10f, 10f), vLocal_92 + Vector(10f, 10f, 10f), false, true, true, true);
	bLocal_97 = true;
...
int func_254(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			if (*iParam0 == 58)
			{
				StringCopy(&(iParam0->f_9), "tonya_mcs_1", 24);
			}
			else if (*iParam0 == 59)
			{
				StringCopy(&(iParam0->f_9), "tonya_mcs_2", 24);
			}
			else if (*iParam0 == 62)
			{
				StringCopy(&(iParam0->f_9), "tonya_mcs_3", 24);
			}
		...
		case 2:
			...
			{
				iParam0->f_28[0] = PED::CREATE_PED(5, joaat("IG_TONYA"), -16.53f, -1473.12f, 29.61f, 319.56f, true, true);
			...
			break;
		case 3:
			if (func_127(iParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
				...
				TASK::CLOSE_SEQUENCE_TASK(iVar1);
				TASK::TASK_PERFORM_SEQUENCE(iParam0->f_28[0], iVar1);
				TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				TASK::TASK_LOOK_AT_ENTITY(iParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 4);
			}
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_266((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_266((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_266(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_267(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_267(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_268(int iParam0, bool bParam1)
{
	...
	UNK_0x1082C25039B168F8("special_ped@tonya@intro");
	UNK_0x1082C25039B168F8("special_ped@tonya@base");
	if (bLocal_98)
	{
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_1@franklin_1a");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_1@franklin_1b");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_1@franklin_1c");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_2@franklin_2a");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_2@franklin_2b");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_2@franklin_2c");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_3@franklin_3a");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_3@franklin_3b");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_4@franklin_4a");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_4@franklin_4b");
		UNK_0x1082C25039B168F8("special_ped@tonya@franklin_4@franklin_4c");
	}
	UNK_0x1082C25039B168F8("special_ped@tonya@franklin_5@franklin_5a");
	UNK_0x1082C25039B168F8("special_ped@tonya@franklin_5@franklin_5b");
	UNK_0x1082C25039B168F8("special_ped@tonya@franklin_5@franklin_5c");
	if (iLocal_269 != -1)
	{
...
void func_269(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_277(iParam0, iParam1);
	func_273(iParam0, bParam2);
	func_270(iParam0, bParam3);
}

void func_270(int iParam0, bool bParam1)
{
	func_271(&(iParam0->f_41), bParam1);
}
