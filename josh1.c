		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_208(iParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_208(iParam0) };
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_279(Global_76877, Global_76879, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_290(0) || Global_76891) || Global_76880 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_76876)
...
{
	return func_292(iParam0, Global_41431);
}
...
int func_327()
{
	...
	iVar0 = func_328(&(Global_98744.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_331()
{
	...
	{
		if (func_326(&(Global_98744.f_3)) > -1)
		{
			return 1;
		}
	}
