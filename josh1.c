...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_345(58);
	iLocal_81 = joaat("FELON2");
	vLocal_150 = { -1106.999f, 288.96f, 63.4f };
	vLocal_153 = { 0f, 0f, 12.06f };
	...
	switch (iLocal_145)
	{
		...
		case 1:
			...
			if (!bLocal_160)
			{
				...
				{
					iLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
		...
		if (bParam2)
		{
			if (!Global_76833)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8210[iParam1 /*4*/] = { func_208(iParam0) };
					...
					{
						Global_8161[1 /*6*/] = { func_208(iParam0) };
...
int func_241(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_244()
{
	...
	{
		case 0:
			if (func_260(1, 1093140480 /* Float: 10.5f */, 0))
			{
				...
				MISC::CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, false, false, false, false, false, false);
				MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, false, false, false, false, false, 0);
				...
				func_249(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 3f, 6f, 3f, 1, 1, 1, 0, 0);
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!bLocal_160)
				{
					...
					if (func_294(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
					{
						...
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
						PED::_0x2208438012482A1A(Local_83.f_28[0], false, false);
						bLocal_160 = true;
					}
				}
				iLocal_145 = 2;
...
int func_245(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_246(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_249(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, int iParam17, float fParam18)
{
	func_250(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, iParam17, fParam18);
}

void func_250(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_254(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_254(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_255(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_255(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_255(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_255(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_255(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_255(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_255(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_255(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_255(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_255(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_255(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_255(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_255(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_255(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_255(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_255(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_266(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			...
			if (!func_5(0))
			{
				if (!bLocal_156)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, false, true, 0))
					{
						if (func_294(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
						{
							iLocal_148 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
...
void func_270()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_266(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_279(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_290(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_292(iParam0, Global_41631);
}
...
void func_298(int* iParam0, bool bParam1)
{
	...
	func_299(iParam0, iLocal_81, vVar0, fVar3);
...
void func_299(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_300(iParam0);
...
int func_301(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_302(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_302(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_327()
{
	...
	iVar0 = func_328(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_331()
{
	...
	{
		if (func_326(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
