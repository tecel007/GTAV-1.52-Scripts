		...
		switch (iLocal_27)
		{
			case 0:
				if (uLocal_18[0])
				{
					...
					iLocal_22 = 0;
					while (iLocal_22 < Global_22124[1 /*42*/].f_32[1])
					{
						Global_31022[iLocal_22] = 0;
						Global_31018[iLocal_22] = 0;
						iLocal_22++;
					}
					func_4(1, 1, 1, 1);
...
int func_5(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	func_6(Global_22123);
	Global_22293[Global_22123 /*9*/].f_1 = iParam1;
	Global_22293[Global_22123 /*9*/] = iParam0;
	if (iParam3 == 0)
	{
	}
	else
