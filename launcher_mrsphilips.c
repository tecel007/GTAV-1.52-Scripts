...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110945[Var0 /*10*/].f_9 != -1)
			{
				...
				func_259(&(Global_110945[Var0 /*10*/].f_9));
			}
		}
		func_246(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_243(&iVar64, &Var0, vVar61, 1f))
	{
		func_242();
	...
	func_231(&Var0);
	iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), false, true, true, true);
	...
	while (true)
	{
		...
		func_192(Var0);
		func_184(&iLocal_91, &(Var0.f_9), vVar61);
		if (func_169(&Var0, 0))
		{
			if (Var0 == 35)
			{
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;

	if (*iParam0 == 1)
	{
		if (func_244((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_244((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_244(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	if (func_245(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_245(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_247(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_251(iParam0, bParam2);
	func_248(iParam0, bParam3);
}

void func_248(int iParam0, bool bParam1)
{
	func_249(&(iParam0->f_41), bParam1);
}
