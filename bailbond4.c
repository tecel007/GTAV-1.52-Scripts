...
void __EntryFunction__()
{
	...
	StringCopy(&cLocal_598, "", 24);
	StringCopy(&cLocal_604, "MAUDE_MCS_5", 24);
	StringCopy(&cLocal_610, "", 24);
	...
	if (func_522())
	{
		...
		{
			case 0:
				func_448(&uLocal_640, 1476.887f, 6363.799f, 22.5945f, 171.3869f, 0, 0, 0, 0, 0, joaat("ASTEROPE"), 0, 145, 1);
				func_447(vLocal_625, fLocal_392, 1, 0);
				iLocal_101 = 2;
				func_436(1, 0);
				break;
			case 1:
				func_448(&uLocal_640, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("ASTEROPE"), 0, 145, 1);
				func_447(vLocal_616, 254.9762f, 0, 0);
				func_436(4, 0);
				break;
			default:
				break;
	...
	else if (func_435(0))
	{
		...
		{
			func_433(PLAYER::PLAYER_PED_ID(), vLocal_625, fLocal_392, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_619 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_422();
			func_421();
			switch (iLocal_98)
			{
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_628, fLocal_393, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), vLocal_631, fLocal_394, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_379 == 0)
						{
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					func_433(Local_112.f_9, vLocal_616, 0f, 0, 0);
					if (!func_71())
					{
						func_433(PLAYER::PLAYER_PED_ID(), vLocal_616, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_379 == 0)
						{
...
int func_3(int iParam0, float fParam1)
{
	...
	if (func_23(iParam0))
	{
		if (func_4(ENTITY::GET_ENTITY_COORDS(iParam0, true), &vVar0, fParam1, 0))
		{
...
bool func_4(vector3 vParam0, Vector3* vParam3, float fParam4, bool bParam5)
{
	var uVar0;
	vector3 vVar1;
...
int func_20(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_27(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
bool func_37()
{
	if (func_59(vLocal_619, Local_322.f_1, 210f))
	{
		if (!bLocal_385)
		{
		...
		{
			if (func_59(vLocal_619, Local_342.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_342.f_1, 10f, func_48(), false))
				{
					Local_342 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_342.f_1, 10f, func_48(), true, false, true);
					if (func_434(Local_342))
					{
						ENTITY::SET_ENTITY_COORDS(Local_342, func_47(), true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(Local_342, func_46());
						ENTITY::FREEZE_ENTITY_POSITION(Local_342, true);
					}
				}
			}
		}
		...
		{
			if (func_59(vLocal_619, Local_348.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_348.f_1, 10f, func_45(), false))
				{
					Local_348 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_348.f_1, 10f, func_45(), true, false, true);
				}
			}
		}
	}
	...
	{
		func_42(&Local_322, 1);
		UNK_0x1082C25039B168F8(func_41());
		func_38(&Local_330, 1);
		func_38(&Local_336, 1);
		func_38(&Local_342, 0);
		func_38(&Local_348, 0);
...
void func_49()
{
	...
	if (func_23(Local_322))
	{
		if (func_434(Local_330))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_322, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_330, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1000f);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_322, true);
				PED::SET_PED_MONEY(Local_322, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_322, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_322, joaat("PLAYER"));
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_322, false);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_322, false);
				PED::SET_PED_KEEP_TASK(Local_322, true);
				PED::SET_PED_CONFIG_FLAG(Local_322, 118, false);
			}
		}
	}
}
...
int func_54(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_56(iParam1))
...
int func_57(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_56(iParam1))
...
int func_60(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_65(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_67()
{
	...
	if (func_434(Local_322))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_428, Local_322, 0);
		}
	}
}
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_322))
				{
					...
					func_113(Local_322, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_322))
					{
						if (func_112(Local_322, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(Local_322, false);
							func_110(Local_322, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_336))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_336, false);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_342))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_342, false);
				}
			...
			{
				bLocal_375 = false;
				StringCopy(&cLocal_598, "BBC_T12", 24);
			}
			if (func_23(Local_112.f_9))
			{
		...
		case 1:
			...
			else if (!bLocal_375)
			{
				...
				if (iLocal_102 == 4)
				{
					if (func_23(Local_322))
					{
						if (func_112(Local_322, vLocal_619, 35f))
						{
							func_97(&uLocal_432, 4, Local_322, "MAUDE", 0, 1);
							if (func_75(&uLocal_432, cLocal_426, &cLocal_598, 4, 0, 0, 0))
							{
								bLocal_375 = true;
							}
						}
				...
				else if (func_75(&uLocal_432, cLocal_426, &cLocal_598, 4, 0, 0, 0))
				{
					bLocal_375 = true;
				}
				if (iLocal_102 == 4)
				{
					...
					else if (func_23(Local_322))
					{
						if (!func_64(Local_322, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_322))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_322, func_109(), func_74(), 3))
								{
									func_73(&Local_322);
									TASK::TASK_SMART_FLEE_PED(Local_322, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
									PED::SET_PED_KEEP_TASK(Local_322, true);
								}
							}
						}
...
void func_88()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_91(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_90(PLAYER::PLAYER_PED_ID());
			if (func_89(iVar0) && (!func_93(14) || Global_110809))
			{
...
void func_98(bool bParam0)
{
	...
	if (func_23(Local_322))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_322, false);
		PED::SET_PED_KEEP_TASK(Local_322, true);
	}
...
void func_124()
{
	...
	{
		func_127(13, SYSTEM::FLOOR(Global_111858.f_10190.f_3853));
	}
	...
	switch (iLocal_100)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_322))
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_322, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_322, true);
				}
...
void func_132(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_184(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_181(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_133(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_133(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_167(iParam5, &Var0, vParam1, fParam4, func_173(iParam0));
...
void func_134(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_164(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_153();
			}
...
void func_135(int iParam0, int iParam1)
{
	...
	func_175(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_152(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	...
	switch (iParam1)
	{
		...
		case 1:
			...
			*uParam0 = { 148.2868f, -1270.569f, 28.2252f };
			...
			MISC::SET_BIT(&(uParam0->f_9), 7);
			iVar0 = 1;
			Jump @5415; //curOff = 1109
			*uParam0 = { 1459.509f, -1380.45f, 78.3259f };
			uParam0->f_3 = 99.6211f;
			uParam0->f_4 = joaat("SCORCHER");
			MISC::SET_BIT(&(uParam0->f_9), 6);
			iVar0 = 1;
			Jump @5415; //curOff = 1161
			*uParam0 = { -1518.947f, -1387.865f, -0.5134f };
			uParam0->f_3 = 98.3867f;
			uParam0->f_4 = joaat("SEASHARK");
			iVar0 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 6);
			Jump @5415; //curOff = 1213
			*uParam0 = { 353.0926f, 3577.593f, 32.351f };
			uParam0->f_3 = 16.6205f;
			uParam0->f_4 = joaat("DUSTER");
			iVar0 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 6);
			Jump @5415; //curOff = 1265
			uParam0->f_14 = 0;
			...
			*uParam0 = { 1333.875f, 4262.226f, 30.78f };
			...
			if (MISC::IS_BIT_SET(uParam0->f_9, 10))
			{
				...
				if (!func_174(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
				{
			...
			{
				if (!func_174(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
				{
			...
			{
				if (!func_174(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
				{
...
void func_167(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_164(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_172(iParam0);
			func_171(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_181(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_182(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_185(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_186(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}

void func_186(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_188(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_188(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
{
	return func_193(Global_102423.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_193(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_249(iVar10, iParam1, iParam2, -1) };
		if (!func_248(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_249(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_249(iVar10, 14, uVar28[iVar1], -1) };
							func_219(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_241(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_241(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_249(iVar10, iVar0, func_208(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_249(iVar10, 14, uVar69[iVar1], -1) };
			func_219(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_241(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_209(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_209(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
int func_200(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_313(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76647[1 /*14*/] = { func_249(iParam0, iParam1, iParam2, -1) };
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_313(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_209(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_209(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_222(iParam0, func_209(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_226(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_234(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_234(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_234(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_233(vVar16.z)] = func_226(iParam1, vVar16.x, func_233(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
...
void func_241(int iParam0)
{
	...
	{
		func_247(iParam0, Global_76647[1 /*14*/].f_5, Global_76647[1 /*14*/].f_2, 2, Global_76647[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
bool func_246(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_251(int iParam0)
{
	...
	func_252(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_245(func_255(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_245(func_254(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_245(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_252(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_252(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_252(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_252(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_209(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_313(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_249(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_313(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_313(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_249(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_313(iParam0, 14, iVar4))
										{
											if (!func_205(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_249(iVar0, iVar2, iVar1, -1) };
						if (!func_205(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_209(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_209(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_315()
{
	...
	if (func_23(Local_112.f_9))
	{
		...
		func_382(Local_112.f_9, &iLocal_408, 1126825984 /* Float: 170f */, 7);
		...
		switch (iLocal_100)
		{
			case 0:
				...
				bLocal_412 = ENTITY::GET_ENTITY_HEALTH(Local_112.f_9);
				vLocal_634 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, false) };
				func_361(&vLocal_637, vLocal_634);
			...
			case 1:
				if (!bLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_619, iVar0, 0, 1, bLocal_412))
						{
							if ((func_120(iLocal_410, 5000) || func_174(vLocal_637, 0f, 0f, 0f, 0)) || (!func_59(vVar1, vLocal_637, 8.5f) && !func_59(vVar1, vLocal_634, 8.5f)))
							{
								func_326();
						...
						else
						{
							if (!bLocal_354)
							{
								if (!func_120(iLocal_397, 2500))
								{
									if (!func_62())
									{
										if (func_112(Local_112.f_9, vLocal_619, 30f))
										{
							...
							func_323(Local_112.f_9, vLocal_619, iLocal_410, 925353388);
						}
					}
					else
					{
				...
				{
					func_326();
					if (!func_112(Local_112.f_9, vLocal_619, 10f))
					{
						if (!bLocal_370)
						{
...
void func_319(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_323(int iParam0, vector3 vParam1, int iParam4, float fParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_327(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	...
	if (func_23(iParam0))
	{
		...
		if (bParam5)
		{
			if (func_328(iParam0, vParam1, 1112014848 /* Float: 50f */, 1084227584 /* Float: 5f */))
			{
				return 1;
			}
		}
...
int func_328(int iParam0, vector3 vParam1, float fParam4, float fParam5)
{
...
void func_330(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6)
{
	func_331(uParam0, iParam1, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_331(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6)
{
	func_332(uParam0, iParam1, 0f, 0f, 0f, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_332(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, char* sParam7, int iParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_333(uParam0, iParam1, vParam2, iParam5, iParam6, sParam7, iParam8, bParam9);
}

void func_333(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
	...
	if (func_356(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_348(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_339(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_346() || func_345(Global_4456448.f_129348)) || func_344())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_340(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_341(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_348(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_358(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
void func_362()
{
	...
	if (func_23(Local_112.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_112(Local_112.f_9, vLocal_619, 20f))
					{
				...
				case 5:
					...
					break;
				case 6:
					if (!func_112(Local_112.f_9, vLocal_619, 3.5f))
					{
				...
				case 31:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 1f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
						TASK::TASK_SEEK_COVER_FROM_PED(0, PLAYER::PLAYER_PED_ID(), MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500), true);
						TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_622, 50f);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_418);
						TASK::TASK_PERFORM_SEQUENCE(Local_112.f_9, iLocal_418);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, true);
				...
				case 33:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, true, 0.5f, 4f, true, 0, false, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
				...
				case 35:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_418);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, false);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, true, 0.75f, 4f, true, 0, false, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_418);
						TASK::TASK_PERFORM_SEQUENCE(Local_112.f_9, iLocal_418);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, true);
				...
				case 13:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_112.f_9, vLocal_619);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, true);
						if (iVar0 != joaat("WEAPON_UNARMED"))
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_364())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_112.f_9, iVar1, false))
								{
									...
									if (fVar4 < 1.75f && func_112(Local_112.f_9, vLocal_619, 8f))
									{
				...
				case 23:
					if (func_367(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040 /* Float: 8f */, 1097859072 /* Float: 15f */, 0) || func_366())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_363(Local_112.f_19, 10) && func_112(Local_112.f_9, vLocal_619, 50f)) || !func_120(iLocal_415, 2000))
							{
					...
					if (func_367(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040 /* Float: 8f */, 1097859072 /* Float: 15f */, 0) || func_366())
					{
						if (!func_64(Local_112.f_9, -1519143300))
						{
							if (!func_64(Local_112.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, false))
								{
									if (!func_363(Local_112.f_19, 10) && func_112(Local_112.f_9, vLocal_619, 50f))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_112.f_9, 0, 0);
										Local_112.f_10 = 23;
									}
							...
							else if (!func_363(Local_112.f_19, 10) && func_112(Local_112.f_9, vLocal_619, 50f))
							{
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		if (func_112(iParam0, vLocal_619, fParam2))
		{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_376(&(Local_56[iVar4 /*4*/]), vVar1, iParam1, &(Local_56[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar4 /*4*/].f_3) < iParam4);
}

int func_376(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_377(iParam4, iParam7) };
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_190(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_383()
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_616, 100f))
	{
		if (!func_384())
		{
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_616, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!bLocal_383)
				{
					...
					func_117(&(Local_112.f_8));
					if (!func_112(Local_112.f_9, vLocal_619, 25f))
					{
					...
					{
						func_388();
						func_386(&Local_322, vLocal_619, &iLocal_399, 5000, 1101004800 /* Float: 20f */);
					}
				}
				else if (func_112(Local_112.f_9, vLocal_619, 8f))
				{
...
int func_386(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!bLocal_383)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_390))
						{
							if (bLocal_369)
							{
								iLocal_390 = func_395(vLocal_616, 5, 1);
							}
						}
						if (!bLocal_356)
						{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_616, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_616, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), vLocal_616, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
				...
				else
				{
					...
					if (func_112(Local_112.f_9, vLocal_619, 8f))
					{
						if (Local_112.f_10 == 25 || Local_112.f_10 == 26)
						{
							Local_112.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_380)
				{
					bLocal_380 = func_393(vLocal_619, vLocal_103, 180f);
				}
				if (func_316(&(Local_112.f_9)))
				{
					bLocal_387 = true;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_380)
					{
						bLocal_380 = func_393(vLocal_619, vLocal_103, 0f);
					}
					func_131(4);
				}
				break;
...
int func_393(vector3 vParam0, vector3 vParam3, float fParam6)
{
	int iVar0;

	if (!func_394(vParam0, vParam3, fParam6))
	{
...
bool func_394(vector3 vParam0, vector3 vParam3, float fParam6)
{
	vector3 vVar0;
			...
			case 1:
				...
				if (!bLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_619, iVar0, 0, 1, 170))
						{
							func_326();
							func_398(iLocal_407);
							Local_112.f_17 = MISC::GET_GAME_TIMER();
						...
						else
						{
							...
							func_323(Local_112.f_9, vLocal_619, iLocal_409, 925353388);
						}
					}
				}
				else
...
void func_399(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_132[iVar0 /*19*/]))
		{
			func_374(Local_132[iVar0 /*19*/], &(Local_132[iVar0 /*19*/].f_16), 1126825984 /* Float: 170f */, 7);
			switch (Local_132[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						func_116(&(Local_132[iVar0 /*19*/].f_6));
						if (func_112(Local_132[iVar0 /*19*/], vLocal_619, 5f))
						{
					...
					{
						if (!func_112(Local_132[iVar0 /*19*/], vLocal_619, 7f))
						{
							TASK::CLEAR_PED_TASKS(Local_132[iVar0 /*19*/]);
						...
						func_400(Local_132[iVar0 /*19*/], &(Local_132[iVar0 /*19*/].f_6), -1, 0, 0, 0, -1082130432 /* Float: -1f */, 0, -1, -1, 1);
					}
					break;
				case 3:
...
int func_400(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
int func_401(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	...
	if (func_23(iParam0))
	{
		...
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0, true) };
			if (MISC::IS_BULLET_IN_AREA(vVar0, fParam5, true))
			{
				return 1;
			}
			if (func_112(iParam0, vLocal_619, fParam2))
			...
			vVar3.f_1 = (vVar3.y - fParam6);
			vVar3.f_2 = (vVar3.z - fParam6);
			vVar6.x = (vVar6.x + fParam6);
			vVar6.f_1 = (vVar6.y + fParam6);
			vVar6.f_2 = (vVar6.z + fParam6);
			if (MISC::IS_PROJECTILE_IN_AREA(vVar3, vVar6, true))
			{
				return 1;
			}
...
void func_403()
{
	if (func_23(Local_112.f_9))
	{
		func_382(Local_112.f_9, &iLocal_408, 1126825984 /* Float: 170f */, 1);
				...
				switch (iLocal_101)
				{
					case 2:
						...
						else
						{
							...
							if (func_112(Local_112.f_9, vLocal_619, 25f) && func_413(Local_112.f_9, vLocal_619, 10f))
							{
								...
								else if (func_411(Local_112.f_9, iLocal_408, 0, 1103626240 /* Float: 25f */, 1086324736 /* Float: 6f */))
								{
									iLocal_101 = 0;
								}
								else if (func_112(Local_112.f_9, vLocal_619, 5f))
								{
									iLocal_101 = 0;
								}
						...
						if (func_367(Local_112.f_9, Local_112.f_19, 25f, 0, 1090519040 /* Float: 8f */, 1097859072 /* Float: 15f */, 0))
						{
							iLocal_100 = 2;
						}
						break;
...
void func_407()
{
	if (!bLocal_367)
	{
		if (!func_62())
		{
			if (func_112(Local_112.f_9, vLocal_619, (25f + 5f)))
			{
				iLocal_391 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_610))
				{
				...
				else if (func_409(&uLocal_432, cLocal_425, "BB4_AMB", &cLocal_610, 1, iLocal_391, 0))
				{
					bLocal_367 = true;
					StringCopy(&cLocal_610, "", 24);
				}
	...
	{
		if (!func_112(Local_112.f_9, vLocal_619, (25f + 10f)))
		{
			cLocal_610 = { func_408() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_610))
			{
...
int func_411(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_434(iParam0))
	{
		if (!func_363(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_112(Local_112.f_9, vLocal_619, fParam3))
				{
					return 0;
				}
				if (!func_413(iParam0, vLocal_619, fParam4))
				{
					return 0;
				}
			}
...
int func_413(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	float fVar3;
...
void func_414()
{
	switch (iLocal_100)
	{
		case 0:
			...
			break;
		case 1:
			func_415(&vLocal_103, &uLocal_432);
			if (func_23(Local_112.f_9))
			{
				func_382(Local_112.f_9, &iLocal_408, 1126825984 /* Float: 170f */, 1);
				func_374(Local_112.f_9, &(Local_112.f_19), 120f, 7);
				...
				if (func_112(Local_112.f_9, vLocal_619, 25f) && func_413(Local_112.f_9, vLocal_619, 10f))
				{
					...
					{
						if (func_112(Local_112.f_9, vLocal_619, (25f - 1.5f)))
						{
							iLocal_101 = 1;
							iLocal_100 = 2;
						}
...
void func_423()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_322, false) || PED::IS_PED_INJURED(Local_322))
		{
			iLocal_102 = 3;
			return;
		}
	...
	if (iLocal_98 == 0)
	{
		if (!SYSTEM::VDIST2(vLocal_619, vLocal_103) <= ((vLocal_103.f_3 + 25f) * (vLocal_103.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_112.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_112.f_9, false) && !PED::IS_PED_INJURED(Local_112.f_9))
		{
			...
			{
				if (!func_112(Local_112.f_9, vLocal_619, 150f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_112.f_9))
					{
						iLocal_102 = 2;
			...
			{
				if (!func_112(Local_112.f_9, vLocal_619, 80f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_112.f_9))
					{
						iLocal_102 = 2;
...
int func_424(bool bParam0)
{
	if (func_23(Local_322))
	{
		...
		if (PED::HAS_PED_RECEIVED_EVENT(Local_322, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(Local_322))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_322, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_322, 51))
		{
			return 1;
		}
		if (func_430(Local_322, 1126825984 /* Float: 170f */))
		{
			return 1;
		}
		if (func_425(Local_322, 1, 0, 0, 0))
		{
			return 1;
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_322, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_322, 73))
		{
			return 1;
		}
		if (bParam0)
...
int func_428(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
{
	func_20(iParam0, vParam1, fParam4, iParam5, 1);
	if (bParam6)
	{
		if (func_434(iParam0))
		{
...
void func_439(bool bParam0)
{
	...
	UNK_0x1082C25039B168F8("oddjobs@bailbond_hobodepressed");
	UNK_0x1082C25039B168F8("oddjobs@bailbond_hobohang_out_street_b");
	UNK_0x1082C25039B168F8("oddjobs@bailbond_hobohang_out_street_c");
	UNK_0x1082C25039B168F8("oddjobs@bailbond_hobotwitchy");
...
void func_447(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_522())
	{
...
void func_448(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_490(iParam12, 0);
			while (!func_449(iParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_449(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_485(iParam0, &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_485(iParam0, &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_450(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_177(iParam1, &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111858.f_20114[iParam0 /*43*/].f_31 = func_453(*iParam1);
				...
				func_451(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_111858.f_20114[iParam0 /*43*/].f_1));
				...
				func_451(Global_111858.f_2359.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111858.f_20114[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_451(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_452(iVar0, &uVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_452(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
...
int func_455(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_460(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 7;
			}
		}
	}
	return 0;
...
int func_464(int iParam0)
{
	...
	if (func_465(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_477(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_82())
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_478(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1 && Global_2425869[iParam0 /*443*/].f_314.f_9 != func_82())
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_479(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2425869[iParam0 /*443*/].f_314.f_6 != -1)
			{
				return func_456(Global_2425869[iParam0 /*443*/].f_314.f_6) == 9;
			}
		}
	}
	return 0;
...
void func_490(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96286[iVar0]) == func_165(iParam0, iParam1))
				{
...
void func_491(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_164(&(Global_75654.f_555[0 /*21*/]), iVar0))
		{
...
void func_492(int iParam0)
{
	...
	if (func_164(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_75654.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_170(iParam0, 0)) && Global_76563.f_66 == 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] != 0) && Global_111858.f_32745.f_1958[Global_75654.f_555[0 /*21*/].f_14] > 3) && (!func_493(0, Global_75654.f_555[0 /*21*/].f_12) || !func_493(1, Global_75654.f_555[0 /*21*/].f_12)))
			{
				func_171(&(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]), &Global_76563);
...
int func_493(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_494(&(Global_111858.f_32745.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_138(Global_111858.f_32745.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_174(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
bool func_514()
{
	return func_512(&(Global_105407.f_2890));
}

void func_515()
{
	func_516(&(Global_105407.f_2890));
}
...
int func_517(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_519(Global_105407.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_523()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("PLAYER"), iLocal_597);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_597, joaat("PLAYER"));
	vVar0 = { func_530(vLocal_103) };
	vVar3 = { func_529(vLocal_103) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	iLocal_416 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, false, true, true, true);
...
int func_527(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_528(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110905) || Global_30970) || func_552()) || func_95(8, -1)) || func_551()) || func_550()) || func_544()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_546()) || Global_30970) || func_552()) || func_95(8, -1)) || func_544()) || func_551()) || func_550()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110905) || Global_30970) || func_552()) || func_95(8, -1)) || func_544()) || func_551()) || func_550()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_546()) || Global_110905) || Global_30970) || func_552()) || func_95(8, -1)) || func_551()) || func_550()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_546() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_545()) || func_549()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_546()) || Global_30970) || func_552()) || func_95(8, -1)) || func_550()) || func_544()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_546()) || func_550()) || Global_110905) || Global_30970) || func_552()) || Global_42801) || func_95(8, -1)) || func_544()) || func_549()) || func_545()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_546()) || Global_110905) || Global_30970) || func_552()) || func_95(8, -1)) || func_544()) || func_549()) || func_551()) || func_550()) || func_545())
						{
							return 0;
						}
						break;
...
int func_564()
{
	...
	iVar0 = func_565(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_568()
{
	...
	{
		if (func_558(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
