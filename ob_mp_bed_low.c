...
void __EntryFunction__()
{
	...
	if ((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(16) || func_82()) || Global_2540384.f_1913)
	{
		func_81();
	}
	...
	vLocal_343 = { ScriptParam_0.f_1[0 /*3*/] };
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 3f)
			{
				switch (iLocal_325)
				{
					case 0:
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > (3f + 2f))
			{
				func_81();
			}
		}
...
void func_1()
{
	...
	switch (iLocal_326)
	{
		case 0:
			...
			if (func_72() == 5)
			{
				iLocal_330 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, false, true, 1f, 0f, 1f);
			...
			{
				if ((((func_49(vLocal_343, vVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_343)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_337, vLocal_340, 2f, false, true, 0)) && func_48()) && !func_45(PLAYER::PLAYER_ID()))
				{
					if (iLocal_332 == -1)
					{
		...
		case 1:
			if (func_43(1, 0, 1))
			{
				if (((((func_49(vLocal_343, vVar0) && func_53(8)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_343)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_337, vLocal_340, 2f, false, true, 0)) && func_48()) && !func_45(PLAYER::PLAYER_ID()))
				{
					if (func_41(iLocal_332, 1))
					{
						...
						MISC::CLEAR_AREA_OF_PROJECTILES(vLocal_343, 3f, 0);
						func_27(PLAYER::PLAYER_ID(), 0, 256, 0);
						bLocal_36 = true;
						func_26();
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
						func_16(1, 1, 1, 0, 0, 0, 0);
						vLocal_343 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_333, sLocal_334, vLocal_347, vLocal_350, 0f, 2) };
						vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_333, sLocal_334, vLocal_347, vLocal_350, 0f, 2) };
						fLocal_346 = vVar3.z;
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_343, 1f, 5000, fLocal_346, 0.05f);
		...
		case 2:
			...
			{
				iLocal_330 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, false, false, 1f, 0f, 1f);
		...
		case 3:
			...
			func_11(1);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			iLocal_331 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_330);
		...
		case 6:
			...
			break;
		case 7:
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_343)) && !func_7()) && !func_5()) && Global_1312485.f_8 == 0)
			{
				bLocal_328 = true;
				iLocal_330 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, false, false, 1f, 0f, 1f);
...
float func_15(struct<2> Param0, int iParam2, struct<2> Param3, Vector3 vParam5)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

void func_16(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_23(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
{
	return MISC::IS_BIT_SET(Global_1377236.f_241.f_136[func_47(9) /*33*/][iParam0], func_46(9));
}
...
int func_48()
{
	...
	if (iVar9 > 0)
	{
		...
		while (iVar10 <= 7)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar10], vLocal_337, vLocal_340, 2f, false, true, 0))
				{
					return 0;
				}
			}
...
int func_49(vector3 vParam0, Vector3 vParam3, var uParam4, var uParam5)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95883 && Global_95884) || func_51())
					{
						return 0;
					}
					if (func_50(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, vParam3, 0))
					{
						return 1;
					}
				}
...
{
	if ((((((MISC::IS_BIT_SET(Global_1573336, iParam0) || Global_1573337 != -1) || func_58()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_57()) || func_54(iParam0))
	{
		return 0;
	}
	return 1;
...
int func_60()
{
	...
	if (func_61() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_61()) == 0)
		{
			return 1;
		}
	}
...
{
	return func_80(iParam0, Global_41631);
}
...
void func_81()
{
	...
	if (bLocal_327)
	{
		UNK_0x1082C25039B168F8(sLocal_333);
	}
	if (bLocal_36 && !func_21(PLAYER::PLAYER_ID()))
	{
		func_27(PLAYER::PLAYER_ID(), 1, 0, 0);
	}
	func_8();
