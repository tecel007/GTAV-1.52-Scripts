...
void func_1()
{
	...
	switch (iLocal_326)
	{
		...
		case 6:
			...
			break;
		case 7:
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_343)) && !func_7()) && !func_5()) && Global_1312467.f_8 == 0)
			{
				bLocal_328 = true;
				iLocal_330 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, false, false, 1f, 0f, 1f);
...
void func_16(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
{
	return MISC::IS_BIT_SET(Global_1377170.f_241.f_136[func_47(9) /*33*/][iParam0], func_46(9));
}
