...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			vLocal_88 = { ENTITY::GET_ENTITY_COORDS(iLocal_86, true) };
			fLocal_94 = SYSTEM::VDIST2(vLocal_88, ScriptParam_0.f_1[0 /*3*/]);
			fLocal_94 = fLocal_94;
			vLocal_112 = { vLocal_88 };
			vLocal_115 = { ScriptParam_0.f_1[0 /*3*/] };
			vLocal_112.f_2 = 0f;
			vLocal_115.f_2 = 0f;
			fLocal_111 = SYSTEM::VDIST2(vLocal_112, vLocal_115);
			switch (iLocal_96)
			{
				case 0:
					...
					else
					{
						...
						if ((vLocal_88.z - ScriptParam_0.f_1[0 /*3*/].f_2) > 500f)
						{
						}
					}
					break;
				...
				case 3:
					...
					if (!func_178(iLocal_101))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98955.f_3), &cLocal_70))
							{
								cLocal_70 = { cLocal_54 };
								bVar1 = false;
							}
							...
							else
							{
								...
								if (fLocal_111 > (fLocal_103 * fLocal_103) && !Global_98989)
								{
									if (iLocal_106 != 263)
									{
								...
								else
								{
									...
									if (!func_165(3) && !Global_98989)
									{
										if (func_180(uLocal_95, 2097152))
										{
											if ((!func_180(uLocal_95, 1) || !ENTITY::DOES_ENTITY_EXIST(func_164())) && !Global_98989)
											{
												func_173(10);
											}
											else
											{
												...
												if ((!func_153(6) || Global_110905) || func_152())
												{
													bVar2 = false;
												}
												if (!bLocal_127)
												...
												if (bVar2)
												{
													if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_118, vLocal_121, fLocal_124, true, false, iLocal_104) || (fLocal_126 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_139(vLocal_118, vLocal_121, 0.5f), false) > fLocal_126))
													{
														bVar2 = false;
													}
													else if (fLocal_125 > 0f)
													{
														if (MISC::ABSF((vLocal_88.z - vLocal_118.z)) > fLocal_125)
														{
															bVar2 = false;
														}
													}
												...
												if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_70))
												{
													...
													if (iVar3 == 1)
													{
														...
														UNK_0xDDEDC06C88DA4E04(PLAYER::PLAYER_ID(), true, 56);
												...
												Jump @2645; //curOff = 1958
												if (func_180(Global_110509, 262144))
												{
													func_186(&Global_110509, 262144);
													func_15();
												}
												if (func_180(uLocal_95, 2097152))
												{
												...
												if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_53))
												{
													...
													if (iLocal_100 != -1)
													{
														if (func_180(Global_110509, 0))
														{
															STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_98992, 0);
															func_7(func_19(iLocal_100), 0, Global_98992, 1, 0);
														}
														else
														{
															STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_98992, 0);
															func_7(func_19(iLocal_100), 0, Global_98992, 0, 0);
														}
													}
													func_6();
													func_186(&Global_110509, 0);
												...
												func_5();
												Jump @2645; //curOff = 2317
												func_173(0);
												Jump @2645; //curOff = 2325
												func_188(1);
												Jump @2645; //curOff = 2333
												if (fLocal_111 > (fLocal_103 * fLocal_103))
												{
													if (iLocal_106 != 263)
													{
...
struct<10> func_47(int iParam0, bool bParam1)
{
	int iVar0;
	struct<10> Var1;
		...
		case joaat("PLAYER_ZERO"):
			switch (bParam1)
			{
				...
				case 9:
					...
					break;
				default:
					func_48(&Var1, iParam0, bParam1, 10);
					break;
			}
			break;
		case joaat("PLAYER_ONE"):
			switch (bParam1)
			{
				...
				case 8:
					...
					break;
				default:
					func_48(&Var1, iParam0, bParam1, 9);
					break;
			}
			break;
		...
		case joaat("MP_M_FREEMODE_01"):
			switch (bParam1)
			{
				...
				case 24:
					...
					break;
				default:
					func_48(&Var1, iParam0, bParam1, 25);
					break;
			}
			break;
...
void func_48(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_49(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
int func_49(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_51(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(bParam1);
		if (fVar1 != -1)
		{
			return (func_50(iParam0, func_51(iParam2)) + fVar1);
		}
	}
	return -99;
}
...
void func_56(int iParam0)
{
	...
	func_57(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_57(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_65(Global_2621444, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_65(Global_2621444, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_60(func_63(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_60(func_59(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_60(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_65(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_66(bParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_66(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_57(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_57(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_57(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_57(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_51(iParam0));
			if (iVar57 > iVar56)
			{
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_125(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_125(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_125(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::_0xF3FBE2D50A6A8C28(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_122(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_122(vVar16.z)] = func_49(iParam1, vVar16.x, func_122(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					(*uParam0)[func_122(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
int func_147(vector3 vParam0)
{
	...
	while (iVar3 < 10)
	{
		fVar1 = SYSTEM::VDIST2(vParam0, func_148(iVar3));
		if (fVar0 > fVar1)
		{
			fVar0 = fVar1;
			iVar2 = iVar3;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110905) || Global_30970) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_156()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_160()) || Global_30970) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110905) || Global_30970) || func_159()) || func_142(8, -1)) || func_156()) || func_158()) || func_157()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_110905) || Global_30970) || func_159()) || func_142(8, -1)) || func_158()) || func_157()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_160() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_142(8, -1)) || func_144()) || func_155()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_30970) || func_159()) || func_142(8, -1)) || func_157()) || func_156()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_160()) || func_157()) || Global_110905) || Global_30970) || func_159()) || Global_42801) || func_142(8, -1)) || func_156()) || func_155()) || func_144()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_110905) || Global_30970) || func_159()) || func_142(8, -1)) || func_156()) || func_155()) || func_158()) || func_157()) || func_144())
						{
							return 0;
						}
						break;
...
void func_162()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			iVar0 = func_130(PLAYER::PLAYER_PED_ID());
			if (func_133(iVar0) && (!func_167(14) || Global_110809))
			{
				if (Global_111858.f_2359.f_539.f_4321 != iVar0 && func_133(Global_111858.f_2359.f_539.f_4321))
				{
...
{
	return func_179(iParam0, Global_41631);
}
...
void func_181()
{
	...
	iLocal_100 = 13;
	StringCopy(&cLocal_54, "tennis", 64);
	iLocal_98 = 37500;
	func_168(&uLocal_95, 1);
	sLocal_102 = "PLAY_TENNIS";
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		iLocal_128 = func_147(vLocal_91);
	}
	iLocal_106 = func_184(vLocal_91);
	bLocal_129 = true;
	iVar0 = func_130(PLAYER::PLAYER_PED_ID());
	if (iVar0 == 1)
	{
	...
	switch (iLocal_128)
	{
		case 2:
			...
			bLocal_129 = true;
			vLocal_118 = { -765.014f, 154.244f, 67.25f };
			vLocal_121 = { -782.014f, 154.244f, 67.25f };
			fLocal_124 = 28f;
			fLocal_125 = 2f;
			break;
		case 1:
			...
			vLocal_118 = { -1164.958f, -1667.262f, 4.28f };
			vLocal_121 = { -1200.919f, -1615.872f, 4.28f };
			fLocal_124 = 65.5f;
			fLocal_125 = 5f;
			break;
		case 3:
			...
			vLocal_118 = { 491.2348f, -206.7215f, 52.78849f };
			vLocal_121 = { 469.6835f, -266.507f, 53.78639f };
			fLocal_124 = 14f;
			fLocal_125 = 5f;
			break;
		case 4:
			...
			vLocal_118 = { -1218.939f, 321.685f, 79.02952f };
			vLocal_121 = { -1228.746f, 355.2947f, 79.98589f };
			fLocal_124 = 20f;
			fLocal_125 = 2f;
			break;
		case 5:
			...
			vLocal_118 = { -1250.003f, 367.6283f, 79.94628f };
			vLocal_121 = { -1216.369f, 377.5503f, 80.10213f };
			fLocal_124 = 20f;
			fLocal_125 = 2f;
			break;
		case 6:
			...
			vLocal_118 = { -1610.862f, 249.7006f, 60.1168f };
			vLocal_121 = { -1626.516f, 282.9467f, 59.83001f };
			fLocal_124 = 32f;
			fLocal_125 = 5f;
			break;
		case 7:
			...
			vLocal_118 = { -942.1958f, -1251.207f, 7.1391f };
			vLocal_121 = { -930.3892f, -1271.587f, 8.0366f };
			fLocal_124 = 12f;
			fLocal_125 = 5f;
			break;
		case 8:
			...
			vLocal_118 = { -1373.602f, -83.734f, 50f };
			vLocal_121 = { -1369.198f, -120.774f, 50f };
			fLocal_124 = 20.84f;
			fLocal_125 = 5f;
			fLocal_126 = 19.6f;
			break;
		case 9:
			...
			vLocal_118 = { -2860.762f, 13.3794f, 10.6083f };
			vLocal_121 = { -2924.066f, 31.5452f, 10.6083f };
			fLocal_124 = 28f;
			fLocal_125 = 5f;
			break;
	}
...
int func_183(int iParam0)
{
	if (func_133(iParam0))
	{
		if ((Global_111858.f_9081 || Global_3) || func_18(0))
		{
...
{
	return func_185(func_147(vParam0));
}
...
void func_189()
{
	...
	{
		if (UNK_0x984EC4F65F95F1DF(&cLocal_70) != 0)
		{
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_70);
		}
	}
