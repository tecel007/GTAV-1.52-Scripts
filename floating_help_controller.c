	...
	while (iVar0 < Global_110510)
	{
		if (Global_110510[iVar0 /*28*/].f_21 != 0)
		{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!MISC::IS_BIT_SET(Global_110510[iVar0 /*28*/].f_27, 0))
					{
						...
						{
							MISC::SET_BIT(&(Global_110510[iVar0 /*28*/].f_27), 0);
						}
					}
				}
				if (Global_110510[iVar0 /*28*/].f_24.f_2 != 9999f)
				{
					...
					{
						if (!ENTITY::IS_ENTITY_DEAD(Global_110510[iVar0 /*28*/].f_23, false))
						{
							if (!MISC::IS_BIT_SET(Global_110510[iVar0 /*28*/].f_27, 3))
							{
								HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(iVar1, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110510[iVar0 /*28*/].f_23, Global_110510[iVar0 /*28*/].f_24));
							}
							else
							{
