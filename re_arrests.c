			...
			case 0:
				if ((iLocal_243 == 3 || iLocal_52 == 5) || iLocal_52 == 6)
				{
					if (!func_91())
					{
						TASK::CLEAR_PED_TASKS(bLocal_54);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
						TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(bLocal_55, false), 1.401298E-41f, 0, 2);
					...
					switch (iLocal_247)
					{
						...
						case 1:
							...
							else
							{
								TASK::CLEAR_PED_TASKS(bLocal_55);
								TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
								TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(bLocal_54, false), 1.401298E-42f, 0, 2);
...
int func_99(bool bParam0)
{
	if (func_104())
	{
		...
		if (bParam0 && func_103(Global_111847))
		{
...
int func_136(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
