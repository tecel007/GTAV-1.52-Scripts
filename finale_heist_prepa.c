...
void func_15(int iParam0)
{
	...
	if (Global_111858.f_9081 || func_30(0))
	{
		iVar0 = func_29();
		if (!func_16(iVar0))
		{
...
int func_16(int iParam0)
{
	...
	func_17(&(Global_111858.f_2359.f_539), iVar1);
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_51(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_30(0) && Global_77079.f_1 == 1) && func_52(Global_77079))
		{
		}
		else
		{
...
int func_58(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	float fVar0;
...
bool func_63(int iParam0, vector3 vParam1, float fParam4)
{
...
void func_72()
{
	...
	bLocal_662 = true;
	func_380(27, 0);
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40754[13 /*31*/], 4, true, false);
	iLocal_663 = 0;
}
...
void func_74(int iParam0, vector3 vParam1, float fParam4)
{
	...
	func_49(iParam0, vParam1, fParam4, 0, 1);
}
...
int func_82(int iParam0, vector3 vParam1, float fParam4)
{
	int iVar0;
	int iVar1;
	char cVar2[16];
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_95452.f_9[iVar0], true))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452.f_9[iVar0], true, true);
						Local_389[iVar0 /*22*/] = Global_95452.f_9[iVar0];
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				if (func_7(Global_95452[iVar6]))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[iVar6], true, true);
					Local_462[iVar7 /*6*/] = Global_95452[iVar6];
...
int func_83(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_86(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
...
int func_88(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_85(iParam1, "Loading", 0))
...
int func_101(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, false), vLocal_364, 4, 20f, 786469, 3.5f, 5f, true);
			iLocal_83[iParam0] = 3;
			break;
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(PLAYER::PLAYER_PED_ID(), vLocal_364, 2f))
			{
				iLocal_83[iParam0] = 4;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_456) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_456, false)) && !ENTITY::IS_ENTITY_AT_COORD(Local_456, vLocal_364, 2f, 2f, 2f, false, true, 0))
		{
			...
			{
				if (PED::IS_PED_IN_VEHICLE(iParam1, Local_456, false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_456, -1, false) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_116(int iParam0)
{
	...
	return Global_96433[func_117(iParam0)];
}
...
int func_171(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_71(iLocal_80, bLocal_28))
			{
				...
				if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_40754[13 /*31*/]))
				{
					AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_40754[13 /*31*/], true);
				}
				iLocal_678 = 0;
...
void func_226(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_257(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_246();
			}
...
int func_244(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_257(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_11(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_260(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_257(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_265(iParam0);
			func_264(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_76647[1 /*14*/] = { func_293(iVar0, iParam1, iParam2, -1) };
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_273(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_273(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_293(iVar0, 14, iVar4, -1) };
									if (Global_76647[2 /*14*/].f_12 == iVar3)
									{
										if (func_273(iParam0, 14, iVar4))
										{
											if (!func_277(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_76647[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_293(iVar0, iVar2, iVar1, -1) };
						if (!func_277(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_76647[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_274(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_274(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_274(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(iParam1);
		if (fVar1 != -1)
		{
			return (func_280(iParam0, func_274(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		case joaat("PLAYER_ZERO"):
			switch (iParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_292(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (iParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_292(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (iParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_292(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
...
void func_295(int iParam0)
{
	...
	func_296(&(Global_76647[0 /*14*/]), iVar10, iParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_299(func_301(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_299(func_298(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_299(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_299(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_300(iParam1)];
...
bool func_304(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_296(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_274(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_364()
{
	if (bLocal_374)
	{
		if (PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, false, true, 0))
		{
			if (func_12(&uLocal_196, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
			{
				func_366(Global_40754[13 /*31*/], &fLocal_370);
				return;
			}
		}
		else
		{
			func_365(Global_40754[13 /*31*/], &fLocal_370);
		}
	}
...
void func_385()
{
	...
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40754[13 /*31*/], 1, true, false);
...
void func_396()
{
	...
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_40754[13 /*31*/]))
	{
		AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_40754[13 /*31*/], false);
	}
	OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_40754[13 /*31*/], 0f, true, true);
	OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40754[13 /*31*/], 4, true, true);
