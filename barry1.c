...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), fLocal_178);
		if (func_9())
		{
			func_1();
		}
...
void func_1()
{
	...
	bVar0 = func_8(PLAYER::PLAYER_PED_ID(), vLocal_170, 1) < (fLocal_173 + 10f);
	if (bLocal_181)
	{
	...
	else if (func_8(PLAYER::PLAYER_PED_ID(), vLocal_170, 1) > fLocal_173)
	{
...
float func_8(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
int func_13(int iParam0)
{
	...
	switch (iLocal_161)
	{
		...
		case 1:
			...
			CAM::ATTACH_CAM_TO_ENTITY(iVar5, PLAYER::PLAYER_PED_ID(), -vVar0, true);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() > iLocal_158)
			{
				if (iParam0 == 1)
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(vLocal_174, 200f, false, false, false, false, false, false);
					GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_174, 500f);
...
void func_44(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_51(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_55(vector3 vParam0, float fParam3)
{
	func_56(&(Global_105407.f_2890), vParam0, fParam3);
}

void func_56(var uParam0, vector3 vParam1, float fParam4)
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = fParam4;
}
...
{
	if (func_58(Global_77073, 0f, 0f, 0f, 0))
	{
...
int func_71()
{
	...
	{
		case 0:
			iLocal_930 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", vLocal_967, vLocal_970, 50f, false, 2);
		...
		case 3:
			if (MISC::GET_GAME_TIMER() > iLocal_966)
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_967, true, false, false, true);
				...
				if (UNK_0xF7B3A1430308F92B(0) != 4)
				{
					...
					{
						CAM::SET_CAM_ROT(iLocal_930, vLocal_970, 2);
...
int func_75(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			if (bVar9)
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar10, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, vVar6, true);
			}
			else
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar11, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar11, vVar6, true);
			}
			CAM::SET_CAM_ROT((*uParam0)[uParam0->f_24], vVar3, 2);
			...
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar10, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, vVar6 + Vector(15f, 0f, 0f), true);
			}
			else
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar11, 0f, 0f, 5f, false);
			}
			CAM::SET_CAM_ROT((*uParam0)[uParam0->f_24], -87.5f, 0f, vVar3.z, 2);
			CAM::SET_CAM_FOV((*uParam0)[uParam0->f_24], CAM::GET_FINAL_RENDERED_CAM_FOV());
			...
			uParam0->f_24++;
			uParam0->f_27 += 400;
			vVar12 = { CAM::GET_CAM_ROT(uParam0->f_11, 2) };
			vVar12.x = 21f;
			CAM::ADD_CAM_SPLINE_NODE(uParam0->f_9, CAM::GET_CAM_COORD(uParam0->f_11), vVar12, iVar1, 3, 2);
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_22411.f_111)
			{
				...
				{
					Global_22411.f_109 = AUDIO::GET_SOUND_ID();
					Global_22411.f_110 = MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
				AUDIO::PLAY_SOUND(Global_22411.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, false, 0, true);
	...
	if (uParam0->f_17)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			if (CAM::DOES_CAM_EXIST(uParam0->f_11))
			{
				Global_1312485.f_1 = { CAM::GET_CAM_COORD(uParam0->f_9) };
				Global_1312485.f_4 = { CAM::GET_CAM_ROT(uParam0->f_9, 2) };
				Global_1312485.f_7 = CAM::GET_CAM_FOV(uParam0->f_9);
				CAM::SET_CAM_COORD(uParam0->f_11, Global_1312485.f_1);
				CAM::SET_CAM_ROT(uParam0->f_11, Global_1312485.f_4, 2);
				CAM::SET_CAM_FOV(uParam0->f_11, Global_1312485.f_7);
			}
			CAM::DESTROY_CAM(uParam0->f_9, false);
		}
		if (uParam0->f_24 > 0)
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_22411.f_109 != -1 && Global_22411.f_110 == MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
			AUDIO::STOP_SOUND(Global_22411.f_109);
			AUDIO::RELEASE_SOUND_ID(Global_22411.f_109);
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			break;
		case 1:
			if (func_333(1, 1093140480 /* Float: 10.5f */, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				bLocal_356 = false;
				if (func_12(PLAYER::PLAYER_PED_ID()))
				{
				...
				func_332();
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_174, 250f, false, false, false, false, false, false);
				MISC::CLEAR_AREA_OF_PEDS(vLocal_174, 50f, 0);
				MISC::CLEAR_AREA_OF_OBJECTS(vLocal_174, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_174, 500f);
		...
		case 3:
			...
			func_53(1, 1, 1, 1);
			func_275(PLAYER::PLAYER_PED_ID(), vLocal_174);
...
Vector3 func_275(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_278(int* iParam0, int iParam1)
{
	...
	fVar3 = 23.45f;
	func_279(iParam0, iParam1, vVar0, fVar3);
}

void func_279(int* iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_14(iParam0);
...
void func_283()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_331()) && !func_58(vLocal_925, vLocal_166, 0))
	{
		MISC::CLEAR_AREA(vLocal_925, 3f, true, false, false, false);
		if (func_575(func_331()))
		{
			ENTITY::SET_ENTITY_COORDS(func_331(), vLocal_925, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(func_331(), fLocal_928);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(func_331(), 5f);
		}
		if (func_328(func_330(), 1))
		{
			func_284(func_331(), vLocal_925, fLocal_928, 24, 0);
		}
	}
	bLocal_929 = true;
}

void func_284(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_319(iParam5, &Var0, vParam1, fParam4, func_322(iParam0));
...
void func_285(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_316(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_305();
			}
...
void func_286(int iParam0, int iParam1)
{
	...
	func_323(iParam0, &(Global_111858.f_32745.f_5510));
}
...
int func_303(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_316(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_58(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_58(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_319(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_316(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_321(iParam0);
			func_320(uParam1, &(Global_111858.f_32745.f_69[Global_75654.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_329(Global_102423.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_329(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_333(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_339(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_341(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
int func_353(float fParam0, bool bParam1)
{
	vector3 vVar0;
	float fVar3;

	fVar3 = 15f;
	if (!PATHFIND::GET_SAFE_COORD_FOR_PED(*fParam0, false, &vVar0, 14))
	{
		return 0;
	}
	if (bParam1)
	...
	if (func_355(PLAYER::PLAYER_PED_ID(), vVar0, fVar3))
	{
		return 0;
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_170, true) > fLocal_173)
	{
		return 0;
	}
	if (!OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, Local_200[0 /*3*/], Local_200[1 /*3*/], Local_200.f_7, false, true))
	{
		return 0;
	}
	if (bLocal_185)
	...
	else if (PED::IS_ANY_PED_NEAR_POINT(vVar0, 2f))
	{
		return 0;
	}
	*fParam0 = { vVar0 };
...
bool func_354(vector3 vParam0, float fParam3, int iParam4, bool bParam5)
{
...
Vector3 func_356(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_357(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_359(var uParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	if (bParam5)
	{
	...
	uParam0->f_2 = PED::CREATE_PED(26, iLocal_357, vParam1, 0f, true, true);
...
float func_362(struct<2> Param0, int iParam2, struct<2> Param3, Vector3 vParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_364(var uParam0)
{
	...
	while (iVar0 < 9)
	{
		if (iVar1 < vVar2.x)
		{
			if (!PED::IS_ANY_PED_NEAR_POINT(vLocal_897[iVar0 /*3*/], 1.5f))
			{
				func_365(&vVar2, iVar1, vLocal_897[iVar0 /*3*/]);
				iVar1++;
			}
		}
		else
...
void func_365(int iParam0, int iParam1, vector3 vParam2)
{
...
void func_366(int iParam0)
{
	...
	while (iVar0 < *iParam0)
	{
		func_365(iParam0, iVar0, 0f, 0f, 0f);
		iVar0++;
	}
}
...
float func_376(int iParam0)
{
	if (func_379(iParam0))
	{
		...
		{
			return (func_377(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
int func_385(vector3 vParam0, float fParam3, float fParam4)
{
	if (bLocal_181 == 0)
	{
		return 0;
...
void func_386()
{
	...
	StringIntConCat(&cVar0, MISC::GET_RANDOM_INT_IN_RANGE(0, 3) + 1, 16);
	func_41(&uLocal_390, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_418()
{
	if (func_328(func_330(), 1))
	{
		if (func_575(func_331()))
		{
			vLocal_925 = { ENTITY::GET_ENTITY_COORDS(func_331(), true) };
...
void func_419(vector3 vParam0, vector3 vParam3, int iParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, int iParam17, float fParam18)
{
	func_420(vParam0, vParam3, iParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, iParam17, fParam18);
}

void func_420(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_422(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_422(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_435(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		func_436(iParam0, &(Global_111858.f_2359.f_539.f_1764));
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			Global_111858.f_2359.f_539.f_1730[iVar1 /*4*/][iVar0] = HUD::_HUD_WEAPON_WHEEL_GET_SLOT_HASH(iVar1);
			iVar1++;
		}
	}
}
...
void func_436(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_438(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((UNK_0xC517E2708E06CD75(iVar9, &Var11) && !func_437(Var11.f_1)) && iVar72 < 51)
			{
...
void func_443()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_339(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
void func_446(var uParam0)
{
	...
	{
		vVar0 = { PED::GET_PED_BONE_COORDS(uParam0->f_2, 31086, vLocal_864) };
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_4, vVar0, false, false, true);
		ENTITY::SET_ENTITY_COLLISION(uParam0->f_4, false, false);
	}
	...
	switch (uParam0->f_1)
	{
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				uParam0->f_23 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, vLocal_867, fLocal_858, false, false, false);
		...
		case 7:
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true) };
				...
				AUDIO::PLAY_SOUND_FROM_COORD(-1, "DESPAWN", vVar0, "BARRY_01_SOUNDSET", false, 0, false);
				if (iLocal_184 == 1)
				{
				}
				uParam0->f_1 = 8;
...
int func_448(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_449(var uParam0)
{
	...
	vVar5 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true) };
	vVar8 = { vVar5 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((uParam0->f_12 + 3f)) };
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(vVar5, vVar8, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar11, &uVar14, &uVar17);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				uParam0->f_27 = { MISC::_0x21C235BC64831E5A(vVar11, vVar5, vVar8, false) };
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, true) <= 0.7f)
				{
					fLocal_179 = 0f;
					if (MISC::ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						if ((MISC::GET_FRAME_COUNT() % 20) == 0)
						{
							MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar5, vVar8, 0, true, joaat("WEAPON_PISTOL"), 0, false, true, -1f);
						}
						if (iLocal_851 == 1)
						{
...
void func_453(var uParam0)
{
	...
	vVar3 = { func_457(CAM::GET_FINAL_RENDERED_CAM_ROT(2)) };
	vVar6 = { vVar0 + vVar3 * FtoV(CAM::GET_FINAL_RENDERED_CAM_NEAR_CLIP()) };
	fVar13 = (fLocal_571 * 1.25f);
	if (func_456(&vVar9, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, true), vVar3, vVar6))
	{
		if (CAM::IS_SPHERE_VISIBLE(vVar9, 0.5f))
		{
			iVar14 = func_454(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true));
			iVar15 = func_454(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, true));
			if (iVar14 > 0 && iVar15 < 0)
			{
				vVar9 = { vVar9 - ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(fLocal_870, fLocal_870, fLocal_870) };
			}
			else if (iVar14 < 0 && iVar15 > 0)
			{
				vVar9 = { vVar9 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((fLocal_870 * 4.5f)) };
			}
			if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_25))
			{
				uParam0->f_25 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_alien_impact", vVar9, 0f, 0f, 0f, fVar13, false, false, false, false);
			}
...
int func_456(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_458(int iParam0, vector3 vParam1)
{
	...
	func_459(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1, &fVar0, &fVar1, 1);
	ENTITY::SET_ENTITY_ROTATION(iParam0, fVar0, 0f, fVar1, 2, true);
}

void func_459(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, int iParam8)
{
	vector3 vVar0;

	vVar0 = { vParam3 - vParam0 };
	func_460(vVar0, fParam6, fParam7, iParam8);
}

void func_460(vector3 vParam0, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	...
	if (fVar0 != 0f)
	{
		*fParam3 = MISC::ATAN2(vParam0.z, fVar0);
	}
...
void func_461(var uParam0)
{
	...
	vVar3 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_4, true) };
	if (!uParam0->f_32)
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 1227113341) != 1)
		{
	...
	if (uParam0->f_26 == 0)
	{
		vVar6 = { PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f) };
		uParam0->f_26 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(vVar3, vVar6, 511, PLAYER::PLAYER_PED_ID(), 7);
	...
	{
		iVar1 = SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar6, &uVar9, &uVar12);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				ENTITY::SET_ENTITY_COORDS(uParam0->f_5, vVar3, true, false, false, true);
				if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_24))
				{
					uParam0->f_24 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_571, false, false, false);
				}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_463(iParam3), false);
}
...
void func_468(var uParam0)
{
	...
	if (!func_471(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 0))
	{
		return;
	}
	...
	TASK::CLEAR_SEQUENCE_TASK(&iVar0);
	PED::_0x2208438012482A1A(uParam0->f_2, false, false);
...
int func_471(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_424(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_424(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_480(char* sParam0, char* sParam1, vector3 vParam2, int iParam5)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, vParam2, func_463(iParam5));
}
	...
	if (Global_77087 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_491(Global_77088, Global_77090, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_502(0) || Global_77102) || Global_77091 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_77087)
...
{
	return func_504(iParam0, Global_41631);
}
...
int func_513(var uParam0)
{
	...
	switch (iLocal_82)
	{
		...
		case 2:
			...
			{
				if (func_514(&(uParam0->f_28[0]), 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
		...
		case 3:
			if (func_575(uParam0->f_28[0]))
			{
				...
				ENTITY::SET_ENTITY_COORDS(uParam0->f_28[0], vVar8, true, false, false, true);
...
int func_514(int* iParam0, int iParam1, vector3 vParam2, int iParam5, char* sParam6, int iParam7)
{
	if (func_515(iParam0, iParam1, vParam2, iParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_515(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_547()
{
	...
	iVar0 = func_548(&(Global_98955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_551()
{
	...
	{
		if (func_546(&(Global_98955.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_563(int iParam0)
{
	if (func_31(iParam0))
	{
		Global_111858.f_2359.f_539.f_298[iParam0 /*477*/] = { Global_111858.f_2359.f_539.f_1764 };
	}
}
...
void func_564(int iParam0, bool bParam1)
{
	...
	if (func_31(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_436(iParam0, &(Global_111858.f_2359.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_565(int iParam0, bool bParam1)
{
	...
	{
		iVar0 = func_32(iParam0);
		func_566(iParam0, &(Global_111858.f_2359.f_539.f_1764), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!FILES::IS_CONTENT_ITEM_LOCKED(Var9) && !func_437(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
bool func_572(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("WEAPON_HATCHET"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_297() && !Global_262145.f_19760)
				{
					return false;
				}
			}
	...
	while (iVar0 < FILES::GET_NUM_DLC_WEAPONS())
	{
		if (FILES::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (FILES::IS_CONTENT_ITEM_LOCKED(Var1) || func_437(Var1.f_1))
				{
					return false;
				}
			}
