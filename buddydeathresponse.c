	...
	if (!PED::IS_PED_INJURED(iLocal_20))
	{
		if (!Global_95450)
		{
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_20, false))
			{
				...
				{
					TASK::TASK_TURN_PED_TO_FACE_COORD(0, vVar0, 6000);
				}
			}
			TASK::TASK_LOOK_AT_COORD(0, vVar0, 8.407791E-42f, 0, 2);
...
int func_9(int iParam0)
{
	...
	while (iLocal_18 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96324[iLocal_18]) && !PED::IS_PED_INJURED(Global_96324[iLocal_18]))
		{
			if (Global_96324[iLocal_18] != PLAYER::PLAYER_PED_ID())
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_96324[iLocal_18]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Global_96324[iLocal_18], false) || !ENTITY::IS_ENTITY_ATTACHED(Global_96324[iLocal_18]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_96324[iLocal_18], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 10f)
						{
							...
							if ((iLocal_19 == 0 || iLocal_19 == 2) || iLocal_19 == 1)
							{
								...
								{
									if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_96324[iLocal_18], PLAYER::PLAYER_PED_ID(), 17))
									{
										if (PED::IS_PED_IN_ANY_VEHICLE(Global_96324[iLocal_18], false))
										{
											iVar0 = PED::GET_VEHICLE_PED_IS_IN(Global_96324[iLocal_18], false);
										}
										if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false)) || !ENTITY::DOES_ENTITY_EXIST(iVar0))
										{
											*iParam0 = Global_96324[iLocal_18];
											return 1;
										}
									}
								}
...
void func_11()
{
	...
	{
		if (func_6(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
