...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_173)
		{
			...
			switch (iLocal_50)
			{
				...
				case 2:
					...
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40554[9 /*31*/], 0, false, true);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40554[10 /*31*/], 0, false, true);
					break;
				case 4:
...
void func_12(int iParam0, bool bParam1)
{
	...
	{
		if (MISC::IS_BIT_SET(iLocal_48, 1) || bParam1)
		{
...
void func_13(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (MISC::IS_BIT_SET(iLocal_48, 2) || bParam2)
		{
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_14(int iParam0, bool bParam1)
{
	...
	if (iParam0 == 1)
	{
		if (!MISC::IS_BIT_SET(iLocal_48, 0) || bParam1)
		{
...
int func_32(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, bool bParam5, int iParam6)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			...
			if (IntToFloat(SYSTEM::TIMERA()) > (1500f * 0.2f))
			{
				...
				func_33(iParam2, uParam1, sParam3, sParam4, bParam5, ((iParam6 - 4 & iParam6) - 2 & iParam6) | 16, 7, 1, 1097859072 /* Float: 15f */, 0);
			}
			break;
		case 2:
			if (func_33(iParam2, uParam1, sParam3, sParam4, bParam5, (((iParam6 - 8 & iParam6) - 4 & iParam6) - 2 & iParam6), 7, 1, 1097859072 /* Float: 15f */, 1))
			{
				func_14(0, 1);
				func_12(0, 1);
				func_22();
...
int func_33(int iParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5, int iParam6, bool bParam7, float fParam8, bool bParam9)
{
	switch (*uParam1)
	{
		case 0:
...
void func_63()
{
	...
	if (SYSTEM::TIMERA() > 10000)
	{
		...
		while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER::PLAYER_ID()), vLocal_117, true) < 209f && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			SYSTEM::WAIT(0);
		}
		func_64(18);
...
int func_92()
{
	if ((Global_111627 == func_93() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_111628)
	{
		return 1;
	}
	return 0;
...
void func_116()
{
	...
	switch (iLocal_190)
	{
		case 0:
			...
			MISC::CLEAR_AREA(vLocal_117, 100f, true, false, false, false);
			PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_117 - Vector(100f, 60f, 80f), vLocal_117 + Vector(100f, 60f, 80f), false, true, true, true);
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		...
		case 6:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
			{
				...
				while (iVar1 < iLocal_196)
				{
					...
					{
						iLocal_196[iVar1] = PED::CREATE_PED(26, joaat("A_M_O_ACULT_01"), vLocal_51[iVar1 /*3*/], fLocal_100[iVar1], true, true);
					...
					{
						iLocal_196[iVar1] = PED::CREATE_PED(26, joaat("A_M_O_ACULT_02"), vLocal_51[iVar1 /*3*/], fLocal_100[iVar1], true, true);
						PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_196[iVar1], 0);
...
void func_157()
{
	...
	if (fLocal_183 >= 0f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_40554[10 /*31*/], fLocal_183, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40554[10 /*31*/], 4, false, true);
	}
	if (fLocal_182 < 0f)
	{
	...
	if (fLocal_182 <= 0f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_40554[9 /*31*/], fLocal_182, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40554[9 /*31*/], 4, false, true);
	}
}
...
void func_159()
{
	switch (iLocal_189)
	{
		...
		case 1:
			...
			MISC::CLEAR_AREA(vLocal_120, 12f, true, false, false, false);
			...
			if (Global_111638.f_24990.f_5 < 2)
			{
				iLocal_214 = OBJECT::CREATE_OBJECT(joaat("PROP_ANIM_CASH_PILE_02"), vLocal_117, true, true, false);
...
void func_164(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_111638.f_20559.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_166() /*10930*/].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_111638.f_20559.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_166() /*10930*/].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_171(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_166() /*10930*/].f_6174.f_10, iParam0);
}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_183(iParam3), false);
}
...
void func_188()
{
	switch (iLocal_189)
	{
		...
		case 3:
			...
			if (Global_111638.f_24990.f_5 == 1 || Global_111638.f_24990.f_5 == 2)
			{
				if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_188) > 0.9742857f && !bLocal_181) && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
		...
		if (func_15() == 2)
		{
			if (PED::DOES_GROUP_EXIST(func_190()))
			{
				...
				if (iLocal_187 == 1)
				{
					...
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_193[0], vLocal_120, 5f, 5f, 5f, false, true, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
				...
				else if (iLocal_187 == 2)
				{
					...
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_193[0], vLocal_120, 5f, 5f, 5f, false, true, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_193[1], vLocal_120, 5f, 5f, 5f, false, true, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
...
void func_192()
{
	if (func_195())
	{
		if (iLocal_400 == 0)
		{
			iLocal_400 = PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_117 - Vector(100f, 60f, 80f), vLocal_117 + Vector(100f, 60f, 80f), false, true, true, true);
		}
		while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER::PLAYER_ID()), vLocal_117, true) < 209f)
		{
			SYSTEM::WAIT(0);
		}
	}
	...
	if (func_194())
	{
		if (bLocal_179)
		{
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_40554[9 /*31*/].f_2, 6f, Global_40554[9 /*31*/].f_5, false))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_40554[9 /*31*/].f_5, Global_40554[9 /*31*/].f_2, false, 0f, false);
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_40554[10 /*31*/].f_2, 6f, Global_40554[10 /*31*/].f_5, false))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_40554[10 /*31*/].f_5, Global_40554[10 /*31*/].f_2, false, 0f, false);
			}
			bLocal_180 = true;
			bLocal_179 = false;
		}
...
int func_193()
{
	if ((((((MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_123, vLocal_126, fLocal_129, true) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_130, vLocal_133, fLocal_136, true)) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_137, vLocal_140, fLocal_143, true)) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_144, vLocal_147, fLocal_150, true)) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_151, vLocal_154, fLocal_157, true)) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_158, vLocal_161, fLocal_164, true)) || MISC::IS_BULLET_IN_ANGLED_AREA(vLocal_165, vLocal_168, fLocal_171, true))
	{
		return 1;
	}
	return 0;
...
int func_194()
{
	if ((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_123, vLocal_126, fLocal_129, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_130, vLocal_133, fLocal_136, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_137, vLocal_140, fLocal_143, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_144, vLocal_147, fLocal_150, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_151, vLocal_154, fLocal_157, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_158, vLocal_161, fLocal_164, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_165, vLocal_168, fLocal_171, false, true, 0))
	{
		return 1;
	}
	return 0;
