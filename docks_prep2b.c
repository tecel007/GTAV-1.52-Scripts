...
{
	func_6(&(Global_105407.f_2890), vParam0, fParam3);
}
...
{
	if (func_8(Global_77073, 0f, 0f, 0f, 0))
	{
...
void func_13(int iParam0)
{
	...
	if (Global_111858.f_9081 || func_28(0))
	{
		iVar0 = func_27();
		if (!func_14(iVar0))
		{
...
int func_14(int iParam0)
{
	...
	func_15(&(Global_111858.f_2359.f_539), iVar1);
...
void func_15(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_17(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_32(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_28(0) && Global_77079.f_1 == 1) && func_33(Global_77079))
		{
		}
		else
		{
...
void func_37()
{
	switch (iLocal_28)
	{
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				MISC::CLEAR_AREA(vLocal_311, 10f, true, false, false, false);
				iLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), vLocal_311, fLocal_323, true, true, false);
...
{
	return func_39(&(Global_105407.f_2890), vParam0, fParam3, 0);
}
...
int func_63(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_71(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_8(Global_111858.f_32745.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_111858.f_2359.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_8(Global_111858.f_2359.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_8(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_79(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96286[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_96286[iVar0]) == func_72(iParam0, iParam1))
				{
...
void func_102(var uParam0, int iParam1)
{
	...
	while (iVar0 < 16)
	{
		if (Global_73965[iVar0 /*2*/] == 0)
		{
			Global_73965[iVar0 /*2*/] = uParam0;
			Global_73965[iVar0 /*2*/].f_1 = iParam1;
			if (iVar0 == Global_73998)
			{
				Global_73998++;
			}
			return;
...
bool func_104()
{
	return func_98(&(Global_105407.f_2890));
}

void func_105()
{
	func_106(&(Global_105407.f_2890));
}
...
bool func_108()
{
	return func_99(&(Global_105407.f_2890));
}

void func_109(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, float fParam15)
{
	func_110(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, fParam15);
}

void func_110(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_112(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_112(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_116()
{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95452[0], true))
		{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95452[1], true))
		{
	...
	{
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_95452[2], true))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[2], true, true);
		}
		VEHICLE::DELETE_VEHICLE(&(Global_95452[2]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_51[0]))
	{
		...
		if (iLocal_308 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, false))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_311, true) > 800f)
						{
...
void func_150(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_214(&(Global_98955.f_3));
				if (iVar10 > -1)
				{
...
void func_151(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	func_152(&Global_105407, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, sParam1, iParam3, iParam2);
}

void func_152(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_161(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				uParam1->f_59 = func_162(2052, iParam3, 0);
			}
			else
			{
...
int func_162(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		iVar0 = Global_2551832[iParam0 /*3*/][func_163(iParam1)];
...
int func_165(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2587834[iParam0 /*3*/][func_163(iParam1)];
...
Vector3 func_187(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 44:
			...
			break;
		case 45:
			return func_197(Global_101058);
		case 46:
			if (Global_1590519 != func_137())
			{
...
void func_217(int iParam0, char* sParam1)
{
	switch (iParam0)
	{
		case 0:
			func_218(sParam1, "Abigail1", func_220(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 1:
			func_218(sParam1, "Abigail2", func_220(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 2:
			func_218(sParam1, "Barry1", func_220(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 3:
			func_218(sParam1, "Barry2", func_220(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 4:
			func_218(sParam1, "Barry3", func_220(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 5:
			func_218(sParam1, "Barry3A", func_220(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 6:
			func_218(sParam1, "Barry3C", func_220(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 7:
			func_218(sParam1, "Barry4", func_220(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_219(iParam0), 0, 0);
			break;
		case 8:
			func_218(sParam1, "Dreyfuss1", func_220(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 9:
			func_218(sParam1, "Epsilon1", func_220(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 10:
			func_218(sParam1, "Epsilon2", func_220(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 11:
			func_218(sParam1, "Epsilon3", func_220(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 12:
			func_218(sParam1, "Epsilon4", func_220(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 13:
			func_218(sParam1, "Epsilon5", func_220(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 14:
			func_218(sParam1, "Epsilon6", func_220(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 15:
			func_218(sParam1, "Epsilon7", func_220(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 16:
			func_218(sParam1, "Epsilon8", func_220(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 17:
			func_218(sParam1, "Extreme1", func_220(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 18:
			func_218(sParam1, "Extreme2", func_220(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 19:
			func_218(sParam1, "Extreme3", func_220(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 20:
			func_218(sParam1, "Extreme4", func_220(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 21:
			func_218(sParam1, "Fanatic1", func_220(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_219(iParam0), 1, 0);
			break;
		case 22:
			func_218(sParam1, "Fanatic2", func_220(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_219(iParam0), 1, 0);
			break;
		case 23:
			func_218(sParam1, "Fanatic3", func_220(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_219(iParam0), 0, 1);
			break;
		case 24:
			func_218(sParam1, "Hao1", func_220(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_219(iParam0), 0, 1);
			break;
		case 25:
			func_218(sParam1, "Hunting1", func_220(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 26:
			func_218(sParam1, "Hunting2", func_220(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 27:
			func_218(sParam1, "Josh1", func_220(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 28:
			func_218(sParam1, "Josh2", func_220(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 29:
			func_218(sParam1, "Josh3", func_220(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 30:
			func_218(sParam1, "Josh4", func_220(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 31:
			func_218(sParam1, "Maude1", func_220(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 32:
			func_218(sParam1, "Minute1", func_220(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 33:
			func_218(sParam1, "Minute2", func_220(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 34:
			func_218(sParam1, "Minute3", func_220(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 35:
			func_218(sParam1, "MrsPhilips1", func_220(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 36:
			func_218(sParam1, "MrsPhilips2", func_220(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 37:
			func_218(sParam1, "Nigel1", func_220(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 38:
			func_218(sParam1, "Nigel1A", func_220(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 39:
			func_218(sParam1, "Nigel1B", func_220(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_219(iParam0), 1, 1);
			break;
		case 40:
			func_218(sParam1, "Nigel1C", func_220(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_219(iParam0), 1, 1);
			break;
		case 41:
			func_218(sParam1, "Nigel1D", func_220(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_219(iParam0), 1, 1);
			break;
		case 42:
			func_218(sParam1, "Nigel2", func_220(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 43:
			func_218(sParam1, "Nigel3", func_220(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_219(iParam0), 1, 1);
			break;
		case 44:
			func_218(sParam1, "Omega1", func_220(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 45:
			func_218(sParam1, "Omega2", func_220(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 46:
			func_218(sParam1, "Paparazzo1", func_220(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 47:
			func_218(sParam1, "Paparazzo2", func_220(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 48:
			func_218(sParam1, "Paparazzo3", func_220(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 49:
			func_218(sParam1, "Paparazzo3A", func_220(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 50:
			func_218(sParam1, "Paparazzo3B", func_220(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 51:
			func_218(sParam1, "Paparazzo4", func_220(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 52:
			func_218(sParam1, "Rampage1", func_220(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 54:
			func_218(sParam1, "Rampage3", func_220(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 55:
			func_218(sParam1, "Rampage4", func_220(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 56:
			func_218(sParam1, "Rampage5", func_220(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_219(iParam0), 0, 0);
			break;
		case 53:
			func_218(sParam1, "Rampage2", func_220(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_219(iParam0), 1, 0);
			break;
		case 57:
			func_218(sParam1, "TheLastOne", func_220(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 58:
			func_218(sParam1, "Tonya1", func_220(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 59:
			func_218(sParam1, "Tonya2", func_220(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 60:
			func_218(sParam1, "Tonya3", func_220(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 61:
			func_218(sParam1, "Tonya4", func_220(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		case 62:
			func_218(sParam1, "Tonya5", func_220(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_219(iParam0), 0, 1);
			break;
		default:
			break;
	}
...
void func_218(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
int func_221(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_222(Global_111858.f_9081.f_99.f_205[10]);
		case 74:
		case 75:
			return func_222(Global_111858.f_9081.f_99.f_205[8]);
		case 84:
		case 85:
			return func_222(Global_111858.f_9081.f_99.f_205[11]);
		case 90:
			return func_222(Global_111858.f_9081.f_99.f_205[7]);
		case 93:
			return func_222(Global_111858.f_9081.f_99.f_205[9]);
	}
	return 0;
}
...
void func_228()
{
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_314, true) < 500f)
	{
		if (iLocal_214 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_51[0]))
	...
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_314, true) > 550f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_51[0]))
			{
				VEHICLE::DELETE_VEHICLE(&(iLocal_51[0]));
...
int func_232(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
	...
	if (iLocal_28 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false))
				{
					vLocal_320 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									...
									{
										if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, true) > 1600f && MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, true) < 1000f)
										{
											if (vLocal_320.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, true) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
											...
											if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, true) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
				...
				else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, true) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_215[0] = 1;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							{
								vLocal_317 = { ENTITY::GET_ENTITY_COORDS(iLocal_49[0], true) };
								TASK::CLEAR_PED_TASKS(iLocal_31[0]);
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_31[0], vLocal_317, 10f, false, false);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							TASK::TASK_HELI_MISSION(0, iLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, (vLocal_317.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1082130432, 0);
							TASK::TASK_HELI_MISSION(0, iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1082130432, 0);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_49[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_49[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_49[0], ENTITY::GET_ENTITY_COORDS(iLocal_49[0], true), true, true)), 100, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
								{
									if (!PED::IS_PED_INJURED(iLocal_31[0]))
									{
										TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1082130432, 0);
										iLocal_295 = 1;
									}
								}
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
...
int func_236(vector3 vParam0, int iParam3, int iParam4, bool bParam5)
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_237()
{
	...
	if (iLocal_175 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452[2]))
		{
			...
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_95452[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[2], true, true);
					func_245(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_95452[2])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_95452[2]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_95452[2]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_95452[2])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452[2], true, true);
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[0]))
		{
			...
			iLocal_33[0] = Global_95452.f_9[0];
		}
		if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[1]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452.f_9[1], true, true);
			iLocal_33[1] = Global_95452.f_9[1];
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
		{
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_48, false);
...
{
	MISC::CLEAR_BIT(&Global_94810, iParam0);
}
...
void func_245(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		...
		{
			if (func_254(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_251(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_246(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_246(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_248(iParam5, &Var0, vParam1, fParam4, func_61(iParam0));
...
void func_247(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_111858.f_32745.f_4801 = func_203();
			}
...
void func_248(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_71(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
	...
	if (iLocal_175 == 0)
	{
		...
		if (func_272())
		{
			if (Global_93132 == 1)
			{
				if (func_258() == 0)
				{
					func_257(vLocal_311, fLocal_323, 1, 0);
					iLocal_196 = 1;
					iLocal_175 = 0;
					iLocal_28 = 3;
				}
...
void func_257(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_272())
	{
...
void func_263()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_28 == 4)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_311, true) > 1000f)
			{
				PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, false);
				PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
			}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_267(iParam2), true);
}
