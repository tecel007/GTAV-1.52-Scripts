...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBBB", 8);
	StringCopy(&cLocal_236, "BILLBINDER", 16);
	StringCopy(&cLocal_202, "Special_Ped@bill", 64);
	...
	StringCopy(&cLocal_312, "PBBB_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBBB_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBBB_CONV_GF", 16);
