...
void func_8(bool bParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x))
	{
		if (bParam0)
		{
			PED::DELETE_PED(&vLocal_1331);
		}
		else
		{
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1331);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_1343))
	{
...
int func_23()
{
	...
	if (!bLocal_95)
	{
		if (func_199(Local_1343))
		{
			if (HUD::GET_BLIP_FROM_ENTITY(Local_1343) != 0)
			{
				Local_1343.f_1 = HUD::GET_BLIP_FROM_ENTITY(Local_1343);
			}
			else
			{
				Local_1343.f_1 = func_198(Local_1343, 0, 0);
			}
			func_197("JHP2A_STEAL", 7500, 1);
			func_196("JHP2A_HLP2", 15000);
		}
		else if (HUD::GET_BLIP_FROM_ENTITY(Local_1343) != 0)
		{
			MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(true);
			iVar7 = HUD::GET_BLIP_FROM_ENTITY(Local_1343);
	...
	if (bLocal_95)
	{
		...
		{
			case 1:
				if ((((((iLocal_1328 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_1343)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false)) && ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x)) && !PED::IS_PED_INJURED(vLocal_1331.x)) && PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, false)) && func_134(&(Local_1109[0 /*8*/])))
				{
					func_106(&uLocal_1316, Local_1343, 0, 0, 1, 1, 1);
				}
				else
				{
					func_11(&uLocal_1316, 0, 0);
				...
				else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_1345) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1345, false)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1345, Local_1343))
				{
					...
					func_101(&iLocal_1126, vVar0, 0.1f, 0.1f, 0.1f, 1, iLocal_1345, "JHP2A_RTNVAN", "", "", 1, 0, 1, -1);
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1343, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, false, true, 0))
					{
				...
				else if (iLocal_1328 == 1)
				{
					...
					if (!HUD::DOES_BLIP_EXIST(Local_1347[0 /*2*/].f_1))
					{
						...
						func_197("JHP2A_TAKEBZ", 7500, 1);
						bLocal_1370 = true;
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1343, false);
					}
				}
				else if (iLocal_1328 == 0)
				{
					...
					if (func_98(&iLocal_1126, vVar0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1343, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1343, false), 0, 1, -1))
					{
						iLocal_94 = 101;
					}
				...
				break;
			case 101:
				if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1343, false))
				{
					bVar8 = Local_1343;
				}
				else if (ENTITY::DOES_ENTITY_EXIST(iLocal_1345) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1345, Local_1343))
				{
					bVar8 = iLocal_1345;
				}
			...
			case 102:
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
				{
					HUD::CLEAR_PRINTS();
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1343, false);
					VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1343, true);
			...
			case 2:
					...
					while (iVar6 < Local_1347)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1347[iVar6 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1347[iVar6 /*2*/]))
						{
							if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_BRIEFCASE"), false))
							{
								...
								if ((bVar9 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, 0f, -3f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, 0f, -4.5f, 1f), 1.68f, false, true, 1)) || (!bVar9 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_1347[iVar6 /*2*/], true), 0.75f, 0.75f, 4f, false, false, 1)))
								{
				...
				else
				{
					...
					func_48(&iLocal_1126, vVar3, 0.1f, 0.1f, 0.1f, 0, "JHP2A_RTNBZ", 1, 1, -1, 1);
					...
					if (bVar11 || ((bVar12 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && bLocal_1377))
					{
...
int func_94(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Local_1343, false))
	{
		return 0;
	}
	vVar0 = { MISC::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, vLocal_87), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, vLocal_90), false) };
	if (SYSTEM::VDIST2(vVar0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, vLocal_87)) <= SYSTEM::VDIST2(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, vLocal_90), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, vLocal_87)))
	{
		return 1;
	}
	return 0;
...
int func_115(int iParam0)
{
	if (iParam0 != func_32())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_116(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_137()
{
	...
	{
		if (((ENTITY::IS_ENTITY_DEAD(Local_1343, false) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[0 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1347[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[1 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1347[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[2 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1347[2 /*2*/])))
		{
			iLocal_1328 = 2;
		}
	}
	if (iLocal_1328 == 2)
	{
		if ((((!ENTITY::DOES_ENTITY_EXIST(Local_1343) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false)) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[0 /*2*/]) && !func_94(Local_1347[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[1 /*2*/]) && !func_94(Local_1347[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1347[2 /*2*/]) && !func_94(Local_1347[2 /*2*/])))
		{
			iLocal_1328 = 3;
		}
	}
	if (iLocal_1328 == 0)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("TOWTRUCK") || ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("TOWTRUCK2"))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
				{
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar0, Local_1343))
					{
						iLocal_1345 = iVar0;
					}
				}
	...
	if (iLocal_1328 == 0)
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false))
		{
			iLocal_1328 = 1;
		}
	}
	if (iLocal_1328 == 1 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1343, true))
	{
		func_9(6, 1);
	}
	else
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102423.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102423.f_4, false))
		{
			if (func_190(24) != Global_102423.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_187(ENTITY::GET_ENTITY_COORDS(Global_102423.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
				}
				func_139(Global_102423.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_192()
{
	...
	{
		if (func_194(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_201()
{
	...
	if (!bLocal_1374)
	{
		if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1343, true))
			{
	...
	if (iLocal_93 == 0)
	{
		...
		{
			case 0:
				if ((ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x) && !PED::IS_PED_INJURED(vLocal_1331.x)) && func_134(&(Local_1109[0 /*8*/])))
				{
					if (Local_1109[0 /*8*/].f_1 == 1)
					{
						if (func_202(PLAYER::PLAYER_PED_ID(), Local_1343, 1) > 500f)
						{
							func_308(1);
						}
					}
					...
					{
						if (func_202(PLAYER::PLAYER_PED_ID(), Local_1343, 1) > 250f)
						{
							func_308(1);
						}
					}
					else if (func_202(PLAYER::PLAYER_PED_ID(), Local_1343, 1) > 250f)
					{
						func_308(2);
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1343))
	{
		if ((ENTITY::IS_ENTITY_IN_WATER(Local_1343) && !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false)) && !WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_BRIEFCASE"), false))
		{
			func_308(4);
		}
	}
...
void func_205()
{
	if (ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(vLocal_1331.x, false))
		{
			func_206(vLocal_1331.x, &(vLocal_1331.f_2), -1, 0, 0, 0, -1082130432 /* Float: -1f */, 0, -1, -1, 1);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_1343))
	{
		if (((!func_199(Local_1343) && ENTITY::IS_ENTITY_DEAD(Local_1343, false)) && bLocal_1371) && func_202(Local_1343, PLAYER::PLAYER_PED_ID(), 1) > 200f)
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1343);
		}
	}
		...
		else
		{
			...
			switch (iLocal_93)
			{
				case 0:
					...
					func_276(&uLocal_99, &Global_95817);
					break;
				case 1:
			...
			switch (iLocal_93)
			{
				case 0:
					...
					if (MISC::ARE_STRINGS_EQUAL(&Global_95817, "jhp2a_main"))
					{
				...
				case 1:
					if (!func_7(87))
					{
						Local_1343 = VEHICLE::CREATE_VEHICLE(joaat("BOXVILLE3"), 693.725f, -1006.302f, 21.8355f, 359.884f, true, true, false);
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1343, false);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1343, 5f);
					}
					if (func_282())
					{
						func_208(0, -1, 1);
...
int func_264(int iParam0, var uParam1)
{
	...
	{
		if (Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam0 /*98*/] == uParam1->f_66 && MISC::GET_HASH_KEY(&(Global_111858.f_2359.f_539.f_2407[0 /*295*/][iParam0 /*98*/].f_27)) == MISC::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	{
		if (Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam0 /*98*/] == uParam1->f_66 && MISC::GET_HASH_KEY(&(Global_111858.f_2359.f_539.f_2407[1 /*295*/][iParam0 /*98*/].f_27)) == MISC::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
...
int func_268(bool bParam0)
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_ARMOURED_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_85)) && STREAMING::HAS_MODEL_LOADED(iLocal_86))
	{
		if (bParam0)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_95452.f_9[0]))
				{
					...
					vLocal_1331.x = Global_95452.f_9[0];
				}
				else
				{
					bVar0 = false;
		...
		{
			func_277(&uLocal_99, iLocal_84);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_84) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_95817))
			{
				if (MISC::ARE_STRINGS_EQUAL(&Global_95817, "jhp2a_main"))
				{
					TASK::WAYPOINT_RECORDING_GET_COORD(&Global_95817, 23, &vVar1);
					MISC::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, false, false, false, false, false, false);
					Local_1343 = VEHICLE::CREATE_VEHICLE(iLocal_84, vVar1, 119.4988f, true, true, false);
					vLocal_1331.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1343, 26, iLocal_83, -1, true, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1343, 5f);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1331.x, Local_1343, &Global_95817, 786475, 23, 16, -1, 12f, false, 2f);
				}
				else
				{
					TASK::WAYPOINT_RECORDING_GET_COORD(&Global_95817, 29, &vVar1);
					MISC::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, false, false, false, false, false, false);
					Local_1343 = VEHICLE::CREATE_VEHICLE(iLocal_84, vVar1, 134.0011f, true, true, false);
					vLocal_1331.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1343, 26, iLocal_83, -1, true, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1343, 5f);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1331.x, Local_1343, &Global_95817, 786475, 29, 16, -1, 12f, false, 2f);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1343))
		{
			func_274(Local_1343, 0);
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false))
			{
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_1343, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1343, true, 1);
				VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_1343, true);
				VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1343, true);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x))
		{
			if (!PED::IS_PED_INJURED(vLocal_1331.x))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(vLocal_1331.x, true);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(vLocal_1331.x, iLocal_1330);
				PED::SET_PED_ACCURACY(vLocal_1331.x, 5);
				PED::SET_PED_CAN_BE_TARGETTED(vLocal_1331.x, false);
				PED::SET_PED_COMBAT_ATTRIBUTES(vLocal_1331.x, 1, false);
				WEAPON::GIVE_WEAPON_TO_PED(vLocal_1331.x, joaat("WEAPON_PISTOL"), 15, false, true);
				func_273(&uLocal_1151, 3, vLocal_1331.x, "JHP2A_Driver", 0, 1);
				func_272(&(Local_1109[0 /*8*/]), 0, 0, 1);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x))
		{
			func_271();
...
void func_271()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1343))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_1343, false) && !ENTITY::DOES_ENTITY_EXIST(iLocal_1354))
		{
			iLocal_1354 = OBJECT::CREATE_OBJECT(iLocal_86, ENTITY::GET_ENTITY_COORDS(Local_1343, true), true, true, false);
			OBJECT::SET_OBJECT_PHYSICS_PARAMS(iLocal_1354, 0.1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
			ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(iLocal_1354, Local_1343, -1, -1, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_1343, ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(Local_1343, 5)) + Vector(0f, 0f, 0.02f), 0f, 0f, 0f, 0f, 0f, 0f, -1f, true, true, false, true, 2);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[0 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1343, false))
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, MISC::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), false, false);
				Local_1347[0 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, vVar0, true, true, false);
			}
			else
			{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[1 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1343, false))
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, MISC::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), false, false);
				Local_1347[1 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, vVar0, true, true, false);
			}
			else
			{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[2 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1343, false))
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, MISC::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), false, false);
				Local_1347[2 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, vVar0, true, true, false);
			}
			else
			{
...
{
	Global_98955.f_22[iParam1] = bParam0;
}
...
int func_279(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	if (uParam0->f_893)
	{
		if (func_126(uParam0->f_893.f_4, vParam1, 0) && uParam0->f_893.f_10 == fParam4)
		{
			uParam0->f_893.f_2 = 0;
...
void func_287()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1330, joaat("SECURITY_GUARD"));
	...
	func_288();
	if (MISC::IS_STRING_NULL_OR_EMPTY(&Global_95817))
	{
	}
...
void func_294()
{
	func_302(&(Local_1109[0 /*8*/]), 83214, "Van Driver Manager");
	func_302(&(Local_1109[1 /*8*/]), 81860, "Cargo Manager");
}
		...
		else
		{
			switch (uParam0->f_1)
			{
				case 1:
					...
					if (((((iLocal_1360 >= 3 || ENTITY::IS_ENTITY_DEAD(iLocal_1354, false)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 2)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 3)) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1343, 2) > 0f) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1343, 3) > 0f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_1354))
						{
							OBJECT::DELETE_OBJECT(&iLocal_1354);
						}
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 2))
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1343, 2, false, false);
						}
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 3))
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1343, 3, false, false);
						}
						iLocal_1372 = 0;
						iLocal_1373 = 0;
					...
					break;
				case 2:
					if (func_296(Local_1343))
					{
						if (MISC::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1343, 2)) > 0.5f && MISC::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1343, 3)) > 0.5f)
						{
				...
				case 3:
					if (func_296(Local_1343))
					{
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 2))
						{
							if (VEHICLE::IS_VEHICLE_DOOR_FULLY_OPEN(Local_1343, 2))
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1343, 2, true, false);
								VEHICLE::SET_VEHICLE_DOOR_LATCHED(Local_1343, 2, false, false, true);
								iLocal_1372 = 1;
							}
						}
						else
						...
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1343, 3))
						{
							if (VEHICLE::IS_VEHICLE_DOOR_FULLY_OPEN(Local_1343, 3))
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1343, 3, true, false);
								VEHICLE::SET_VEHICLE_DOOR_LATCHED(Local_1343, 3, false, false, true);
								iLocal_1373 = 1;
							}
						}
						else
...
void func_300(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (bParam1)
		{
			vVar0 = { func_301(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
			...
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(iParam0, Local_1343, true);
		}
	}
}
...
void func_303(var uParam0)
{
	...
	if (!func_135(uParam0))
	{
		if (((!ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x) || PED::IS_PED_INJURED(vLocal_1331.x)) || (ENTITY::DOES_ENTITY_EXIST(Local_1343) && func_202(Local_1343, vLocal_1331.x, 1) > 200f)) || (!PED::IS_PED_IN_ANY_VEHICLE(vLocal_1331.x, false) && func_202(Local_1343, vLocal_1331.x, 1) > 200f))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false))
			{
				VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1343, false);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1331);
			func_299(uParam0);
		}
		...
		{
			if ((uParam0->f_1 != 5 && uParam0->f_1 != 3) && ((!ENTITY::DOES_ENTITY_EXIST(Local_1343) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false)) || !PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, false)))
			{
				iLocal_1362 = 0;
				iLocal_1363 = 0;
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				...
				{
					iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, Local_1343))
					{
						if ((!bLocal_1357 && (MISC::GET_GAME_TIMER() - iLocal_1359) > 500) && fLocal_1358 >= 4f)
						{
							bLocal_1357 = true;
							iLocal_1356++;
						}
					...
					vVar1 = { func_301(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(Local_1343, true)) };
					vVar4 = { ENTITY::GET_ENTITY_VELOCITY(Local_1343) - ENTITY::GET_ENTITY_VELOCITY(iVar0) };
					fLocal_1358 = func_307(vVar4, vVar1);
				}
			}
			switch (uParam0->f_1)
			{
				case 1:
					if ((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1343, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1331.x, PLAYER::PLAYER_PED_ID(), true)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1331.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1343)) || iLocal_1356 > 0)
					{
						iLocal_1362 = 0;
						iLocal_1363 = 0;
						StringCopy(&cLocal_1364, "", 24);
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false))
						{
							if ((ENTITY::IS_ENTITY_STATIC(PLAYER::PLAYER_PED_ID()) || fLocal_1358 > 0.5f) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, 0f, 2f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343, 0f, 10f, 2f), 4.5f, false, true, 0))
							{
								if (!AUDIO::IS_HORN_ACTIVE(Local_1343))
								{
									if (iLocal_1375 == -1)
									{
									...
									{
										VEHICLE::START_VEHICLE_HORN(Local_1343, 2000, joaat("NORMAL"), false);
									}
								}
								else
								{
						...
						if (func_306(Local_1343, -993.7236f, -2418.757f, 12.9447f, 1) < 20f)
						{
							func_276(&uLocal_99, "jhp2a_airport");
						}
						if (!func_305(vLocal_1331.x, -235832601, 1))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1343, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, false, true, 0))
							{
							...
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1331.x, Local_1343, &Global_95817, 786475, -1, 24, -1, 12f, false, 2f);
							}
						}
					}
					break;
				case 2:
					...
					else if (!func_305(vLocal_1331.x, -235832601, 1))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1343, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, false, true, 0))
						{
							iLocal_1362 = 0;
							iLocal_1363 = 0;
							StringCopy(&cLocal_1364, "", 24);
						...
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1331.x, Local_1343, "jhp2a_airport", 786475, -1, 24, -1, 12f, false, 2f);
						}
					}
					break;
				case 3:
					if (((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1343, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1331.x, PLAYER::PLAYER_PED_ID(), true)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1331.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1343)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1343, true)) || iLocal_1356 > 0)
					{
						iLocal_1362 = 0;
						iLocal_1363 = 0;
						StringCopy(&cLocal_1364, "", 24);
					...
					else if (PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, true))
					{
						if (!func_305(vLocal_1331.x, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1))
						{
							TASK::TASK_LEAVE_VEHICLE(vLocal_1331.x, Local_1343, 0);
						}
					}
					else
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_1343, 2);
						if (!func_305(vLocal_1331.x, 242628503, 1))
						{
							...
							TASK::TASK_PERFORM_SEQUENCE(vLocal_1331.x, iLocal_1329);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_1329);
						}
					}
					break;
				case 4:
					if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1343, 0, true))
					{
						iVar7++;
					}
					if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1343, 1, true))
					{
						iVar7++;
					}
					if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1343, 4, true))
					{
						iVar7++;
					}
					if (VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1343, 5, true))
					{
						iVar7++;
					}
					if (((((IntToFloat(ENTITY::GET_ENTITY_HEALTH(Local_1343)) <= 0f || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_1343) <= 250f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_1343) <= 400f) || PED::IS_PED_INJURED(vLocal_1331.x)) || iVar7 >= 2) || iLocal_1356 > 6)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1343, false))
						{
							VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1343, false);
					...
					else if (!func_305(vLocal_1331.x, -1273030092, 1))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1331.x, Local_1343, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, false);
					}
					break;
				case 5:
					if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && !ENTITY::IS_ENTITY_DEAD(Local_1343, false))
					{
						if (PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, false))
						{
							if (!func_87(Local_1343))
							{
								if (!func_305(vLocal_1331.x, -2118855366, 1))
								{
									TASK::CLEAR_PED_TASKS(vLocal_1331.x);
									TASK::TASK_VEHICLE_TEMP_ACTION(vLocal_1331.x, Local_1343, 5, -1);
								}
							}
							else if (!func_305(vLocal_1331.x, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1))
							{
								TASK::TASK_LEAVE_VEHICLE(vLocal_1331.x, Local_1343, 256);
							}
						}
						else if (!func_305(vLocal_1331.x, 780511057, 1))
						{
							PED::SET_PED_CAN_BE_TARGETTED(vLocal_1331.x, true);
							TASK::TASK_COMBAT_PED(vLocal_1331.x, PLAYER::PLAYER_PED_ID(), 0, 16);
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(Local_1343) && !ENTITY::IS_ENTITY_DEAD(Local_1343, false))
					{
						VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_1343, 2, true);
						VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_1343, 3, true);
					}
					break;
			}
		}
		if ((ENTITY::DOES_ENTITY_EXIST(vLocal_1331.x) && !PED::IS_PED_INJURED(vLocal_1331.x)) && !PED::IS_CONVERSATION_PED_DEAD(vLocal_1331.x))
		{
			switch (uParam0->f_1)
			{
				case 4:
					...
					{
						case 0:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1331.x))
							{
								if (PED::IS_PED_BEING_JACKED(vLocal_1331.x))
								{
									func_62(vLocal_1331.x, "JACKED_GENERIC", 10);
								}
								else
								{
									func_62(vLocal_1331.x, "GENERIC_SHOCKED_HIGH", 10);
								}
								iLocal_1362++;
							}
							break;
						case 1:
							if (!PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, false) || iLocal_1328 == 3)
							{
								if (!PED::IS_PED_IN_VEHICLE(vLocal_1331.x, Local_1343, false))
								{
									iLocal_1362 = 4;
							...
							else if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1331.x))
							{
						...
						case 2:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1331.x))
							{
								...
								{
									fVar8 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_1331.x, true));
									if ((((((bLocal_1357 || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1331.x, 126)) || fVar8 < 49f) && (MISC::GET_GAME_TIMER() - iLocal_1363) > 5000) && fVar8 < 225f)
									{
								...
								if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1364))
								{
									...
									{
										func_62(vLocal_1331.x, "GENERIC_CURSE_HIGH", 10);
										iLocal_1362++;
									}
									else
									{
							...
							break;
						case 3:
							if (!func_43() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1331.x))
							{
					...
					switch (iLocal_1362)
					{
						case 0:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1331.x))
							{
								if (MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1364))
								{
									if ((MISC::GET_GAME_TIMER() - iLocal_1363) > 5000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(vLocal_1331.x, true)) < 400f)
									{
										if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
										{
								...
								if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1364))
								{
									...
									{
										func_62(vLocal_1331.x, "GENERIC_INSULT_HIGH", 10);
										iLocal_1362++;
									}
...
void func_312(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_314(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
