...
void func_1()
{
	if (bLocal_534 && !bLocal_535)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
		{
			VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_319, 0f);
			ENTITY::FREEZE_ENTITY_POSITION(bLocal_319, false);
		}
...
void func_2(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
void func_12()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_319))
		{
			ENTITY::FREEZE_ENTITY_POSITION(bLocal_319, false);
			ENTITY::APPLY_FORCE_TO_ENTITY(bLocal_319, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, true, true, true, false, true);
			if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
			{
				UNK_0x369FC9C428863FC8(bLocal_319, 1, 0);
			}
		}
	}
}
...
void func_22()
{
	switch (iLocal_302)
	{
		case 0:
			...
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_319, false))
				{
					iLocal_317 = PED::CREATE_PED_INSIDE_VEHICLE(bLocal_319, 26, joaat("S_M_M_DOCKWORK_01"), -1, true, true);
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
					...
					if (!PED::IS_PED_INJURED(iLocal_317))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, false, true, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
							{
								if (!HUD::DOES_BLIP_EXIST(iLocal_324))
								{
									iLocal_324 = func_96(bLocal_319, 0, 0);
								}
							}
						}
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_317, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_319, PLAYER::PLAYER_PED_ID(), true))
						{
							ENTITY::FREEZE_ENTITY_POSITION(bLocal_319, false);
				...
				else
				{
					if (!PED::IS_PED_INJURED(iLocal_317))
					{
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false) && !HUD::DOES_BLIP_EXIST(iLocal_324))
							{
								iLocal_324 = func_96(bLocal_319, 0, 0);
							}
						}
					...
					else
					{
						...
						if (PED::IS_PED_INJURED(iLocal_317) || ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
						{
							func_95();
						}
					}
					if (!VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_320, false))
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_325))
						{
							HUD::REMOVE_BLIP(&iLocal_325);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_320, false))
				{
					if (iLocal_353 >= 3)
					{
						...
						else if (!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_317, false) && HUD::DOES_BLIP_EXIST(iLocal_324))
							{
								HUD::REMOVE_BLIP(&iLocal_324);
								if (!HUD::DOES_BLIP_EXIST(iLocal_325))
								{
									iLocal_325 = func_96(bLocal_320, 0, 0);
								}
							}
						}
					}
				...
				if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
				{
					if (FIRE::IS_ENTITY_ON_FIRE(bLocal_319))
					{
						iLocal_347 = 0;
						while (iLocal_347 < 11)
						{
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_355) > iLocal_304 || func_51())
			{
				...
				if (!bLocal_345)
				{
					if (!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
					{
						if (!VEHICLE::_0x639431E895B9AA57(iLocal_317, bLocal_319, -1, false, false) && !VEHICLE::_0x639431E895B9AA57(iLocal_317, bLocal_319, false, false, false))
						{
							func_46();
							SYSTEM::WAIT(0);
							func_24(&uLocal_358, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
...
void func_52()
{
	...
	switch (iLocal_348)
	{
		case 0:
			if (iLocal_353 >= 2)
			{
				if (!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
				{
					...
					if (VEHICLE::_0x639431E895B9AA57(iLocal_317, bLocal_319, -1, false, false) || VEHICLE::_0x639431E895B9AA57(iLocal_317, bLocal_319, false, false, false))
					{
						if (VEHICLE::_0x639431E895B9AA57(iLocal_317, bLocal_319, -1, false, false))
						{
							bLocal_344 = true;
							vLocal_314 = { ENTITY::GET_ENTITY_COORDS(bLocal_319, false) + Vector(0f, -1f, -3f) };
						}
						else
						{
							vLocal_314 = { ENTITY::GET_ENTITY_COORDS(bLocal_319, false) + Vector(0f, 1.5f, -3f) };
						}
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
			{
				if (!ENTITY::IS_ENTITY_DEAD(bLocal_320, false))
				{
					ENTITY::SET_ENTITY_PROOFS(bLocal_320, false, true, true, false, false, false, false, false);
				}
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_351) > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_317))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(bLocal_320, false))
					{
						ENTITY::SET_ENTITY_PROOFS(bLocal_320, false, false, false, false, false, false, false, false);
					}
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_317))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_351) > 6400)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(bLocal_320))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(bLocal_320, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
						{
							vVar0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
...
int func_84(bool bParam0)
{
	if (func_88())
	{
		...
		if (bParam0 && func_65(Global_111847))
		{
...
{
	return func_82(bParam0, !bParam1, bParam2);
}
...
void func_97()
{
	if (func_100(1000))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
		{
			VEHICLE::SET_VEHICLE_DAMAGE(bLocal_319, 0f, 1f, 1f, 200f, 800f, true);
		}
		bLocal_536 = true;
		iLocal_303 = 8;
	}
	switch (iLocal_303)
	{
		...
		case 1:
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 3500)
			{
				...
				{
					TASK::CLEAR_PED_TASKS(iLocal_317);
					TASK::TASK_LOOK_AT_COORD(iLocal_317, -461.4785f, -984.8583f, 28.0809f, 4.203895E-41f, 2080, 2);
				}
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				if (!ENTITY::IS_ENTITY_DEAD(bLocal_319, false))
				{
					...
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipe_impact", bLocal_319, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
		...
		case 6:
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_317))
				{
					TASK::TASK_LOOK_AT_COORD(iLocal_317, ENTITY::GET_ENTITY_COORDS(iLocal_317, true) - Vector(10f, 0f, 2f), 4.203895E-41f, 2080, 2);
				}
				iLocal_354 = MISC::GET_GAME_TIMER();
				iLocal_303 = 7;
			}
		...
		case 7:
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 2500)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_319, false))
				{
					ENTITY::FREEZE_ENTITY_POSITION(bLocal_319, true);
				}
				iLocal_303 = 8;
			}
			break;
		case 8:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_319, false))
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_319, 250f);
				ENTITY::SET_ENTITY_COORDS(bLocal_319, vLocal_308, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(bLocal_319, 80f);
...
void func_115()
{
	...
	if (func_104(&Local_537))
	{
		...
		bLocal_319 = VEHICLE::CREATE_VEHICLE(joaat("UTILLITRUCK2"), vLocal_308, 80f, true, true, false);
		VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_319, false, true, false);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_319, 3);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 1, true);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 2, true);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 3, false);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 4, true);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 5, true);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 6, false);
		VEHICLE::SET_VEHICLE_EXTRA(bLocal_319, 7, true);
		ENTITY::FREEZE_ENTITY_POSITION(bLocal_319, true);
		ENTITY::SET_ENTITY_PROOFS(bLocal_319, false, false, false, true, false, false, false, false);
		ENTITY::SET_ENTITY_LOD_DIST(bLocal_319, 10000);
		VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(bLocal_319, 5f);
		bLocal_320 = VEHICLE::CREATE_VEHICLE(joaat("BULLDOZER"), -472.9444f, -966.671f, 22.5534f, 181.8365f, true, true, false);
...
int func_215(int iParam0, int iParam1, char* sParam2, int iParam3)
{
