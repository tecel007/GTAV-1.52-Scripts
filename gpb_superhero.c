...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBSH", 8);
	StringCopy(&cLocal_236, "IMPORAGE", 16);
	StringCopy(&cLocal_202, "Special_Ped@Impotent_Rage", 64);
	...
	StringCopy(&cLocal_312, "PBSH_CONV_M1", 16);
	StringCopy(&cLocal_316, "PBSH_CONV_T1", 16);
	StringCopy(&cLocal_320, "PBSH_CONV_F1", 16);
