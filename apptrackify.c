		...
		if (Global_19681.f_1 != 9)
		{
			switch (Global_19681.f_1)
			{
				case 7:
					...
					{
						GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_19662, "APP_FUNCTION");
	...
	if (func_18() == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (iLocal_31 == 0)
			{
				...
				if (MISC::IS_BIT_SET(Global_7552, 30))
				{
				...
				if (MISC::IS_BIT_SET(Global_7552, 22))
				{
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
				}
				else
				...
				if (MISC::IS_BIT_SET(Global_7552, 29))
				{
			...
			func_14(Global_19662, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		}
	}
	else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		while (iVar0 < Global_4271299)
		{
			...
			if (iLocal_31 == 0)
			{
				...
				{
					case 0:
						if (MISC::IS_BIT_SET(Global_4271024, 5))
						{
							bVar1 = true;
						}
						break;
					case 1:
						if (MISC::IS_BIT_SET(Global_4271024, 6))
						{
							bVar1 = true;
						}
						break;
					case 2:
						if (MISC::IS_BIT_SET(Global_4271024, 7))
						{
							bVar1 = true;
						}
						break;
					case 3:
						if (MISC::IS_BIT_SET(Global_4271024, 8))
						{
							bVar1 = true;
						}
						break;
				...
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_30);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4271277[iVar0]);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
			if (fLocal_23 == fLocal_23)
			{
...
{
	fLocal_25 = (Global_4271213[iParam0 /*3*/] - vLocal_20.x);
	fLocal_26 = (SYSTEM::COS(((3.14159f / 180f) * vLocal_20.x)) * (Global_4271213[iParam0 /*3*/].f_1 - vLocal_20.y));
...
{
	fLocal_29 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4271213[iParam0 /*3*/], vLocal_20));
	fLocal_30 = (Global_4271213[iParam0 /*3*/].f_2 - vLocal_20.z);
	return fLocal_29;
}

float func_13(int iParam0)
{
	fLocal_28 = SYSTEM::SQRT((((Global_4271213[iParam0 /*3*/] - vLocal_20.x) * (Global_4271213[iParam0 /*3*/] - vLocal_20.x)) + ((Global_4271213[iParam0 /*3*/].f_1 - vLocal_20.y) * (Global_4271213[iParam0 /*3*/].f_1 - vLocal_20.y))));
	return fLocal_28;
}
...
float func_15()
{
	fLocal_25 = (Global_22111 - vLocal_20.x);
	fLocal_26 = (SYSTEM::COS(((3.14159f / 180f) * vLocal_20.x)) * (Global_22111.f_1 - vLocal_20.y));
	fLocal_27 = MISC::ATAN2(fLocal_25, fLocal_26);
	if (fLocal_27 < 0f)
	{
		fLocal_27 = (fLocal_27 + 360f);
...
float func_16()
{
	fLocal_29 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_22111, vLocal_20));
	fLocal_30 = (Global_22111.f_2 - vLocal_20.z);
	return fLocal_29;
}

float func_17()
{
	fLocal_28 = SYSTEM::SQRT((((Global_22111 - vLocal_20.x) * (Global_22111 - vLocal_20.x)) + ((Global_22111.f_1 - vLocal_20.y) * (Global_22111.f_1 - vLocal_20.y))));
	return fLocal_28;
}
