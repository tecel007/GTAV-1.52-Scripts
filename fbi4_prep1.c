...
void func_1()
{
	...
	switch (iLocal_684)
	{
		case 0:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(iLocal_818))
			{
				func_34(iLocal_818);
			}
			else
...
{
	func_13(&(Global_105407.f_2890), vParam0, fParam3);
}
...
void func_20(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_22(Global_111858.f_18529[iVar0], &vVar2, &fVar5))
			{
...
void func_26()
{
	...
	{
		if (func_30(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_39()
{
	...
	switch (iLocal_684)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_107(PLAYER::PLAYER_PED_ID(), vLocal_827, 270f))
			{
				iLocal_684 = 2;
			}
...
void func_43(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_50(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_107(int iParam0, vector3 vParam1, float fParam4)
{
...
void func_108()
{
	func_215(&iLocal_874, &iLocal_875, &iLocal_686, &iLocal_822, &iLocal_821, vLocal_827, Local_868, 0, 1090519040 /* Float: 8f */);
	func_214();
	func_155();
	switch (iLocal_684)
	{
		case 0:
			...
			break;
		case 1:
			func_120(&iLocal_821, vLocal_827, &iLocal_685, iLocal_686, &iLocal_820, &iLocal_838);
			if (func_113(iLocal_874, vLocal_827, &iLocal_821, iLocal_686, iLocal_685, &iLocal_836, &iLocal_839, &iLocal_835, &iLocal_834, &iLocal_820, 1090519040 /* Float: 8f */))
			{
				if (!func_112())
				{
					if (func_67(&uLocal_687, &cLocal_1044, &uLocal_879))
		...
		case 3:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_868, false))
				{
...
int func_109(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_113(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	float fVar0;
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			else
			{
				...
				{
					fVar0 = (fParam12 / 2f);
					if (func_107(PLAYER::PLAYER_PED_ID(), vParam1, fVar0))
					{
						*iParam7 = 0;
...
void func_117(int iParam0, vector3 vParam1, int iParam4)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_118(vParam1, 5, iParam4);
	}
}
...
void func_120(int* iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	switch (*iParam4)
	{
		case 0:
...
void func_124(int iParam0, vector3 vParam1, float fParam4)
{
	if (func_341(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_109(iParam0, vParam1, fParam4, 0, 1);
}
...
int func_132()
{
	...
	if (func_37(iLocal_109))
	{
		...
		fVar30 = func_133(Local_134[iVar0 /*25*/] - vVar1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_109));
		iVar5 = iVar0;
		iVar31 = 0;
		while (fVar30 < 0f && iVar31 < 40)
		{
			...
			vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_109, true) };
			fVar30 = func_133(Local_134[iVar5 /*25*/] - vVar1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_109));
			iVar31++;
		}
		if (iVar31 >= 40)
		{
...
void func_144(int iParam0, vector3 vParam1)
{
	...
	if ((vParam1.x == Global_31346[iVar0 /*23*/][0 /*3*/] && vParam1.y == Global_31346[iVar0 /*23*/][0 /*3*/].f_1) && vParam1.z == Global_31346[iVar0 /*23*/][0 /*3*/].f_2)
	{
		return;
	}
	Global_31343 = 1;
	MISC::SET_BIT(&(Global_31346[iVar0 /*23*/].f_11), 18);
	Global_31346[iVar0 /*23*/][0 /*3*/] = { vParam1 };
	Global_37396 = 1;
}
...
int func_149(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95452.f_9[1], true))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95452.f_9[1], true, true);
					Local_854 = Global_95452.f_9[1];
					if (func_341(Local_854))
					{
						...
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_854, true, 1);
						return 1;
					}
				}
				else
...
int func_150(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_153(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_152(iParam1, "Loading", 0))
...
int func_154(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_158(int* iParam0)
{
	...
	switch (iParam0->f_6)
	{
		...
		case 21:
			...
			{
				if (func_177(*iParam0, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 1, 250, 7))
				{
					func_176(iParam0, 1);
					return;
				}
		...
		case 11:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				if (!func_184(*iParam0, 713668775))
				{
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_667, 1f, -1, 2f, false, 40000f);
					}
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 23;
		...
		case 13:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) >= iParam0->f_2)
			{
				...
				else if (func_177(Local_111[func_171(iParam0->f_10) /*11*/], *iParam0, 1126825984 /* Float: 170f */, 1, 250, 7))
				{
					func_176(iParam0, 0);
				}
				else
		...
		case 23:
			...
			func_172(iParam0);
			if (func_107(*iParam0, vLocal_667, 2f))
			{
				if (func_159(*iParam0, vLocal_667, 1126825984 /* Float: 170f */, 0))
				{
					TASK::CLEAR_PED_TASKS(*iParam0);
					iParam0->f_6 = 19;
					iParam0->f_5 = 1;
...
int func_159(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_160(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar3 = { func_160(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_162(int* iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_37(iVar0))
		{
			if (!VEHICLE::_0x639431E895B9AA57(*iParam0, iVar0, -1, false, false))
			{
				iParam0->f_6 = 18;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
...
{
	if (!func_184(*iParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
	{
		if (Local_134[iLocal_661 /*25*/].f_23 != 0)
		{
			if (func_10(Local_134[iLocal_661 /*25*/].f_17))
			{
				TASK::TASK_GOTO_ENTITY_OFFSET(*iParam0, Local_134[iLocal_661 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, Local_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, false, func_165(Local_134[iLocal_661 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*iParam0, true), 1));
		}
		if (func_37(iLocal_109))
		{
...
float func_165(struct<2> Param0, int iParam2, struct<2> Param3, Vector3 vParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (iParam0->f_7 == 9)
	{
		if (iParam0->f_9 >= 2)
		{
			if (!PED::IS_PED_INJURED(*iParam0))
			{
				PED::RESET_PED_MOVEMENT_CLIPSET(*iParam0, 0.25f);
				PED::RESET_PED_WEAPON_MOVEMENT_CLIPSET(*iParam0);
				TASK::TASK_PLAY_ANIM(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 8f, -8f, -1, 56, 0f, false, false, false);
			}
		}
	}
}
...
{
	func_169(iParam0);
	if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || bParam1) || iParam0->f_6 == 23)
	{
	...
	{
		if (!func_184(*iParam0, 780511057) && !func_184(*iParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
		{
			iParam0->f_5 = 1;
			iParam0->f_6 = 21;
			iParam0->f_1 = MISC::GET_GAME_TIMER();
...
bool func_177(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	bVar0 = func_178(&(Local_38[iVar4 /*4*/]), vVar1, iParam1, &(Local_38[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (bVar0 || (MISC::GET_GAME_TIMER() - Local_38[iVar4 /*4*/].f_3) < iParam4);
}

int func_178(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_179(iParam4, iParam7) };
...
int func_181(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_160(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_185(int* iParam0)
{
	...
	if (iParam0->f_9 == 0 && iParam0->f_10 == 1)
	{
	}
	switch (iParam0->f_7)
	{
		case 1:
			...
			break;
		case 2:
			if (PED::IS_PED_SITTING_IN_VEHICLE(*iParam0, iLocal_109))
			{
				if (!func_184(*iParam0, -1794415470))
				{
					if (iParam0->f_10 == 0)
					{
						func_130(0);
		...
		case 3:
			...
			if (bLocal_664)
			{
				if (iLocal_661 <= 20 && iLocal_661 != -1)
				{
					if (!Local_134[iLocal_661 /*25*/].f_18)
					{
						if (func_107(*iParam0, Local_134[iLocal_661 /*25*/], 20f))
						{
			...
			break;
		case 4:
			if (func_107(*iParam0, Local_134[iLocal_661 /*25*/], 25f))
			{
		...
		case 5:
			...
			break;
		case 6:
			if (!func_184(*iParam0, 242628503) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_109))
			{
				if (bLocal_664)
				{
					iParam0->f_8 = iParam0->f_7;
...
void func_186(int* iParam0)
{
	...
	if (iParam0->f_9 >= 1 && iParam0->f_9 != 0)
	{
	}
	switch (iParam0->f_9)
	{
		case 1:
			if (!func_184(*iParam0, -2015108952))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (func_170(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Local_134[iLocal_661 /*25*/].f_19) > 1.5f)
				{
			...
			else if (func_191(Local_134[iLocal_661 /*25*/].f_19, *iParam0, 1f, 1f, 8f))
			{
				func_190(iParam0);
				return;
			}
			PED::SET_PED_CAPSULE(*iParam0, 0.2f);
			break;
		case 2:
			if (func_184(*iParam0, 242628503))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0.333f)
					{
						PED::SET_PED_MOVEMENT_CLIPSET(*iParam0, "missfbi4prepp1_garbageman", 0f);
						PED::SET_PED_WEAPON_MOVEMENT_CLIPSET(*iParam0, "missfbi4prepp1_garbageman");
						if (func_10(Local_134[iLocal_661 /*25*/].f_17) && !ENTITY::IS_ENTITY_ATTACHED(Local_134[iLocal_661 /*25*/].f_17))
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_134[iLocal_661 /*25*/].f_17, *iParam0, PED::GET_PED_BONE_INDEX(*iParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true);
						}
					}
				}
				if (func_191(Local_134[iLocal_661 /*25*/].f_19, *iParam0, 1f, 1f, 8f))
				{
					func_190(iParam0);
					return;
				}
			}
			else if (!func_184(*iParam0, 713668775))
			{
				if (func_37(iLocal_109))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, -4.8f, 0f), 1f, -1, 0.25f, false, ENTITY::GET_ENTITY_HEADING(iLocal_109));
				}
				iParam0->f_9 = 3;
			}
			PED::SET_PED_CAPSULE(*iParam0, 0.2f);
		...
		case 3:
			if (func_37(iLocal_109))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						if (!func_184(*iParam0, 713668775))
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar1);
							if (func_170(ENTITY::GET_ENTITY_COORDS(*iParam0, true), ENTITY::GET_ENTITY_COORDS(iLocal_109, true)) > 3f)
							{
			...
			break;
		case 4:
			if (!func_191(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, -5.5f, 0f), *iParam0, 1.9f, 1.9f, 8f))
			{
				if (func_184(*iParam0, 242628503))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, "missfbi4prepp1", "_bag_throw_garbage_man", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*iParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_134[iLocal_661 /*25*/].f_17))
							{
								if (ENTITY::IS_ENTITY_ATTACHED(Local_134[iLocal_661 /*25*/].f_17))
...
int func_191(vector3 vParam0, int iParam3, vector3 vParam4)
{
...
void func_192(int iParam0, int iParam1)
{
	...
	iVar1 = SHAPETEST::GET_SHAPE_TEST_RESULT(*iParam0, &iVar0, &(iParam0->f_20), &(iParam0->f_23), &(iParam0->f_18));
...
void func_193(int iParam0, int iParam1)
{
	switch (iParam0->f_1)
	{
		case 0:
			break;
		case 1:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(iParam0->f_2, iParam0->f_5, 511, iParam1, 7);
			break;
		case 2:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_BOUND(iParam0->f_17, 511, 4);
			break;
		case 3:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_BOUNDING_BOX(iParam0->f_17, 511, 4);
			break;
		case 4:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_BOX(iParam0->f_2, iParam0->f_8, iParam0->f_11, iParam0->f_14, 6, iParam1, 4);
			break;
		case 5:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_CAPSULE(iParam0->f_2, iParam0->f_5, iParam0->f_15, 511, iParam1, 4);
			break;
	}
...
void func_196(int* iParam0, bool bParam1)
{
	...
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, true) + Vector(2f, 0f, 0f), 9f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			func_197(iParam0);
		}
		else if (!func_184(*iParam0, 1227113341) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			TASK::CLEAR_PED_TASKS(*iParam0);
			TASK::TASK_GO_TO_ENTITY(*iParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 2f, 0);
		}
	}
	else if (func_107(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		TASK::TASK_ENTER_VEHICLE(*iParam0, iLocal_109, -1, iVar0, 1f, 8388609, 0);
		iParam0->f_7 = 2;
	}
}
...
void func_198(int* iParam0)
{
	if (iParam0->f_5 != 1)
	{
		...
		{
			if (!func_184(*iParam0, 2104565373) && PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_109, false))
			{
...
int func_200(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_152(iParam1, "Loading", 0))
		{
			*uParam0 = OBJECT::CREATE_OBJECT(iParam1, vParam2, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
		...
		if (!func_341(Local_111[func_171(iParam1) /*11*/]))
		{
			if (!bLocal_665)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_111[func_171(iParam1) /*11*/]))
				{
					...
					{
						vLocal_667 = { ENTITY::GET_ENTITY_COORDS(Local_111[func_171(iParam1) /*11*/], true) };
						iParam0->f_1 = MISC::GET_GAME_TIMER();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
				...
				if (func_37(iLocal_109))
				{
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_109, false))
					{
						...
						else
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_111[func_171(iParam1) /*11*/]))
							{
								if (func_181(Local_111[func_171(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 0))
								{
					...
					else
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_111[func_171(iParam1) /*11*/]))
						{
							if (func_177(Local_111[func_171(iParam1) /*11*/], *iParam0, 1126825984 /* Float: 170f */, 1, 250, 7))
							{
								func_176(&(Local_111[func_171(iParam1) /*11*/]), 0);
							}
						}
...
{
	if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*iParam0, 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) && PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
void func_214()
{
	if (func_37(Local_868))
	{
		if (func_157(PLAYER::PLAYER_PED_ID(), Local_868, 100f, 1) && !bLocal_837)
		{
		...
		else if (!func_157(PLAYER::PLAYER_PED_ID(), Local_868, 120f, 1) && bLocal_837)
		{
...
void func_215(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, vector3 vParam5, int iParam8, bool bParam9, float fParam10)
{
	if (func_37(*iParam0))
	{
		switch (*iParam2)
	...
	switch (iLocal_684)
	{
		case 0:
			if (func_122(iLocal_683, bLocal_28))
			{
				...
				{
					func_117(&iLocal_821, vLocal_827, 1);
		...
		case 1:
			func_120(&iLocal_821, vLocal_827, &iLocal_685, iLocal_686, &iLocal_820, &iLocal_838);
			func_227();
			if (func_225(iLocal_874, vLocal_827, &iLocal_821, iLocal_685, iLocal_686, &iLocal_820, &iLocal_839, 0, 0, 1086324736 /* Float: 6f */))
			{
		...
		case 3:
			if (func_37(iLocal_874))
			{
				...
				{
					func_109(iLocal_874, vLocal_827, 146.5443f, 0, 1);
					func_40(1, 1, 1);
					iLocal_684 = 1;
				}
			}
...
int func_225(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{
		...
		if (!PED::IS_PED_INJURED(iVar2))
		{
			...
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, true))
			{
				if (func_231(iVar2))
				{
					...
					{
						if (PATHFIND::_ARE_PATH_NODES_LOADED_IN_AREA(623.3781f, -172.26f, 1700.732f, -2115.843f))
						{
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, false), vLocal_827, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_229(iVar2))
				{
					if (func_37(Local_868))
					{
						if (!func_157(iVar2, Local_868, 17f, 1))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
							{
								TASK::TASK_VEHICLE_MISSION(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, false), Local_868, 3, 20f, 786468, 2f, 0.5f, true);
							}
						}
					}
				}
...
int func_231(int iParam0)
{
	if (!func_230())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_868) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_868, false)) && !ENTITY::IS_ENTITY_AT_COORD(Local_868, vLocal_827, 2f, 2f, 2f, false, true, 0))
		{
			if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_868, false)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (PED::IS_PED_IN_VEHICLE(iParam0, Local_868, false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_868, -1, false) == iParam0)
				{
					return 1;
				}
			}
...
void func_232(int iParam0)
{
	if (iLocal_683 > 1)
	{
		...
		else
		{
			...
			{
				if (func_235(iLocal_874, vLocal_827, 1) < 15f && iLocal_686 == 1)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
...
void func_238()
{
	if (func_107(PLAYER::PLAYER_PED_ID(), vLocal_827, 220f))
	{
		if (!bLocal_877 && !func_107(PLAYER::PLAYER_PED_ID(), vLocal_827, 100f))
		{
			bLocal_877 = func_153(&iLocal_876, joaat("CAVALCADE2"), 1370.912f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (func_107(PLAYER::PLAYER_PED_ID(), vLocal_827, 240f))
	{
		if (bLocal_877)
		{
			func_6(&iLocal_876);
...
void func_239()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (!bLocal_833)
			{
				if (func_341(Local_840) && PED::IS_PED_BEING_JACKED(Local_840))
				{
					func_241();
				}
				if (func_341(Local_854) && PED::IS_PED_BEING_JACKED(Local_854))
				{
					func_241();
				}
			}
...
void func_242(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6)
{
	func_243(uParam0, iParam1, 0f, 0f, 0f, iParam2, iParam3, iParam4, iParam5, sParam6);
}

void func_243(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9)
{
	func_244(uParam0, iParam1, vParam2, iParam5, iParam6, iParam7, iParam8, sParam9);
}

void func_244(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, char* sParam7, int iParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_245(uParam0, iParam1, vParam2, iParam5, iParam6, sParam7, iParam8, bParam9);
}

void func_245(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
	...
	if (func_268(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_260(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_252(int iParam0)
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1312896 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2425869[iParam0 /*443*/].f_314.f_6 != -1;
		}
	}
...
void func_260(var uParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_272(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
void func_285(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_320(iParam5, &Var0, vParam1, fParam4, func_326(iParam0));
...
int func_304(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_320(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_317(&(Global_75654.f_555[0 /*21*/]), iParam0))
	{
...
void func_338()
{
	...
	if (!func_37(iLocal_874))
	{
		if (!func_37(iLocal_875) && !func_37(Local_868))
		{
			func_340(1);
			return;
		}
		if (func_37(Local_868) && !func_157(PLAYER::PLAYER_PED_ID(), Local_868, fVar0, 1))
		{
			func_340(2);
		}
	}
	else
	{
		...
		if (func_37(Local_868))
		{
			if (!func_157(PLAYER::PLAYER_PED_ID(), Local_868, fVar0, 1))
			{
				iVar1++;
			}
		}
...
void func_340(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			break;
		case 1:
			iLocal_818 = "PRA_FWRECK";
			break;
		case 2:
			iLocal_818 = "PRA_FFAR";
			break;
		case 3:
			iLocal_818 = "PRA_FSTUCK";
			break;
	}
	iLocal_683 = 5;
	iLocal_684 = 0;
