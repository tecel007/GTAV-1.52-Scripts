...
void func_43(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_79(int iParam0)
{
	...
	return Global_96222[func_80(iParam0)];
}
...
int func_149(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_95241.f_9[1], true))
				{
...
int func_252(int iParam0)
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1312877 && iParam0 == PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0))
		{
			return Global_2425662[iParam0 /*421*/].f_310.f_5 != -1;
		}
	}
...
void func_287(int iParam0, int iParam1)
{
	...
	func_327(iParam0, &(Global_111638.f_32744.f_5510));
}
