...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (((!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !MISC::IS_BIT_SET(Global_4456448.f_17, 4)) && !func_110()) && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-1085924656) == 0)
		{
			if (Global_21005 != 0)
			{
				...
				else
				{
					if (iLocal_30 == 0)
					{
						...
						if (Global_21060)
						{
							...
							func_51(Global_19662, "DISPLAY_VIEW", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
							if (Global_19669)
							{
		...
		else
		{
			while (Global_21058)
			{
				...
				else
				{
					...
					{
						func_52();
						func_51(Global_19662, "SET_DATA_SLOT_EMPTY", 18f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
						...
						func_51(Global_19662, "DISPLAY_VIEW", 18f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_8()
{
	...
	{
		case 6:
			func_51(Global_19662, "SET_DATA_SLOT_EMPTY", 1f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
			func_13(Global_8156);
			if (Global_8156 == 1)
			{
				func_51(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19685), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				Global_19661 = Global_19685;
			}
			else
			{
				func_51(Global_19662, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19686), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
		...
		case 9:
			...
			{
				func_10();
				func_51(Global_19662, "SET_THEME", SYSTEM::TO_FLOAT(Global_111858.f_14047[Global_19681 /*20*/].f_6), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
				if (Global_21018)
				{
			...
			else if (Global_21005 == 4 || Global_21005 == 3)
			{
				...
				else
				{
					...
					if (func_50(Global_6866, Global_19681) == 0)
					{
						func_51(Global_19662, "SET_DATA_SLOT_EMPTY", 4f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_17()
{
	func_51(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
...
void func_20()
{
	func_51(Global_19662, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_19670, true);
	func_21();
}
...
int func_75(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 6, iParam0 * 7 + 7);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
	return 1;
...
int func_76(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 5, iParam0 * 7 + 6);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_77(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 4, iParam0 * 7 + 5);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_78(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 3, iParam0 * 7 + 4);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 1;
	}
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "1"))
	{
		return 1;
	}
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "2"))
	{
		return 2;
	}
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "3"))
	{
		return 3;
	}
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "4"))
	{
		return 0;
	}
	return 0;
...
int func_79(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 2, iParam0 * 7 + 3);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_80(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7 + 1, iParam0 * 7 + 2);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_81(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_85), iParam0 * 7, iParam0 * 7 + 1);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_82()
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 2, 3);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_83()
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 1, 2);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_84()
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 0, 1);
	if (MISC::ARE_STRINGS_EQUAL(fVar0, "0"))
	{
		return 0;
	}
...
int func_85(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_66), iParam0 * 3 + 2, iParam0 * 3 + 3);
	return func_86(fVar0);
}

int func_86(void fParam0)
{
...
int func_87(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_66), iParam0 * 3 + 1, iParam0 * 3 + 2);
	return func_86(fVar0);
}
...
int func_88(int iParam0)
{
	...
	fVar0 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_66), iParam0 * 3, iParam0 * 3 + 1);
	return func_86(fVar0);
}
...
void func_90()
{
	...
	{
		fLocal_79 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 0, 1);
		if (MISC::IS_STRING_NULL(fLocal_79))
		{
		}
		fLocal_80 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 1, 2);
		if (MISC::IS_STRING_NULL(fLocal_80))
		{
		}
		fLocal_81 = STREAMING::REMOVE_ANIM_DICT(HUD::_GET_LABEL_TEXT(&cLocal_73), 2, 3);
		if (MISC::IS_STRING_NULL(fLocal_81))
		{
		}
	}
}
...
void func_93()
{
	...
	if (HUD::DOES_TEXT_BLOCK_EXIST(&Global_21081))
	{
		...
		iVar13 = 0;
		if (UNK_0xDCA0815D900F27F8() || MISC::IS_DURANGO_VERSION())
		{
			if (Global_1573348 == 1)
			{
				iVar13 = 1;
		...
		else if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-1085924656) == 0)
		{
...
float func_106(vector3 vParam0, vector3 vParam3, vector3 vParam6, vector3 vParam9, float fParam12, bool bParam13)
{
	...
	if (fVar3 < 1f)
	{
		...
		Global_19609 = { func_107(vParam0, vParam3, fVar4) };
		Global_19612 = { func_107(vParam6, vParam9, fVar4) };
	}
	else
	{
