...
void func_105()
{
	...
	StringCopy(&cLocal_234, "PBAM", 8);
	StringCopy(&cLocal_236, "ANDYMOON", 16);
	StringCopy(&cLocal_202, "Special_Ped@andy_moon", 64);
	StringCopy(&cLocal_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 15;
	sLocal_303 = "PBAM_INTERACT";
	StringCopy(&cLocal_312, "PBAM_CONV_GM", 16);
	StringCopy(&cLocal_316, "PBAM_CONV_GT", 16);
	StringCopy(&cLocal_320, "PBAM_CONV_GF", 16);
...
{
	return func_111(Global_111858.f_20113, iParam0);
}
