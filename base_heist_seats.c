...
void func_1()
{
	MISC::CLEAR_BIT(&Global_1573983, 1);
	func_3(&Local_47);
	func_2();
}
...
{
	func_19(&Local_47);
	if (Global_1590525 == PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1627436[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*90*/].f_38.f_27, 5))
	{
		...
		{
			MISC::SET_BIT(&Global_1573983, 1);
			if ((((((iLocal_484 == 0 && !MISC::IS_BIT_SET(Global_1627436[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*90*/].f_38.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 5:
			...
			if (iVar41 != 1 && iVar41 != 0)
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iParam0->f_421.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_33(iParam0);
			func_26(iParam0);
			iVar42 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0->f_421.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar42))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar42) >= 1f)
				{
					...
					func_46(iParam0, &uVar16);
					iParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, true, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iParam0->f_421.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iParam0->f_421.f_1);
					func_13(&(iParam0->f_421), 8);
		...
		case 7:
			...
			break;
		case 8:
			iVar43 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0->f_421.f_1);
...
void func_32(int iParam0)
{
	...
	iParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, true, false, 1f, 0f, 1f);
	func_47(iParam0, &uVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iParam0->f_421.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iParam0->f_421.f_1);
	func_9(&(iParam0->f_421.f_5));
	func_58(iParam0, 8);
}
...
int func_78()
{
	if (Global_1590525 != func_65())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1590525, true, 0))
		{
			return 0;
		}
...
int func_84(int iParam0)
{
	if (iParam0 != func_65())
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_1627436[iParam0 /*90*/].f_38.f_27, 3))
			{
				return 1;
			}
		}
