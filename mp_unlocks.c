...
void func_27(int iParam0, bool bParam1)
{
	...
	func_17(1, *iParam0, iLocal_84, *iParam0, &cVar0, bParam1, 0);
	*iParam0++;
}
...
int func_32(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2589533[iParam0 /*3*/][func_14(iParam1)];
	if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
void func_37(int iParam0, int iParam1, int iParam2)
{
	...
	StringIntConCat(&cVar0, *iParam0, 16);
	func_38(1, *iParam0, iLocal_84, *iParam0, &cVar0, "PM_UGEN_NUM", iParam1, iParam2);
	*iParam0++;
}
...
int func_39(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			if ((((func_41() || func_40()) || MISC::IS_PC_VERSION()) || UNK_0xDCA0815D900F27F8()) || MISC::IS_DURANGO_VERSION())
			{
				iVar0 += 2;
				iVar0 += 2;
				iVar0++;
