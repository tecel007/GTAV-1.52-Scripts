...
void __EntryFunction__()
{
	...
	if (iLocal_301 == 2)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (vVar0.z > 23f || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -743.3924f, -2129.82f, 12.07619f, -708.892f, -2160.705f, 19.7035f, 124.5f, false, true, 0))
				{
					SCRIPT::TERMINATE_THIS_THREAD();
				}
			}
	...
	if (func_194(vLocal_52, 17, iLocal_301, 0, 0))
	{
		func_191(-1);
	}
	else
			...
			if (func_168(iLocal_77) && !func_110())
			{
						...
						switch (iLocal_49)
						{
							case 0:
								if (!PED::IS_PED_INJURED(iLocal_76))
								{
									if (PED::IS_PED_IN_VEHICLE(iLocal_76, iLocal_77, false))
									{
										...
										vLocal_317 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_77, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_77, "wheel_lr")) };
										vLocal_320 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_77, vLocal_317) };
										GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_wheel_burnout", iLocal_77, vLocal_320 + Vector(-0.5f, -1f, 0f), 0f, 180f, 0f, 0.25f, false, false, false);
										vLocal_323 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_77, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_77, "wheel_rr")) };
										vLocal_326 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_77, vLocal_323) };
										GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_wheel_burnout", iLocal_77, vLocal_326 + Vector(-0.5f, -1f, 0f), 0f, 180f, 0f, 0.25f, false, false, false);
										SYSTEM::SETTIMERA(0);
							...
							case 2:
								...
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_76, false))
								{
									if (!PED::IS_PED_IN_VEHICLE(iLocal_76, iLocal_77, false))
									{
										func_70(iLocal_76, &iLocal_67, -1, 0, 0, 0, -1082130432 /* Float: -1f */, 0, -1, -1, 1);
									}
								}
								else
								{
								...
								if (HUD::DOES_BLIP_EXIST(iLocal_65))
								{
									if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_77, false))
									{
										...
										if (!bLocal_60)
										{
											...
											if (!CAM::IS_SPHERE_VISIBLE(vLocal_93, 2f) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_75))
											{
												ENTITY::SET_ENTITY_COORDS(iLocal_75, vLocal_93, true, false, false, true);
									...
									else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_77, iLocal_75, 20f, 20f, 7f, false, true, 0))
									{
										...
										if (func_62())
										{
											if (VEHICLE::_0x639431E895B9AA57(iLocal_75, iLocal_77, -1, false, false))
											{
												if (!bLocal_296)
												{
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_75))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_78);
						TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_102, 1f, 20000, 40000f, 0.5f);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_2(iParam2), true);
}
		...
		switch (iLocal_51)
		{
					...
					if (func_46(1, 0, 1))
					{
						if (!MISC::IS_BIT_SET(Global_7551, 11))
						{
							if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
							{
								...
								{
									HUD::CLEAR_HELP(true);
									while (!func_33(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_57, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
									{
										HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
										SYSTEM::WAIT(0);
									}
									func_33(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_57, 0, 1056964608 /* Float: 0.5f */, 0, 1, 0);
								}
								HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
								if (!PED::IS_PED_INJURED(iLocal_75))
								{
			...
			case 1:
				...
				if (iLocal_301 == 1)
				{
					...
					fVar7 = 53.23f;
					fLocal_112 = 50f;
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_87, true, false, false, true);
					WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
					ENTITY::SET_ENTITY_COORDS(iLocal_75, vLocal_93, true, false, false, true);
					ENTITY::SET_ENTITY_HEADING(iLocal_77, fLocal_105);
					ENTITY::SET_ENTITY_COORDS(iLocal_77, vLocal_90, true, false, false, true);
				}
				else
				{
				...
				iLocal_79 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_ANIMATED_CAMERA", vLocal_113, vLocal_116, fLocal_112, false, 2);
				...
				vLocal_310 = { ENTITY::GET_ENTITY_COORDS(iLocal_77, true) };
				vLocal_313 = { ENTITY::GET_ENTITY_ROTATION(iLocal_77, 2) };
				if (func_168(iLocal_80))
				{
					if (func_23(iLocal_80, vLocal_90, 1) <= 11f)
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_80, vVar4, true, false, false, true);
				...
				MISC::CLEAR_AREA(vLocal_90, 10f, true, false, false, false);
				SYSTEM::SETTIMERA(0);
				if (iLocal_301 == 2)
				{
			...
			case 4:
						...
						if (!PED::IS_PED_INJURED(iLocal_75))
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_302) >= 0.83f)
							{
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_75, sLocal_306, sLocal_308, 2))
								{
									...
									PED::_0x2208438012482A1A(iLocal_75, true, false);
								}
								else
								{
									PED::SET_PED_RESET_FLAG(iLocal_75, 310, true);
				...
				if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_302) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_302) >= 0.99f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_302)) || func_20())
				{
					...
					if (bLocal_342)
					{
						vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_306, sLocal_309, vLocal_310, vLocal_313, 1f, 2) };
						...
						vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_306, sLocal_309, vLocal_310, vLocal_313, 1f, 2) };
...
float func_23(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
void func_35(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_41(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
void func_43(vector3 vParam0, float fParam3, float fParam4)
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;
...
void func_63()
{
	...
	if (func_168(iLocal_77))
	{
		...
		if (bVar1 && VEHICLE::ARE_ALL_VEHICLE_WINDOWS_INTACT(iLocal_77))
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_77(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6)
{
	func_78(uParam0, iParam1, 0f, 0f, 0f, iParam2, iParam3, iParam4, iParam5, sParam6);
}

void func_78(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9)
{
	func_79(uParam0, iParam1, vParam2, iParam5, iParam6, iParam7, iParam8, sParam9);
}

void func_79(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, char* sParam7, int iParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_80(uParam0, iParam1, vParam2, iParam5, iParam6, sParam7, iParam8, bParam9);
}

void func_80(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
	...
	if (func_104(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_95(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_95(var uParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_108()
{
	...
	if (func_168(iLocal_77))
	{
		func_109(iLocal_64, iLocal_77, fVar0, 1061158912 /* Float: 0.75f */, 0);
...
void func_109(int iParam0, int iParam1, float fParam2, float fParam3, bool bParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		switch (iLocal_50)
		{
			...
			case 2:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_75, 242628503) != 1 && !func_115(iLocal_75, -875674219))
				{
					if (iLocal_301 == 1)
					{
						...
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_75, vLocal_93, 1.5f, 1.5f, 1.5f, false, true, 0))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_75, 242628503) == 7)
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_78);
								TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_93, 1f, 20000, fLocal_106, 0.5f);
			...
			case 3:
				...
				else
				{
					...
					if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_75, vLocal_93, 4f, 4f, 4f, false, true, 0))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_75, 2106541073) == 7)
						{
							TASK::TASK_GO_STRAIGHT_TO_COORD(iLocal_75, vLocal_93, 1f, 20000, fLocal_106, 0.5f);
						}
					}
...
struct<10> func_150(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	struct<10> Var0;
...
int func_157(bool bParam0)
{
	if (func_160())
	{
		...
		if (bParam0 && func_131(Global_111847))
		{
...
int func_169()
{
	...
	switch (iLocal_301)
	{
		case 1:
			...
			fLocal_57 = 3f;
			if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_96) < SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_99))
			{
				vVar3 = { vLocal_96 };
				fVar6 = fLocal_110;
				bLocal_61 = true;
	...
	if (((((((STREAMING::HAS_MODEL_LOADED(iVar7) && STREAMING::HAS_MODEL_LOADED(iVar8)) && STREAMING::HAS_MODEL_LOADED(iVar9)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_83)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_84)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_85)) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4")) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_301 == 1)
		{
			func_183("re_cartheft - Distance to vTop = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_96));
			func_183("re_cartheft - Distance to vBottom = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_99));
			iLocal_77 = VEHICLE::CREATE_VEHICLE(iVar9, vVar3, fVar6, true, true, false);
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - vLocal_52 };
				fLocal_55 = MISC::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
			}
			iLocal_75 = PED::CREATE_PED(5, iVar7, vLocal_52, fLocal_55, true, true);
...
int func_194(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
void func_198(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_199(func_210(), iParam0, uParam1, uParam2, iParam3, iParam4, iParam5, iParam6);
}

void func_199(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110905) || Global_30970) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_223()) || func_222()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 1:
						...
						break;
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110905) || Global_30970) || func_226()) || func_59(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_111858.f_7684.f_919[iVar0] == 5) || Global_42178 != -1)
						{
							return 0;
						}
						break;
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_110905) || Global_30970) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_222()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 4:
						if (((((func_227() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_59(8, -1)) || func_222()) || func_221()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_30970) || func_226()) || func_59(8, -1)) || func_224()) || func_223()) || func_222()) || Global_111858.f_7684.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
						break;
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_227()) || func_224()) || Global_110905) || Global_30970) || func_226()) || Global_42801) || func_59(8, -1)) || func_223()) || func_221()) || func_222()) || Global_111858.f_7684.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_110905) || Global_30970) || func_226()) || func_59(8, -1)) || func_223()) || func_221()) || func_225()) || func_224()) || func_222())
						{
							return 0;
						}
						break;
...
void func_243(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_210();
	func_246(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_245(iParam0, &iVar0);
	Var1 = { func_244(&iVar0) };
}

struct<16> func_244(int iParam0)
{
	struct<16> Var0;
	int iVar16;

	StringCopy(&Var0, "", 64);
	iVar16 = func_204(*iParam0);
	if (iVar16 < 10)
	{
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_206(*iParam0), 64);
	return Var0;
}
...
void func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
