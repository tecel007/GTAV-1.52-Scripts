#region Local Var
	...
	var uLocal_102 = 0;
	var uLocal_103 = 0;
	vector3 vLocal_104[32] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
		...
		switch (func_207(PLAYER::NETWORK_PLAYER_ID_TO_INT()))
		{
			case 0:
				if (func_206() == 1)
				{
					if (func_205())
					{
						vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/] = 1;
					}
				}
				break;
			case 1:
				...
				{
					vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/] = 3;
				}
				break;
			case 3:
				func_219();
...
int func_30(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, float fParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	if (bParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_31(vParam0, fParam6, iParam7, fParam9, bParam10, bParam11, bParam12, bParam16, bParam17))
			{
				return 0;
			}
		}
...
int func_31(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam4 && !bParam7)
	{
		if (func_40(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_36(PLAYER::PLAYER_ID()), vParam0, true) <= (bVar2 + fParam3))
				{
				...
				if (bParam4 == 1 || (bParam4 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_32(iVar1) || !bParam10) && !Global_2425662[iVar1 /*421*/].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_36(iVar1), vParam0, true) <= (bVar2 + fParam3))
								{
...
int func_41(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
			...
			if (func_40(iVar1, bParam4, bParam5))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_32(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && bParam9) && bParam6) && func_42(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_37(iVar1), vParam0, true) < fParam3)
								{
									return 1;
								}
							}
...
int func_64(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar1724 <= iVar3)
	{
		...
		else
		{
			...
			{
				fVar1728 = SYSTEM::VDIST2(vVar4, vVar1725);
				if (fVar10 > fVar1728)
				{
					iVar1723++;
					if (iVar1723 == iVar0)
		...
		case 1:
			switch (iParam2)
			{
				case 1:
					...
					uParam0->f_1149.f_1[6 /*10*/].f_2 = 750871581;
...
int func_100(struct<2> Param0, var uParam2, var uParam3, var uParam4)
{
	...
	while (iVar0 < func_102())
	{
		...
		{
			if (MISC::IS_BIT_SET(vLocal_104[iVar0 /*3*/].f_1, 0))
			{
				if (!MISC::IS_BIT_SET(vLocal_104[iVar0 /*3*/].f_1, 4))
				{
					iLocal_95++;
				}
				if (Param0.f_1 == 18)
			...
			else if (MISC::IS_BIT_SET(vLocal_104[iVar0 /*3*/].f_1, 1))
			{
			}
			else if (!MISC::IS_BIT_SET(vLocal_104[iVar0 /*3*/].f_1, 1))
			{
...
void func_122()
{
	...
	iVar0 = 10000;
	switch (vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			if (Global_2506618.f_2 >= 4 && Global_2506618.f_2 != 8)
			{
				if (func_96(1))
				{
					MISC::SET_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 0);
					MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 1);
				}
				...
				{
					func_116(&uLocal_96);
					MISC::SET_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 3);
				}
				else
				{
					...
					if (func_15(&uLocal_96, iVar0, 0))
					{
						...
						func_203(4);
						MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 3);
					}
				}
			}
		...
		case 4:
			if (func_204(PLAYER::PLAYER_ID(), 0))
			{
				...
				{
					func_203(8);
					MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 0);
					MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 4);
				}
			...
			else
			{
				if (func_179())
				{
					if (!func_166())
					{
						MISC::SET_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 4);
					}
				...
				if (!func_204(PLAYER::PLAYER_ID(), 0))
				{
					...
					func_203(0);
					MISC::SET_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 1);
					MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 4);
				}
			}
			break;
			...
			if (!func_127())
			{
					...
					if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&cVar1)) == 0)
					{
						if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE(&cVar1, -1, false, 0) || NETWORK::NETWORK_GET_NUM_SCRIPT_PARTICIPANTS(&cVar1, -1, 0) < 32)
						{
							if (!NETWORK::NETWORK_IS_SCRIPT_ACTIVE(&cVar1, -1, true, 0))
							{
								...
								{
									MISC::SET_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 2);
								}
							}
						}
					}
				...
				else if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&cVar1)) != 0)
				{
					if (Global_2506618.f_2 == 7)
					{
						...
						MISC::CLEAR_BIT(&(vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 2);
					}
				}
			}
			break;
...
{
	vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_2 = iParam0;
}

bool func_204(int iParam0, int iParam1)
{
	return MISC::IS_BIT_SET(vLocal_104[iParam0 /*3*/].f_1, iParam1);
}
...
int func_220(struct<21> Param0)
{
	...
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_104, 97);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
	vLocal_104[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/] = 0;
	func_203(0);
	return 1;
}
