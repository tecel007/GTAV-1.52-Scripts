...
bool func_5(var uParam0)
{
	...
	func_7(uParam0, uParam0->f_57.f_2, &uVar0);
	func_7(uParam0, uParam0->f_57.f_2, &uVar4);
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 5:
			...
			if (iVar41 != 1 && iVar41 != 0)
			{
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar42))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar42) >= 1f)
				{
					...
					func_40(uParam0, &uVar16);
					uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 7:
			...
			break;
		case 8:
			iVar43 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
...
void func_24(var uParam0)
{
	...
	uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
	func_41(uParam0, &uVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
	func_9(&(uParam0->f_57.f_5));
	func_52(uParam0, 8);
}
...
Vector3 func_38(var uParam0)
{
	...
	vVar0 = { (uParam0[uParam0->f_57.f_2 /*14*/])->f_8.f_3 };
...
int func_73()
{
	if (Global_1590525 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1590525, true, 0))
		{
			return 0;
		}
...
void func_74()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_75(0, &uLocal_85, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_75(1, &uLocal_85, &iVar0);
}
...
void func_75(int iParam0, var uParam1, int iParam2)
{
	...
	func_82(iParam0, &vVar0, &fVar3);
	iVar4 = 0;
	while (iVar4 < 2)
	{
		(*uParam1)[(*iParam2)[iVar4] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_78(func_79(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_78(func_77(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_78(func_76(iVar4), fVar3) + vVar0 };
...
Vector3 func_78(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_82(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 0:
