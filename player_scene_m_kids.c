				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &uLocal_349, &(Local_430[iParam1 /*16*/]), 2))
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iParam1], false))
						{
							...
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285) > 0.817f)
								{
						...
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96285) > fLocal_481)
						{
			...
			case 10:
				...
				else
				{
					if (func_6(iLocal_246[iParam1], iLocal_249[iParam1], &uVar42, &cVar58, &uVar74, &uVar75) && func_4(iLocal_246[iParam1], iLocal_249[iParam1], &vVar76, &fVar79))
					{
						...
						{
							iLocal_480 = PED::CREATE_SYNCHRONIZED_SCENE(vVar0 + vVar76, 0f, 0f, (fVar3 + fVar79), 2);
							PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_480, true);
							PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_480, false);
						}
						TASK::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_480, &uVar42, &cVar58, 1000f, -8f, 0, 0, 1000f, 0);
						PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_480, true);
						iLocal_243[iParam1] = 1;
					}
					Jump @691; //curOff = 592
					if (iLocal_249[iParam1] != Global_93961[iLocal_246[iParam1]])
					{
						if (!ENTITY::DOES_ENTITY_EXIST(Global_98676))
						{
							Global_93961[iLocal_246[iParam1]] = 140;
							Global_93977 = iLocal_249[iParam1];
...
int func_4(int iParam0, int iParam1, var uParam2, float fParam3)
{
	switch (iParam1)
	{
		case 0:
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_111858.f_2359.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_29(14) || Global_110809))
			{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96285))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96285, &uLocal_349, &(Local_430[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
					iLocal_243[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], false))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96285, &(Local_302[iVar0 /*16*/]), &uLocal_349, 8f, 8f, 0, 1000f);
				}
				iVar0++;
			}
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_463) && bLocal_468)
...
int func_36()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96284))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96284, &uLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], false))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96284, &(Local_269[iVar0 /*16*/]), &uLocal_349, 8f, 8f, 0, 1000f);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_253[iVar0]))
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_463))
		{
			...
			if (iLocal_70 == 156)
			{
				func_37(&uLocal_71, 3, Global_98676, "JIMMY", 0, 1);
...
int func_38(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_39(Global_98676) && iParam1 != 0)
		{
			Global_98676 = 0;
		}
	}
	...
	switch (iParam1)
	{
		...
		case 9:
			if (iParam2 == 108)
			{
				iVar0 = 12;
				iVar1 = 32;
				if (MISC::IS_BIT_SET(Global_111858.f_2359.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32)))
				{
...
int func_49(int iParam0, int iParam1, bool bParam2)
{
	...
	Global_76647[1 /*14*/] = { func_69(iVar0, iParam1, bParam2, -1) };
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_49(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_49(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (bVar4 <= 19)
								{
									Global_76647[2 /*14*/] = { func_69(iVar0, 14, bVar4, -1) };
					...
					else
					{
						...
						Global_76647[2 /*14*/] = { func_69(iVar0, iVar2, bVar1, -1) };
	...
	else if (Global_76647[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_50(iParam1)) && Global_76647[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_50(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_55(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (bParam1 - func_57(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (bParam1 - func_56(iParam0, func_50(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_50(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_58(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
int func_63(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, false, -1, func_50(iParam2));
		fVar1 = FILES::INIT_SHOP_PED_COMPONENT(bParam1);
		if (fVar1 != -1)
		{
			return (func_56(iParam0, func_50(iParam2)) + fVar1);
		}
	}
	return -99;
}
		...
		case joaat("PLAYER_ZERO"):
			switch (bParam1)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_68(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[0], Global_111858.f_2359.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				case 6:
		...
		case joaat("PLAYER_ONE"):
			switch (bParam1)
			{
				...
				case 1:
					...
					break;
				case 2:
					func_68(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[1], Global_111858.f_2359.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				case 3:
		...
		case joaat("PLAYER_TWO"):
			switch (bParam1)
			{
				...
				case 3:
					...
					break;
				case 4:
					func_68(&Var1, -99, -99, Global_111858.f_2359.f_539.f_196[2], Global_111858.f_2359.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				case 5:
...
void func_71(bool bParam0)
{
	...
	func_72(&(Global_76647[0 /*14*/]), iVar10, bParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_75(func_78(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_75(func_74(iParam1, uParam0->f_2), Global_76644, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_75(iVar1, Global_76644, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_74(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 2:
			...
			Jump @1044; //curOff = 966
			switch (iParam0)
			{
				case 14:
					return 975;
			}
			Jump @1044; //curOff = 991
			switch (iParam0)
			{
				case 14:
					return 976;
			}
			Jump @1044; //curOff = 1016
			switch (iParam0)
			{
				case 14:
					return 977;
...
int func_80(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_83(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				Global_2621445 = Var2;
				func_72(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_72(&(Global_76647[0 /*14*/]), iParam0, bParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_72(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_72(&(Global_76647[0 /*14*/]), iParam0, bParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (bParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, false, -1, func_50(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_138(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_76647[1 /*14*/] = { func_69(iVar10, iParam1, bParam2, -1) };
		if (!func_164(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_76647[1 /*14*/] = { func_69(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76647[1 /*14*/] = { func_69(iVar10, 14, uVar28[iVar1], -1) };
							func_155(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
							func_161(14);
							if (Global_76645 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_50(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iVar0), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
						}
						func_161(iVar0);
						if (Global_76645 == 1)
						{
			...
			{
				Global_76647[1 /*14*/] = { func_69(iVar10, iVar0, func_145(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76647[1 /*14*/] = { func_69(iVar10, 14, uVar69[iVar1], -1) };
			func_155(iParam0, Global_76647[1 /*14*/].f_12, Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4);
			func_161(14);
			if (Global_76645 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_50(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iParam1), Global_76647[1 /*14*/].f_3, Global_76647[1 /*14*/].f_4, iParam4);
		}
		if (Global_76645 == 1)
		{
			iVar2 = 0;
...
int func_139(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!func_49(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_76647[1 /*14*/] = { func_69(iParam0, iParam1, bParam2, -1) };
	return MISC::IS_BIT_SET(Global_76647[1 /*14*/].f_6, 2);
}

int func_144(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	...
	{
		if (!func_49(iParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_157(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (bVar1 != -1 && bVar1 != 0)
	{
		...
		{
			return func_63(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 3);
		}
		else if (iVar0 == joaat("MP_F_FREEMODE_01"))
		{
			return func_63(ENTITY::GET_ENTITY_MODEL(iParam0), bVar1, 14, 4);
		}
	}
...
int func_171(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_184(int iParam0, float fParam1, char* sParam2)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[0];
			StringCopy(sParam2, func_186(Global_111858.f_2359.f_539.f_2314[0]), 32);
			return 1;
		case 6:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[1];
			StringCopy(sParam2, func_186(Global_111858.f_2359.f_539.f_2314[1]), 32);
			return 1;
		case 7:
			*fParam1 = Global_111858.f_2359.f_539.f_2310[2];
			StringCopy(sParam2, func_186(Global_111858.f_2359.f_539.f_2314[2]), 32);
			return 1;
		case 11:
...
int func_185(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
