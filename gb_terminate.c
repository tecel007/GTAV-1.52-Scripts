...
bool func_23(bool bParam0)
{
	...
	return MISC::IS_BIT_SET(Global_1377170.f_241.f_136[func_25(10) /*33*/][bParam0], func_24(10));
}
...
void func_38()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_42() < 2)
		{
			if (MISC::IS_BIT_SET(Local_93[iVar2 /*4*/].f_1, 1))
			{
				func_39(PLAYER::INT_TO_PLAYERINDEX(iVar2));
				MISC::SET_BIT(&(Local_82.f_1), 1);
			}
			if (MISC::IS_BIT_SET(Local_93[iVar2 /*4*/].f_1, 4))
			{
				func_39(func_11());
				MISC::SET_BIT(&(Local_82.f_1), 7);
			}
			if (MISC::IS_BIT_SET(Local_93[iVar2 /*4*/].f_1, 0))
			{
				MISC::SET_BIT(&(Local_82.f_1), 0);
			}
			if (MISC::IS_BIT_SET(Local_93[iVar2 /*4*/].f_1, 2))
			{
				MISC::SET_BIT(&(Local_82.f_1), 4);
			}
		}
		...
		{
			if (MISC::IS_BIT_SET(Local_93[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
...
int func_63(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
				...
				if (NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(iVar1) != -1)
				{
					if (func_9(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(iVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_76(bParam0, NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(iVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
	{
		...
		{
			return func_76(bParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
		}
	}
	return func_76(bParam0, PLAYER::PLAYER_ID(), iParam1, bParam2, bParam3);
}
...
int func_76(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_78(iParam1, bParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_70(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(bParam0), 0) && MISC::IS_BIT_SET(Global_4456448.f_15, 23)) && !MISC::IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_69(1);
			}
...
bool func_78(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
int func_87(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && bParam1 != func_10())
	{
		...
		if (MISC::IS_BIT_SET(Global_4456448.f_15, 26) && !func_70(iParam0, PLAYER::GET_PLAYER_TEAM(bParam1), 0))
		{
			iVar0 = func_77(1);
		}
	}
...
void func_96()
{
	switch (func_620())
	{
		...
		case 1:
			...
			break;
		case 2:
			if (!MISC::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
			{
				func_394(0, func_10());
				func_302();
				func_97();
...
void func_97()
{
	...
	if (!MISC::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
	{
		...
		{
			MISC::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
			return;
		}
		if (func_301())
		{
		...
		{
			func_98(151, MISC::IS_BIT_SET(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 1), &Var0, 0);
		}
		MISC::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
	}
}
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
	...
	*iParam0 = 5;
	...
	if ((bVar0 || bVar1) || NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(&iVar4, iParam3, iParam4, iParam2, iParam5, iParam6))
	{
		...
		{
			*iParam0 = func_145(iVar4, iParam1, iParam4, iParam2, iParam3, iParam5, 0, iParam6, iParam7, 1, 1);
			if (bVar1 && !bVar0)
			{
			}
			if (bVar0)
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
var func_153(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, int iParam10)
{
	return func_154(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, bParam9, iParam10);
}

var func_154(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, int iParam10)
{
	var uVar0;
	int iVar1;

	uVar0 = func_164(iParam0, sParam2, iParam3, iParam4, iParam5, iParam6, iParam7, bParam9);
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam1))
		{
			if (ENTITY::IS_ENTITY_A_PED(iParam1))
			{
				...
				func_160(PED::GET_PED_BONE_COORDS(iVar1, 31086, 0f, 0f, 0f), uVar0, 0, iParam8, iParam10);
			}
		}
	}
	else
	{
		func_155(iParam1, uVar0, iParam8, iParam10);
	}
	return uVar0;
}
...
void func_155(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_160(vVar0, uParam1, 0, iParam2, iParam3);
}
...
{
	return SYSTEM::VDIST(func_189(iParam0), func_189(bParam1));
	return 0f;
}
...
int func_211(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	char cVar1[64];
	...
	if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iParam1) || bParam5)
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_216(&cVar1));
		if (!iParam3 == 0)
		{
...
void func_221(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 237)
	{
		...
		if (iVar11 != -1)
		{
			...
			*iParam3 = iVar1;
			...
			{
				iVar2 = func_237(Global_1590535[iVar11 /*876*/].f_854, *iParam3);
			}
			if (uParam1->f_17)
			{
...
void func_238(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_122())
			{
				...
				iVar7 = func_262(PLAYER::PLAYER_ID(), Var0, *iParam3);
				if (Var0.f_1 == 1)
				{
...
void func_269(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_326(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, bool bParam5, bool bParam6, bool bParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)
{
	struct<80> Var0;
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 28)
						{
							...
							while (iVar52 < 32)
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									if (!func_19(iVar35, 0))
									{
										if ((func_460(iVar35) || Global_2425662[iVar35 /*421*/].f_236 != -1) || func_30(iVar35))
										{
											iVar44 = iVar35;
											if (func_29(iVar35))
											{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_455(iVar35) && func_451(iVar35, iParam2)) && func_9(iVar35, 0, 1))
							{
								...
								*(uParam4[iVar52 /*13*/]) = { func_175(iVar35) };
								...
								if (iParam5 != -1)
								{
									func_435(&iVar43, &fVar45, (uParam0[iVar52 /*42*/])->f_9, iParam5);
								...
								if (func_432(iParam5))
								{
									func_431(iVar35, iParam1, uParam3, iVar53, Var38, sVar36, uVar42, iVar43, sVar51, iVar50, fVar45, iVar43, iVar47, &cVar57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
								else
								{
									func_431(iVar35, iParam1, uParam3, iVar53, Var38, sVar36, uVar42, iVar43, sVar51, iVar50, fVar45, iVar46, iVar47, &cVar57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
							...
							if (func_455(iVar35))
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									*(uParam4[iVar52 /*13*/]) = { func_175(iVar35) };
									...
									uParam3->f_38[iVar44 /*2*/].f_1 = iVar53;
									func_411(iVar35, PLAYER::GET_PLAYER_NAME(iVar35), iParam1, uParam3, iVar53, Var38, sVar36, uVar42, sVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
...
void func_411(bool bParam0, char* sParam1, int* iParam2, var uParam3, int iParam4, var uParam5, char* sParam6, var uParam7, char* sParam8, char* sParam9, int iParam10, int iParam11, int iParam12)
{
	int iVar0;
	char* sVar1;
...
void func_431(bool bParam0, int* iParam1, var uParam2, int iParam3, var uParam4, char* sParam5, var uParam6, int iParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, float fParam13, int iParam14, int iParam15, bool bParam16, int iParam17, int iParam18, bool bParam19)
{
	int iVar0;
	char* sVar1;
...
int func_435(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_439(iParam3))
	{
...
int func_460(bool bParam0)
{
	if (func_9(bParam0, 0, 1))
	{
		...
		{
			if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(bParam0, PLAYER::PLAYER_ID()) || func_32(bParam0) == 233)
			{
				return 1;
			}
		}
...
void func_474(int* iParam0, bool bParam1, char* sParam2, int iParam3)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
	{
...
void func_480(int* iParam0, bool bParam1, char* sParam2, int iParam3)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*iParam0, "SET_TITLE");
...
void func_487(int* iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
...
int func_516(int iParam0)
{
	...
	else if (bVar3 || ((!bVar2 && !func_35(iParam0)) && !func_517(iParam0)))
	{
		iVar0 = 2;
	}
	else
...
void func_519()
{
	...
	{
		func_520(151, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(func_37()), true), &uLocal_81, 1140457472 /* Float: 500f */, 1144750080 /* Float: 750f */, 0);
	}
}
...
void func_520(int iParam0, vector3 vParam1, int iParam4, float fParam5, float fParam6, bool bParam7)
{
	...
	if ((((func_426(PLAYER::PLAYER_ID()) && !func_454(PLAYER::PLAYER_ID())) && !MISC::IS_BIT_SET(Global_1628237[PLAYER::PLAYER_ID() /*615*/].f_1, 8)) && (func_423(PLAYER::PLAYER_ID()) || func_518(PLAYER::PLAYER_ID()))) || func_562(vParam1))
	{
		return;
	}
	...
	else
	{
		...
		if (*iParam4 && func_9(PLAYER::PLAYER_ID(), 1, 1))
		{
			*iParam4 = 0;
			...
			if (bParam7 && !func_426(PLAYER::PLAYER_ID()))
			{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(Var0) && ENTITY::IS_ENTITY_A_PED(Var0)) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var0) == PLAYER::GET_PLAYER_PED(func_37()))
		{
			if (Var0.f_5)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Var0.f_1) && ENTITY::IS_ENTITY_A_PED(Var0.f_1))
				{
					...
					{
						MISC::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 1);
					}
				}
			}
		}
...
void func_566(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
			...
			else
			{
				switch (iVar1)
				{
					...
					case 261:
						return func_571(11);
					case 254:
						if (PLAYER::GET_PLAYER_TEAM(bParam0) == PLAYER::GET_PLAYER_TEAM(Global_2439138))
						{
							return func_571(6);
						}
						else
...
{
	if (func_63(iParam0, -2, 0, 0, 0) == func_63(bParam1, -2, 0, 0, 0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (func_570(func_63(iParam0, -2, 0, 0, 0)) && func_570(func_63(bParam1, -2, 0, 0, 0)))
		{
			return 1;
		}
	}
...
int func_575(var uParam0, var uParam1, int* iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	if (bParam5)
	{
...
void func_582(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	var uVar0;
	...
	if (func_575(&(Global_2416079.f_621[bParam0]), &(Global_2416079.f_984[bParam0]), &(Global_2416079.f_389), bParam2, bParam0, bParam3, &uVar0))
	{
		if (bParam2)
		{
			Global_2416079.f_456[bParam0] = uParam1;
		}
	}
}
...
void func_585(char* sParam0, bool bParam1, int iParam2, bool bParam3)
{
	func_586(sParam0, PLAYER::GET_PLAYER_NAME(bParam1), bParam3, 1);
}
...
void func_600()
{
	...
	if (PLAYER::PLAYER_ID() != func_60())
	{
		...
		else
		{
			...
			MISC::SET_BIT(&(Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
		}
	}
...
{
	Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 = iParam0;
}
...
void func_607()
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_48(bVar1, iVar2, 1) || func_608(bVar1, PLAYER::PLAYER_ID()))
			{
...
int func_608(bool bParam0, bool bParam1)
{
...
int func_620()
{
	return Local_93[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2;
}
...
int func_693(struct<21> Param0)
{
	...
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_93, 129);
