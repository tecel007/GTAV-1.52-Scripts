...
void func_1()
{
	...
	{
		case 0:
			if (func_52(vVar0, vVar3) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_41, true), 90f))
			{
				func_76();
		...
		case 3:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294))
			{
				...
				if (!bLocal_299 && MISC::GET_GAME_TIMER() > iLocal_300)
				{
...
void func_40(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_95883 && Global_95884) || func_54())
					{
						return 0;
					}
					if (func_53(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
	...
	switch (iLocal_40)
	{
		...
		case joaat("PROP_MR_RASPBERRY_01"):
			if (Global_111858.f_7257.f_227[145] == 1)
			{
				if (func_15() == 2)
				{
					if (((((Global_93961[13] != 127 && Global_93961[13] != 135) && Global_93977 != 127) && Global_93977 != 135) && !func_65()) && !func_67())
					{
						return 1;
					}
				}
...
{
	return func_73(iParam0, Global_41631);
}
...
void func_74()
{
	...
	if (bLocal_298)
	{
		UNK_0x1082C25039B168F8(func_35());
	}
	func_75();
	func_76();
...
void func_75()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && func_49(1, 0, 1)) && bLocal_36)
		{
			func_40(0, 1, 1, 0, 0, 0, 0);
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
